---
url: "https://daisyui.com/docs/install/nextjs/"
title: "Install daisyUI for Next.js — daisyUI Tailwind CSS Component UI Library"
---
...
Next.js is a meta framework for React, providing server-side rendering, static site generation, and routing
...
### [Link to heading](https://daisyui.com/docs/install/nextjs/\#1-create-a-new-nextjs-project) 1\. Create a new Next.js project
...
### [Link to heading](https://daisyui.com/docs/install/nextjs/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/nextjs/\#3-add-tailwind-css-and-daisyui) 3\. Add Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/nextjs/\#note-about-using-turbopack) Note about using Turbopack
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/nextjs/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/nextjs/+page.md?plain=1)
