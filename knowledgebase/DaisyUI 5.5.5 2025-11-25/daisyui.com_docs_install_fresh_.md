---
url: "https://daisyui.com/docs/install/fresh/"
title: "Install daisyUI for Deno Fresh — daisyUI Tailwind CSS Component UI Library"
---
...
[Website](https://fresh.deno.dev/) [GitHub](https://github.com/denoland/fresh)

# Install daisyUI for Deno Fresh

How to install Tailwind CSS and daisyUI in a Deno Fresh project

### [Link to heading](https://daisyui.com/docs/install/fresh/\#1-create-a-new-fresh-project) 1\. Create a new Fresh project
...
### [Link to heading](https://daisyui.com/docs/install/fresh/\#2-install-daisyui) 2\. Install daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/fresh/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/fresh/+page.md?plain=1)
