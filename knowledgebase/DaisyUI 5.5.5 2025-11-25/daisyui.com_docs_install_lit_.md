---
url: "https://daisyui.com/docs/install/lit/"
title: "Install daisyUI for Lit — daisyUI Tailwind CSS Component UI Library"
---
...
### [Link to heading](https://daisyui.com/docs/install/lit/\#1-create-a-new-vite-project) 1\. Create a new Vite project
...
### [Link to heading](https://daisyui.com/docs/install/lit/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/lit/\#3-make-the-css-available-for-shadow-dom-elements) 3\. Make the CSS available for shadow DOM elements
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/lit/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/lit/+page.md?plain=1)
