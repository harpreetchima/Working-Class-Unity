---
url: "https://daisyui.com/docs/install/postcss/"
title: "Install daisyUI for PostCSS — daisyUI Tailwind CSS Component UI Library"
---
...
PostCSS is a CSS processor for transforming CSS using JavaScript plugins.

[Website](https://postcss.org/) [GitHub](https://github.com/postcss/postcss)

# Install daisyUI for PostCSS

How to install Tailwind CSS and daisyUI in PostCSS

### [Link to heading](https://daisyui.com/docs/install/postcss/\#1-install) 1\. Install
...
### [Link to heading](https://daisyui.com/docs/install/postcss/\#2-add-tailwind-css-and-daisyui) 2\. Add Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/postcss/\#3-build-css) 3\. Build CSS
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/postcss/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/postcss/+page.md?plain=1)
