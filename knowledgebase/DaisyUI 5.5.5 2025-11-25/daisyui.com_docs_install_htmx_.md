---
url: "https://daisyui.com/docs/install/htmx/"
title: "Use daisyUI with HTMX — daisyUI Tailwind CSS Component UI Library"
---
...
[Website](https://htmx.org/) [GitHub](https://github.com/bigskysoftware/htmx)

# Use daisyUI with HTMX

How to install and use daisyUI with HTMX

> This guide uses daisyUI as a Node.js dependency. If you don't want to use Node.js, try the [CDN version of daisyUI](https://daisyui.com/docs/cdn/).

### [Link to heading](https://daisyui.com/docs/install/htmx/\#1-install) 1\. Install
...
### [Link to heading](https://daisyui.com/docs/install/htmx/\#2-add-tailwind-css-and-daisyui) 2\. Add Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/htmx/\#3-build-css) 3\. Build CSS
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/htmx/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/htmx/+page.md?plain=1)
