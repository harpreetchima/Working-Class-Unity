---
url: "https://daisyui.com/docs/editor/zed/"
title: "Zed setup for daisyUI — daisyUI Tailwind CSS Component UI Library"
---
...
## [Link to heading](https://daisyui.com/docs/editor/zed/\#-zed-llm-setup)![Zed](https://img.daisyui.com/images/logos/zed.webp) Zed LLM setup
...
### [Link to heading](https://daisyui.com/docs/editor/zed/\#quick-use) Quick use
...
### [Link to heading](https://daisyui.com/docs/editor/zed/\#mcp-server) MCP server

MCP is an API to communicate with AI models.

You can add MCP servers to your code editor and Zed will communicate with them to get more accurate results.

You can use [Context7](https://context7.com/) or [daisyUI GitMCP](https://gitmcp.io/saadeghi/daisyui) as MCP server in Zed.

#### [Link to heading](https://daisyui.com/docs/editor/zed/\#daisyui-blueprint) daisyUI Blueprint
...
2. In Zed press `⌘ CMD` \+ `⇧ Shift` \+ `P` ( Or `Ctrl` \+ `Shift` \+ `P` )
...
#### [Link to heading](https://daisyui.com/docs/editor/zed/\#usage) Usage
...
#### [Link to heading](https://daisyui.com/docs/editor/zed/\#setup-context7-mcp-server) Setup Context7 MCP server
...
#### [Link to heading](https://daisyui.com/docs/editor/zed/\#setup-daisyui-gitmcp-server) Setup daisyUI GitMCP server
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/editor/zed/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/editor/zed/+page.md?plain=1)
