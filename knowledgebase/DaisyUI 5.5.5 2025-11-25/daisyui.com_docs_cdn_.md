---
url: "https://daisyui.com/docs/cdn/"
title: "Use daisyUI from CDN — daisyUI Tailwind CSS Component UI Library"
---
...
- Some uncommon Tailwind CSS color utility classes for daisyUI colors are available on additional CSS files for CDN usage, see [colors docs](https://daisyui.com/docs/colors/#how-to-use) for more info.
...
[PrevInstall](https://daisyui.com/docs/install/)
...
Do you see a bug? [open an issue on GitHub](https://github.com/saadeghi/daisyui/issues?q=CDN)
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/cdn/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/cdn/+page.md?plain=1)
