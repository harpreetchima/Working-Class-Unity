---
url: "https://daisyui.com/blog/tag/frameworks/"
title: "frameworks — daisyUI Tailwind CSS Component UI Library"
---
...
\\
SvelteKit is a meta framework for building web applications. It is based on Svelte, a compiler that turns your Svelte components into fast and efficient JavaScript.](https://daisyui.com/blog/how-to-install-sveltekit-and-daisyui) [![How to install daisyUI and Tailwind CSS in Next.js 14](https://img.daisyui.com/images/blog/daisyui-nextjs-component-library.webp)\\
**How to install daisyUI and Tailwind CSS in Next.js 14** \\
\\
In this article, we will learn how to use daisyUI component library in Next.js.](https://daisyui.com/blog/install-daisyui-and-tailwindcss-in-nextjs) [![Mary UI: Laravel blade components made with daisyUI](https://img.daisyui.com/images/blog/mary-ui.webp)\\
**Mary UI: Laravel blade components made with daisyUI** \\
\\
Mary UI is a collection of Laravel blade components made for Livewire 3 and styled around daisyUI and Tailwind CSS](https://daisyui.com/blog/mary-ui)
