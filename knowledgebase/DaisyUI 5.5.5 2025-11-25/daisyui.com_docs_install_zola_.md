---
url: "https://daisyui.com/docs/install/zola/"
title: "Install Tailwind CSS and daisyUI for Zola — daisyUI Tailwind CSS Component UI Library"
---
...
[Website](https://www.getzola.org/) [GitHub](https://github.com/getzola/zola)

# Install Tailwind CSS and daisyUI for Zola

How to install Tailwind CSS and daisyUI in a Zola project, without Node.js

### [Link to heading](https://daisyui.com/docs/install/zola/\#1-create-a-new-zola-project) 1\. Create a new Zola project
...
### [Link to heading](https://daisyui.com/docs/install/zola/\#2-get-tailwind-css-executable) 2\. Get Tailwind CSS executable
...
### [Link to heading](https://daisyui.com/docs/install/zola/\#3-get-daisyui-bundled-js-file) 3\. Get daisyUI bundled JS file
...
### [Link to heading](https://daisyui.com/docs/install/zola/\#4-add-tailwind-css-and-daisyui) 4\. Add Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/zola/\#4-build-css) 4\. Build CSS
...
### [Link to heading](https://daisyui.com/docs/install/zola/\#5-run-the-zola-server) 5\. Run the Zola server
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/zola/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/zola/+page.md?plain=1)
