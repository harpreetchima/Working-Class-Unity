---
url: "https://daisyui.com/docs/install/cli/"
title: "Use daisyUI with Tailwind CSS CLI — daisyUI Tailwind CSS Component UI Library"
---
...
The official Tailwind CSS command-line interface.

[Website](https://tailwindcss.com/) [GitHub](https://github.com/tailwindlabs/tailwindcss)

# Use daisyUI with Tailwind CSS CLI

How to install and use daisyUI with Tailwind CSS CLI

### [Link to heading](https://daisyui.com/docs/install/cli/\#1-install) 1\. Install
...
### [Link to heading](https://daisyui.com/docs/install/cli/\#2-add-tailwind-css-and-daisyui) 2\. Add Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/cli/\#3-build-css) 3\. Build CSS
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/cli/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/cli/+page.md?plain=1)
