---
url: "https://daisyui.com/docs/install/sveltekit/"
title: "Install daisyUI for SvelteKit — daisyUI Tailwind CSS Component UI Library"
---
...
SvelteKit is a meta framework for building web applications with Svelte.

[Website](https://kit.svelte.dev/) [GitHub](https://github.com/sveltejs/kit)

# Install daisyUI for SvelteKit

How to install Tailwind CSS and daisyUI in a SvelteKit project

### [Link to heading](https://daisyui.com/docs/install/sveltekit/\#1-create-a-new-sveltekit-project) 1\. Create a new SvelteKit project
...
### [Link to heading](https://daisyui.com/docs/install/sveltekit/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/sveltekit/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/sveltekit/+page.md?plain=1)
