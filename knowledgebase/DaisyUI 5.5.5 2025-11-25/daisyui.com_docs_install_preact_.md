---
url: "https://daisyui.com/docs/install/preact/"
title: "Install daisyUI for Preact — daisyUI Tailwind CSS Component UI Library"
---
...
### [Link to heading](https://daisyui.com/docs/install/preact/\#1-create-a-new-preact-project) 1\. Create a new Preact project
...
### [Link to heading](https://daisyui.com/docs/install/preact/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/preact/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/preact/+page.md?plain=1)
