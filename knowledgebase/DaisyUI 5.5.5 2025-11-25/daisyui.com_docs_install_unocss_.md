---
url: "https://daisyui.com/docs/install/unocss/"
title: "Install daisyUI for UnoCSS — daisyUI Tailwind CSS Component UI Library"
---
...
[Website](https://unocss.dev/) [GitHub](https://github.com/unocss/unocss)
...
### [Link to heading](https://daisyui.com/docs/install/unocss/\#1-create-a-new-vite-project) 1\. Create a new Vite project
...
### [Link to heading](https://daisyui.com/docs/install/unocss/\#2-install-unocss-daisyui-and-unocss-preset-daisy) 2\. Install UnoCSS, daisyUI and unocss-preset-daisy
...
### [Link to heading](https://daisyui.com/docs/install/unocss/\#3-create-a-unocss-config-file) 3\. Create a UnoCSS config file
...
### [Link to heading](https://daisyui.com/docs/install/unocss/\#4-add-unocss-to-your-js-file) 4\. Add UnoCSS to your JS file
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/unocss/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/unocss/+page.md?plain=1)
