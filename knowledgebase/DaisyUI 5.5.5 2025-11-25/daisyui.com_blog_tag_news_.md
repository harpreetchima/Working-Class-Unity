---
url: "https://daisyui.com/blog/tag/news/"
title: "news — daisyUI Tailwind CSS Component UI Library"
---
...
[![New daisyUI logo!](https://img.daisyui.com/images/daisyui/wallpaper-black.png)\\
**New daisyUI logo!** \\
\\
I've been working on a new logo for daisyUI for a long time. Here's the new logo!](https://daisyui.com/blog/daisyui-logo) [![daisyUI 2024 Wrapped](https://img.daisyui.com/images/blog/2024-wrapped-star-history.webp)\\
**daisyUI 2024 Wrapped** \\
\\
Wrapping up 2024. Exciting things are coming in 2025!](https://daisyui.com/blog/daisyui-2024-wrapped) [![daisyUI 5 alpha is in development](https://img.daisyui.com/images/blog/daisyui-alpha.webp)\\
**daisyUI 5 alpha is in development** \\
\\
daisyUI 5 alpha is in development and I'm looking for your suggestions, feedbacks and ideas to make it better.](https://daisyui.com/blog/daisyui-5-alpha) [![The Official daisyUI Figma Library: Designers and Developers, Finally on the Same Page](https://img.daisyui.com/images/store/large/daisyui-figma-file/figma-file-properties.webp)\\
**The Official daisyUI Figma Library: Designers and Developers, Finally on the Same Page** \\
\\
I know how frustrating it’s been for designers to work on a daisyUI project without having access to the daisyUI design system in Figma. Recreating components from scratch is a real pain, and it’s time-consuming.](https://daisyui.com/blog/figma) [![What to expect from daisyUI 5?](https://img.daisyui.com/images/blog/daisyui-5-flowers.webp)\\
**What to expect from daisyUI 5?** \\
\\
An overview of of daisyUI 5 upcoming changes and features](https://daisyui.com/blog/daisyui-5-upcoming-changes) [![daisyUI is now on Discord!](https://img.daisyui.com/images/blog/daisyui-discord.webp)\\
**daisyUI is now on Discord!** \\
\\
Finally we have a Discord server for daisyUI!](https://daisyui.com/blog/discord) [![daisyUI 2023 Wrapped](https://img.daisyui.com/images/blog/daisyui-is-the-best-component-library.webp)\\
**daisyUI 2023 Wrapped** \\
\\
It's the end of the year and this year was amazing! For Front-end development, For CSS, For Tailwind and for daisyUI! Let's take a look at what we've accomplished in 2023.](https://daisyui.com/blog/daisyui-2023-wrapped)
