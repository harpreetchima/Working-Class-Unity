---
url: "https://daisyui.com/docs/install/ember/"
title: "Install daisyUI for Ember — daisyUI Tailwind CSS Component UI Library"
---
...
Ember.js is a productive JavaScript framework for building modern web applications.
...
### [Link to heading](https://daisyui.com/docs/install/ember/\#1-create-a-new-ember-project) 1\. Create a new Ember project
...
### [Link to heading](https://daisyui.com/docs/install/ember/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/ember/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/ember/+page.md?plain=1)
