---
url: "https://daisyui.com/docs/install/laravel/"
title: "Install daisyUI for Laravel — daisyUI Tailwind CSS Component UI Library"
---
...
Laravel is a popular full stack PHP Framework

[Website](https://laravel.com/) [GitHub](https://github.com/laravel/laravel)

# Install daisyUI for Laravel

How to install Tailwind CSS and daisyUI in a Laravel project

### [Link to heading](https://daisyui.com/docs/install/laravel/\#1-create-a-new-laravel-project) 1\. Create a new Laravel project
...
### [Link to heading](https://daisyui.com/docs/install/laravel/\#2-install-daisyui) 2\. Install daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/laravel/\#3-run-your-project) 3\. Run your project
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/laravel/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/laravel/+page.md?plain=1)
