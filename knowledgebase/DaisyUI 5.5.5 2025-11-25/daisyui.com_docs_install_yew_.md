---
url: "https://daisyui.com/docs/install/yew/"
title: "Install daisyUI for Yew — daisyUI Tailwind CSS Component UI Library"
---
...
[Website](https://yew.rs/) [GitHub](https://github.com/yewstack/yew)

# Install daisyUI for Yew

How to install Tailwind CSS and daisyUI in a Yew project

### [Link to heading](https://daisyui.com/docs/install/yew/\#1-install-rust-webassembly-target-and-trunk) 1\. Install Rust, WebAssembly Target and Trunk
...
### [Link to heading](https://daisyui.com/docs/install/yew/\#2-create-a-yew-project) 2\. Create a Yew project
...
### [Link to heading](https://daisyui.com/docs/install/yew/\#3-update-srcmainrs-file) 3\. Update `src/main.rs` file
...
### [Link to heading](https://daisyui.com/docs/install/yew/\#4-create-indexhtml-file) 4\. Create `index.html` file
...
### [Link to heading](https://daisyui.com/docs/install/yew/\#5-add-tailwind-css-and-daisyui) 5\. Add Tailwind CSS and daisyUI
...
#### [Link to heading](https://daisyui.com/docs/install/yew/\#get-tailwind-css-executable) Get Tailwind CSS executable
...
#### [Link to heading](https://daisyui.com/docs/install/yew/\#get-daisyui-bundle-js-file) Get daisyUI bundle JS file
...
#### [Link to heading](https://daisyui.com/docs/install/yew/\#add-tailwind-css-and-daisyui) Add Tailwind CSS and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/yew/\#6-add-a-hook-to-build-outputcss-automatically) 6\. Add a hook to build `output.css` automatically
...
### [Link to heading](https://daisyui.com/docs/install/yew/\#7-run-the-app) 7\. Run the app
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/yew/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/yew/+page.md?plain=1)
