---
url: "https://daisyui.com/docs/install/astro/"
title: "Install daisyUI for Astro — daisyUI Tailwind CSS Component UI Library"
---
...
Astro is JavaScript web framework and site generator focusing on reducing client-side JavaScript. Astro supports components from different front-end libraries such as Vue, Svelte, React, etc.

[Website](https://astro.build/) [GitHub](https://github.com/withastro/astro)

# Install daisyUI for Astro

How to install Tailwind CSS and daisyUI in a Astro project

### [Link to heading](https://daisyui.com/docs/install/astro/\#1-create-a-new-astro-project) 1\. Create a new Astro project
...
### [Link to heading](https://daisyui.com/docs/install/astro/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/astro/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/astro/+page.md?plain=1)
