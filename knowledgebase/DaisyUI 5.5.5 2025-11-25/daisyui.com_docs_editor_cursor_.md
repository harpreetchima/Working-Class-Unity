---
url: "https://daisyui.com/docs/editor/cursor/"
title: "Cursor setup for daisyUI — daisyUI Tailwind CSS Component UI Library"
---
...
## [Link to heading](https://daisyui.com/docs/editor/cursor/\#-cursor-llm-setup)![Cursor](https://img.daisyui.com/images/logos/cursor.webp) Cursor LLM setup
...
### [Link to heading](https://daisyui.com/docs/editor/cursor/\#quick-use) Quick use
...
### [Link to heading](https://daisyui.com/docs/editor/cursor/\#project-level-permanent-setup) Project-level permanent setup
...
### [Link to heading](https://daisyui.com/docs/editor/cursor/\#add-as-an-optional-document-to-cursor) Add as an optional document to Cursor
...
### [Link to heading](https://daisyui.com/docs/editor/cursor/\#mcp-server) MCP server
...
#### [Link to heading](https://daisyui.com/docs/editor/cursor/\#daisyui-blueprint) daisyUI Blueprint
...
#### [Link to heading](https://daisyui.com/docs/editor/cursor/\#usage) Usage
...
#### [Link to heading](https://daisyui.com/docs/editor/cursor/\#setup-context7-mcp-server) Setup Context7 MCP server
...
#### [Link to heading](https://daisyui.com/docs/editor/cursor/\#setup-daisyui-gitmcp-server) Setup daisyUI GitMCP server
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/editor/cursor/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/editor/cursor/+page.md?plain=1)
