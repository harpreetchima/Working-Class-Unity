---
url: "https://daisyui.com/resources/courses/"
title: "daisyUI community courses — daisyUI Tailwind CSS Component UI Library"
---
...
[Videos](https://daisyui.com/resources/videos/) [Articles](https://daisyui.com/resources/articles/) [Courses](https://daisyui.com/resources/courses/)

# daisyUI community courses

If you have a course or tutorial about daisyUI, [add it here](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/lib/data/courses.js)

[**Tailwind + DaisyUI** \\
\\
by Fireship.io](https://fireship.io/courses/sveltekit/setup-tailwind/) [**Building with SvelteKit and GraphCMS - Styling with Tailwind and DaisyUI** \\
\\
by Netlify](https://explorers.netlify.com/learn/building-with-sveltekit-and-graphcms/styling-with-tailwind-and-daisyui) [**Svelte for Beginners by Mike Karan** \\
\\
by Udemy](https://www.udemy.com/course/svelte-for-beginners/) [**React Front To Back 2022 by Brad Traversy** \\
\\
by Udemy](https://www.udemy.com/course/react-front-to-back-2022/) [**Build Instagram profile page UI clone w/Next.js TailwindCSS** \\
\\
by Udemy](https://www.udemy.com/course/build-instagram-profile-page-ui-clone-nextjs-tailwindcss/) [**Instagram UI Clone Login Page w/ NextJS & TailwindCSS** \\
\\
by Udemy](https://www.udemy.com/course/instagram-ui-clone-login-page-w-nextjs-tailwindcss/) [**Build your Developer Portfolio and Blog from Scratch with Svelte and GraphCMS** \\
\\
by freeCodeCamp](https://www.freecodecamp.org/news/build-your-developer-portfolio-from-scratch-with-sveltekit-and-graphcms/) [**Building a React Admin Panel with refine and daisyUI** \\
\\
by Refine.dev](https://refine.dev/blog/daisy-ui-react-admin-panel/)
