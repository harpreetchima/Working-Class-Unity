---
url: "https://daisyui.com/docs/editor/grok/"
title: "Grok setup for daisyUI — daisyUI Tailwind CSS Component UI Library"
---
...
# Grok setup for daisyUI

Setup Grok to correctly generate daisyUI code based on your prompt.

## [Link to heading](https://daisyui.com/docs/editor/grok/\#-grok-llm-setup)![Grok](https://img.daisyui.com/images/logos/grok.webp) Grok LLM setup

### [Link to heading](https://daisyui.com/docs/editor/grok/\#quick-use) Quick use
...
#### [Link to heading](https://daisyui.com/docs/editor/grok/\#through-deep-search) Through Deep Search
...
#### [Link to heading](https://daisyui.com/docs/editor/grok/\#through-workspace-supergrok-only) Through Workspace (SuperGrok Only)
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/editor/grok/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/editor/grok/+page.md?plain=1)
