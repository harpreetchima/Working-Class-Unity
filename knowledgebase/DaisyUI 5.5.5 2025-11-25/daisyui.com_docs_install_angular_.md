---
url: "https://daisyui.com/docs/install/angular/"
title: "Install daisyUI for Angular — daisyUI Tailwind CSS Component UI Library"
---
...
[Website](https://angular.dev/) [GitHub](https://github.com/angular/angular)

# Install daisyUI for Angular

How to install Tailwind CSS and daisyUI in a Angular project

### [Link to heading](https://daisyui.com/docs/install/angular/\#1-create-a-new-angular-project) 1\. Create a new Angular project
...
### [Link to heading](https://daisyui.com/docs/install/angular/\#2-install-tailwind-css-postcss-and-daisyui) 2\. Install Tailwind CSS, PostCSS, and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/angular/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/angular/+page.md?plain=1)
