---
url: "https://daisyui.com/docs/install/vike/"
title: "Install daisyUI for Vike — daisyUI Tailwind CSS Component UI Library"
---
...
Vike is a JavaScript framework providing integration with different front-end, backend, database and auth stacks

[Website](https://vike.dev/) [GitHub](https://github.com/vikejs/vike)

# Install daisyUI for Vike

How to install Tailwind CSS and daisyUI in a Vike project

### [Link to heading](https://daisyui.com/docs/install/vike/\#1-create-a-new-vike-project) 1\. Create a new Vike project
...
### [Link to heading](https://daisyui.com/docs/install/vike/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/vike/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/vike/+page.md?plain=1)
