---
url: "https://daisyui.com/docs/editor/claude/"
title: "Claude desktop setup for daisyUI — daisyUI Tailwind CSS Component UI Library"
---
...
## [Link to heading](https://daisyui.com/docs/editor/claude/\#-claude-desktop-llm-setup)![Claude](https://img.daisyui.com/images/logos/claude.webp) Claude desktop LLM setup

### [Link to heading](https://daisyui.com/docs/editor/claude/\#quick-use) Quick use
...
### [Link to heading](https://daisyui.com/docs/editor/claude/\#mcp-server) MCP server
...
#### [Link to heading](https://daisyui.com/docs/editor/claude/\#daisyui-blueprint) daisyUI Blueprint
...
#### [Link to heading](https://daisyui.com/docs/editor/claude/\#usage) Usage
...
#### [Link to heading](https://daisyui.com/docs/editor/claude/\#setup-context7-mcp-server) Setup Context7 MCP server
...
#### [Link to heading](https://daisyui.com/docs/editor/claude/\#setup-daisyui-gitmcp-server) Setup daisyUI GitMCP server
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/editor/claude/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/editor/claude/+page.md?plain=1)
