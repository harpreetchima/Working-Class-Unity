---
url: "https://daisyui.com/blog/tag/guides/"
title: "guides — daisyUI Tailwind CSS Component UI Library"
---
...
[![How to make a bidirectional site using Tailwind CSS and daisyUI](https://img.daisyui.com/images/blog/bidirectional.webp)\\
**How to make a bidirectional site using Tailwind CSS and daisyUI** \\
\\
Learn how to use CSS logical properties to make a bidirectional website using Tailwind CSS and daisyUI](https://daisyui.com/blog/bidirectional) [![How to update daisyUI from version 3 to version 4](https://img.daisyui.com/images/blog/daisyui-4-update-guide.webp)\\
**How to update daisyUI from version 3 to version 4** \\
\\
This upgrade guide helps you easily update daisyUI to version 4 without breaking anything.](https://daisyui.com/blog/how-to-update-daisyui-4) [![Install Tailwind CSS and PostCSS and daisyUI with one command](https://img.daisyui.com/images/blog/npm-init-daisyui.webp)\\
**Install Tailwind CSS and PostCSS and daisyUI with one command** \\
\\
It can be annoying to install, setup, config and import all the dependencies. But now, you can do it with a single command.](https://daisyui.com/blog/npm-init-daisyui) [![How to add a new color to daisyUI themes](https://img.daisyui.com/images/blog/how-to-add-new-colors-to-daisyui.webp)\\
**How to add a new color to daisyUI themes** \\
\\
Do you want to add new color names to daisyUI color palette? Here is how you can do it.](https://daisyui.com/blog/how-to-add-new-colors-to-daisyui) [![The most common mistake when using Tailwind CSS (and how to fix it)](https://img.daisyui.com/images/blog/tailwind-mistake.webp)\\
**The most common mistake when using Tailwind CSS (and how to fix it)** \\
\\
While working on daisyUI, I see a lot of people making this mistake when using Tailwind CSS.](https://daisyui.com/blog/most-common-mistake-when-using-tailwind-css)
