---
url: "https://daisyui.com/docs/install/bun/"
title: "Use daisyUI in a Bun dev server — daisyUI Tailwind CSS Component UI Library"
---
...
Bun is a fast and efficient all-in-one JavaScript runtime, bundler, build tool, dev server, package manager, writtern in Zig programming language
...
### [Link to heading](https://daisyui.com/docs/install/bun/\#1-create-a-new-bun-project) 1\. Create a new Bun project
...
### [Link to heading](https://daisyui.com/docs/install/bun/\#2-install-bun-plugin-tailwind-and-daisyui) 2\. Install bun-plugin-tailwind and daisyUI
...
### [Link to heading](https://daisyui.com/docs/install/bun/\#3-add-html-and-css-files) 3\. Add HTML and CSS files
...
## [Link to heading](https://daisyui.com/docs/install/bun/\#serve-the-html-file) Serve the HTML file
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/bun/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/bun/+page.md?plain=1)
