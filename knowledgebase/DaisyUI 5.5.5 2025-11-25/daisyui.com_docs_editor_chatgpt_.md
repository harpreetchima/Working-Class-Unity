---
url: "https://daisyui.com/docs/editor/chatgpt/"
title: "ChatGPT setup for daisyUI — daisyUI Tailwind CSS Component UI Library"
---
...
Setup ChatGPT to correctly generate daisyUI code based on your prompt.

## [Link to heading](https://daisyui.com/docs/editor/chatgpt/\#-chatgpt-llm-setup)![ChatGPT](https://img.daisyui.com/images/logos/chatgpt.webp) ChatGPT LLM setup

### [Link to heading](https://daisyui.com/docs/editor/chatgpt/\#quick-use) Quick use
...
### [Link to heading](https://daisyui.com/docs/editor/chatgpt/\#mcp-server) MCP server
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/editor/chatgpt/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/editor/chatgpt/+page.md?plain=1)
