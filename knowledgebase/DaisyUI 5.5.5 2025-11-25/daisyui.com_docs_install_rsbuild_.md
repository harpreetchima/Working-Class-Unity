---
url: "https://daisyui.com/docs/install/rsbuild/"
title: "Install daisyUI for Rsbuild — daisyUI Tailwind CSS Component UI Library"
---
...
Rsbuild is a build tool written in Rust

[Website](https://rsbuild.dev/) [GitHub](https://github.com/web-infra-dev/rsbuild)

# Install daisyUI for Rsbuild

How to install Tailwind CSS and daisyUI in a Rsbuild project

### [Link to heading](https://daisyui.com/docs/install/rsbuild/\#1-create-a-new-rsbuild-project) 1\. Create a new Rsbuild project
...
### [Link to heading](https://daisyui.com/docs/install/rsbuild/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/rsbuild/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/rsbuild/+page.md?plain=1)
