---
url: "https://daisyui.com/docs/install/phoenix/"
title: "Install daisyUI for Elixir Phoenix — daisyUI Tailwind CSS Component UI Library"
---
...
### [Link to heading](https://daisyui.com/docs/install/phoenix/\#1-create-a-new-phoenix-project) 1\. Create a new Phoenix project
...
### [Link to heading](https://daisyui.com/docs/install/phoenix/\#2-run-your-project) 2\. Run your project
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/phoenix/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/phoenix/+page.md?plain=1)
