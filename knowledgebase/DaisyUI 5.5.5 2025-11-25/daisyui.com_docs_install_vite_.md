---
url: "https://daisyui.com/docs/install/vite/"
title: "Install daisyUI for Vite — daisyUI Tailwind CSS Component UI Library"
---
...
Vite is fast front-end JavaScript build tool

[Website](https://vite.dev/) [GitHub](https://github.com/vitejs/vite)

# Install daisyUI for Vite

How to install Tailwind CSS and daisyUI in a Vite project

### [Link to heading](https://daisyui.com/docs/install/vite/\#1-create-a-new-vite-project) 1\. Create a new Vite project
...
### [Link to heading](https://daisyui.com/docs/install/vite/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/vite/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/vite/+page.md?plain=1)
