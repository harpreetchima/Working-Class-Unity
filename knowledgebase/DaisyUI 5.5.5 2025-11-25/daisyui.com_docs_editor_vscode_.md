---
url: "https://daisyui.com/docs/editor/vscode/"
title: "VSCode setup for daisyUI — daisyUI Tailwind CSS Component UI Library"
---
...
## [Link to heading](https://daisyui.com/docs/editor/vscode/\#-vscode-and-copilot-llm-setup)![VSCode](https://img.daisyui.com/images/logos/vscode.webp) VSCode and Copilot LLM setup
...
### [Link to heading](https://daisyui.com/docs/editor/vscode/\#quick-use) Quick use
...
### [Link to heading](https://daisyui.com/docs/editor/vscode/\#project-level-permanent-setup) Project-level permanent setup
...
### [Link to heading](https://daisyui.com/docs/editor/vscode/\#mcp-server) MCP server

MCP is a an API to communicate with AI models.

You can add MCP servers and Copilot will communicate with them to get more accurate results.

You can use [Context7](https://context7.com/) or [daisyUI GitMCP](https://gitmcp.io/saadeghi/daisyui) as MCP server in VSCode.

#### [Link to heading](https://daisyui.com/docs/editor/vscode/\#daisyui-blueprint) daisyUI Blueprint
...
#### [Link to heading](https://daisyui.com/docs/editor/vscode/\#usage) Usage
...
#### [Link to heading](https://daisyui.com/docs/editor/vscode/\#option-1-setup-context7-mcp-server-for-vscode) Option 1. Setup Context7 MCP server for VSCode

Click this button to install Context7 MCP server in VSCode:

[![VSCode](https://img.daisyui.com/images/logos/vscode.webp) Install Context7 MCP](vscode:mcp/install?%7B%22name%22%3A%22context7%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22%40upstash%2Fcontext7-mcp%40latest%22%5D%7D)

#### [Link to heading](https://daisyui.com/docs/editor/vscode/\#option-2-setup-context7-mcp-server-for-current-workspace-only) Option 2. Setup Context7 MCP server for current workspace only
...
#### [Link to heading](https://daisyui.com/docs/editor/vscode/\#option-1-setup-daisyui-gitmcp-server-for-vscode) Option 1. Setup daisyUI GitMCP server for VSCode

Click this button to install GitMCP server in VSCode:

[![VSCode](https://img.daisyui.com/images/logos/vscode.webp) Install daisyUI GitMCP](vscode:mcp/install?%7B%22name%22%3A%22daisyUI%22%2C%22type%22%3A%22sse%22%2C%22url%22%3A%22https%3A%2F%2Fgitmcp.io%2Fsaadeghi%2Fdaisyui%22%7D)

#### [Link to heading](https://daisyui.com/docs/editor/vscode/\#option-2-setup-daisyui-gitmcp-server-for-current-workspace-only) Option 2. Setup daisyUI GitMCP server for current workspace only
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/editor/vscode/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/editor/vscode/+page.md?plain=1)
