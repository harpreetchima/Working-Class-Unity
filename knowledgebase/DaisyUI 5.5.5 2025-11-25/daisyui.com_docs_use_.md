...
title: "Add component classes to your HTML — daisyUI Tailwind CSS Component UI Library"
---
...
[PrevCDN](https://daisyui.com/docs/cdn/)

[NextCode editor & LLM setup](https://daisyui.com/docs/editor/)
...
Do you see a bug? [open an issue on GitHub](https://github.com/saadeghi/daisyui/issues?q=Use)
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/use/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/use/+page.md?plain=1)
