---
url: "https://daisyui.com/store/auth-template/"
title: "Auth template 2.0 – daisyUI and Tailwind CSS templates"
---
...
![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2.webp)

![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2-1.webp)

![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2-3.webp)

![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2-2.webp)

![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2-4.webp)
...
| Version | Changes |
| --- | --- |
| v2 | - Added 9 new pages, 3 new designs, total 12 pages now<br>- Added dark mode/light mode toggle<br>- Client-side validation + styles<br>- Bug fixes and dependency updates |
...
[Buy now](https://www.creem.io/payment/prod_5WTF3NMjAyFXqUppgngpBP)
...
[license](https://api.daisyui.com/license/auth@2.txt)

[screenshot](https://img.daisyui.com/images/store/screenshots/auth-2.webp)

### Auth template 2.0 License
...
![Screenshot](https://daisyui.com/store/auth-template/)
...
![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2-1.webp)![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2-3.webp)![Auth template 2.0](https://img.daisyui.com/images/store/large/auth/auth@2.webp)

[Buy Auth template 2.0](https://www.creem.io/payment/prod_5WTF3NMjAyFXqUppgngpBP)
