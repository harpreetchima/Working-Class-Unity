---
url: "https://daisyui.com/docs/install/rails/"
title: "Install daisyUI for Rails — daisyUI Tailwind CSS Component UI Library"
---
...
Ruby on Rails is a web framework focusing on simplicity and rapid development

[Website](https://rubyonrails.org/) [GitHub](https://github.com/rails/rails)

# Install daisyUI for Rails

How to install Tailwind CSS and daisyUI in a Rails project

### [Link to heading](https://daisyui.com/docs/install/rails/\#1-create-a-new-rails-project) 1\. Create a new Rails project
...
### [Link to heading](https://daisyui.com/docs/install/rails/\#2-install-tailwind-css-for-rails) 2\. Install Tailwind CSS for Rails
...
### [Link to heading](https://daisyui.com/docs/install/rails/\#3-add-daisyui) 3\. Add daisyUI
...
- You can [choose the parts you need](https://daisyui.com/docs/cdn/)
...
### [Link to heading](https://daisyui.com/docs/install/rails/\#4-create-a-homepage-in-rails) 4\. Create a homepage in Rails
...
### [Link to heading](https://daisyui.com/docs/install/rails/\#5-start-rails) 5\. Start Rails
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/rails/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/rails/+page.md?plain=1)
