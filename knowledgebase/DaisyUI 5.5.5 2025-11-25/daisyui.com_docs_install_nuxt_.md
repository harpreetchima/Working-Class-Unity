---
url: "https://daisyui.com/docs/install/nuxt/"
title: "Install daisyUI for Nuxt — daisyUI Tailwind CSS Component UI Library"
---
...
Nuxt is a meta framework for Vue, providing server-side rendering, static site generation, and routing

[Website](https://nuxt.com/) [GitHub](https://github.com/nuxt/nuxt)

# Install daisyUI for Nuxt

How to install Tailwind CSS and daisyUI in a Nuxt project

### [Link to heading](https://daisyui.com/docs/install/nuxt/\#1-create-a-new-nuxt-project) 1\. Create a new Nuxt project
...
### [Link to heading](https://daisyui.com/docs/install/nuxt/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/nuxt/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/nuxt/+page.md?plain=1)
