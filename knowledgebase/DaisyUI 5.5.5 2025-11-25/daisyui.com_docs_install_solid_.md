---
url: "https://daisyui.com/docs/install/solid/"
title: "Install daisyUI for Solid — daisyUI Tailwind CSS Component UI Library"
---
...
Solid is a JavaScript front-end framework known for fine-grained reactivity and performance
...
### [Link to heading](https://daisyui.com/docs/install/solid/\#1-create-a-new-solid-project) 1\. Create a new Solid project
...
### [Link to heading](https://daisyui.com/docs/install/solid/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/solid/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/solid/+page.md?plain=1)
