...
title: "Install daisyUI as a Tailwind plugin — daisyUI Tailwind CSS Component UI Library"
---
...
## [Link to heading](https://daisyui.com/docs/install/\#framework-install-tutorials) Framework install tutorials

See example setup of daisyUI and Tailwind CSS on different frameworks and build tools.

[Vite](https://daisyui.com/docs/install/vite/) [Tailwind CSS CLI](https://daisyui.com/docs/install/cli/) [Tailwind CSS Standalone without Node](https://daisyui.com/docs/install/standalone/) [Post CSS](https://daisyui.com/docs/install/postcss/) [SvelteKit](https://daisyui.com/docs/install/sveltekit/) [Astro](https://daisyui.com/docs/install/astro/) [React](https://daisyui.com/docs/install/react/) [Laravel](https://daisyui.com/docs/install/laravel/) [Rails](https://daisyui.com/docs/install/rails/) [Next.js](https://daisyui.com/docs/install/nextjs/) [file\_type\_vue\\
\\
file\_type\_vue\\
\\
file\_type\_vue\\
\\
Vue](https://daisyui.com/docs/install/vue/) [Nuxt](https://daisyui.com/docs/install/nuxt/) [Elixir Phoenix](https://daisyui.com/docs/install/phoenix/) [Django](https://daisyui.com/docs/install/django/) [Electron](https://daisyui.com/docs/install/electron/) [Angular](https://daisyui.com/docs/install/angular/) [Solid](https://daisyui.com/docs/install/solid/) [Solid Start](https://daisyui.com/docs/install/solid-start/) [Qwik](https://daisyui.com/docs/install/qwik/) [HTMX](https://daisyui.com/docs/install/htmx/) [WordPress](https://daisyui.com/docs/install/wordpress/) [Bun dev server](https://daisyui.com/docs/install/bun/) [Rsbuild](https://daisyui.com/docs/install/rsbuild/) [Vike](https://daisyui.com/docs/install/vike/) [React Router](https://daisyui.com/docs/install/reactrouter/) [Elysia](https://daisyui.com/docs/install/elysia/) [Deno Fresh](https://daisyui.com/docs/install/fresh/) [Lit](https://daisyui.com/docs/install/lit/) [UnoCSS](https://daisyui.com/docs/install/unocss/) [Eleventy](https://daisyui.com/docs/install/11ty/) [Waku](https://daisyui.com/docs/install/waku/) [Zola](https://daisyui.com/docs/install/zola/) [Ember](https://daisyui.com/docs/install/ember/) [Preact](https://daisyui.com/docs/install/preact/) [Dioxus](https://daisyui.com/docs/install/dioxus/) [Yew](https://daisyui.com/docs/install/yew/)

[PrevIntroduction](https://daisyui.com/docs/intro/)

[NextCDN](https://daisyui.com/docs/cdn/)
...
Do you see a bug? [open an issue on GitHub](https://github.com/saadeghi/daisyui/issues?q=Install)
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/+page.md?plain=1)
