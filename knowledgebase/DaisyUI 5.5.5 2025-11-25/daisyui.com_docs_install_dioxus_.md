---
url: "https://daisyui.com/docs/install/dioxus/"
title: "Install daisyUI for Dioxus — daisyUI Tailwind CSS Component UI Library"
---
...
[Website](https://dioxuslabs.com/) [GitHub](https://github.com/DioxusLabs/dioxus)

# Install daisyUI for Dioxus

How to install Tailwind CSS and daisyUI in a Dioxus project

### [Link to heading](https://daisyui.com/docs/install/dioxus/\#1-create-a-new-dioxus-project) 1\. Create a new Dioxus project
...
### [Link to heading](https://daisyui.com/docs/install/dioxus/\#2-install-tailwind-css-cli-and-daisyui) 2\. Install Tailwind CSS CLI and daisyUI

Initialize a new Node project.

And install Tailwind CSS CLI and daisyUI.

> If you don't want to use Node.js, try [Tailwind CSS and daisyUI standalone](https://daisyui.com/docs/install/standalone/) files instead.
...
### [Link to heading](https://daisyui.com/docs/install/dioxus/\#3-setup-srcmainrs) 3\. Setup `src/main.rs`
...
### [Link to heading](https://daisyui.com/docs/install/dioxus/\#4-run-the-dev-server) 4\. Run the dev server
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/dioxus/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/dioxus/+page.md?plain=1)
