---
url: "https://daisyui.com/docs/install/solid-start/"
title: "Install daisyUI for Solid Start — daisyUI Tailwind CSS Component UI Library"
---
...
SolidStart is a meta framework for Solid.js

[Website](https://start.solidjs.com/) [GitHub](https://github.com/solidjs/solid-start)

# Install daisyUI for Solid Start

How to install Tailwind CSS and daisyUI in a Solid Start project

### [Link to heading](https://daisyui.com/docs/install/solid-start/\#1-create-a-new-solid-start-project) 1\. Create a new Solid Start project
...
### [Link to heading](https://daisyui.com/docs/install/solid-start/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/solid-start/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/solid-start/+page.md?plain=1)
