---
url: "https://daisyui.com/docs/install/qwik/"
title: "Install daisyUI for Qwik — daisyUI Tailwind CSS Component UI Library"
---
...
Qwik is a front-end JavaScript framework focusing on performance and speed
...
### [Link to heading](https://daisyui.com/docs/install/qwik/\#1-create-a-new-qwik-project) 1\. Create a new Qwik project
...
### [Link to heading](https://daisyui.com/docs/install/qwik/\#2-install-tailwind-css-and-daisyui) 2\. Install Tailwind CSS and daisyUI
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/install/qwik/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/qwik/+page.md?plain=1)
