---
url: "https://daisyui.com/docs/editor/gemini/"
title: "Gemini setup for daisyUI — daisyUI Tailwind CSS Component UI Library"
---
...
# Gemini setup for daisyUI

Setup Gemini to correctly generate daisyUI code based on your prompt.

## [Link to heading](https://daisyui.com/docs/editor/gemini/\#-gemini-llm-setup)![Gemini](https://img.daisyui.com/images/logos/gemini.webp) Gemini LLM setup

### [Link to heading](https://daisyui.com/docs/editor/gemini/\#quick-use) Quick use
...
[Edit this page on GitHub](https://github.com/saadeghi/daisyui/blob/master/packages/docs/src/routes/(routes)/docs/editor/gemini/+page.md?plain=1)

[Text version for AI prompts](https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/editor/gemini/+page.md?plain=1)
