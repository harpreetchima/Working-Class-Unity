---
url: "https://nodejs.org/dist/latest/docs/api/cluster.json"
title: undefined
---
  ...
  "modules": [
    {
      ...
      "classes": [
        {
          ...
          "properties": [
            {
              "textRaw": "`exitedAfterDisconnect` Type: {boolean}",
              "type": "boolean",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`process` Type: {ChildProcess}",
              "type": "ChildProcess",
              "name": "Type",
              "meta": {
                "added": [
      ...
      "properties": [
        ...
        {
          "textRaw": "`isPrimary` Type: {boolean}",
          "type": "boolean",
          "name": "Type",
          "meta": {
            "added": [
