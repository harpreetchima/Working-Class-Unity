---
url: "https://nodejs.org/dist/latest/docs/api/fs.json"
title: undefined
---
          ...
          "classes": [
            {
              ...
              "properties": [
                {
                  "textRaw": "`fd` Type: {number} The numeric file descriptor managed by the {FileHandle} object.",
                  "type": "number",
                  "name": "Type",
                  "meta": {
                    "added": [
              ...
              "signatures": [
                {
                  "params": [
                    ...
                    {
                      "textRaw": "Retrieves the files matching the specified pattern.",
                      "name": "Retrieves",
                      "desc": "the files matching the specified pattern."
                    }
                  ]
                }
              ],
        ...
        },
        {
          ...
          "classes": [
            ...
            },
            {
              ...
              "properties": [
                {
                  "textRaw": "`name` Type: {string|Buffer}",
                  "type": "string|Buffer",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`parentPath` Type: {string}",
                  "type": "string",
                  "name": "Type",
                  "meta": {
                    "added": [
                  ...
                  "desc": "<p>The path to the parent directory of the file this <a href=\"fs.html#class-fsdirent\" class=\"type\">&lt;fs.Dirent&gt;</a> object refers to.</p>"
                }
              ]
            },
            {
            ...
            },
            {
              ...
              "properties": [
                ...
                {
                  "textRaw": "`path` Type: {string|Buffer}",
                  "type": "string|Buffer",
                  "name": "Type",
                  "meta": {
                    "added": [
            ...
            },
            {
              ...
              "properties": [
                ...
                {
                  "textRaw": "`mtimeMs` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`ctimeMs` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`birthtimeMs` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`birthtimeNs` Type: {bigint}",
                  "type": "bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
            ...
            },
            {
              ...
              "properties": [
                {
                  "textRaw": "`bavail` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`bfree` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`bsize` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`ffree` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`files` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`type` Type: {number|bigint}",
                  "type": "number|bigint",
                  "name": "Type",
                  "meta": {
                    "added": [
            ...
            },
            {
              ...
              "events": [
                ...
                },
                {
                  ...
                  "name": "drop",
                  "params": [],
                  "desc": "<p>The <code>'drop'</code> event is emitted when to maximal length is reached and that data\nwill not be written. The data that was dropped is passed as the first argument\nto the event handle.</p>"
                },
                {
                  "textRaw": "Event: `'error'`",
                  "type": "event",
              ...
              "properties": [
                {
                  "textRaw": "`append` {boolean} Whether the stream is appending to the file or truncating it.",
                  "type": "boolean",
                  "name": "append",
                  "desc": "Whether the stream is appending to the file or truncating it."
                },
                {
                  "textRaw": "`contentMode` {string} The type of data that can be written to the stream. Supported values are `'utf8'` or `'buffer'`. **Default**: `'utf8'`.",
                  "type": "string",
                  "name": "contentMode",
                  "desc": "The type of data that can be written to the stream. Supported values are `'utf8'` or `'buffer'`. **Default**: `'utf8'`."
                },
                {
                  "textRaw": "`fd` {number} The file descriptor that is being written to.",
                  "type": "number",
                  "name": "fd",
                  "desc": "The file descriptor that is being written to."
                },
                {
                  "textRaw": "`file` {string} The file that is being written to.",
                  "type": "string",
                  "name": "file",
                  "desc": "The file that is being written to."
                },
                {
                  "textRaw": "`fsync` {boolean} Whether the stream is performing a `fs.fsyncSync()` after every write operation.",
                  "type": "boolean",
                  "name": "fsync",
                ...
                {
                  "textRaw": "`mkdir` {boolean} Whether the stream should ensure that the directory for the `dest` file exists. If `true`, it will create the directory if it does not exist. **Default**: `false`.",
                  "type": "boolean",
                  "name": "mkdir",
                ...
                {
                  "textRaw": "`mode` {number|string} The mode of the file that is being written to.",
                  "type": "number|string",
                  "name": "mode",
                  "desc": "The mode of the file that is being written to."
                },
                {
                  "textRaw": "`periodicFlush` {number} The number of milliseconds between flushes. If set to `0`, no periodic flushes will be performed.",
                  "type": "number",
                  "name": "periodicFlush",
                  "desc": "The number of milliseconds between flushes. If set to `0`, no periodic flushes will be performed."
                },
                {
                  "textRaw": "`sync` {boolean} Whether the stream is writing synchronously or asynchronously.",
                  "type": "boolean",
                  "name": "sync",
                  "desc": "Whether the stream is writing synchronously or asynchronously."
                },
                {
                  "textRaw": "`writing` {boolean} Whether the stream is currently writing data to the file.",
                  "type": "boolean",
                  "name": "writing",
              ...
              "methods": [
                ...
                },
                {
                  ...
                  "signatures": [
                    {
                      "params": [
                        {
                          "textRaw": "`file`: {string|Buffer|URL} A path to a file to be written to (mode controlled by the append option).",
                          "name": "file",
                          "type": "string|Buffer|URL",
                  ...
                  "desc": "<p>Reopen the file in place, useful for log rotation.</p>"
                },
                {
