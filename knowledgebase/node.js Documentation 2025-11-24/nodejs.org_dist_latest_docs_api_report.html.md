---
url: "https://nodejs.org/dist/latest/docs/api/report.html"
title: "Diagnostic report | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/report.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/report.html#toc-picker)




- [Diagnostic report](https://nodejs.org/dist/latest/docs/api/report.html#diagnostic-report)
  - [Usage](https://nodejs.org/dist/latest/docs/api/report.html#usage)
  - [Report Version](https://nodejs.org/dist/latest/docs/api/report.html#report-version)
    - [Version history](https://nodejs.org/dist/latest/docs/api/report.html#version-history)
      - [Version 5](https://nodejs.org/dist/latest/docs/api/report.html#version-5)
      - [Version 4](https://nodejs.org/dist/latest/docs/api/report.html#version-4)
      - [Version 3](https://nodejs.org/dist/latest/docs/api/report.html#version-3)
      - [Version 2](https://nodejs.org/dist/latest/docs/api/report.html#version-2)
      - [Version 1](https://nodejs.org/dist/latest/docs/api/report.html#version-1)
  - [Configuration](https://nodejs.org/dist/latest/docs/api/report.html#configuration)
  - [Interaction with workers](https://nodejs.org/dist/latest/docs/api/report.html#interaction-with-workers)

- [Index](https://nodejs.org/dist/latest/docs/api/report.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/report.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/report.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/report.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/report.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/report.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/report.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/report.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/report.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/report.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/report.html)
10. [16.x](https://nodejs.org/docs/latest-v16.x/api/report.html)
11. [15.x](https://nodejs.org/docs/latest-v15.x/api/report.html)
12. [14.x](https://nodejs.org/docs/latest-v14.x/api/report.html)
13. [13.x](https://nodejs.org/docs/latest-v13.x/api/report.html)
14. [12.x](https://nodejs.org/docs/latest-v12.x/api/report.html)
15. [11.x](https://nodejs.org/docs/latest-v11.x/api/report.html)

- [Options](https://nodejs.org/dist/latest/docs/api/report.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/report.json)
- [Edit on GitHub](https://github.com/nodejs/node/edit/main/doc/api/report.md)
...
\
Added [`Worker`](https://nodejs.org/dist/latest/docs/api/worker_threads.html) support. Refer to [Interaction with workers](https://nodejs.org/dist/latest/docs/api/report.html#interaction-with-workers) section for more details.\
\
##### Version 1[\#](https://nodejs.org/dist/latest/docs/api/report.html\#version-1)\
\
...
[`process API documentation`](https://nodejs.org/dist/latest/docs/api/process.html) section.\
\
### Interaction with workers[\#](https://nodejs.org/dist/latest/docs/api/report.html\#interaction-with-workers)\
\
History\
...
| v13.9.0, v12.16.2 | Workers are now included in the report. |\
\
[`Worker`](https://nodejs.org/dist/latest/docs/api/worker_threads.html) threads can create reports in the same way that the main thread\
does.\
\
