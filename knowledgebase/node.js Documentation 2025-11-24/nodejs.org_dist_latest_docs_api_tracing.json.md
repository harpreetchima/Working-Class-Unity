---
url: "https://nodejs.org/dist/latest/docs/api/tracing.json"
title: undefined
---
          ...
          "modules": [
            {
              ...
              "properties": [
                {
                  "textRaw": "`categories` Type: {string}",
                  "type": "string",
                  "name": "Type",
                  "meta": {
                    "added": [
                ...
                {
                  "textRaw": "`enabled` Type: {boolean} `true` only if the `Tracing` object has been enabled.",
                  "type": "boolean",
                  "name": "Type",
                  "meta": {
                    "added": [
