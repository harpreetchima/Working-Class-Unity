---
url: "https://nodejs.org/dist/latest/docs/api/url.json"
title: undefined
---
      ...
      "modules": [
        ...
        },
        {
          ...
          "classes": [
            {
              ...
              "properties": [
                ...
                {
                  "textRaw": "`searchParams` Type: {URLSearchParams}",
              ...
              "methods": [
                ...
                },
                {
                  ...
                  "desc": "<p>Checks if an <code>input</code> relative to the <code>base</code> can be parsed to a <code>URL</code>.</p>\n<pre><code class=\"language-js\">const isValid = URL.canParse('/foo', 'https://example.org/'); // true\n\nconst isNotValid = URL.canParse('/foo'); // false\n</code></pre>"
                },
                {
                  "textRaw": "`URL.parse(input[, base])`",
                  "type": "method",
                  "name": "parse",
                  "meta": {
                    "added": [
            ...
            },
            {
              ...
              "signatures": [
                {
                  "params": [],
                  "desc": "<p>Instantiate a new empty <code>URLPattern</code> object.</p>"
                },
                {
                  "params": [
                    {
                      "textRaw": "`string` {string} A URL string",
                      "name": "string",
                      "type": "string",
                      "desc": "A URL string"
                    },
            ...
            },
            {
              ...
              "methods": [
                ...
                {
                  "textRaw": "`urlSearchParams.delete(name[, value])`",
                  "type": "method",
                  "name": "delete",
                  "meta": {
                    "changes": [
                ...
                {
                  "textRaw": "`urlSearchParams.has(name[, value])`",
                  "type": "method",
                  "name": "has",
                  "meta": {
                    "changes": [
          ...
          "methods": [
            ...
            {
              "textRaw": "`url.fileURLToPath(url[, options])`",
              "type": "method",
              "name": "fileURLToPath",
              "meta": {
                "added": [
                ...
                "changes": [
                  {
                    ...
                    "description": "The `options` argument can now be used to determine how to parse the `path` argument."
                  }
                ]
              },
              "signatures": [
                {
                  ...
                  "params": [
                    ...
                    },
                    {
                      ...
                      "options": [
                        {
                          "textRaw": "`windows` {boolean|undefined} `true` if the `path` should be return as a windows filepath, `false` for posix, and `undefined` for the system default. **Default:** `undefined`.",
                          "name": "windows",
                          "type": "boolean|undefined",
                          "default": "`undefined`",
                          "desc": "`true` if the `path` should be return as a windows filepath, `false` for posix, and `undefined` for the system default."
                        }
                      ]
                    }
                  ]
            ...
            {
              "textRaw": "`url.fileURLToPathBuffer(url[, options])`",
              "type": "method",
              "name": "fileURLToPathBuffer",
              "signatures": [
                {
                  "params": []
                }
            ...
            {
              "textRaw": "`url.pathToFileURL(path[, options])`",
              "type": "method",
              "name": "pathToFileURL",
              "meta": {
                "added": [
                ...
                "changes": [
                  {
                    ...
                    "pr-url": "https://github.com/nodejs/node/pull/52509",
                    "description": "The `options` argument can now be used to determine how to return the `path` value."
                  }
                ]
              },
              "signatures": [
                {
                  ...
                  "params": [
                    ...
                    },
                    {
                      ...
                      "options": [
                        {
                          "textRaw": "`windows` {boolean|undefined} `true` if the `path` should be treated as a windows filepath, `false` for posix, and `undefined` for the system default. **Default:** `undefined`.",
                          "name": "windows",
                          "type": "boolean|undefined",
                          "default": "`undefined`",
                          "desc": "`true` if the `path` should be treated as a windows filepath, `false` for posix, and `undefined` for the system default."
                        }
                      ]
                    }
                  ]
                ...
                "changes": [
                  {
                    ...
                    "description": "The returned object will also contain all the own enumerable properties of the `url` argument."
                  }
                ]
              },
              "signatures": [
