---
url: "https://nodejs.org/dist/latest/docs/api/crypto.json"
title: undefined
---
  ...
  "modules": [
    {
              ...
              "signatures": [
                {
                  ...
                  "params": [
                    ...
                    },
                    {
                      ...
                      "options": [
                        {
                          "textRaw": "`outputEncoding` {string} [Encoding][encoding] used to encode the returned digest. **Default:** `'hex'`.",
                          "name": "outputEncoding",
                          "type": "string",
                          "default": "`'hex'`",
                          "desc": "[Encoding][encoding] used to encode the returned digest."
                        },
                        {
      ...
      "classes": [
        ...
        },
        {
          ...
          "properties": [
            {
              "textRaw": "`asymmetricKeyDetails` Type: {Object}",
              "type": "Object",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`asymmetricKeyType` Type: {string}",
              "type": "string",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`symmetricKeySize` Type: {number}",
              "type": "number",
              "name": "Type",
              "meta": {
                "added": [
        ...
        },
        {
          ...
          "properties": [
            ...
            {
              "textRaw": "`validFromDate` Type: {Date}",
              "type": "Date",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`signatureAlgorithm` Type: {string|undefined}",
              "type": "string|undefined",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`signatureAlgorithmOid` Type: {string}",
              "type": "string",
              "name": "Type",
              "meta": {
                "added": [
