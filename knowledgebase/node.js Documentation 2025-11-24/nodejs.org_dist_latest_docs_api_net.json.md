---
url: "https://nodejs.org/dist/latest/docs/api/net.json"
title: undefined
---
      ...
      "classes": [
        ...
        },
        {
          ...
          "properties": [
            ...
            {
              "textRaw": "`maxConnections` Type: {integer}",
              "type": "integer",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`dropMaxConnection` Type: {boolean}",
              "type": "boolean",
              "name": "Type",
              "meta": {
                "added": [
              ...
              "desc": "<p>Set this property to <code>true</code> to begin closing connections once the number of connections reaches the [<code>server.maxConnections</code>][] threshold. This setting is only effective in cluster mode.</p>"
            }
          ],
          "signatures": [
            {
        ...
        },
        {
          ...
          "properties": [
            {
              "textRaw": "`autoSelectFamilyAttemptedAddresses` Type: {string\\[]}",
              "type": "string\\[]",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`bufferSize` Type: {integer}",
              "type": "integer",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`bytesRead` Type: {integer}",
              "type": "integer",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`bytesWritten` Type: {integer}",
              "type": "integer",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`destroyed` Type: {boolean} Indicates if the connection is destroyed or not. Once a connection is destroyed no further data can be transferred using it.",
              "type": "boolean",
              "name": "Type",
            ...
            {
              "textRaw": "`localFamily` Type: {string}",
              "type": "string",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`timeout` Type: {number|undefined}",
            ...
            {
              "textRaw": "`readyState` Type: {string}",
              "type": "string",
              "name": "Type",
              "meta": {
                "added": [
