---
url: "https://nodejs.org/dist/latest/docs/api/util.html"
title: "Util | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/util.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/util.html#toc-picker)




- [Util](https://nodejs.org/dist/latest/docs/api/util.html#util)
  - [`util.callbackify(original)`](https://nodejs.org/dist/latest/docs/api/util.html#utilcallbackifyoriginal)
  - [`util.debuglog(section[, callback])`](https://nodejs.org/dist/latest/docs/api/util.html#utildebuglogsection-callback)
    - [`debuglog().enabled`](https://nodejs.org/dist/latest/docs/api/util.html#debuglogenabled)
  - [`util.debug(section)`](https://nodejs.org/dist/latest/docs/api/util.html#utildebugsection)
  - [`util.deprecate(fn, msg[, code[, options]])`](https://nodejs.org/dist/latest/docs/api/util.html#utildeprecatefn-msg-code-options)
  - [`util.diff(actual, expected)`](https://nodejs.org/dist/latest/docs/api/util.html#utildiffactual-expected)
  - [`util.format(format[, ...args])`](https://nodejs.org/dist/latest/docs/api/util.html#utilformatformat-args)
  - [`util.formatWithOptions(inspectOptions, format[, ...args])`](https://nodejs.org/dist/latest/docs/api/util.html#utilformatwithoptionsinspectoptions-format-args)
  - [`util.getCallSites([frameCount][, options])`](https://nodejs.org/dist/latest/docs/api/util.html#utilgetcallsitesframecount-options)
  - [`util.getSystemErrorName(err)`](https://nodejs.org/dist/latest/docs/api/util.html#utilgetsystemerrornameerr)
  - [`util.getSystemErrorMap()`](https://nodejs.org/dist/latest/docs/api/util.html#utilgetsystemerrormap)
  - [`util.getSystemErrorMessage(err)`](https://nodejs.org/dist/latest/docs/api/util.html#utilgetsystemerrormessageerr)
  - [`util.setTraceSigInt(enable)`](https://nodejs.org/dist/latest/docs/api/util.html#utilsettracesigintenable)
  - [`util.inherits(constructor, superConstructor)`](https://nodejs.org/dist/latest/docs/api/util.html#utilinheritsconstructor-superconstructor)
  - [`util.inspect(object[, options])`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectobject-options)
  - [`util.inspect(object[, showHidden[, depth[, colors]]])`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectobject-showhidden-depth-colors)
    - [Customizing `util.inspect` colors](https://nodejs.org/dist/latest/docs/api/util.html#customizing-utilinspect-colors)
      - [Complex custom coloring](https://nodejs.org/dist/latest/docs/api/util.html#complex-custom-coloring)
      - [Modifiers](https://nodejs.org/dist/latest/docs/api/util.html#modifiers)
      - [Foreground colors](https://nodejs.org/dist/latest/docs/api/util.html#foreground-colors)
      - [Background colors](https://nodejs.org/dist/latest/docs/api/util.html#background-colors)
    - [Custom inspection functions on objects](https://nodejs.org/dist/latest/docs/api/util.html#custom-inspection-functions-on-objects)
    - [`util.inspect.custom`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectcustom)
    - [`util.inspect.defaultOptions`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectdefaultoptions)
  - [`util.isDeepStrictEqual(val1, val2[, options])`](https://nodejs.org/dist/latest/docs/api/util.html#utilisdeepstrictequalval1-val2-options)
  - [Class: `util.MIMEType`](https://nodejs.org/dist/latest/docs/api/util.html#class-utilmimetype)
    - [`new MIMEType(input)`](https://nodejs.org/dist/latest/docs/api/util.html#new-mimetypeinput)
    - [`mime.type`](https://nodejs.org/dist/latest/docs/api/util.html#mimetype)
    - [`mime.subtype`](https://nodejs.org/dist/latest/docs/api/util.html#mimesubtype)
    - [`mime.essence`](https://nodejs.org/dist/latest/docs/api/util.html#mimeessence)
    - [`mime.params`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparams)
    - [`mime.toString()`](https://nodejs.org/dist/latest/docs/api/util.html#mimetostring)
    - [`mime.toJSON()`](https://nodejs.org/dist/latest/docs/api/util.html#mimetojson)
  - [Class: `util.MIMEParams`](https://nodejs.org/dist/latest/docs/api/util.html#class-utilmimeparams)
    - [`new MIMEParams()`](https://nodejs.org/dist/latest/docs/api/util.html#new-mimeparams)
    - [`mimeParams.delete(name)`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamsdeletename)
    - [`mimeParams.entries()`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamsentries)
    - [`mimeParams.get(name)`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamsgetname)
    - [`mimeParams.has(name)`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamshasname)
    - [`mimeParams.keys()`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamskeys)
    - [`mimeParams.set(name, value)`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamssetname-value)
    - [`mimeParams.values()`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamsvalues)
    - [`mimeParams[Symbol.iterator]()`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamssymboliterator)
  - [`util.parseArgs([config])`](https://nodejs.org/dist/latest/docs/api/util.html#utilparseargsconfig)
    - [`parseArgs``tokens`](https://nodejs.org/dist/latest/docs/api/util.html#parseargs-tokens)
  - [`util.parseEnv(content)`](https://nodejs.org/dist/latest/docs/api/util.html#utilparseenvcontent)
  - [`util.promisify(original)`](https://nodejs.org/dist/latest/docs/api/util.html#utilpromisifyoriginal)
    - [Custom promisified functions](https://nodejs.org/dist/latest/docs/api/util.html#custom-promisified-functions)
    - [`util.promisify.custom`](https://nodejs.org/dist/latest/docs/api/util.html#utilpromisifycustom)
  - [`util.stripVTControlCharacters(str)`](https://nodejs.org/dist/latest/docs/api/util.html#utilstripvtcontrolcharactersstr)
  - [`util.styleText(format, text[, options])`](https://nodejs.org/dist/latest/docs/api/util.html#utilstyletextformat-text-options)
  - [Class: `util.TextDecoder`](https://nodejs.org/dist/latest/docs/api/util.html#class-utiltextdecoder)
    - [WHATWG supported encodings](https://nodejs.org/dist/latest/docs/api/util.html#whatwg-supported-encodings)
      - [Encodings supported by default (with full ICU data)](https://nodejs.org/dist/latest/docs/api/util.html#encodings-supported-by-default-with-full-icu-data)
      - [Encodings supported when Node.js is built with the `small-icu` option](https://nodejs.org/dist/latest/docs/api/util.html#encodings-supported-when-nodejs-is-built-with-the-small-icu-option)
      - [Encodings supported when ICU is disabled](https://nodejs.org/dist/latest/docs/api/util.html#encodings-supported-when-icu-is-disabled)
    - [`new TextDecoder([encoding[, options]])`](https://nodejs.org/dist/latest/docs/api/util.html#new-textdecoderencoding-options)
    - [`textDecoder.decode([input[, options]])`](https://nodejs.org/dist/latest/docs/api/util.html#textdecoderdecodeinput-options)
    - [`textDecoder.encoding`](https://nodejs.org/dist/latest/docs/api/util.html#textdecoderencoding)
    - [`textDecoder.fatal`](https://nodejs.org/dist/latest/docs/api/util.html#textdecoderfatal)
    - [`textDecoder.ignoreBOM`](https://nodejs.org/dist/latest/docs/api/util.html#textdecoderignorebom)
  - [Class: `util.TextEncoder`](https://nodejs.org/dist/latest/docs/api/util.html#class-utiltextencoder)
    - [`textEncoder.encode([input])`](https://nodejs.org/dist/latest/docs/api/util.html#textencoderencodeinput)
    - [`textEncoder.encodeInto(src, dest)`](https://nodejs.org/dist/latest/docs/api/util.html#textencoderencodeintosrc-dest)
    - [`textEncoder.encoding`](https://nodejs.org/dist/latest/docs/api/util.html#textencoderencoding)
  - [`util.toUSVString(string)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltousvstringstring)
  - [`util.transferableAbortController()`](https://nodejs.org/dist/latest/docs/api/util.html#utiltransferableabortcontroller)
  - [`util.transferableAbortSignal(signal)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltransferableabortsignalsignal)
  - [`util.aborted(signal, resource)`](https://nodejs.org/dist/latest/docs/api/util.html#utilabortedsignal-resource)
  - [`util.types`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypes)
    - [`util.types.isAnyArrayBuffer(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisanyarraybuffervalue)
    - [`util.types.isArrayBufferView(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisarraybufferviewvalue)
    - [`util.types.isArgumentsObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisargumentsobjectvalue)
    - [`util.types.isArrayBuffer(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisarraybuffervalue)
    - [`util.types.isAsyncFunction(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisasyncfunctionvalue)
    - [`util.types.isBigInt64Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisbigint64arrayvalue)
    - [`util.types.isBigIntObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisbigintobjectvalue)
    - [`util.types.isBigUint64Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisbiguint64arrayvalue)
    - [`util.types.isBooleanObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisbooleanobjectvalue)
    - [`util.types.isBoxedPrimitive(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisboxedprimitivevalue)
    - [`util.types.isCryptoKey(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesiscryptokeyvalue)
    - [`util.types.isDataView(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisdataviewvalue)
    - [`util.types.isDate(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisdatevalue)
    - [`util.types.isExternal(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisexternalvalue)
    - [`util.types.isFloat16Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisfloat16arrayvalue)
    - [`util.types.isFloat32Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisfloat32arrayvalue)
    - [`util.types.isFloat64Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisfloat64arrayvalue)
    - [`util.types.isGeneratorFunction(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisgeneratorfunctionvalue)
    - [`util.types.isGeneratorObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisgeneratorobjectvalue)
    - [`util.types.isInt8Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisint8arrayvalue)
    - [`util.types.isInt16Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisint16arrayvalue)
    - [`util.types.isInt32Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisint32arrayvalue)
    - [`util.types.isKeyObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesiskeyobjectvalue)
    - [`util.types.isMap(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesismapvalue)
    - [`util.types.isMapIterator(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesismapiteratorvalue)
    - [`util.types.isModuleNamespaceObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesismodulenamespaceobjectvalue)
    - [`util.types.isNativeError(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisnativeerrorvalue)
    - [`util.types.isNumberObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisnumberobjectvalue)
    - [`util.types.isPromise(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesispromisevalue)
    - [`util.types.isProxy(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisproxyvalue)
    - [`util.types.isRegExp(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisregexpvalue)
    - [`util.types.isSet(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesissetvalue)
    - [`util.types.isSetIterator(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesissetiteratorvalue)
    - [`util.types.isSharedArrayBuffer(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesissharedarraybuffervalue)
    - [`util.types.isStringObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisstringobjectvalue)
    - [`util.types.isSymbolObject(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesissymbolobjectvalue)
    - [`util.types.isTypedArray(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesistypedarrayvalue)
    - [`util.types.isUint8Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisuint8arrayvalue)
    - [`util.types.isUint8ClampedArray(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisuint8clampedarrayvalue)
    - [`util.types.isUint16Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisuint16arrayvalue)
    - [`util.types.isUint32Array(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisuint32arrayvalue)
    - [`util.types.isWeakMap(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisweakmapvalue)
    - [`util.types.isWeakSet(value)`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisweaksetvalue)
  - [Deprecated APIs](https://nodejs.org/dist/latest/docs/api/util.html#deprecated-apis)
    - [`util._extend(target, source)`](https://nodejs.org/dist/latest/docs/api/util.html#util_extendtarget-source)
    - [`util.isArray(object)`](https://nodejs.org/dist/latest/docs/api/util.html#utilisarrayobject)

- [Index](https://nodejs.org/dist/latest/docs/api/util.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/util.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/util.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/util.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/util.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/util.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/util.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/util.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/util.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/util.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/util.html)
10. [16.x](https://nodejs.org/docs/latest-v16.x/api/util.html)
11. [15.x](https://nodejs.org/docs/latest-v15.x/api/util.html)
12. [14.x](https://nodejs.org/docs/latest-v14.x/api/util.html)
13. [13.x](https://nodejs.org/docs/latest-v13.x/api/util.html)
14. [12.x](https://nodejs.org/docs/latest-v12.x/api/util.html)
15. [11.x](https://nodejs.org/docs/latest-v11.x/api/util.html)
16. [10.x](https://nodejs.org/docs/latest-v10.x/api/util.html)
17. [9.x](https://nodejs.org/docs/latest-v9.x/api/util.html)
18. [8.x](https://nodejs.org/docs/latest-v8.x/api/util.html)
19. [7.x](https://nodejs.org/docs/latest-v7.x/api/util.html)
20. [6.x](https://nodejs.org/docs/latest-v6.x/api/util.html)
21. [5.x](https://nodejs.org/docs/latest-v5.x/api/util.html)
22. [4.x](https://nodejs.org/docs/latest-v4.x/api/util.html)
23. [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/util.html)
24. [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/util.html)

- [Options](https://nodejs.org/dist/latest/docs/api/util.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/util.json)
...
**Source Code:** [lib/util.js](https://github.com/nodejs/node/blob/v25.2.1/lib/util.js)
...
If the callback throws, the process will emit an [`'uncaughtException'`](https://nodejs.org/dist/latest/docs/api/process.html#event-uncaughtexception)
...
[`console.error()`](https://nodejs.org/dist/latest/docs/api/console.html#consoleerrordata-args). If not, then the returned function is a no-op.
...
invoked.
- `code` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) A deprecation code. See the [list of deprecated APIs](https://nodejs.org/dist/latest/docs/api/deprecations.html#list-of-deprecated-apis) for a
list of codes.
...
`DeprecationWarning` using the [`'warning'`](https://nodejs.org/dist/latest/docs/api/process.html#event-warning) event. The warning will
...
[`util.diff()`](https://nodejs.org/dist/latest/docs/api/util.html#utildiffactual-expected) compares two string or array values and returns an array of difference entries.
...
This function is identical to [`util.format()`](https://nodejs.org/dist/latest/docs/api/util.html#utilformatformat-args), except in that it takes
...
- `frameCount` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Optional number of frames to capture as call site objects.
...
See [Common System Errors](https://nodejs.org/dist/latest/docs/api/errors.html#common-system-errors) for the names of common errors.
...
[Stability: 3](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Legacy: Use ES2015 class syntax and `extends` keyword instead.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `colors` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, the output is styled with ANSI color
    codes. Colors are customizable. See [Customizing `util.inspect` colors](https://nodejs.org/dist/latest/docs/api/util.html#customizing-utilinspect-colors).
    **Default:**`false`.
...
terminals. To verify color support use [`tty.hasColors()`](https://nodejs.org/dist/latest/docs/api/tty.html#writestreamhascolorscount-env).
...
[`[util.inspect.custom](depth, opts, inspect)`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectcustom) function,
...
See [Custom inspection functions on Objects](https://nodejs.org/dist/latest/docs/api/util.html#custom-inspection-functions-on-objects) for more details.
...
object containing one or more valid [`util.inspect()`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectobject-options) options. Setting
...
See [`assert.deepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message) for more information about deep strict
equality.
...
- Type: [<MIMEParams>](https://nodejs.org/dist/latest/docs/api/util.html#class-utilmimeparams)

Gets the [`MIMEParams`](https://nodejs.org/dist/latest/docs/api/util.html#class-utilmimeparams) object representing the
parameters of the MIME. This property is read-only. See
[`MIMEParams`](https://nodejs.org/dist/latest/docs/api/util.html#class-utilmimeparams) documentation for details.
...
Alias for [`mime.toString()`](https://nodejs.org/dist/latest/docs/api/util.html#mimetostring).
...
Alias for [`mimeParams.entries()`](https://nodejs.org/dist/latest/docs/api/util.html#mimeparamsentries).
...
- Returns: [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) The parsed command line arguments:
  ...
  - `tokens` [<Object\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) See [parseArgs tokens](https://nodejs.org/dist/latest/docs/api/util.html#parseargs-tokens)
...
will return its value, see [Custom promisified functions](https://nodejs.org/dist/latest/docs/api/util.html#custom-promisified-functions).
...
see [Custom promisified functions](https://nodejs.org/dist/latest/docs/api/util.html#custom-promisified-functions).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)\
  ...
  - `stream` [<Stream>](https://nodejs.org/dist/latest/docs/api/stream.html#stream) A stream that will be validated if it can be colored. **Default:**`process.stdout`.\
\
...
\
The full list of formats can be found in [modifiers](https://nodejs.org/dist/latest/docs/api/util.html#modifiers).\
\
### Class: `util.TextDecoder`[\#](https://nodejs.org/dist/latest/docs/api/util.html\#class-utiltextdecoder)\
\
History\
...
(see [Internationalization](https://nodejs.org/dist/latest/docs/api/intl.html))\
\
##### Encodings supported by default (with full ICU data)[\#](https://nodejs.org/dist/latest/docs/api/util.html\#encodings-supported-by-default-with-full-icu-data)\
\
| Encoding | Aliases |\
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)\
  - `fatal` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)`true` if decoding failures are fatal.\
    ...
    (see [Internationalization](https://nodejs.org/dist/latest/docs/api/intl.html)). **Default:**`false`.\
...
\
Creates and returns an [<AbortController>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortcontroller) instance whose [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) is marked\
...
\
Marks the given [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) as transferable so that it can be used with\
...
\
See also [`util.types.isArrayBuffer()`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisarraybuffervalue) and\
[`util.types.isSharedArrayBuffer()`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesissharedarraybuffervalue).\
\
```js\
...
desirable to test for both; See [`util.types.isAnyArrayBuffer()`](https://nodejs.org/dist/latest/docs/api/util.html#utiltypesisanyarraybuffervalue) for that.\
\
```js\
...
- Returns: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)\
\
Returns `true` if `value` is a [<CryptoKey>](https://nodejs.org/dist/latest/docs/api/webcrypto.html#class-cryptokey), `false` otherwise.\
\
#### `util.types.isDataView(value)`[\#](https://nodejs.org/dist/latest/docs/api/util.html\#utiltypesisdataviewvalue)\
\
Added in: v10.0.0\
...
- Returns: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)\
\
Returns `true` if `value` is a [<KeyObject>](https://nodejs.org/dist/latest/docs/api/crypto.html#class-keyobject), `false` otherwise.\
\
#### `util.types.isMap(value)`[\#](https://nodejs.org/dist/latest/docs/api/util.html\#utiltypesismapvalue)\
\
Added in: v10.0.0\
...
\
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated: Use [`Error.isError`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error/isError) instead.\
\
...
\
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated: Use [`Object.assign()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/assign) instead.\
\
...
\
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated: Use [`Array.isArray()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/isArray) instead.\
\
