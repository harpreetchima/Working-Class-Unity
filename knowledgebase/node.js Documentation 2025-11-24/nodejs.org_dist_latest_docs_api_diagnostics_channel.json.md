---
url: "https://nodejs.org/dist/latest/docs/api/diagnostics_channel.json"
title: undefined
---
      ...
      "modules": [
        {
                  ...
                  "signatures": [
                    {
                      "params": [
                        {
                          "textRaw": "Name: `tracing:${name}:start`",
                          "name": "Name",
                          "desc": "`tracing:${name}:start`"
                        }
                      ]
                    }
                  ],
                  "desc": "<p>The <code>start</code> event represents the point at which a function is called. At this\npoint the event data may contain function arguments or anything else available\nat the very start of the execution of the function.</p>"
                },
                {
                  "textRaw": "`end(event)`",
                  "type": "method",
          ...
          "classes": [
            ...
            },
            {
              ...
              "properties": [
                {
                  "textRaw": "`hasSubscribers` Returns: {boolean} `true` if any of the individual channels has a subscriber, `false` if not.",
                  "type": "boolean",
                  "name": "return",
                  "meta": {
                    "added": [
