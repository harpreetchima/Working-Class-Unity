---
url: "https://nodejs.org/dist/latest/docs/api/async_context.html"
title: "Asynchronous context tracking | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/async_context.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/async_context.html#toc-picker)




- [Asynchronous context tracking](https://nodejs.org/dist/latest/docs/api/async_context.html#asynchronous-context-tracking)
  - [Introduction](https://nodejs.org/dist/latest/docs/api/async_context.html#introduction)
  - [Class: `AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage)
    - [`new AsyncLocalStorage([options])`](https://nodejs.org/dist/latest/docs/api/async_context.html#new-asynclocalstorageoptions)
    - [Static method: `AsyncLocalStorage.bind(fn)`](https://nodejs.org/dist/latest/docs/api/async_context.html#static-method-asynclocalstoragebindfn)
    - [Static method: `AsyncLocalStorage.snapshot()`](https://nodejs.org/dist/latest/docs/api/async_context.html#static-method-asynclocalstoragesnapshot)
    - [`asyncLocalStorage.disable()`](https://nodejs.org/dist/latest/docs/api/async_context.html#asynclocalstoragedisable)
    - [`asyncLocalStorage.getStore()`](https://nodejs.org/dist/latest/docs/api/async_context.html#asynclocalstoragegetstore)
    - [`asyncLocalStorage.enterWith(store)`](https://nodejs.org/dist/latest/docs/api/async_context.html#asynclocalstorageenterwithstore)
    - [`asyncLocalStorage.name`](https://nodejs.org/dist/latest/docs/api/async_context.html#asynclocalstoragename)
    - [`asyncLocalStorage.run(store, callback[, ...args])`](https://nodejs.org/dist/latest/docs/api/async_context.html#asynclocalstoragerunstore-callback-args)
    - [`asyncLocalStorage.exit(callback[, ...args])`](https://nodejs.org/dist/latest/docs/api/async_context.html#asynclocalstorageexitcallback-args)
    - [Usage with `async/await`](https://nodejs.org/dist/latest/docs/api/async_context.html#usage-with-asyncawait)
    - [Troubleshooting: Context loss](https://nodejs.org/dist/latest/docs/api/async_context.html#troubleshooting-context-loss)
  - [Class: `AsyncResource`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asyncresource)
    - [`new AsyncResource(type[, options])`](https://nodejs.org/dist/latest/docs/api/async_context.html#new-asyncresourcetype-options)
    - [Static method: `AsyncResource.bind(fn[, type[, thisArg]])`](https://nodejs.org/dist/latest/docs/api/async_context.html#static-method-asyncresourcebindfn-type-thisarg)
    - [`asyncResource.bind(fn[, thisArg])`](https://nodejs.org/dist/latest/docs/api/async_context.html#asyncresourcebindfn-thisarg)
    - [`asyncResource.runInAsyncScope(fn[, thisArg, ...args])`](https://nodejs.org/dist/latest/docs/api/async_context.html#asyncresourceruninasyncscopefn-thisarg-args)
    - [`asyncResource.emitDestroy()`](https://nodejs.org/dist/latest/docs/api/async_context.html#asyncresourceemitdestroy)
    - [`asyncResource.asyncId()`](https://nodejs.org/dist/latest/docs/api/async_context.html#asyncresourceasyncid)
    - [`asyncResource.triggerAsyncId()`](https://nodejs.org/dist/latest/docs/api/async_context.html#asyncresourcetriggerasyncid)
    ...
    - [Integrating `AsyncResource` with `EventEmitter`](https://nodejs.org/dist/latest/docs/api/async_context.html#integrating-asyncresource-with-eventemitter)

- [Index](https://nodejs.org/dist/latest/docs/api/async_context.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/async_context.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/async_context.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/async_context.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/async_context.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/async_context.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/async_context.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/async_context.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/async_context.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/async_context.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/async_context.html)
10. [16.x](https://nodejs.org/docs/latest-v16.x/api/async_context.html)

- [Options](https://nodejs.org/dist/latest/docs/api/async_context.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/async_context.json)
...
[`util.promisify()`](https://nodejs.org/dist/latest/docs/api/util.html#utilpromisifyoriginal) so it starts working with native promises.

If you need to use a callback-based API or your code assumes
a custom thenable implementation, use the [`AsyncResource`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asyncresource) class
...
- Returns: [<AsyncResource>](https://nodejs.org/dist/latest/docs/api/async_hooks.html#class-asyncresource) A reference to `asyncResource`.
...
provide async tracking for a [`Worker`](https://nodejs.org/dist/latest/docs/api/worker_threads.html#class-worker) pool. Other resource pools, such as
...
Event listeners triggered by an [`EventEmitter`](https://nodejs.org/dist/latest/docs/api/events.html#class-eventemitter) may be run in a different
execution context than the one that was active when `eventEmitter.on()` was
called.

The following example shows how to use the `AsyncResource` class to properly
associate an event listener with the correct execution context. The same
approach can be applied to a [`Stream`](https://nodejs.org/dist/latest/docs/api/stream.html#stream) or a similar event-driven class.
