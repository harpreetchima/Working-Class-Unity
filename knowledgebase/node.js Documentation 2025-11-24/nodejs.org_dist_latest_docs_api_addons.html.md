---
url: "https://nodejs.org/dist/latest/docs/api/addons.html"
title: "C++ addons | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/addons.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/addons.html#toc-picker)




- [C++ addons](https://nodejs.org/dist/latest/docs/api/addons.html#c-addons)
  - [Hello world](https://nodejs.org/dist/latest/docs/api/addons.html#hello-world)
    - [Context-aware addons](https://nodejs.org/dist/latest/docs/api/addons.html#context-aware-addons)
      - [Worker support](https://nodejs.org/dist/latest/docs/api/addons.html#worker-support)
    - [Building](https://nodejs.org/dist/latest/docs/api/addons.html#building)
    - [Linking to libraries included with Node.js](https://nodejs.org/dist/latest/docs/api/addons.html#linking-to-libraries-included-with-nodejs)
    - [Loading addons using `require()`](https://nodejs.org/dist/latest/docs/api/addons.html#loading-addons-using-require)
  - [Native abstractions for Node.js](https://nodejs.org/dist/latest/docs/api/addons.html#native-abstractions-for-nodejs)
  - [Node-API](https://nodejs.org/dist/latest/docs/api/addons.html#node-api)
  - [Addon examples](https://nodejs.org/dist/latest/docs/api/addons.html#addon-examples)
    - [Function arguments](https://nodejs.org/dist/latest/docs/api/addons.html#function-arguments)
    - [Callbacks](https://nodejs.org/dist/latest/docs/api/addons.html#callbacks)
    - [Object factory](https://nodejs.org/dist/latest/docs/api/addons.html#object-factory)
    - [Function factory](https://nodejs.org/dist/latest/docs/api/addons.html#function-factory)
    - [Wrapping C++ objects](https://nodejs.org/dist/latest/docs/api/addons.html#wrapping-c-objects)
    - [Factory of wrapped objects](https://nodejs.org/dist/latest/docs/api/addons.html#factory-of-wrapped-objects)
    - [Passing wrapped objects around](https://nodejs.org/dist/latest/docs/api/addons.html#passing-wrapped-objects-around)

- [Index](https://nodejs.org/dist/latest/docs/api/addons.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/addons.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/addons.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/addons.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/addons.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/addons.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/addons.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/addons.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/addons.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/addons.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/addons.html)
10. [16.x](https://nodejs.org/docs/latest-v16.x/api/addons.html)
11. [15.x](https://nodejs.org/docs/latest-v15.x/api/addons.html)
12. [14.x](https://nodejs.org/docs/latest-v14.x/api/addons.html)
13. [13.x](https://nodejs.org/docs/latest-v13.x/api/addons.html)
14. [12.x](https://nodejs.org/docs/latest-v12.x/api/addons.html)
15. [11.x](https://nodejs.org/docs/latest-v11.x/api/addons.html)
16. [10.x](https://nodejs.org/docs/latest-v10.x/api/addons.html)
17. [9.x](https://nodejs.org/docs/latest-v9.x/api/addons.html)
18. [8.x](https://nodejs.org/docs/latest-v8.x/api/addons.html)
19. [7.x](https://nodejs.org/docs/latest-v7.x/api/addons.html)
20. [6.x](https://nodejs.org/docs/latest-v6.x/api/addons.html)
21. [5.x](https://nodejs.org/docs/latest-v5.x/api/addons.html)
22. [4.x](https://nodejs.org/docs/latest-v4.x/api/addons.html)
23. [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/addons.html)
24. [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/addons.html)

- [Options](https://nodejs.org/dist/latest/docs/api/addons.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/addons.json)
...
[`require()`](https://nodejs.org/dist/latest/docs/api/modules.html#requireid) function can load addons as ordinary Node.js modules.
...
Refer to [C/C++ addons with Node-API](https://nodejs.org/dist/latest/docs/api/n-api.html) for more information on
Node-API.
...
[Linking to libraries included with Node.js](https://nodejs.org/dist/latest/docs/api/addons.html#linking-to-libraries-included-with-nodejs) for additional information.
...
In order to support [`Worker`](https://nodejs.org/dist/latest/docs/api/worker_threads.html#class-worker) threads, addons need to clean up any resources
...
[`require()`](https://nodejs.org/dist/latest/docs/api/modules.html#requireid) to the built `addon.node` module:
...
to `.dll` or `.so`). The [`require()`](https://nodejs.org/dist/latest/docs/api/modules.html#requireid) function is written to look for
files with the `.node` file extension and initialize those as dynamically-linked
libraries.

When calling [`require()`](https://nodejs.org/dist/latest/docs/api/modules.html#requireid), the `.node` extension can usually be
omitted and Node.js will still find and initialize the addon. One caveat,
however, is that Node.js will first attempt to locate and load modules or
JavaScript files that happen to share the same base name. For instance, if
there is a file `addon.js` in the same directory as the binary `addon.node`,
then [`require('addon')`](https://nodejs.org/dist/latest/docs/api/modules.html#requireid) will give precedence to the `addon.js` file
and load it instead.
...
[implementation considerations](https://nodejs.org/dist/latest/docs/api/n-api.html#implications-of-abi-stability).
