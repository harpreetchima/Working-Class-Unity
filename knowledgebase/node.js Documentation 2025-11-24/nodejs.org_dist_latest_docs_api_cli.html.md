---
url: "https://nodejs.org/dist/latest/docs/api/cli.html"
title: "Command-line API | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/cli.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/cli.html#toc-picker)




- [Command-line API](https://nodejs.org/dist/latest/docs/api/cli.html#command-line-api)
  - [Synopsis](https://nodejs.org/dist/latest/docs/api/cli.html#synopsis)
  - [Program entry point](https://nodejs.org/dist/latest/docs/api/cli.html#program-entry-point)
  - [Options](https://nodejs.org/dist/latest/docs/api/cli.html#options)
    - [`-`](https://nodejs.org/dist/latest/docs/api/cli.html#-)
    - [`--`](https://nodejs.org/dist/latest/docs/api/cli.html#--)
    - [`--abort-on-uncaught-exception`](https://nodejs.org/dist/latest/docs/api/cli.html#--abort-on-uncaught-exception)
    - [`--allow-addons`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-addons)
    - [`--allow-child-process`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-child-process)
    - [`--allow-fs-read`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-fs-read)
    - [`--allow-fs-write`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-fs-write)
    - [`--allow-inspector`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-inspector)
    - [`--allow-net`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-net)
    - [`--allow-wasi`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-wasi)
    - [`--allow-worker`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-worker)
    - [`--build-snapshot`](https://nodejs.org/dist/latest/docs/api/cli.html#--build-snapshot)
    - [`--build-snapshot-config`](https://nodejs.org/dist/latest/docs/api/cli.html#--build-snapshot-config)
    - [`-c`, `--check`](https://nodejs.org/dist/latest/docs/api/cli.html#-c---check)
    - [`--completion-bash`](https://nodejs.org/dist/latest/docs/api/cli.html#--completion-bash)
    - [`-C condition`, `--conditions=condition`](https://nodejs.org/dist/latest/docs/api/cli.html#-c-condition---conditionscondition)
    - [`--cpu-prof`](https://nodejs.org/dist/latest/docs/api/cli.html#--cpu-prof)
    - [`--cpu-prof-dir`](https://nodejs.org/dist/latest/docs/api/cli.html#--cpu-prof-dir)
    - [`--cpu-prof-interval`](https://nodejs.org/dist/latest/docs/api/cli.html#--cpu-prof-interval)
    - [`--cpu-prof-name`](https://nodejs.org/dist/latest/docs/api/cli.html#--cpu-prof-name)
    - [`--diagnostic-dir=directory`](https://nodejs.org/dist/latest/docs/api/cli.html#--diagnostic-dirdirectory)
    - [`--disable-proto=mode`](https://nodejs.org/dist/latest/docs/api/cli.html#--disable-protomode)
    - [`--disable-sigusr1`](https://nodejs.org/dist/latest/docs/api/cli.html#--disable-sigusr1)
    - [`--disable-warning=code-or-type`](https://nodejs.org/dist/latest/docs/api/cli.html#--disable-warningcode-or-type)
    - [`--disable-wasm-trap-handler`](https://nodejs.org/dist/latest/docs/api/cli.html#--disable-wasm-trap-handler)
    - [`--disallow-code-generation-from-strings`](https://nodejs.org/dist/latest/docs/api/cli.html#--disallow-code-generation-from-strings)
    - [`--dns-result-order=order`](https://nodejs.org/dist/latest/docs/api/cli.html#--dns-result-orderorder)
    - [`--enable-fips`](https://nodejs.org/dist/latest/docs/api/cli.html#--enable-fips)
    - [`--enable-network-family-autoselection`](https://nodejs.org/dist/latest/docs/api/cli.html#--enable-network-family-autoselection)
    - [`--enable-source-maps`](https://nodejs.org/dist/latest/docs/api/cli.html#--enable-source-maps)
    - [`--entry-url`](https://nodejs.org/dist/latest/docs/api/cli.html#--entry-url)
    ...
    - [`-e`, `--eval "script"`](https://nodejs.org/dist/latest/docs/api/cli.html#-e---eval-script)
    - [`--experimental-addon-modules`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-addon-modules)
    - [`--experimental-config-file=config`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-config-fileconfig)
    - [`--experimental-default-config-file`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-default-config-file)
    - [`--experimental-eventsource`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-eventsource)
    - [`--experimental-import-meta-resolve`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-import-meta-resolve)
    - [`--experimental-inspector-network-resource`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-inspector-network-resource)
    - [`--experimental-loader=module`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-loadermodule)
    - [`--experimental-network-inspection`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-network-inspection)
    - [`--experimental-print-required-tla`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-print-required-tla)
    - [`--experimental-quic`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-quic)
    - [`--experimental-require-module`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-require-module)
    - [`--experimental-sea-config`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-sea-config)
    - [`--experimental-shadow-realm`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-shadow-realm)
    - [`--experimental-test-coverage`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-test-coverage)
    - [`--experimental-test-module-mocks`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-test-module-mocks)
    - [`--experimental-transform-types`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-transform-types)
    - [`--experimental-vm-modules`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-vm-modules)
    - [`--experimental-wasi-unstable-preview1`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-wasi-unstable-preview1)
    - [`--experimental-worker-inspection`](https://nodejs.org/dist/latest/docs/api/cli.html#--experimental-worker-inspection)
    - [`--expose-gc`](https://nodejs.org/dist/latest/docs/api/cli.html#--expose-gc)
    - [`--force-context-aware`](https://nodejs.org/dist/latest/docs/api/cli.html#--force-context-aware)
    - [`--force-fips`](https://nodejs.org/dist/latest/docs/api/cli.html#--force-fips)
    - [`--force-node-api-uncaught-exceptions-policy`](https://nodejs.org/dist/latest/docs/api/cli.html#--force-node-api-uncaught-exceptions-policy)
    - [`--frozen-intrinsics`](https://nodejs.org/dist/latest/docs/api/cli.html#--frozen-intrinsics)
    - [`--heap-prof`](https://nodejs.org/dist/latest/docs/api/cli.html#--heap-prof)
    - [`--heap-prof-dir`](https://nodejs.org/dist/latest/docs/api/cli.html#--heap-prof-dir)
    - [`--heap-prof-interval`](https://nodejs.org/dist/latest/docs/api/cli.html#--heap-prof-interval)
    - [`--heap-prof-name`](https://nodejs.org/dist/latest/docs/api/cli.html#--heap-prof-name)
    - [`--heapsnapshot-near-heap-limit=max_count`](https://nodejs.org/dist/latest/docs/api/cli.html#--heapsnapshot-near-heap-limitmax_count)
    - [`--heapsnapshot-signal=signal`](https://nodejs.org/dist/latest/docs/api/cli.html#--heapsnapshot-signalsignal)
    - [`-h`, `--help`](https://nodejs.org/dist/latest/docs/api/cli.html#-h---help)
    - [`--icu-data-dir=file`](https://nodejs.org/dist/latest/docs/api/cli.html#--icu-data-dirfile)
    - [`--import=module`](https://nodejs.org/dist/latest/docs/api/cli.html#--importmodule)
    - [`--input-type=type`](https://nodejs.org/dist/latest/docs/api/cli.html#--input-typetype)
    - [`--insecure-http-parser`](https://nodejs.org/dist/latest/docs/api/cli.html#--insecure-http-parser)
      - [Warning: binding inspector to a public IP:port combination is insecure](https://nodejs.org/dist/latest/docs/api/cli.html#warning-binding-inspector-to-a-public-ipport-combination-is-insecure)
    - [`--inspect-brk[=[host:]port]`](https://nodejs.org/dist/latest/docs/api/cli.html#--inspect-brkhostport)
    - [`--inspect-port=[host:]port`](https://nodejs.org/dist/latest/docs/api/cli.html#--inspect-porthostport)
    - [`--inspect-publish-uid=stderr,http`](https://nodejs.org/dist/latest/docs/api/cli.html#--inspect-publish-uidstderrhttp)
    - [`--inspect-wait[=[host:]port]`](https://nodejs.org/dist/latest/docs/api/cli.html#--inspect-waithostport)
    - [`--inspect[=[host:]port]`](https://nodejs.org/dist/latest/docs/api/cli.html#--inspecthostport)
    - [`-i`, `--interactive`](https://nodejs.org/dist/latest/docs/api/cli.html#-i---interactive)
    - [`--jitless`](https://nodejs.org/dist/latest/docs/api/cli.html#--jitless)
    - [`--localstorage-file=file`](https://nodejs.org/dist/latest/docs/api/cli.html#--localstorage-filefile)
    - [`--max-http-header-size=size`](https://nodejs.org/dist/latest/docs/api/cli.html#--max-http-header-sizesize)
    - [`--max-old-space-size-percentage=percentage`](https://nodejs.org/dist/latest/docs/api/cli.html#--max-old-space-size-percentagepercentage)
    - [`--napi-modules`](https://nodejs.org/dist/latest/docs/api/cli.html#--napi-modules)
    - [`--network-family-autoselection-attempt-timeout`](https://nodejs.org/dist/latest/docs/api/cli.html#--network-family-autoselection-attempt-timeout)
    - [`--no-addons`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-addons)
    - [`--no-async-context-frame`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-async-context-frame)
    - [`--no-deprecation`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-deprecation)
    - [`--no-experimental-detect-module`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-experimental-detect-module)
    - [`--no-experimental-global-navigator`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-experimental-global-navigator)
    - [`--no-experimental-repl-await`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-experimental-repl-await)
    - [`--no-experimental-require-module`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-experimental-require-module)
    - [`--no-experimental-sqlite`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-experimental-sqlite)
    - [`--no-experimental-websocket`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-experimental-websocket)
    - [`--no-experimental-webstorage`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-experimental-webstorage)
    - [`--no-extra-info-on-fatal-exception`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-extra-info-on-fatal-exception)
    - [`--no-force-async-hooks-checks`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-force-async-hooks-checks)
    - [`--no-global-search-paths`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-global-search-paths)
    - [`--no-network-family-autoselection`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-network-family-autoselection)
    - [`--no-strip-types`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-strip-types)
    - [`--no-warnings`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-warnings)
    - [`--node-memory-debug`](https://nodejs.org/dist/latest/docs/api/cli.html#--node-memory-debug)
    - [`--openssl-config=file`](https://nodejs.org/dist/latest/docs/api/cli.html#--openssl-configfile)
    - [`--openssl-legacy-provider`](https://nodejs.org/dist/latest/docs/api/cli.html#--openssl-legacy-provider)
    - [`--openssl-shared-config`](https://nodejs.org/dist/latest/docs/api/cli.html#--openssl-shared-config)
    - [`--pending-deprecation`](https://nodejs.org/dist/latest/docs/api/cli.html#--pending-deprecation)
    - [`--permission`](https://nodejs.org/dist/latest/docs/api/cli.html#--permission)
    - [`--preserve-symlinks`](https://nodejs.org/dist/latest/docs/api/cli.html#--preserve-symlinks)
    - [`--preserve-symlinks-main`](https://nodejs.org/dist/latest/docs/api/cli.html#--preserve-symlinks-main)
    - [`-p`, `--print "script"`](https://nodejs.org/dist/latest/docs/api/cli.html#-p---print-script)
    - [`--prof`](https://nodejs.org/dist/latest/docs/api/cli.html#--prof)
    - [`--prof-process`](https://nodejs.org/dist/latest/docs/api/cli.html#--prof-process)
    - [`--redirect-warnings=file`](https://nodejs.org/dist/latest/docs/api/cli.html#--redirect-warningsfile)
    - [`--report-compact`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-compact)
    - [`--report-dir=directory`, `report-directory=directory`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-dirdirectory-report-directorydirectory)
    - [`--report-exclude-env`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-exclude-env)
    - [`--report-exclude-network`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-exclude-network)
    - [`--report-filename=filename`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-filenamefilename)
    - [`--report-on-fatalerror`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-on-fatalerror)
    - [`--report-on-signal`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-on-signal)
    - [`--report-signal=signal`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-signalsignal)
    - [`--report-uncaught-exception`](https://nodejs.org/dist/latest/docs/api/cli.html#--report-uncaught-exception)
    - [`-r`, `--require module`](https://nodejs.org/dist/latest/docs/api/cli.html#-r---require-module)
    - [`--run`](https://nodejs.org/dist/latest/docs/api/cli.html#--run)
      - [Intentional limitations](https://nodejs.org/dist/latest/docs/api/cli.html#intentional-limitations)
      - [Environment variables](https://nodejs.org/dist/latest/docs/api/cli.html#environment-variables)
    - [`--secure-heap-min=n`](https://nodejs.org/dist/latest/docs/api/cli.html#--secure-heap-minn)
    - [`--secure-heap=n`](https://nodejs.org/dist/latest/docs/api/cli.html#--secure-heapn)
    - [`--snapshot-blob=path`](https://nodejs.org/dist/latest/docs/api/cli.html#--snapshot-blobpath)
    - [`--test`](https://nodejs.org/dist/latest/docs/api/cli.html#--test)
    - [`--test-concurrency`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-concurrency)
    - [`--test-coverage-branches=threshold`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-coverage-branchesthreshold)
    - [`--test-coverage-exclude`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-coverage-exclude)
    - [`--test-coverage-functions=threshold`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-coverage-functionsthreshold)
    - [`--test-coverage-include`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-coverage-include)
    - [`--test-coverage-lines=threshold`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-coverage-linesthreshold)
    - [`--test-force-exit`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-force-exit)
    - [`--test-global-setup=module`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-global-setupmodule)
    - [`--test-isolation=mode`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-isolationmode)
    - [`--test-name-pattern`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-name-pattern)
    - [`--test-only`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-only)
    - [`--test-reporter`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-reporter)
    - [`--test-reporter-destination`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-reporter-destination)
    - [`--test-rerun-failures`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-rerun-failures)
    - [`--test-shard`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-shard)
    - [`--test-skip-pattern`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-skip-pattern)
    - [`--test-timeout`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-timeout)
    - [`--test-update-snapshots`](https://nodejs.org/dist/latest/docs/api/cli.html#--test-update-snapshots)
    - [`--throw-deprecation`](https://nodejs.org/dist/latest/docs/api/cli.html#--throw-deprecation)
    - [`--title=title`](https://nodejs.org/dist/latest/docs/api/cli.html#--titletitle)
    - [`--tls-cipher-list=list`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-cipher-listlist)
    - [`--tls-keylog=file`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-keylogfile)
    - [`--tls-max-v1.2`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-max-v12)
    - [`--tls-max-v1.3`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-max-v13)
    - [`--tls-min-v1.0`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-min-v10)
    - [`--tls-min-v1.1`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-min-v11)
    - [`--tls-min-v1.2`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-min-v12)
    - [`--tls-min-v1.3`](https://nodejs.org/dist/latest/docs/api/cli.html#--tls-min-v13)
    - [`--trace-deprecation`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-deprecation)
    - [`--trace-env`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-env)
    - [`--trace-env-js-stack`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-env-js-stack)
    - [`--trace-env-native-stack`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-env-native-stack)
    - [`--trace-event-categories`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-event-categories)
    - [`--trace-event-file-pattern`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-event-file-pattern)
    - [`--trace-events-enabled`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-events-enabled)
    - [`--trace-exit`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-exit)
    - [`--trace-require-module=mode`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-require-modulemode)
    - [`--trace-sigint`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-sigint)
    - [`--trace-sync-io`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-sync-io)
    - [`--trace-tls`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-tls)
    - [`--trace-uncaught`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-uncaught)
    - [`--trace-warnings`](https://nodejs.org/dist/latest/docs/api/cli.html#--trace-warnings)
    - [`--track-heap-objects`](https://nodejs.org/dist/latest/docs/api/cli.html#--track-heap-objects)
    - [`--unhandled-rejections=mode`](https://nodejs.org/dist/latest/docs/api/cli.html#--unhandled-rejectionsmode)
    - [`--use-bundled-ca`, `--use-openssl-ca`](https://nodejs.org/dist/latest/docs/api/cli.html#--use-bundled-ca---use-openssl-ca)
    - [`--use-env-proxy`](https://nodejs.org/dist/latest/docs/api/cli.html#--use-env-proxy)
    - [`--use-largepages=mode`](https://nodejs.org/dist/latest/docs/api/cli.html#--use-largepagesmode)
    - [`--use-system-ca`](https://nodejs.org/dist/latest/docs/api/cli.html#--use-system-ca)
    - [`--v8-options`](https://nodejs.org/dist/latest/docs/api/cli.html#--v8-options)
    - [`--v8-pool-size=num`](https://nodejs.org/dist/latest/docs/api/cli.html#--v8-pool-sizenum)
    - [`-v`, `--version`](https://nodejs.org/dist/latest/docs/api/cli.html#-v---version)
    - [`--watch`](https://nodejs.org/dist/latest/docs/api/cli.html#--watch)
    - [`--watch-kill-signal`](https://nodejs.org/dist/latest/docs/api/cli.html#--watch-kill-signal)
    - [`--watch-path`](https://nodejs.org/dist/latest/docs/api/cli.html#--watch-path)
    - [`--watch-preserve-output`](https://nodejs.org/dist/latest/docs/api/cli.html#--watch-preserve-output)
    - [`--zero-fill-buffers`](https://nodejs.org/dist/latest/docs/api/cli.html#--zero-fill-buffers)
  - [Environment variables](https://nodejs.org/dist/latest/docs/api/cli.html#environment-variables_1)
    - [`FORCE_COLOR=[1, 2, 3]`](https://nodejs.org/dist/latest/docs/api/cli.html#force_color1-2-3)
    - [`NODE_COMPILE_CACHE=dir`](https://nodejs.org/dist/latest/docs/api/cli.html#node_compile_cachedir)
    - [`NODE_COMPILE_CACHE_PORTABLE=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_compile_cache_portable1)
    - [`NODE_DEBUG=module[,…]`](https://nodejs.org/dist/latest/docs/api/cli.html#node_debugmodule)
    - [`NODE_DEBUG_NATIVE=module[,…]`](https://nodejs.org/dist/latest/docs/api/cli.html#node_debug_nativemodule)
    - [`NODE_DISABLE_COLORS=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_disable_colors1)
    - [`NODE_DISABLE_COMPILE_CACHE=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_disable_compile_cache1)
    - [`NODE_EXTRA_CA_CERTS=file`](https://nodejs.org/dist/latest/docs/api/cli.html#node_extra_ca_certsfile)
    - [`NODE_ICU_DATA=file`](https://nodejs.org/dist/latest/docs/api/cli.html#node_icu_datafile)
    - [`NODE_NO_WARNINGS=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_no_warnings1)
    - [`NODE_OPTIONS=options...`](https://nodejs.org/dist/latest/docs/api/cli.html#node_optionsoptions)
    - [`NODE_PATH=path[:…]`](https://nodejs.org/dist/latest/docs/api/cli.html#node_pathpath)
    - [`NODE_PENDING_DEPRECATION=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_pending_deprecation1)
    - [`NODE_PENDING_PIPE_INSTANCES=instances`](https://nodejs.org/dist/latest/docs/api/cli.html#node_pending_pipe_instancesinstances)
    - [`NODE_PRESERVE_SYMLINKS=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_preserve_symlinks1)
    - [`NODE_REDIRECT_WARNINGS=file`](https://nodejs.org/dist/latest/docs/api/cli.html#node_redirect_warningsfile)
    - [`NODE_REPL_EXTERNAL_MODULE=file`](https://nodejs.org/dist/latest/docs/api/cli.html#node_repl_external_modulefile)
    - [`NODE_REPL_HISTORY=file`](https://nodejs.org/dist/latest/docs/api/cli.html#node_repl_historyfile)
    - [`NODE_SKIP_PLATFORM_CHECK=value`](https://nodejs.org/dist/latest/docs/api/cli.html#node_skip_platform_checkvalue)
    - [`NODE_TEST_CONTEXT=value`](https://nodejs.org/dist/latest/docs/api/cli.html#node_test_contextvalue)
    - [`NODE_TLS_REJECT_UNAUTHORIZED=value`](https://nodejs.org/dist/latest/docs/api/cli.html#node_tls_reject_unauthorizedvalue)
    - [`NODE_USE_ENV_PROXY=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_use_env_proxy1)
    - [`NODE_USE_SYSTEM_CA=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_use_system_ca1)
    - [`NODE_V8_COVERAGE=dir`](https://nodejs.org/dist/latest/docs/api/cli.html#node_v8_coveragedir)
      - [Coverage output](https://nodejs.org/dist/latest/docs/api/cli.html#coverage-output)
      - [Source map cache](https://nodejs.org/dist/latest/docs/api/cli.html#source-map-cache)
    - [`NO_COLOR=<any>`](https://nodejs.org/dist/latest/docs/api/cli.html#no_colorany)
    - [`OPENSSL_CONF=file`](https://nodejs.org/dist/latest/docs/api/cli.html#openssl_conffile)
    - [`SSL_CERT_DIR=dir`](https://nodejs.org/dist/latest/docs/api/cli.html#ssl_cert_dirdir)
    - [`SSL_CERT_FILE=file`](https://nodejs.org/dist/latest/docs/api/cli.html#ssl_cert_filefile)
    - [`TZ`](https://nodejs.org/dist/latest/docs/api/cli.html#tz)
    - [`UV_THREADPOOL_SIZE=size`](https://nodejs.org/dist/latest/docs/api/cli.html#uv_threadpool_sizesize)
  - [Useful V8 options](https://nodejs.org/dist/latest/docs/api/cli.html#useful-v8-options)
    - [`--abort-on-uncaught-exception`](https://nodejs.org/dist/latest/docs/api/cli.html#--abort-on-uncaught-exception_1)
    - [`--disallow-code-generation-from-strings`](https://nodejs.org/dist/latest/docs/api/cli.html#--disallow-code-generation-from-strings_1)
    - [`--enable-etw-stack-walking`](https://nodejs.org/dist/latest/docs/api/cli.html#--enable-etw-stack-walking)
    - [`--expose-gc`](https://nodejs.org/dist/latest/docs/api/cli.html#--expose-gc_1)
    - [`--harmony-shadow-realm`](https://nodejs.org/dist/latest/docs/api/cli.html#--harmony-shadow-realm)
    - [`--heap-snapshot-on-oom`](https://nodejs.org/dist/latest/docs/api/cli.html#--heap-snapshot-on-oom)
    - [`--interpreted-frames-native-stack`](https://nodejs.org/dist/latest/docs/api/cli.html#--interpreted-frames-native-stack)
    - [`--jitless`](https://nodejs.org/dist/latest/docs/api/cli.html#--jitless_1)
    - [`--max-old-space-size=SIZE` (in MiB)](https://nodejs.org/dist/latest/docs/api/cli.html#--max-old-space-sizesize-in-mib)
    - [`--max-semi-space-size=SIZE` (in MiB)](https://nodejs.org/dist/latest/docs/api/cli.html#--max-semi-space-sizesize-in-mib)
    - [`--perf-basic-prof`](https://nodejs.org/dist/latest/docs/api/cli.html#--perf-basic-prof)
    - [`--perf-basic-prof-only-functions`](https://nodejs.org/dist/latest/docs/api/cli.html#--perf-basic-prof-only-functions)
    - [`--perf-prof`](https://nodejs.org/dist/latest/docs/api/cli.html#--perf-prof)
    - [`--perf-prof-unwinding-info`](https://nodejs.org/dist/latest/docs/api/cli.html#--perf-prof-unwinding-info)
    - [`--prof`](https://nodejs.org/dist/latest/docs/api/cli.html#--prof_1)
    - [`--security-revert`](https://nodejs.org/dist/latest/docs/api/cli.html#--security-revert)
    - [`--stack-trace-limit=limit`](https://nodejs.org/dist/latest/docs/api/cli.html#--stack-trace-limitlimit)

- [Index](https://nodejs.org/dist/latest/docs/api/cli.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/cli.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/cli.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/cli.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/cli.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/cli.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/cli.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/cli.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/cli.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/cli.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/cli.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/cli.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/cli.json)
...
Execute without arguments to start the [REPL](https://nodejs.org/dist/latest/docs/api/repl.html).

For more info about `node inspect`, see the [debugger](https://nodejs.org/dist/latest/docs/api/debugger.html) documentation.
...
`package.json` file contains a top-level [`"type"`](https://nodejs.org/dist/latest/docs/api/packages.html#type) field with a value of
`"module"`.

See [module resolution and loading](https://nodejs.org/dist/latest/docs/api/packages.html#module-resolution-and-loading) for more details.
...
command line take precedence over options passed through the [`NODE_OPTIONS`](https://nodejs.org/dist/latest/docs/api/cli.html#node_optionsoptions)
...
[`process.setUncaughtExceptionCaptureCallback()`](https://nodejs.org/dist/latest/docs/api/process.html#processsetuncaughtexceptioncapturecallbackfn) (and through usage of the
...
When using the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model), the process will not be able to use
...
When using the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model), the process will not be able to spawn any
...
the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model).
...
Examples can be found in the [File System Permissions](https://nodejs.org/dist/latest/docs/api/permissions.html#file-system-permissions) documentation.
...
When using the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model), the process will not be able to connect
...
When using the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model), the process will not be able to access
network by default.
Attempts to do so will throw an `ERR_ACCESS_DENIED` unless the
...
When using the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model), the process will not be capable of creating
...
When using the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model), the process will not be able to create any
...
The [`v8.startupSnapshot` API](https://nodejs.org/dist/latest/docs/api/v8.html#startup-snapshot-api) can be used to specify an entry point at
...
For more information, check out the [`v8.startupSnapshot` API](https://nodejs.org/dist/latest/docs/api/v8.html#startup-snapshot-api) documentation.
...
before building the snapshot, as if [`--build-snapshot`](https://nodejs.org/dist/latest/docs/api/cli.html#--build-snapshot) had been passed
...
Provide custom [conditional exports](https://nodejs.org/dist/latest/docs/api/packages.html#conditional-exports) resolution conditions.
...
[`--diagnostic-dir`](https://nodejs.org/dist/latest/docs/api/cli.html#--diagnostic-dirdirectory) command-line option.
...
- [`--cpu-prof-dir`](https://nodejs.org/dist/latest/docs/api/cli.html#--cpu-prof-dir)
- [`--heap-prof-dir`](https://nodejs.org/dist/latest/docs/api/cli.html#--heap-prof-dir)
- [`--redirect-warnings`](https://nodejs.org/dist/latest/docs/api/cli.html#--redirect-warningsfile)
...
Warnings emitted from [`process.emitWarning()`](https://nodejs.org/dist/latest/docs/api/process.html#processemitwarningwarning-options) may contain a
`code` and a `type`. This option will not-emit warnings that have a matching
`code` or `type`.

List of [deprecation warnings](https://nodejs.org/dist/latest/docs/api/deprecations.html#list-of-deprecated-apis).

The Node.js core warning types are: `DeprecationWarning` and
`ExperimentalWarning`

For example, the following script will not emit
[DEP0025 `require('node:sys')`](https://nodejs.org/dist/latest/docs/api/deprecations.html#dep0025-requirenodesys) when executed with
...
[DEP0025 `require('node:sys')`](https://nodejs.org/dist/latest/docs/api/deprecations.html#dep0025-requirenodesys), but not any Experimental
Warnings (such as
[ExperimentalWarning: `vm.measureMemory` is an experimental feature](https://nodejs.org/dist/latest/docs/api/vm.html#vmmeasurememoryoptions)
...
Set the default value of `order` in [`dns.lookup()`](https://nodejs.org/dist/latest/docs/api/dns.html#dnslookuphostname-options-callback) and
[`dnsPromises.lookup()`](https://nodejs.org/dist/latest/docs/api/dns.html#dnspromiseslookuphostname-options). The value could be:

- `ipv4first`: sets default `order` to `ipv4first`.
- `ipv6first`: sets default `order` to `ipv6first`.
- `verbatim`: sets default `order` to `verbatim`.

The default is `verbatim` and [`dns.setDefaultResultOrder()`](https://nodejs.org/dist/latest/docs/api/dns.html#dnssetdefaultresultorderorder) have higher
...
Follows [ECMAScript module](https://nodejs.org/dist/latest/docs/api/esm.html#modules-ecmascript-modules) resolution rules.

Any query parameter or hash in the URL will be accessible via [`import.meta.url`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetaurl).
...
Behavior is the same as [`--env-file`](https://nodejs.org/dist/latest/docs/api/cli.html#--env-filefile), but an error is not thrown if the file
does not exist.
...
variables which configure Node.js](https://nodejs.org/dist/latest/docs/api/cli.html#environment-variables_1), such as `NODE_OPTIONS`,
...
can use the [`--env-file-if-exists`](https://nodejs.org/dist/latest/docs/api/cli.html#--env-file-if-existsfile) flag instead.
...
[`--no-strip-types`](https://nodejs.org/dist/latest/docs/api/cli.html#--no-strip-types) flag is provided.
...
- The `nodeOptions` field contains CLI flags that are allowed in [`NODE_OPTIONS`](https://nodejs.org/dist/latest/docs/api/cli.html#node_optionsoptions).
...
It is possible to use the [official JSON schema](https://nodejs.org/dist/latest/docs/node-config-schema.json)
...
> Please use
> [`--import` with `register()`](https://nodejs.org/dist/latest/docs/api/module.html#enabling) instead.

Specify the `module` containing exported [module customization hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks).
`module` may be any string accepted as an [`import` specifier](https://nodejs.org/dist/latest/docs/api/esm.html#import-specifiers).

This feature requires `--allow-worker` if used with the [Permission Model](https://nodejs.org/dist/latest/docs/api/permissions.html#permission-model).
...
See [Loading ECMAScript modules using `require()`](https://nodejs.org/dist/latest/docs/api/modules.html#loading-ecmascript-modules-using-require).
...
binary to produce a [single executable application](https://nodejs.org/dist/latest/docs/api/single-executable-applications.html). See the documentation
about [this configuration](https://nodejs.org/dist/latest/docs/api/single-executable-applications.html#generating-single-executable-preparation-blobs) for details.
...
[collecting code coverage from tests](https://nodejs.org/dist/latest/docs/api/test.html#collecting-code-coverage) for more details.
...
[Stability: 1](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Experimental. This flag is inherited from V8 and is subject to
change upstream.
...
Disable loading native addons that are not [context-aware](https://nodejs.org/dist/latest/docs/api/addons.html#context-aware-addons).
...
[`--require`](https://nodejs.org/dist/latest/docs/api/cli.html#-r---require-module) and [`--import`](https://nodejs.org/dist/latest/docs/api/cli.html#--importmodule) both run before freezing intrinsics.
...
with the ones provided in [`NODE_OPTIONS`](https://nodejs.org/dist/latest/docs/api/cli.html#node_optionsoptions).

Follows [ECMAScript module](https://nodejs.org/dist/latest/docs/api/esm.html#modules-ecmascript-modules) resolution rules.
Use [`--require`](https://nodejs.org/dist/latest/docs/api/cli.html#-r---require-module) to load a [CommonJS module](https://nodejs.org/dist/latest/docs/api/modules.html).
...
4. If step 3 fails with an error code [`ERR_UNSUPPORTED_TYPESCRIPT_SYNTAX`](https://nodejs.org/dist/latest/docs/api/errors.html#err_unsupported_typescript_syntax)
or [`ERR_INVALID_TYPESCRIPT_SYNTAX`](https://nodejs.org/dist/latest/docs/api/errors.html#err_invalid_typescript_syntax),
...
[`--print`](https://nodejs.org/dist/latest/docs/api/cli.html#-p---print-script) will throw an error, as `--print` does not support ES module
syntax.
...
See [V8 Inspector integration for Node.js](https://nodejs.org/dist/latest/docs/api/debugger.html#v8-inspector-integration-for-nodejs) for further explanation on Node.js debugger.
...
Except when [`--disable-sigusr1`](https://nodejs.org/dist/latest/docs/api/cli.html#--disable-sigusr1) is passed.

Default host is `127.0.0.1`. If port `0` is specified,
a random available port will be used.

See the [security warning](https://nodejs.org/dist/latest/docs/api/cli.html#warning-binding-inspector-to-a-public-ipport-combination-is-insecure) below regarding the `host`
parameter usage.
...
For more information, see [`net.getDefaultAutoSelectFamilyAttemptTimeout()`](https://nodejs.org/dist/latest/docs/api/net.html#netgetdefaultautoselectfamilyattempttimeout).
...
Disables the use of [`AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage) backed by `AsyncContextFrame` and
...
Disable using [syntax detection](https://nodejs.org/dist/latest/docs/api/packages.html#syntax-detection) to determine module type.
...
Disable exposition of [Navigator API](https://nodejs.org/dist/latest/docs/api/globals.html#navigator) on the global scope.
...
Disable the experimental [`node:sqlite`](https://nodejs.org/dist/latest/docs/api/sqlite.html) module.
...
For more information, see the [TypeScript type-stripping](https://nodejs.org/dist/latest/docs/api/typescript.html#type-stripping) documentation.
...
[`--allow-fs-read`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-fs-read), [`--allow-fs-write`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-fs-write) flags
- Network - manageable through [`--allow-net`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-net) flag
- Child Process - manageable through [`--allow-child-process`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-child-process) flag
- Worker Threads - manageable through [`--allow-worker`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-worker) flag
- WASI - manageable through [`--allow-wasi`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-wasi) flag
- Addons - manageable through [`--allow-addons`](https://nodejs.org/dist/latest/docs/api/cli.html#--allow-addons) flag
...
See [`--preserve-symlinks`](https://nodejs.org/dist/latest/docs/api/cli.html#--preserve-symlinks) for more information.
...
See the documentation on [running tests from the command line](https://nodejs.org/dist/latest/docs/api/test.html#running-tests-from-the-command-line)
for more details.
...
See the documentation on [global setup and teardown](https://nodejs.org/dist/latest/docs/api/test.html#global-setup-and-teardown) for more details.
...
present. See the [test runner execution model](https://nodejs.org/dist/latest/docs/api/test.html#test-runner-execution-model) section for more information.
...
[filtering tests by name](https://nodejs.org/dist/latest/docs/api/test.html#filtering-tests-by-name) for more details.
...
[test reporters](https://nodejs.org/dist/latest/docs/api/test.html#test-reporters) for more details.
...
See the documentation on [test reruns](https://nodejs.org/dist/latest/docs/api/test.html#rerunning-failed-tests) for more details.
...
Regenerates the snapshot files used by the test runner for [snapshot testing](https://nodejs.org/dist/latest/docs/api/test.html#snapshot-testing).
...
Set [`tls.DEFAULT_MAX_VERSION`](https://nodejs.org/dist/latest/docs/api/tls.html#tlsdefault_max_version) to 'TLSv1.2'. Use to disable support for
TLSv1.3.
...
Set default [`tls.DEFAULT_MAX_VERSION`](https://nodejs.org/dist/latest/docs/api/tls.html#tlsdefault_max_version) to 'TLSv1.3'. Use to enable support
for TLSv1.3.
...
Set default [`tls.DEFAULT_MIN_VERSION`](https://nodejs.org/dist/latest/docs/api/tls.html#tlsdefault_min_version) to 'TLSv1'. Use for compatibility with
...
Set default [`tls.DEFAULT_MIN_VERSION`](https://nodejs.org/dist/latest/docs/api/tls.html#tlsdefault_min_version) to 'TLSv1.1'. Use for compatibility
...
Set default [`tls.DEFAULT_MIN_VERSION`](https://nodejs.org/dist/latest/docs/api/tls.html#tlsdefault_min_version) to 'TLSv1.2'. This is the default for
...
Set default [`tls.DEFAULT_MIN_VERSION`](https://nodejs.org/dist/latest/docs/api/tls.html#tlsdefault_min_version) to 'TLSv1.3'. Use to disable support
...
Prints information about usage of [Loading ECMAScript modules using `require()`](https://nodejs.org/dist/latest/docs/api/modules.html#loading-ecmascript-modules-using-require).
...
- `throw`: Emit [`unhandledRejection`](https://nodejs.org/dist/latest/docs/api/process.html#event-unhandledrejection). If this hook is not set, raise the
...
exception is handled, [`unhandledRejection`](https://nodejs.org/dist/latest/docs/api/process.html#event-unhandledrejection) is emitted.
- `warn`: Always trigger a warning, no matter if the [`unhandledRejection`](https://nodejs.org/dist/latest/docs/api/process.html#event-unhandledrejection)
hook is set or not but do not print the deprecation warning.
- `warn-with-error-code`: Emit [`unhandledRejection`](https://nodejs.org/dist/latest/docs/api/process.html#event-unhandledrejection). If this hook is not
...
This is equivalent to setting the [`NODE_USE_ENV_PROXY=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_use_env_proxy1) environment variable.
...
Automatically zero-fills all newly allocated [`Buffer`](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) instances.
...
Enable the [module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) for the Node.js instance. See the documentation of
[module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) for details.

#### `NODE_COMPILE_CACHE_PORTABLE=1`[\#](https://nodejs.org/dist/latest/docs/api/cli.html\#node_compile_cache_portable1)

When set to 1, the [module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) can be reused across different directory
...
Disable the [module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) for the Node.js instance. See the documentation of
[module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) for details.
...
[`process.emitWarning()`](https://nodejs.org/dist/latest/docs/api/process.html#processemitwarningwarning-options) if the file is missing or
...
This can also be enabled using the [`--use-env-proxy`](https://nodejs.org/dist/latest/docs/api/cli.html#--use-env-proxy) command-line flag.
When both are set, `--use-env-proxy` takes precedence.
...
This can also be enabled using the [`--use-system-ca`](https://nodejs.org/dist/latest/docs/api/cli.html#--use-system-ca) command-line flag.
...
If the [`--openssl-config`](https://nodejs.org/dist/latest/docs/api/cli.html#--openssl-configfile) command-line option is used, the environment
variable is ignored.
