---
url: "https://nodejs.org/%22https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number/MAX_SAFE_INTEGER/%22"
title: "Node.js"
---
...
![The Node.js mascot](https://nodejs.org/static/images/node-mascot.svg)

Sorry, we couldn't find the page you're after! Try starting again from the homepage.

[Back to Home](https://nodejs.org/en)
