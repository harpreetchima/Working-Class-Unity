---
url: "https://nodejs.org/dist/latest/docs/api/console.html"
title: "Console | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/console.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/console.html#toc-picker)




- [Console](https://nodejs.org/dist/latest/docs/api/console.html#console)
  - [Class: `Console`](https://nodejs.org/dist/latest/docs/api/console.html#class-console)
    - [`new Console(stdout[, stderr][, ignoreErrors])`](https://nodejs.org/dist/latest/docs/api/console.html#new-consolestdout-stderr-ignoreerrors)
    - [`new Console(options)`](https://nodejs.org/dist/latest/docs/api/console.html#new-consoleoptions)
    - [`console.assert(value[, ...message])`](https://nodejs.org/dist/latest/docs/api/console.html#consoleassertvalue-message)
    - [`console.clear()`](https://nodejs.org/dist/latest/docs/api/console.html#consoleclear)
    - [`console.count([label])`](https://nodejs.org/dist/latest/docs/api/console.html#consolecountlabel)
    - [`console.countReset([label])`](https://nodejs.org/dist/latest/docs/api/console.html#consolecountresetlabel)
    - [`console.debug(data[, ...args])`](https://nodejs.org/dist/latest/docs/api/console.html#consoledebugdata-args)
    - [`console.dir(obj[, options])`](https://nodejs.org/dist/latest/docs/api/console.html#consoledirobj-options)
    - [`console.dirxml(...data)`](https://nodejs.org/dist/latest/docs/api/console.html#consoledirxmldata)
    - [`console.error([data][, ...args])`](https://nodejs.org/dist/latest/docs/api/console.html#consoleerrordata-args)
    - [`console.group([...label])`](https://nodejs.org/dist/latest/docs/api/console.html#consolegrouplabel)
    - [`console.groupCollapsed()`](https://nodejs.org/dist/latest/docs/api/console.html#consolegroupcollapsed)
    - [`console.groupEnd()`](https://nodejs.org/dist/latest/docs/api/console.html#consolegroupend)
    - [`console.info([data][, ...args])`](https://nodejs.org/dist/latest/docs/api/console.html#consoleinfodata-args)
    - [`console.log([data][, ...args])`](https://nodejs.org/dist/latest/docs/api/console.html#consolelogdata-args)
    - [`console.table(tabularData[, properties])`](https://nodejs.org/dist/latest/docs/api/console.html#consoletabletabulardata-properties)
    - [`console.time([label])`](https://nodejs.org/dist/latest/docs/api/console.html#consoletimelabel)
    - [`console.timeEnd([label])`](https://nodejs.org/dist/latest/docs/api/console.html#consoletimeendlabel)
    - [`console.timeLog([label][, ...data])`](https://nodejs.org/dist/latest/docs/api/console.html#consoletimeloglabel-data)
    - [`console.trace([message][, ...args])`](https://nodejs.org/dist/latest/docs/api/console.html#consoletracemessage-args)
    - [`console.warn([data][, ...args])`](https://nodejs.org/dist/latest/docs/api/console.html#consolewarndata-args)
  - [Inspector only methods](https://nodejs.org/dist/latest/docs/api/console.html#inspector-only-methods)
    - [`console.profile([label])`](https://nodejs.org/dist/latest/docs/api/console.html#consoleprofilelabel)
    - [`console.profileEnd([label])`](https://nodejs.org/dist/latest/docs/api/console.html#consoleprofileendlabel)
    - [`console.timeStamp([label])`](https://nodejs.org/dist/latest/docs/api/console.html#consoletimestamplabel)

- [Index](https://nodejs.org/dist/latest/docs/api/console.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/console.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/console.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/console.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/console.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/console.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/console.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/console.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/console.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/console.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/console.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/console.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/console.json)
...
**Source Code:** [lib/console.js](https://github.com/nodejs/node/blob/v25.2.1/lib/console.js)
...
- A global `console` instance configured to write to [`process.stdout`](https://nodejs.org/dist/latest/docs/api/process.html#processstdout) and
[`process.stderr`](https://nodejs.org/dist/latest/docs/api/process.html#processstderr). The global `console` can be used without calling
...
configuration of the current process. See the [note on process I/O](https://nodejs.org/dist/latest/docs/api/process.html#a-note-on-process-io) for
more information.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `stdout` [<stream.Writable>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamwritable)
  - `stderr` [<stream.Writable>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamwritable)
  ...
  - `inspectOptions` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<Map>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map) Specifies options that are passed along to
    [`util.inspect()`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectobject-options). Can be an options object or, if different options
...
[`process.stdout`](https://nodejs.org/dist/latest/docs/api/process.html#processstdout) and [`process.stderr`](https://nodejs.org/dist/latest/docs/api/process.html#processstderr). It is equivalent to calling:
...
[`util.format()`](https://nodejs.org/dist/latest/docs/api/util.html#utilformatformat-args).
...
The `console.debug()` function is an alias for [`console.log()`](https://nodejs.org/dist/latest/docs/api/console.html#consolelogdata-args).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `depth` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Tells [`util.inspect()`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectobject-options) how many times to recurse while
  ...
  - `colors` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, then the output will be styled with ANSI color
    ...
    see [customizing `util.inspect()` colors](https://nodejs.org/dist/latest/docs/api/util.html#customizing-utilinspect-colors). **Default:**`false`.

Uses [`util.inspect()`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectobject-options) on `obj` and prints the resulting string to `stdout`.
...
[`util.inspect()`](https://nodejs.org/dist/latest/docs/api/util.html#utilinspectobject-options) is called on each argument and the resulting string
values are concatenated. See [`util.format()`](https://nodejs.org/dist/latest/docs/api/util.html#utilformatformat-args) for more information.
...
An alias for [`console.group()`](https://nodejs.org/dist/latest/docs/api/console.html#consolegrouplabel).
...
The `console.info()` function is an alias for [`console.log()`](https://nodejs.org/dist/latest/docs/api/console.html#consolelogdata-args).
...
See [`util.format()`](https://nodejs.org/dist/latest/docs/api/util.html#utilformatformat-args) for more information.
...
[`console.timeEnd()`](https://nodejs.org/dist/latest/docs/api/console.html#consoletimeendlabel) to stop the timer and output the elapsed time in
...
Stops a timer that was previously started by calling [`console.time()`](https://nodejs.org/dist/latest/docs/api/console.html#consoletimelabel) and
...
For a timer that was previously started by calling [`console.time()`](https://nodejs.org/dist/latest/docs/api/console.html#consoletimelabel), prints
...
Prints to `stderr` the string `'Trace: '`, followed by the [`util.format()`](https://nodejs.org/dist/latest/docs/api/util.html#utilformatformat-args)
...
The `console.warn()` function is an alias for [`console.error()`](https://nodejs.org/dist/latest/docs/api/console.html#consoleerrordata-args).

### Inspector only methods[\#](https://nodejs.org/dist/latest/docs/api/console.html\#inspector-only-methods)

The following methods are exposed by the V8 engine in the general API but do
not display anything unless used in conjunction with the [inspector](https://nodejs.org/dist/latest/docs/api/debugger.html)
(`--inspect` flag).
...
label until [`console.profileEnd()`](https://nodejs.org/dist/latest/docs/api/console.html#consoleprofileendlabel) is called. The profile is then added to
...
[`console.profile()`](https://nodejs.org/dist/latest/docs/api/console.html#consoleprofilelabel) for an example.
