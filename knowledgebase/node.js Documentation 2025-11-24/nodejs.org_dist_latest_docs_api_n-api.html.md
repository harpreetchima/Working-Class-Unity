---
url: "https://nodejs.org/dist/latest/docs/api/n-api.html"
title: "Node-API | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/n-api.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/n-api.html#toc-picker)




- [Node-API](https://nodejs.org/dist/latest/docs/api/n-api.html#node-api)
  - [Writing addons in various programming languages](https://nodejs.org/dist/latest/docs/api/n-api.html#writing-addons-in-various-programming-languages)
  - [Implications of ABI stability](https://nodejs.org/dist/latest/docs/api/n-api.html#implications-of-abi-stability)
    - [Enum values in ABI stability](https://nodejs.org/dist/latest/docs/api/n-api.html#enum-values-in-abi-stability)
  - [Building](https://nodejs.org/dist/latest/docs/api/n-api.html#building)
    - [Build tools](https://nodejs.org/dist/latest/docs/api/n-api.html#build-tools)
      - [node-gyp](https://nodejs.org/dist/latest/docs/api/n-api.html#node-gyp)
      - [CMake.js](https://nodejs.org/dist/latest/docs/api/n-api.html#cmakejs)
    - [Uploading precompiled binaries](https://nodejs.org/dist/latest/docs/api/n-api.html#uploading-precompiled-binaries)
      - [node-pre-gyp](https://nodejs.org/dist/latest/docs/api/n-api.html#node-pre-gyp)
      - [prebuild](https://nodejs.org/dist/latest/docs/api/n-api.html#prebuild)
      - [prebuildify](https://nodejs.org/dist/latest/docs/api/n-api.html#prebuildify)
  - [Usage](https://nodejs.org/dist/latest/docs/api/n-api.html#usage)
  - [Node-API version matrix](https://nodejs.org/dist/latest/docs/api/n-api.html#node-api-version-matrix)
  - [Environment life cycle APIs](https://nodejs.org/dist/latest/docs/api/n-api.html#environment-life-cycle-apis)
    - [`napi_set_instance_data`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_set_instance_data)
    - [`napi_get_instance_data`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_instance_data)
  - [Basic Node-API data types](https://nodejs.org/dist/latest/docs/api/n-api.html#basic-node-api-data-types)
    - [`napi_status`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_status)
    - [`napi_extended_error_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_extended_error_info)
    - [`napi_env`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_env)
    - [`node_api_basic_env`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_basic_env)
    - [`napi_value`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_value)
    - [`napi_threadsafe_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_threadsafe_function)
    - [`napi_threadsafe_function_release_mode`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_threadsafe_function_release_mode)
    - [`napi_threadsafe_function_call_mode`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_threadsafe_function_call_mode)
    - [Node-API memory management types](https://nodejs.org/dist/latest/docs/api/n-api.html#node-api-memory-management-types)
      - [`napi_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_handle_scope)
      - [`napi_escapable_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_escapable_handle_scope)
      - [`napi_ref`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_ref)
      - [`napi_type_tag`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_type_tag)
      - [`napi_async_cleanup_hook_handle`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_cleanup_hook_handle)
    - [Node-API callback types](https://nodejs.org/dist/latest/docs/api/n-api.html#node-api-callback-types)
      - [`napi_callback_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_callback_info)
      - [`napi_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_callback)
      - [`node_api_basic_finalize`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_basic_finalize)
      - [`napi_finalize`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_finalize)
      - [`napi_async_execute_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_execute_callback)
      - [`napi_async_complete_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_complete_callback)
      - [`napi_threadsafe_function_call_js`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_threadsafe_function_call_js)
      - [`napi_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_cleanup_hook)
      - [`napi_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_cleanup_hook)
  - [Error handling](https://nodejs.org/dist/latest/docs/api/n-api.html#error-handling)
    - [Return values](https://nodejs.org/dist/latest/docs/api/n-api.html#return-values)
      - [`napi_get_last_error_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_last_error_info)
    - [Exceptions](https://nodejs.org/dist/latest/docs/api/n-api.html#exceptions)
      - [`napi_throw`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw)
      - [`napi_throw_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw_error)
      - [`napi_throw_type_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw_type_error)
      - [`napi_throw_range_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw_range_error)
      - [`node_api_throw_syntax_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_throw_syntax_error)
      - [`napi_is_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_error)
      - [`napi_create_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_error)
      - [`napi_create_type_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_type_error)
      - [`napi_create_range_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_range_error)
      - [`node_api_create_syntax_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_syntax_error)
      - [`napi_get_and_clear_last_exception`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_and_clear_last_exception)
      - [`napi_is_exception_pending`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_exception_pending)
      - [`napi_fatal_exception`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_fatal_exception)
    - [Fatal errors](https://nodejs.org/dist/latest/docs/api/n-api.html#fatal-errors)
      - [`napi_fatal_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_fatal_error)
  - [Object lifetime management](https://nodejs.org/dist/latest/docs/api/n-api.html#object-lifetime-management)
    - [Making handle lifespan shorter than that of the native method](https://nodejs.org/dist/latest/docs/api/n-api.html#making-handle-lifespan-shorter-than-that-of-the-native-method)
      - [`napi_open_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_handle_scope)
      - [`napi_close_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_handle_scope)
      - [`napi_open_escapable_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_escapable_handle_scope)
      - [`napi_close_escapable_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_escapable_handle_scope)
      - [`napi_escape_handle`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_escape_handle)
    - [References to values with a lifespan longer than that of the native method](https://nodejs.org/dist/latest/docs/api/n-api.html#references-to-values-with-a-lifespan-longer-than-that-of-the-native-method)
      - [`napi_create_reference`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_reference)
      - [`napi_delete_reference`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_delete_reference)
      - [`napi_reference_ref`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_reference_ref)
      - [`napi_reference_unref`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_reference_unref)
      - [`napi_get_reference_value`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_reference_value)
    - [Cleanup on exit of the current Node.js environment](https://nodejs.org/dist/latest/docs/api/n-api.html#cleanup-on-exit-of-the-current-nodejs-environment)
      - [`napi_add_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_env_cleanup_hook)
      - [`napi_remove_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_remove_env_cleanup_hook)
      - [`napi_add_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_async_cleanup_hook)
      - [`napi_remove_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_remove_async_cleanup_hook)
    - [Finalization on the exit of the Node.js environment](https://nodejs.org/dist/latest/docs/api/n-api.html#finalization-on-the-exit-of-the-nodejs-environment)
  - [Module registration](https://nodejs.org/dist/latest/docs/api/n-api.html#module-registration)
  - [Working with JavaScript values](https://nodejs.org/dist/latest/docs/api/n-api.html#working-with-javascript-values)
    - [Enum types](https://nodejs.org/dist/latest/docs/api/n-api.html#enum-types)
      - [`napi_key_collection_mode`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_key_collection_mode)
      - [`napi_key_filter`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_key_filter)
      - [`napi_key_conversion`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_key_conversion)
      - [`napi_valuetype`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_valuetype)
      - [`napi_typedarray_type`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_typedarray_type)
    - [Object creation functions](https://nodejs.org/dist/latest/docs/api/n-api.html#object-creation-functions)
      - [`napi_create_array`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_array)
      - [`napi_create_array_with_length`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_array_with_length)
      - [`napi_create_arraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_arraybuffer)
      - [`napi_create_buffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_buffer)
      - [`napi_create_buffer_copy`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_buffer_copy)
      - [`napi_create_date`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_date)
      - [`napi_create_external`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external)
      - [`napi_create_external_arraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external_arraybuffer)
      - [`napi_create_external_buffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external_buffer)
      - [`napi_create_object`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_object)
      - [`napi_create_object_with_properties`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_object_with_properties)
      - [`napi_create_symbol`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_symbol)
      - [`node_api_symbol_for`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_symbol_for)
      - [`napi_create_typedarray`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_typedarray)
      - [`node_api_create_buffer_from_arraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_buffer_from_arraybuffer)
      - [`napi_create_dataview`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_dataview)
    - [Functions to convert from C types to Node-API](https://nodejs.org/dist/latest/docs/api/n-api.html#functions-to-convert-from-c-types-to-node-api)
      - [`napi_create_int32`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_int32)
      - [`napi_create_uint32`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_uint32)
      - [`napi_create_int64`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_int64)
      - [`napi_create_double`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_double)
      - [`napi_create_bigint_int64`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_bigint_int64)
      - [`napi_create_bigint_uint64`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_bigint_uint64)
      - [`napi_create_bigint_words`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_bigint_words)
      - [`napi_create_string_latin1`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_string_latin1)
      - [`node_api_create_external_string_latin1`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_external_string_latin1)
      - [`napi_create_string_utf16`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_string_utf16)
      - [`node_api_create_external_string_utf16`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_external_string_utf16)
      - [`napi_create_string_utf8`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_string_utf8)
    - [Functions to create optimized property keys](https://nodejs.org/dist/latest/docs/api/n-api.html#functions-to-create-optimized-property-keys)
      - [`node_api_create_property_key_latin1`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_property_key_latin1)
      - [`node_api_create_property_key_utf16`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_property_key_utf16)
      - [`node_api_create_property_key_utf8`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_property_key_utf8)
    - [Functions to convert from Node-API to C types](https://nodejs.org/dist/latest/docs/api/n-api.html#functions-to-convert-from-node-api-to-c-types)
      - [`napi_get_array_length`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_array_length)
      - [`napi_get_arraybuffer_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_arraybuffer_info)
      - [`napi_get_buffer_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_buffer_info)
      - [`napi_get_prototype`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_prototype)
      - [`napi_get_typedarray_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_typedarray_info)
      - [`napi_get_dataview_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_dataview_info)
      - [`napi_get_date_value`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_date_value)
      - [`napi_get_value_bool`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_bool)
      - [`napi_get_value_double`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_double)
      - [`napi_get_value_bigint_int64`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_bigint_int64)
      - [`napi_get_value_bigint_uint64`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_bigint_uint64)
      - [`napi_get_value_bigint_words`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_bigint_words)
      - [`napi_get_value_external`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_external)
      - [`napi_get_value_int32`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_int32)
      - [`napi_get_value_int64`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_int64)
      - [`napi_get_value_string_latin1`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_string_latin1)
      - [`napi_get_value_string_utf8`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_string_utf8)
      - [`napi_get_value_string_utf16`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_string_utf16)
      - [`napi_get_value_uint32`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_uint32)
    - [Functions to get global instances](https://nodejs.org/dist/latest/docs/api/n-api.html#functions-to-get-global-instances)
      - [`napi_get_boolean`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_boolean)
      - [`napi_get_global`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_global)
      - [`napi_get_null`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_null)
      - [`napi_get_undefined`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_undefined)
  - [Working with JavaScript values and abstract operations](https://nodejs.org/dist/latest/docs/api/n-api.html#working-with-javascript-values-and-abstract-operations)
    - [`napi_coerce_to_bool`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_coerce_to_bool)
    - [`napi_coerce_to_number`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_coerce_to_number)
    - [`napi_coerce_to_object`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_coerce_to_object)
    - [`napi_coerce_to_string`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_coerce_to_string)
    - [`napi_typeof`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_typeof)
    - [`napi_instanceof`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_instanceof)
    - [`napi_is_array`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_array)
    - [`napi_is_arraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_arraybuffer)
    - [`napi_is_buffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_buffer)
    - [`napi_is_date`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_date)
    - [`napi_is_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_error_1)
    - [`napi_is_typedarray`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_typedarray)
    - [`napi_is_dataview`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_dataview)
    - [`napi_strict_equals`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_strict_equals)
    - [`napi_detach_arraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_detach_arraybuffer)
    - [`napi_is_detached_arraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_detached_arraybuffer)
    - [`node_api_is_sharedarraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_is_sharedarraybuffer)
    - [`node_api_create_sharedarraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_sharedarraybuffer)
  - [Working with JavaScript properties](https://nodejs.org/dist/latest/docs/api/n-api.html#working-with-javascript-properties)
    - [Structures](https://nodejs.org/dist/latest/docs/api/n-api.html#structures)
      - [`napi_property_attributes`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_property_attributes)
      - [`napi_property_descriptor`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_property_descriptor)
    - [Functions](https://nodejs.org/dist/latest/docs/api/n-api.html#functions)
      - [`napi_get_property_names`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_property_names)
      - [`napi_get_all_property_names`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_all_property_names)
      - [`napi_set_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_set_property)
      - [`napi_get_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_property)
      - [`napi_has_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_has_property)
      - [`napi_delete_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_delete_property)
      - [`napi_has_own_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_has_own_property)
      - [`napi_set_named_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_set_named_property)
      - [`napi_get_named_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_named_property)
      - [`napi_has_named_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_has_named_property)
      - [`napi_set_element`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_set_element)
      - [`napi_get_element`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_element)
      - [`napi_has_element`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_has_element)
      - [`napi_delete_element`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_delete_element)
      - [`napi_define_properties`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_define_properties)
      - [`napi_object_freeze`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_object_freeze)
      - [`napi_object_seal`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_object_seal)
  - [Working with JavaScript functions](https://nodejs.org/dist/latest/docs/api/n-api.html#working-with-javascript-functions)
    - [`napi_call_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_call_function)
    - [`napi_create_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_function)
    - [`napi_get_cb_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_cb_info)
    - [`napi_get_new_target`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_new_target)
    - [`napi_new_instance`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_new_instance)
  - [Object wrap](https://nodejs.org/dist/latest/docs/api/n-api.html#object-wrap)
    - [`napi_define_class`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_define_class)
    - [`napi_wrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_wrap)
    - [`napi_unwrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_unwrap)
    - [`napi_remove_wrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_remove_wrap)
    - [`napi_type_tag_object`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_type_tag_object)
    - [`napi_check_object_type_tag`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_check_object_type_tag)
    - [`napi_add_finalizer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_finalizer)
      - [`node_api_post_finalizer`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_post_finalizer)
  - [Simple asynchronous operations](https://nodejs.org/dist/latest/docs/api/n-api.html#simple-asynchronous-operations)
    - [`napi_create_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_async_work)
    - [`napi_delete_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_delete_async_work)
    - [`napi_queue_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_queue_async_work)
    - [`napi_cancel_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_cancel_async_work)
  - [Custom asynchronous operations](https://nodejs.org/dist/latest/docs/api/n-api.html#custom-asynchronous-operations)
    - [`napi_async_init`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_init)
    - [`napi_async_destroy`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_destroy)
    - [`napi_make_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_make_callback)
    - [`napi_open_callback_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_callback_scope)
    - [`napi_close_callback_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_callback_scope)
  - [Version management](https://nodejs.org/dist/latest/docs/api/n-api.html#version-management)
    - [`napi_get_node_version`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_node_version)
    - [`napi_get_version`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_version)
  - [Memory management](https://nodejs.org/dist/latest/docs/api/n-api.html#memory-management)
    - [`napi_adjust_external_memory`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_adjust_external_memory)
  - [Promises](https://nodejs.org/dist/latest/docs/api/n-api.html#promises)
    - [`napi_create_promise`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_promise)
    - [`napi_resolve_deferred`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_resolve_deferred)
    - [`napi_reject_deferred`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_reject_deferred)
    - [`napi_is_promise`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_promise)
  - [Script execution](https://nodejs.org/dist/latest/docs/api/n-api.html#script-execution)
    - [`napi_run_script`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_run_script)
  - [libuv event loop](https://nodejs.org/dist/latest/docs/api/n-api.html#libuv-event-loop)
    - [`napi_get_uv_event_loop`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_uv_event_loop)
  - [Asynchronous thread-safe function calls](https://nodejs.org/dist/latest/docs/api/n-api.html#asynchronous-thread-safe-function-calls)
    - [Calling a thread-safe function](https://nodejs.org/dist/latest/docs/api/n-api.html#calling-a-thread-safe-function)
    - [Reference counting of thread-safe functions](https://nodejs.org/dist/latest/docs/api/n-api.html#reference-counting-of-thread-safe-functions)
    - [Deciding whether to keep the process running](https://nodejs.org/dist/latest/docs/api/n-api.html#deciding-whether-to-keep-the-process-running)
    - [`napi_create_threadsafe_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_threadsafe_function)
    - [`napi_get_threadsafe_function_context`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_threadsafe_function_context)
    - [`napi_call_threadsafe_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_call_threadsafe_function)
    - [`napi_acquire_threadsafe_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_acquire_threadsafe_function)
    - [`napi_release_threadsafe_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_release_threadsafe_function)
    - [`napi_ref_threadsafe_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_ref_threadsafe_function)
    - [`napi_unref_threadsafe_function`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_unref_threadsafe_function)
  - [Miscellaneous utilities](https://nodejs.org/dist/latest/docs/api/n-api.html#miscellaneous-utilities)
    - [`node_api_get_module_file_name`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_get_module_file_name)

- [Index](https://nodejs.org/dist/latest/docs/api/n-api.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/n-api.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/n-api.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/n-api.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/n-api.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/n-api.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/n-api.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/n-api.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/n-api.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/n-api.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/n-api.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/n-api.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/n-api.json)
...
titled [C++ Addons](https://nodejs.org/dist/latest/docs/api/addons.html). The only difference is the set of APIs that are used by
...
handling section [Error handling](https://nodejs.org/dist/latest/docs/api/n-api.html#error-handling).
...
[`napi_finalize`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_finalize) provides more details.
...
See the [Error handling](https://nodejs.org/dist/latest/docs/api/n-api.html#error-handling) section for additional information.
...
different [`Worker`](https://nodejs.org/dist/latest/docs/api/worker_threads.html#class-worker) threads is not allowed. The `napi_env` becomes invalid
when an instance of a native addon is unloaded. Notification of this event is
delivered through the callbacks given to [`napi_add_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_env_cleanup_hook) and
[`napi_set_instance_data`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_set_instance_data).
...
( [`node_api_basic_finalize`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_basic_finalize)). There is a subset of Node-APIs which accept
...
Handle scopes are created using [`napi_open_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_handle_scope) and are destroyed
using [`napi_close_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_handle_scope). Closing the scope can indicate to the GC
...
For more details, review the [Object lifetime management](https://nodejs.org/dist/latest/docs/api/n-api.html#object-lifetime-management).
...
with which JavaScript objects or [externals](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external) can be "tagged" in order to
ensure that they are of a certain type. This is a stronger check than
[`napi_instanceof`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_instanceof), because the latter can report a false positive if the
object's prototype has been manipulated. Type-tagging is most useful in
conjunction with [`napi_wrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_wrap) because it ensures that the pointer retrieved
...
An opaque value returned by [`napi_add_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_async_cleanup_hook). It must be passed
to [`napi_remove_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_remove_async_cleanup_hook) when the chain of asynchronous cleanup
events completes.
...
Unless for reasons discussed in [Object Lifetime Management](https://nodejs.org/dist/latest/docs/api/n-api.html#object-lifetime-management), creating a
...
[`node_api_post_finalizer`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_post_finalizer) can be used to schedule Node-API calls that
require access to the JavaScript engine's state to run after the current
garbage collection cycle has completed.

In the case of [`node_api_create_external_string_latin1`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_external_string_latin1) and
[`node_api_create_external_string_utf16`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_external_string_utf16) the `env` parameter may be null,
...
pointers can be used with [`node_api_post_finalizer`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_post_finalizer).
...
[`node_api_post_finalizer`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_post_finalizer). [`node_api_basic_finalize`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_basic_finalize) must be used
...
Function pointer used with [`napi_add_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_env_cleanup_hook). It will be called
...
- `[in] data`: The data that was passed to [`napi_add_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_env_cleanup_hook).

##### `napi_async_cleanup_hook`[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#napi_async_cleanup_hook)

Added in: v14.10.0, v12.19.0

Function pointer used with [`napi_add_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_async_cleanup_hook). It will be called
when the environment is being torn down.
...
[`napi_remove_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_remove_async_cleanup_hook) after completion of the asynchronous
cleanup.
- `[in] data`: The data that was passed to [`napi_add_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_async_cleanup_hook).
...
`napi_pending_exception` is returned, [`napi_is_exception_pending`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_exception_pending)
...
In order to retrieve this information [`napi_get_last_error_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_last_error_info)
...
[`napi_get_last_error_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_last_error_info) returns the information for the last
...
instead of simply returning immediately, [`napi_is_exception_pending`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_exception_pending)
...
cases [`napi_get_and_clear_last_exception`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_and_clear_last_exception) can be used to get and
clear the exception. On success, result will contain the handle to
the last JavaScript `Object` thrown. If it is determined, after
retrieving the exception, the exception cannot be handled after all
it can be re-thrown it with [`napi_throw`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw) where error is the
JavaScript value to be thrown.

The following utility functions are also available in case native code
needs to throw an exception or determine if a `napi_value` is an instance
of a JavaScript `Error` object: [`napi_throw_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw_error),
[`napi_throw_type_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw_type_error), [`napi_throw_range_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_throw_range_error), [`node_api_throw_syntax_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_throw_syntax_error) and [`napi_is_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_error).

The following utility functions are also available in case native
code needs to create an `Error` object: [`napi_create_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_error),
[`napi_create_type_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_type_error), [`napi_create_range_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_range_error) and [`node_api_create_syntax_error`](https://nodejs.org/dist/latest/docs/api/n-api.html#node_api_create_syntax_error),
...
[`napi_open_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_handle_scope) and [`napi_close_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_handle_scope).
...
Taking the earlier example, adding calls to [`napi_open_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_handle_scope) and
[`napi_close_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_handle_scope) would ensure that at most a single handle
...
[`napi_open_escapable_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_escapable_handle_scope) and
[`napi_close_escapable_handle_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_escapable_handle_scope).

The request to promote a handle is made through [`napi_escape_handle`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_escape_handle) which
...
then be modified through [`napi_reference_ref`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_reference_ref) and
[`napi_reference_unref`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_reference_unref). If an object is collected while the count
for a reference is 0, all subsequent calls to
get the object associated with the reference [`napi_get_reference_value`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_reference_value)
will return `NULL` for the returned `napi_value`. An attempt to call
[`napi_reference_ref`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_reference_ref) for a reference whose object has been collected
results in an error.
...
Removing this hook can be done by using [`napi_remove_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_remove_env_cleanup_hook).
Typically, that happens when the resource for which this hook was added
is being torn down anyway.

For asynchronous cleanup, [`napi_add_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_async_cleanup_hook) is available.
...
Registers `hook`, which is a function of type [`napi_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_cleanup_hook), as
a function to be run with the `remove_handle` and `arg` parameters once the
current Node.js environment exits.

Unlike [`napi_add_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_env_cleanup_hook), the hook is allowed to be asynchronous.

Otherwise, behavior generally matches that of [`napi_add_env_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_env_cleanup_hook).

If `remove_handle` is not `NULL`, an opaque value will be stored in it
that must later be passed to [`napi_remove_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_remove_async_cleanup_hook),
...
created with [`napi_add_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_async_cleanup_hook).
...
from [`napi_add_async_cleanup_hook`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_async_cleanup_hook).
...
[`worker.terminate()`](https://nodejs.org/dist/latest/docs/api/worker_threads.html#workerterminate). When the environment is being torn down, the
...
The documentation on [context-aware addons](https://nodejs.org/dist/latest/docs/api/addons.html#context-aware-addons) provides more details.
...
collected. [`napi_finalize`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_finalize) provides more details.
- `[in] finalize_hint`: Optional hint to pass to the finalize callback during
collection.
...
later by native code using [`napi_get_value_external`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_value_external).
...
[`napi_create_reference`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_reference), which can be used to guarantee control over the\
...
[`napi_get_typedarray_info`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_typedarray_info). And `napi_get_typedarray_info` accepts a\
...
[`napi_is_typedarray`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_is_typedarray) should be preferred if the caller needs to check if the\
...
that is, created with [`napi_create_external_arraybuffer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external_arraybuffer).\
\
...
[`napi_define_class`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_define_class). It is ignored by `napi_define_properties`.\
...
performed using a Node-API call). [`napi_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_callback) provides more details.\
...
won't be used). [`napi_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_callback) provides more details.\
...
iterate over `result` using [`napi_get_array_length`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_array_length)\
and [`napi_get_element`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_element).\
\
Returns `napi_ok` if the API succeeded.\
\
...
- `[out] result`: A `napi_value` representing an array of JavaScript values\
that represent the property names of the object. [`napi_get_array_length`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_array_length)\
and [`napi_get_element`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_element) can be used to iterate over `result`.\
\
Returns `napi_ok` if the API succeeded.\
\
...
Returns `napi_ok` if the API succeeded.\
\
This method is equivalent to calling [`napi_set_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_set_property) with a `napi_value`\
...
Returns `napi_ok` if the API succeeded.\
\
This method is equivalent to calling [`napi_get_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_get_property) with a `napi_value`\
created from the string passed in as `utf8Name`.\
\
##### `napi_has_named_property`[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#napi_has_named_property)\
\
...
Returns `napi_ok` if the API succeeded.\
\
This method is equivalent to calling [`napi_has_property`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_has_property) with a `napi_value`\
created from the string passed in as `utf8Name`.\
\
##### `napi_set_element`[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#napi_set_element)\
\
...
[`napi_property_descriptor`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_property_descriptor)). Given an array of such property descriptors,\
...
after an async operation, see [`napi_make_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_make_callback).\
\
...
object is invoked. [`napi_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_callback) provides more details.\
...
passing both the JavaScript function and the data to [`napi_add_finalizer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_finalizer).\
\
...
\
1. The [`napi_define_class`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_define_class) API defines a JavaScript class with constructor,\
static properties and methods, and instance properties and methods that\
correspond to the C++ class.\
2. When JavaScript code invokes the constructor, the constructor callback\
uses [`napi_wrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_wrap) to wrap a new C++ instance in a JavaScript object,\
...
callback, [`napi_unwrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_unwrap) obtains the C++ instance that is the target of\
the call.\
\
...
along with a JavaScript object or [external](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external) stored in a `napi_value` to\
...
with the [`napi_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_callback) signature. A C++ class constructor cannot be\
used. [`napi_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_callback) provides more details.\
...
JavaScript object instance being constructed using [`napi_wrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_wrap).\
...
object. See [`napi_wrap`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_wrap) for details.\
\
The JavaScript constructor function returned from [`napi_define_class`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_define_class) is\
...
[`napi_create_reference`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_reference), ensuring that the reference count is kept >= 1.\
\
...
the JavaScript function and the data to [`napi_add_finalizer`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_add_finalizer).\
\
#### `napi_wrap`[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#napi_wrap)\
\
Added in: v8.0.0N-API version: 1\
...
[`napi_delete_reference`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_delete_reference) ONLY in response to the finalize callback\
...
\
- `[in] env`: The environment that the API is invoked under.\
- `[in] js_object`: The JavaScript object or [external](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external) to be marked.\
...
[external](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external). `napi_check_object_type_tag()` can then be used to compare the tag\
...
\
- `[in] env`: The environment that the API is invoked under.\
- `[in] js_object`: The JavaScript object or [external](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_external) whose type tag to\
examine.\
...
[`napi_create_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_create_async_work) and [`napi_delete_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_delete_async_work).\
\
...
for execution using the [`napi_queue_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_queue_async_work) function:\
\
```c\
...
```\
\
[`napi_cancel_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_cancel_async_work) can be used if the work needs\
to be cancelled before the work has started execution.\
\
After calling [`napi_cancel_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_cancel_async_work), the `complete` callback\
...
that will be passed to possible `async_hooks` [`init` hooks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#initasyncid-type-triggerasyncid-resource).\
...
from the main event loop thread. [`napi_async_complete_callback`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_complete_callback) provides\
more details.\
- `[in] data`: User-provided data context. This will be passed back into the\
...
It should be freed using [`napi_delete_async_work`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_delete_async_work) once the work is no longer\
required.\
\
...
the [`async_hooks` documentation](https://nodejs.org/dist/latest/docs/api/async_hooks.html#type) for more information.\
\
#### `napi_delete_async_work`[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#napi_delete_async_work)\
\
Added in: v8.0.0N-API version: 1\
...
that will be passed to possible `async_hooks` [`init` hooks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#initasyncid-type-triggerasyncid-resource) and can be\
accessed by [`async_hooks.executionAsyncResource()`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hooksexecutionasyncresource).\
- `[in] async_resource_name`: Identifier for the kind of resource that is being\
provided for diagnostic information exposed by the `async_hooks` API.\
...
recommended as this will result in undesirable behavior with `async_hooks` [`init` hooks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#initasyncid-type-triggerasyncid-resource) and `async_hooks.executionAsyncResource()` as the resource is\
...
corresponding call to [`napi_async_destroy`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_destroy) for every call to\
...
obtained from [`napi_async_init`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_init).\
In order to retain ABI compatibility with previous versions, passing `NULL`\
...
that will be passed to possible `async_hooks` [`init` hooks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#initasyncid-type-triggerasyncid-resource). This\
parameter has been deprecated and is ignored at runtime. Use the\
`async_resource` parameter in [`napi_async_init`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_init) instead.\
- `[in] context`: Context for the async operation that is invoking the callback.\
This should be a value previously obtained from [`napi_async_init`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_async_init).\
- `[out] result`: The newly created scope.\
\
There are cases (for example, resolving promises) where it is\
necessary to have the equivalent of the scope associated with a callback\
in place when making certain Node-API calls. If there is no other script on\
the stack the [`napi_open_callback_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_open_callback_scope) and\
[`napi_close_callback_scope`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_close_callback_scope) functions can be used to open/close\
the required scope.\
\
#### `napi_close_callback_scope`[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#napi_close_callback_scope)\
\
...
value of [`process.release.name`](https://nodejs.org/dist/latest/docs/api/process.html#processrelease).\
\
...
[module scope](https://nodejs.org/dist/latest/docs/api/modules.html#the-module-scope), meaning that pseudo-globals such as `require` will not be\
available.\
- The script can access the [global scope](https://nodejs.org/dist/latest/docs/api/globals.html). Function and `var` declarations\
in the script will be added to the [`global`](https://nodejs.org/dist/latest/docs/api/globals.html#global) object. Variable declarations\
made using `let` and `const` will be visible globally, but will not be added\
to the [`global`](https://nodejs.org/dist/latest/docs/api/globals.html#global) object.\
- The value of `this` is [`global`](https://nodejs.org/dist/latest/docs/api/globals.html#global) within the script.\
\
### libuv event loop[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#libuv-event-loop)\
\
...
will be passed to possible `async_hooks` [`init` hooks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#initasyncid-type-triggerasyncid-resource).\
...
[`napi_threadsafe_function_call_js`](https://nodejs.org/dist/latest/docs/api/n-api.html#napi_threadsafe_function_call_js) provides more details.\
...
[`'uncaughtException'`](https://nodejs.org/dist/latest/docs/api/process.html#event-uncaughtexception) event, instead of being ignored.\
\
\
#### `napi_get_threadsafe_function_context`[\#](https://nodejs.org/dist/latest/docs/api/n-api.html\#napi_get_threadsafe_function_context)\
\
