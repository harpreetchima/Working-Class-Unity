...
title: "Async hooks | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/async_hooks.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/async_hooks.html#toc-picker)




- [Async hooks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async-hooks)
  - [Terminology](https://nodejs.org/dist/latest/docs/api/async_hooks.html#terminology)
  - [Overview](https://nodejs.org/dist/latest/docs/api/async_hooks.html#overview)
  - [`async_hooks.createHook(callbacks)`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hookscreatehookcallbacks)
    - [Error handling](https://nodejs.org/dist/latest/docs/api/async_hooks.html#error-handling)
    - [Printing in `AsyncHook` callbacks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#printing-in-asynchook-callbacks)
  - [Class: `AsyncHook`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#class-asynchook)
    - [`asyncHook.enable()`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#asynchookenable)
    - [`asyncHook.disable()`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#asynchookdisable)
    - [Hook callbacks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#hook-callbacks)
      - [`init(asyncId, type, triggerAsyncId, resource)`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#initasyncid-type-triggerasyncid-resource)
        - [`type`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#type)
        - [`triggerAsyncId`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#triggerasyncid)
        - [`resource`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#resource)
        - [Asynchronous context example](https://nodejs.org/dist/latest/docs/api/async_hooks.html#asynchronous-context-example)
      - [`before(asyncId)`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#beforeasyncid)
      - [`after(asyncId)`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#afterasyncid)
      - [`destroy(asyncId)`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#destroyasyncid)
      - [`promiseResolve(asyncId)`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#promiseresolveasyncid)
    - [`async_hooks.executionAsyncResource()`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hooksexecutionasyncresource)
    - [`async_hooks.executionAsyncId()`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hooksexecutionasyncid)
    - [`async_hooks.triggerAsyncId()`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hookstriggerasyncid)
    - [`async_hooks.asyncWrapProviders`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hooksasyncwrapproviders)
  - [Promise execution tracking](https://nodejs.org/dist/latest/docs/api/async_hooks.html#promise-execution-tracking)
  - [JavaScript embedder API](https://nodejs.org/dist/latest/docs/api/async_hooks.html#javascript-embedder-api)
    - [Class: `AsyncResource`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#class-asyncresource)
  - [Class: `AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#class-asynclocalstorage)

- [Index](https://nodejs.org/dist/latest/docs/api/async_hooks.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/async_hooks.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/async_hooks.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/async_hooks.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/async_hooks.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/async_hooks.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/async_hooks.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/async_hooks.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/async_hooks.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/async_hooks.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/async_hooks.html)
10. [16.x](https://nodejs.org/docs/latest-v16.x/api/async_hooks.html)
11. [15.x](https://nodejs.org/docs/latest-v15.x/api/async_hooks.html)
12. [14.x](https://nodejs.org/docs/latest-v14.x/api/async_hooks.html)
13. [13.x](https://nodejs.org/docs/latest-v13.x/api/async_hooks.html)
14. [12.x](https://nodejs.org/docs/latest-v12.x/api/async_hooks.html)
15. [11.x](https://nodejs.org/docs/latest-v11.x/api/async_hooks.html)
16. [10.x](https://nodejs.org/docs/latest-v10.x/api/async_hooks.html)
17. [9.x](https://nodejs.org/docs/latest-v9.x/api/async_hooks.html)
18. [8.x](https://nodejs.org/docs/latest-v8.x/api/async_hooks.html)

- [Options](https://nodejs.org/dist/latest/docs/api/async_hooks.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/async_hooks.json)
...
[Stability: 1](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Experimental. Please migrate away from this API, if you can.
We do not recommend using the [`createHook`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hookscreatehookcallbacks), [`AsyncHook`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#class-asynchook), and
[`executionAsyncResource`](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hooksexecutionasyncresource) APIs as they have usability issues, safety risks,
and performance implications. Async context tracking use cases are better
served by the stable [`AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage) API. If you have a use case for
`createHook`, `AsyncHook`, or `executionAsyncResource` beyond the context
tracking need solved by [`AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage) or diagnostics data currently
provided by [Diagnostics Channel](https://nodejs.org/dist/latest/docs/api/diagnostics_channel.html), please open an issue at
...
**Source Code:** [lib/async\_hooks.js](https://github.com/nodejs/node/blob/v25.2.1/lib/async_hooks.js)

We strongly discourage the use of the `async_hooks` API.
Other APIs that can cover most of its use cases include:

- [`AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage) tracks async context
- [`process.getActiveResourcesInfo()`](https://nodejs.org/dist/latest/docs/api/process.html#processgetactiveresourcesinfo) tracks active resources
...
If [`Worker`](https://nodejs.org/dist/latest/docs/api/worker_threads.html#class-worker) s are used, each thread has an independent `async_hooks`
...
- `callbacks` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) The [Hook Callbacks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#hook-callbacks) to register

  - `init` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`init` callback](https://nodejs.org/dist/latest/docs/api/async_hooks.html#initasyncid-type-triggerasyncid-resource).
  - `before` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`before` callback](https://nodejs.org/dist/latest/docs/api/async_hooks.html#beforeasyncid).
  - `after` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`after` callback](https://nodejs.org/dist/latest/docs/api/async_hooks.html#afterasyncid).
  - `destroy` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`destroy` callback](https://nodejs.org/dist/latest/docs/api/async_hooks.html#destroyasyncid).
  - `promiseResolve` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) The [`promiseResolve` callback](https://nodejs.org/dist/latest/docs/api/async_hooks.html#promiseresolveasyncid).
- Returns: [<AsyncHook>](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hookscreatehookcallbacks) Instance used for disabling and enabling hooks
...
[Hook Callbacks](https://nodejs.org/dist/latest/docs/api/async_hooks.html#hook-callbacks) section.
...
- Returns: [<AsyncHook>](https://nodejs.org/dist/latest/docs/api/async_hooks.html#async_hookscreatehookcallbacks) A reference to `asyncHook`.
...
Furthermore users of [`AsyncResource`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asyncresource) create async resources independent
of Node.js itself.
...
The context tracking use case is covered by the stable API [`AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage).
This example only illustrates async hooks operation but [`AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage)
...
See the section on [promise execution tracking](https://nodejs.org/dist/latest/docs/api/async_hooks.html#promise-execution-tracking).
...
the section on [promise execution tracking](https://nodejs.org/dist/latest/docs/api/async_hooks.html#promise-execution-tracking).
...
See: [DEP0111](https://nodejs.org/dist/latest/docs/api/deprecations.html#dep0111-processbinding)
...
The documentation for this class has moved [`AsyncResource`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asyncresource).

### Class: `AsyncLocalStorage`[\#](https://nodejs.org/dist/latest/docs/api/async_hooks.html\#class-asynclocalstorage)

The documentation for this class has moved [`AsyncLocalStorage`](https://nodejs.org/dist/latest/docs/api/async_context.html#class-asynclocalstorage).