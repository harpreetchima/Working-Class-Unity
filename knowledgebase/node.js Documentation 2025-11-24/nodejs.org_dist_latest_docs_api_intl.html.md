---
url: "https://nodejs.org/dist/latest/docs/api/intl.html"
title: "Internationalization support | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/intl.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/intl.html#toc-picker)




- [Internationalization support](https://nodejs.org/dist/latest/docs/api/intl.html#internationalization-support)
  - [Options for building Node.js](https://nodejs.org/dist/latest/docs/api/intl.html#options-for-building-nodejs)
    - [Disable all internationalization features (`none`)](https://nodejs.org/dist/latest/docs/api/intl.html#disable-all-internationalization-features-none)
    - [Build with a pre-installed ICU (`system-icu`)](https://nodejs.org/dist/latest/docs/api/intl.html#build-with-a-pre-installed-icu-system-icu)
    - [Embed a limited set of ICU data (`small-icu`)](https://nodejs.org/dist/latest/docs/api/intl.html#embed-a-limited-set-of-icu-data-small-icu)
      - [Providing ICU data at runtime](https://nodejs.org/dist/latest/docs/api/intl.html#providing-icu-data-at-runtime)
    - [Embed the entire ICU (`full-icu`)](https://nodejs.org/dist/latest/docs/api/intl.html#embed-the-entire-icu-full-icu)
  - [Detecting internationalization support](https://nodejs.org/dist/latest/docs/api/intl.html#detecting-internationalization-support)

- [Index](https://nodejs.org/dist/latest/docs/api/intl.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/intl.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/intl.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/intl.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/intl.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/intl.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/intl.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/intl.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/intl.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/intl.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/intl.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/intl.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/intl.json)
...
- The [WHATWG URL parser](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)'s [internationalized domain names](https://en.wikipedia.org/wiki/Internationalized_domain_name) (IDNs) support
- [`require('node:buffer').transcode()`](https://nodejs.org/dist/latest/docs/api/buffer.html#buffertranscodesource-fromenc-toenc)
- More accurate [REPL](https://nodejs.org/dist/latest/docs/api/repl.html#repl) line editing
- [`require('node:util').TextDecoder`](https://nodejs.org/dist/latest/docs/api/util.html#class-utiltextdecoder)
...
| [Legacy URL Parser](https://nodejs.org/dist/latest/docs/api/url.html#legacy-url-api) | partial (no IDN support) | full | full | full |
| [WHATWG URL Parser](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) | partial (no IDN support) | full | full | full |
| [`require('node:buffer').transcode()`](https://nodejs.org/dist/latest/docs/api/buffer.html#buffertranscodesource-fromenc-toenc) | none (function does not exist) | full | full | full |
| [REPL](https://nodejs.org/dist/latest/docs/api/repl.html#repl) | partial (inaccurate line editing) | full | full | full |
| [`require('node:util').TextDecoder`](https://nodejs.org/dist/latest/docs/api/util.html#class-utiltextdecoder) | partial (basic encodings support) | partial/full (depends on OS) | partial (Unicode-only) | full |
...
[`String.prototype.normalize()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/normalize) and the [WHATWG URL parser](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api), are fully
...
- The [`NODE_ICU_DATA`](https://nodejs.org/dist/latest/docs/api/cli.html#node_icu_datafile) environment variable:
...
- The [`--icu-data-dir`](https://nodejs.org/dist/latest/docs/api/cli.html#--icu-data-dirfile) CLI parameter:
