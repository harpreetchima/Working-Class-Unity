...
title: "Modules: ECMAScript modules | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/esm.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/esm.html#toc-picker)




- [Modules: ECMAScript modules](https://nodejs.org/dist/latest/docs/api/esm.html#modules-ecmascript-modules)
  - [Introduction](https://nodejs.org/dist/latest/docs/api/esm.html#introduction)
  - [Enabling](https://nodejs.org/dist/latest/docs/api/esm.html#enabling)
  - [Packages](https://nodejs.org/dist/latest/docs/api/esm.html#packages)
  - [`import` Specifiers](https://nodejs.org/dist/latest/docs/api/esm.html#import-specifiers)
    - [Terminology](https://nodejs.org/dist/latest/docs/api/esm.html#terminology)
    - [Mandatory file extensions](https://nodejs.org/dist/latest/docs/api/esm.html#mandatory-file-extensions)
    - [URLs](https://nodejs.org/dist/latest/docs/api/esm.html#urls)
      - [`file:` URLs](https://nodejs.org/dist/latest/docs/api/esm.html#file-urls)
      - [`data:` imports](https://nodejs.org/dist/latest/docs/api/esm.html#data-imports)
      - [`node:` imports](https://nodejs.org/dist/latest/docs/api/esm.html#node-imports)
  - [Import attributes](https://nodejs.org/dist/latest/docs/api/esm.html#import-attributes)
  - [Built-in modules](https://nodejs.org/dist/latest/docs/api/esm.html#built-in-modules)
  - [`import()` expressions](https://nodejs.org/dist/latest/docs/api/esm.html#import-expressions)
  - [`import.meta`](https://nodejs.org/dist/latest/docs/api/esm.html#importmeta)
    - [`import.meta.dirname`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetadirname)
    - [`import.meta.filename`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetafilename)
    - [`import.meta.url`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetaurl)
    - [`import.meta.main`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetamain)
    - [`import.meta.resolve(specifier)`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetaresolvespecifier)
  - [Interoperability with CommonJS](https://nodejs.org/dist/latest/docs/api/esm.html#interoperability-with-commonjs)
    - [`import` statements](https://nodejs.org/dist/latest/docs/api/esm.html#import-statements)
    - [`require`](https://nodejs.org/dist/latest/docs/api/esm.html#require)
    - [CommonJS Namespaces](https://nodejs.org/dist/latest/docs/api/esm.html#commonjs-namespaces)
    - [Differences between ES modules and CommonJS](https://nodejs.org/dist/latest/docs/api/esm.html#differences-between-es-modules-and-commonjs)
      - [No `require`, `exports`, or `module.exports`](https://nodejs.org/dist/latest/docs/api/esm.html#no-require-exports-or-moduleexports)
      - [No `__filename` or `__dirname`](https://nodejs.org/dist/latest/docs/api/esm.html#no-__filename-or-__dirname)
      - [No Addon Loading](https://nodejs.org/dist/latest/docs/api/esm.html#no-addon-loading)
      - [No `require.main`](https://nodejs.org/dist/latest/docs/api/esm.html#no-requiremain)
      - [No `require.resolve`](https://nodejs.org/dist/latest/docs/api/esm.html#no-requireresolve)
      - [No `NODE_PATH`](https://nodejs.org/dist/latest/docs/api/esm.html#no-node_path)
      - [No `require.extensions`](https://nodejs.org/dist/latest/docs/api/esm.html#no-requireextensions)
      - [No `require.cache`](https://nodejs.org/dist/latest/docs/api/esm.html#no-requirecache)
  - [JSON modules](https://nodejs.org/dist/latest/docs/api/esm.html#json-modules)
  - [Wasm modules](https://nodejs.org/dist/latest/docs/api/esm.html#wasm-modules)
    - [Wasm Source Phase Imports](https://nodejs.org/dist/latest/docs/api/esm.html#wasm-source-phase-imports)
    - [JavaScript String Builtins](https://nodejs.org/dist/latest/docs/api/esm.html#javascript-string-builtins)
    - [Wasm Instance Phase Imports](https://nodejs.org/dist/latest/docs/api/esm.html#wasm-instance-phase-imports)
    - [Reserved Wasm Namespaces](https://nodejs.org/dist/latest/docs/api/esm.html#reserved-wasm-namespaces)
  - [Top-level `await`](https://nodejs.org/dist/latest/docs/api/esm.html#top-level-await)
  - [Loaders](https://nodejs.org/dist/latest/docs/api/esm.html#loaders)
  - [Resolution and loading algorithm](https://nodejs.org/dist/latest/docs/api/esm.html#resolution-and-loading-algorithm)
    - [Features](https://nodejs.org/dist/latest/docs/api/esm.html#features)
    - [Resolution algorithm](https://nodejs.org/dist/latest/docs/api/esm.html#resolution-algorithm)
    - [Resolution Algorithm Specification](https://nodejs.org/dist/latest/docs/api/esm.html#resolution-algorithm-specification)
    - [Customizing ESM specifier resolution algorithm](https://nodejs.org/dist/latest/docs/api/esm.html#customizing-esm-specifier-resolution-algorithm)

- [Index](https://nodejs.org/dist/latest/docs/api/esm.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/esm.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/esm.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/esm.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/esm.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/esm.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/esm.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/esm.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/esm.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/esm.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/esm.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/esm.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/esm.json)
...
Node.js has two module systems: [CommonJS](https://nodejs.org/dist/latest/docs/api/modules.html) modules and ECMAScript modules.

Authors can tell Node.js to interpret JavaScript as an ES module via the `.mjs`
file extension, the `package.json` [`"type"`](https://nodejs.org/dist/latest/docs/api/packages.html#type) field with a value `"module"`,
or the [`--input-type`](https://nodejs.org/dist/latest/docs/api/cli.html#--input-typetype) flag with a value of `"module"`. These are explicit
...
CommonJS via the `.cjs` file extension, the `package.json` [`"type"`](https://nodejs.org/dist/latest/docs/api/packages.html#type) field
with a value `"commonjs"`, or the [`--input-type`](https://nodejs.org/dist/latest/docs/api/cli.html#--input-typetype) flag with a value of
`"commonjs"`.
...
module as CommonJS. See [Determining module system](https://nodejs.org/dist/latest/docs/api/packages.html#determining-module-system) for more details.

### Packages[\#](https://nodejs.org/dist/latest/docs/api/esm.html\#packages)

This section was moved to [Modules: Packages](https://nodejs.org/dist/latest/docs/api/packages.html).
...
_for packages without an [`"exports"`](https://nodejs.org/dist/latest/docs/api/packages.html#exports) field._
...
resolution and loading algorithm](https://nodejs.org/dist/latest/docs/api/esm.html#resolution-algorithm-specification).
...
path to the package name unless the package's [`package.json`](https://nodejs.org/dist/latest/docs/api/packages.html#nodejs-packagejson-field-definitions) contains an
[`"exports"`](https://nodejs.org/dist/latest/docs/api/packages.html#exports) field, in which case files within packages can only be accessed
via the paths defined in [`"exports"`](https://nodejs.org/dist/latest/docs/api/packages.html#exports).

For details on these package resolution rules that apply to bare specifiers in
the Node.js module resolution, see the [packages documentation](https://nodejs.org/dist/latest/docs/api/packages.html).
...
must be [percent-encoded](https://nodejs.org/dist/latest/docs/api/url.html#percent-encoding-in-urls), such as `#` with `%23` and `?` with `%3F`.
...
a [custom HTTPS loader](https://nodejs.org/dist/latest/docs/api/module.html#import-from-https).
...
details), it is recommended to use [url.pathToFileURL](https://nodejs.org/dist/latest/docs/api/url.html#urlpathtofileurlpath-options) when importing a path.
...
`data:` URLs only resolve [bare specifiers](https://nodejs.org/dist/latest/docs/api/esm.html#terminology) for builtin modules
and [absolute specifiers](https://nodejs.org/dist/latest/docs/api/esm.html#terminology). Resolving
[relative specifiers](https://nodejs.org/dist/latest/docs/api/esm.html#terminology) does not work because `data:` is not a
...
| --- | --- |
| `'json'` | [JSON modules](https://nodejs.org/dist/latest/docs/api/esm.html#json-modules) |

The `type: 'json'` attribute is mandatory when importing JSON modules.

### Built-in modules[\#](https://nodejs.org/dist/latest/docs/api/esm.html\#built-in-modules)

[Built-in modules](https://nodejs.org/dist/latest/docs/api/modules.html#built-in-modules) provide named exports of their public API. A
...
This is the same as the [`path.dirname()`](https://nodejs.org/dist/latest/docs/api/path.html#pathdirnamepath) of the [`import.meta.filename`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetafilename).
...
This is the same as the [`url.fileURLToPath()`](https://nodejs.org/dist/latest/docs/api/url.html#urlfileurltopathurl-options) of the [`import.meta.url`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetaurl).
...
- `parent` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) An optional absolute parent module URL to resolve from.
...
`import` statements are permitted only in ES modules, but dynamic [`import()`](https://nodejs.org/dist/latest/docs/api/esm.html#import-expressions)
expressions are supported in CommonJS for loading ES modules.

When importing [CommonJS modules](https://nodejs.org/dist/latest/docs/api/esm.html#commonjs-namespaces), the
...
See [Loading ECMAScript modules using `require()`](https://nodejs.org/dist/latest/docs/api/modules.html#loading-ecmascript-modules-using-require) for details.
...
[`require(esm)`](https://nodejs.org/dist/latest/docs/api/modules.html#loading-ecmascript-modules-using-require) interop support.
...
[`module.createRequire()`](https://nodejs.org/dist/latest/docs/api/module.html#modulecreaterequirefilename).
...
[`import.meta.filename`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetafilename) and [`import.meta.dirname`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetadirname).

##### No Addon Loading[\#](https://nodejs.org/dist/latest/docs/api/esm.html\#no-addon-loading)

[Addons](https://nodejs.org/dist/latest/docs/api/addons.html) are not currently supported with ES module imports.

They can instead be loaded with [`module.createRequire()`](https://nodejs.org/dist/latest/docs/api/module.html#modulecreaterequirefilename) or
[`process.dlopen`](https://nodejs.org/dist/latest/docs/api/process.html#processdlopenmodule-filename-flags).

##### No `require.main`[\#](https://nodejs.org/dist/latest/docs/api/esm.html\#no-requiremain)

To replace `require.main === module`, there is the [`import.meta.main`](https://nodejs.org/dist/latest/docs/api/esm.html#importmetamain) API.
...
[import.meta.resolve](https://nodejs.org/dist/latest/docs/api/esm.html#importmetaresolvespecifier) API.
...
The `with { type: 'json' }` syntax is mandatory; see [Import Attributes](https://nodejs.org/dist/latest/docs/api/esm.html#import-attributes).
...
with a `13` [status code](https://nodejs.org/dist/latest/docs/api/process.html#exit-codes).
...
[Modules: Customization hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks).
...
[Module customization hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks) provide a mechanism for customizing the ESM
