...
title: "File system | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/fs.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/fs.html#toc-picker)




- [File system](https://nodejs.org/dist/latest/docs/api/fs.html#file-system)
  - [Promise example](https://nodejs.org/dist/latest/docs/api/fs.html#promise-example)
  - [Callback example](https://nodejs.org/dist/latest/docs/api/fs.html#callback-example)
  - [Synchronous example](https://nodejs.org/dist/latest/docs/api/fs.html#synchronous-example)
  - [Promises API](https://nodejs.org/dist/latest/docs/api/fs.html#promises-api)
    - [Class: `FileHandle`](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle)
      - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-close)
      - [`filehandle.appendFile(data[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandleappendfiledata-options)
      - [`filehandle.chmod(mode)`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlechmodmode)
      - [`filehandle.chown(uid, gid)`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlechownuid-gid)
      - [`filehandle.close()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandleclose)
      - [`filehandle.createReadStream([options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlecreatereadstreamoptions)
      - [`filehandle.createWriteStream([options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlecreatewritestreamoptions)
      - [`filehandle.datasync()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandledatasync)
      - [`filehandle.fd`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlefd)
      - [`filehandle.read(buffer, offset, length, position)`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlereadbuffer-offset-length-position)
      - [`filehandle.read([options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlereadoptions)
      - [`filehandle.read(buffer[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlereadbuffer-options)
      - [`filehandle.readableWebStream([options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlereadablewebstreamoptions)
      - [`filehandle.readFile(options)`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlereadfileoptions)
      - [`filehandle.readLines([options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlereadlinesoptions)
      - [`filehandle.readv(buffers[, position])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlereadvbuffers-position)
      - [`filehandle.stat([options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlestatoptions)
      - [`filehandle.sync()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlesync)
      - [`filehandle.truncate(len)`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandletruncatelen)
      - [`filehandle.utimes(atime, mtime)`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandleutimesatime-mtime)
      - [`filehandle.write(buffer, offset[, length[, position]])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlewritebuffer-offset-length-position)
      - [`filehandle.write(buffer[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlewritebuffer-options)
      - [`filehandle.write(string[, position[, encoding]])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlewritestring-position-encoding)
      - [`filehandle.writeFile(data, options)`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlewritefiledata-options)
      - [`filehandle.writev(buffers[, position])`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlewritevbuffers-position)
      - [`filehandle[Symbol.asyncDispose]()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlesymbolasyncdispose)
    - [`fsPromises.access(path[, mode])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesaccesspath-mode)
    - [`fsPromises.appendFile(path, data[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesappendfilepath-data-options)
    - [`fsPromises.chmod(path, mode)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseschmodpath-mode)
    - [`fsPromises.chown(path, uid, gid)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseschownpath-uid-gid)
    - [`fsPromises.copyFile(src, dest[, mode])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisescopyfilesrc-dest-mode)
    - [`fsPromises.cp(src, dest[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisescpsrc-dest-options)
    - [`fsPromises.glob(pattern[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesglobpattern-options)
    - [`fsPromises.lchmod(path, mode)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseslchmodpath-mode)
    - [`fsPromises.lchown(path, uid, gid)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseslchownpath-uid-gid)
    - [`fsPromises.lutimes(path, atime, mtime)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseslutimespath-atime-mtime)
    - [`fsPromises.link(existingPath, newPath)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseslinkexistingpath-newpath)
    - [`fsPromises.lstat(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseslstatpath-options)
    - [`fsPromises.mkdir(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesmkdirpath-options)
    - [`fsPromises.mkdtemp(prefix[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesmkdtempprefix-options)
    - [`fsPromises.mkdtempDisposable(prefix[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesmkdtempdisposableprefix-options)
    - [`fsPromises.open(path, flags[, mode])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesopenpath-flags-mode)
    - [`fsPromises.opendir(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesopendirpath-options)
    - [`fsPromises.readdir(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesreaddirpath-options)
    - [`fsPromises.readFile(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesreadfilepath-options)
    - [`fsPromises.readlink(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesreadlinkpath-options)
    - [`fsPromises.realpath(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesrealpathpath-options)
    - [`fsPromises.rename(oldPath, newPath)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesrenameoldpath-newpath)
    - [`fsPromises.rmdir(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesrmdirpath-options)
    - [`fsPromises.rm(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesrmpath-options)
    - [`fsPromises.stat(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesstatpath-options)
    - [`fsPromises.statfs(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesstatfspath-options)
    - [`fsPromises.symlink(target, path[, type])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisessymlinktarget-path-type)
    - [`fsPromises.truncate(path[, len])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisestruncatepath-len)
    - [`fsPromises.unlink(path)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesunlinkpath)
    - [`fsPromises.utimes(path, atime, mtime)`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesutimespath-atime-mtime)
    - [`fsPromises.watch(filename[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseswatchfilename-options)
    - [`fsPromises.writeFile(file, data[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromiseswritefilefile-data-options)
    - [`fsPromises.constants`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesconstants)
  - [Callback API](https://nodejs.org/dist/latest/docs/api/fs.html#callback-api)
    - [`fs.access(path[, mode], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsaccesspath-mode-callback)
    - [`fs.appendFile(path, data[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsappendfilepath-data-options-callback)
    - [`fs.chmod(path, mode, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fschmodpath-mode-callback)
      - [File modes](https://nodejs.org/dist/latest/docs/api/fs.html#file-modes)
    - [`fs.chown(path, uid, gid, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fschownpath-uid-gid-callback)
    - [`fs.close(fd[, callback])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsclosefd-callback)
    - [`fs.copyFile(src, dest[, mode], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fscopyfilesrc-dest-mode-callback)
    - [`fs.cp(src, dest[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fscpsrc-dest-options-callback)
    - [`fs.createReadStream(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatereadstreampath-options)
    - [`fs.createWriteStream(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options)
    - [`fs.exists(path, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsexistspath-callback)
    - [`fs.fchmod(fd, mode, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfchmodfd-mode-callback)
    - [`fs.fchown(fd, uid, gid, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfchownfd-uid-gid-callback)
    - [`fs.fdatasync(fd, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfdatasyncfd-callback)
    - [`fs.fstat(fd[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfstatfd-options-callback)
    - [`fs.fsync(fd, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfsyncfd-callback)
    - [`fs.ftruncate(fd[, len], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsftruncatefd-len-callback)
    - [`fs.futimes(fd, atime, mtime, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfutimesfd-atime-mtime-callback)
    - [`fs.glob(pattern[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsglobpattern-options-callback)
    - [`fs.lchmod(path, mode, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslchmodpath-mode-callback)
    - [`fs.lchown(path, uid, gid, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslchownpath-uid-gid-callback)
    - [`fs.lutimes(path, atime, mtime, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslutimespath-atime-mtime-callback)
    - [`fs.link(existingPath, newPath, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslinkexistingpath-newpath-callback)
    - [`fs.lstat(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslstatpath-options-callback)
    - [`fs.mkdir(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdirpath-options-callback)
    - [`fs.mkdtemp(prefix[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdtempprefix-options-callback)
    - [`fs.open(path[, flags[, mode]], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopenpath-flags-mode-callback)
    - [`fs.openAsBlob(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopenasblobpath-options)
    - [`fs.opendir(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopendirpath-options-callback)
    - [`fs.read(fd, buffer, offset, length, position, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfd-buffer-offset-length-position-callback)
    - [`fs.read(fd[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfd-options-callback)
    - [`fs.read(fd, buffer[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfd-buffer-options-callback)
    - [`fs.readdir(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreaddirpath-options-callback)
    - [`fs.readFile(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfilepath-options-callback)
      - [File descriptors](https://nodejs.org/dist/latest/docs/api/fs.html#file-descriptors)
      - [Performance Considerations](https://nodejs.org/dist/latest/docs/api/fs.html#performance-considerations)
    - [`fs.readlink(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadlinkpath-options-callback)
    - [`fs.readv(fd, buffers[, position], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadvfd-buffers-position-callback)
    - [`fs.realpath(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrealpathpath-options-callback)
    - [`fs.realpath.native(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrealpathnativepath-options-callback)
    - [`fs.rename(oldPath, newPath, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrenameoldpath-newpath-callback)
    - [`fs.rmdir(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrmdirpath-options-callback)
    - [`fs.rm(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrmpath-options-callback)
    - [`fs.stat(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatpath-options-callback)
    - [`fs.statfs(path[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatfspath-options-callback)
    - [`fs.symlink(target, path[, type], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fssymlinktarget-path-type-callback)
    - [`fs.truncate(path[, len], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fstruncatepath-len-callback)
    - [`fs.unlink(path, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsunlinkpath-callback)
    - [`fs.unwatchFile(filename[, listener])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsunwatchfilefilename-listener)
    - [`fs.utimes(path, atime, mtime, callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsutimespath-atime-mtime-callback)
    - [`fs.watch(filename[, options][, listener])`](https://nodejs.org/dist/latest/docs/api/fs.html#fswatchfilename-options-listener)
      - [Caveats](https://nodejs.org/dist/latest/docs/api/fs.html#caveats)
        - [Availability](https://nodejs.org/dist/latest/docs/api/fs.html#availability)
        - [Inodes](https://nodejs.org/dist/latest/docs/api/fs.html#inodes)
        - [Filename argument](https://nodejs.org/dist/latest/docs/api/fs.html#filename-argument)
    - [`fs.watchFile(filename[, options], listener)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswatchfilefilename-options-listener)
    - [`fs.write(fd, buffer, offset[, length[, position]], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefd-buffer-offset-length-position-callback)
    - [`fs.write(fd, buffer[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefd-buffer-options-callback)
    - [`fs.write(fd, string[, position[, encoding]], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefd-string-position-encoding-callback)
    - [`fs.writeFile(file, data[, options], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefilefile-data-options-callback)
      - [Using `fs.writeFile()` with file descriptors](https://nodejs.org/dist/latest/docs/api/fs.html#using-fswritefile-with-file-descriptors)
    - [`fs.writev(fd, buffers[, position], callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritevfd-buffers-position-callback)
  - [Synchronous API](https://nodejs.org/dist/latest/docs/api/fs.html#synchronous-api)
    - [`fs.accessSync(path[, mode])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsaccesssyncpath-mode)
    - [`fs.appendFileSync(path, data[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsappendfilesyncpath-data-options)
    - [`fs.chmodSync(path, mode)`](https://nodejs.org/dist/latest/docs/api/fs.html#fschmodsyncpath-mode)
    - [`fs.chownSync(path, uid, gid)`](https://nodejs.org/dist/latest/docs/api/fs.html#fschownsyncpath-uid-gid)
    - [`fs.closeSync(fd)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsclosesyncfd)
    - [`fs.copyFileSync(src, dest[, mode])`](https://nodejs.org/dist/latest/docs/api/fs.html#fscopyfilesyncsrc-dest-mode)
    - [`fs.cpSync(src, dest[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fscpsyncsrc-dest-options)
    - [`fs.existsSync(path)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsexistssyncpath)
    - [`fs.fchmodSync(fd, mode)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfchmodsyncfd-mode)
    - [`fs.fchownSync(fd, uid, gid)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfchownsyncfd-uid-gid)
    - [`fs.fdatasyncSync(fd)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfdatasyncsyncfd)
    - [`fs.fstatSync(fd[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfstatsyncfd-options)
    - [`fs.fsyncSync(fd)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfsyncsyncfd)
    - [`fs.ftruncateSync(fd[, len])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsftruncatesyncfd-len)
    - [`fs.futimesSync(fd, atime, mtime)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfutimessyncfd-atime-mtime)
    - [`fs.globSync(pattern[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsglobsyncpattern-options)
    - [`fs.lchmodSync(path, mode)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslchmodsyncpath-mode)
    - [`fs.lchownSync(path, uid, gid)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslchownsyncpath-uid-gid)
    - [`fs.lutimesSync(path, atime, mtime)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslutimessyncpath-atime-mtime)
    - [`fs.linkSync(existingPath, newPath)`](https://nodejs.org/dist/latest/docs/api/fs.html#fslinksyncexistingpath-newpath)
    - [`fs.lstatSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fslstatsyncpath-options)
    - [`fs.mkdirSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdirsyncpath-options)
    - [`fs.mkdtempSync(prefix[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdtempsyncprefix-options)
    - [`fs.mkdtempDisposableSync(prefix[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdtempdisposablesyncprefix-options)
    - [`fs.opendirSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopendirsyncpath-options)
    - [`fs.openSync(path[, flags[, mode]])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopensyncpath-flags-mode)
    - [`fs.readdirSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreaddirsyncpath-options)
    - [`fs.readFileSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfilesyncpath-options)
    - [`fs.readlinkSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadlinksyncpath-options)
    - [`fs.readSync(fd, buffer, offset, length[, position])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadsyncfd-buffer-offset-length-position)
    - [`fs.readSync(fd, buffer[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadsyncfd-buffer-options)
    - [`fs.readvSync(fd, buffers[, position])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadvsyncfd-buffers-position)
    - [`fs.realpathSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrealpathsyncpath-options)
    - [`fs.realpathSync.native(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrealpathsyncnativepath-options)
    - [`fs.renameSync(oldPath, newPath)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrenamesyncoldpath-newpath)
    - [`fs.rmdirSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrmdirsyncpath-options)
    - [`fs.rmSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrmsyncpath-options)
    - [`fs.statSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatsyncpath-options)
    - [`fs.statfsSync(path[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatfssyncpath-options)
    - [`fs.symlinkSync(target, path[, type])`](https://nodejs.org/dist/latest/docs/api/fs.html#fssymlinksynctarget-path-type)
    - [`fs.truncateSync(path[, len])`](https://nodejs.org/dist/latest/docs/api/fs.html#fstruncatesyncpath-len)
    - [`fs.unlinkSync(path)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsunlinksyncpath)
    - [`fs.utimesSync(path, atime, mtime)`](https://nodejs.org/dist/latest/docs/api/fs.html#fsutimessyncpath-atime-mtime)
    - [`fs.writeFileSync(file, data[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefilesyncfile-data-options)
    - [`fs.writeSync(fd, buffer, offset[, length[, position]])`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritesyncfd-buffer-offset-length-position)
    - [`fs.writeSync(fd, buffer[, options])`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritesyncfd-buffer-options)
    - [`fs.writeSync(fd, string[, position[, encoding]])`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritesyncfd-string-position-encoding)
    - [`fs.writevSync(fd, buffers[, position])`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritevsyncfd-buffers-position)
  - [Common Objects](https://nodejs.org/dist/latest/docs/api/fs.html#common-objects)
    - [Class: `fs.Dir`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir)
      - [`dir.close()`](https://nodejs.org/dist/latest/docs/api/fs.html#dirclose)
      - [`dir.close(callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#dirclosecallback)
      - [`dir.closeSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#dirclosesync)
      - [`dir.path`](https://nodejs.org/dist/latest/docs/api/fs.html#dirpath)
      - [`dir.read()`](https://nodejs.org/dist/latest/docs/api/fs.html#dirread)
      - [`dir.read(callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#dirreadcallback)
      - [`dir.readSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#dirreadsync)
      - [`dir[Symbol.asyncIterator]()`](https://nodejs.org/dist/latest/docs/api/fs.html#dirsymbolasynciterator)
      - [`dir[Symbol.asyncDispose]()`](https://nodejs.org/dist/latest/docs/api/fs.html#dirsymbolasyncdispose)
      - [`dir[Symbol.dispose]()`](https://nodejs.org/dist/latest/docs/api/fs.html#dirsymboldispose)
    - [Class: `fs.Dirent`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent)
      - [`dirent.isBlockDevice()`](https://nodejs.org/dist/latest/docs/api/fs.html#direntisblockdevice)
      - [`dirent.isCharacterDevice()`](https://nodejs.org/dist/latest/docs/api/fs.html#direntischaracterdevice)
      - [`dirent.isDirectory()`](https://nodejs.org/dist/latest/docs/api/fs.html#direntisdirectory)
      - [`dirent.isFIFO()`](https://nodejs.org/dist/latest/docs/api/fs.html#direntisfifo)
      - [`dirent.isFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#direntisfile)
      - [`dirent.isSocket()`](https://nodejs.org/dist/latest/docs/api/fs.html#direntissocket)
      - [`dirent.isSymbolicLink()`](https://nodejs.org/dist/latest/docs/api/fs.html#direntissymboliclink)
      - [`dirent.name`](https://nodejs.org/dist/latest/docs/api/fs.html#direntname)
      - [`dirent.parentPath`](https://nodejs.org/dist/latest/docs/api/fs.html#direntparentpath)
    - [Class: `fs.FSWatcher`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher)
      - [Event: `'change'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-change)
      - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-close_1)
      - [Event: `'error'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-error)
      - [`watcher.close()`](https://nodejs.org/dist/latest/docs/api/fs.html#watcherclose)
      - [`watcher.ref()`](https://nodejs.org/dist/latest/docs/api/fs.html#watcherref)
      - [`watcher.unref()`](https://nodejs.org/dist/latest/docs/api/fs.html#watcherunref)
    - [Class: `fs.StatWatcher`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatwatcher)
      - [`watcher.ref()`](https://nodejs.org/dist/latest/docs/api/fs.html#watcherref_1)
      - [`watcher.unref()`](https://nodejs.org/dist/latest/docs/api/fs.html#watcherunref_1)
    - [Class: `fs.ReadStream`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream)
      - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-close_2)
      - [Event: `'open'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-open)
      - [Event: `'ready'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-ready)
      - [`readStream.bytesRead`](https://nodejs.org/dist/latest/docs/api/fs.html#readstreambytesread)
      - [`readStream.path`](https://nodejs.org/dist/latest/docs/api/fs.html#readstreampath)
      - [`readStream.pending`](https://nodejs.org/dist/latest/docs/api/fs.html#readstreampending)
    - [Class: `fs.Stats`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats)
      - [`stats.isBlockDevice()`](https://nodejs.org/dist/latest/docs/api/fs.html#statsisblockdevice)
      - [`stats.isCharacterDevice()`](https://nodejs.org/dist/latest/docs/api/fs.html#statsischaracterdevice)
      - [`stats.isDirectory()`](https://nodejs.org/dist/latest/docs/api/fs.html#statsisdirectory)
      - [`stats.isFIFO()`](https://nodejs.org/dist/latest/docs/api/fs.html#statsisfifo)
      - [`stats.isFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#statsisfile)
      - [`stats.isSocket()`](https://nodejs.org/dist/latest/docs/api/fs.html#statsissocket)
      - [`stats.isSymbolicLink()`](https://nodejs.org/dist/latest/docs/api/fs.html#statsissymboliclink)
      - [`stats.dev`](https://nodejs.org/dist/latest/docs/api/fs.html#statsdev)
      - [`stats.ino`](https://nodejs.org/dist/latest/docs/api/fs.html#statsino)
      - [`stats.mode`](https://nodejs.org/dist/latest/docs/api/fs.html#statsmode)
      - [`stats.nlink`](https://nodejs.org/dist/latest/docs/api/fs.html#statsnlink)
      - [`stats.uid`](https://nodejs.org/dist/latest/docs/api/fs.html#statsuid)
      - [`stats.gid`](https://nodejs.org/dist/latest/docs/api/fs.html#statsgid)
      - [`stats.rdev`](https://nodejs.org/dist/latest/docs/api/fs.html#statsrdev)
      - [`stats.size`](https://nodejs.org/dist/latest/docs/api/fs.html#statssize)
      - [`stats.blksize`](https://nodejs.org/dist/latest/docs/api/fs.html#statsblksize)
      - [`stats.blocks`](https://nodejs.org/dist/latest/docs/api/fs.html#statsblocks)
      - [`stats.atimeMs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsatimems)
      - [`stats.mtimeMs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsmtimems)
      - [`stats.ctimeMs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsctimems)
      - [`stats.birthtimeMs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsbirthtimems)
      - [`stats.atimeNs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsatimens)
      - [`stats.mtimeNs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsmtimens)
      - [`stats.ctimeNs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsctimens)
      - [`stats.birthtimeNs`](https://nodejs.org/dist/latest/docs/api/fs.html#statsbirthtimens)
      - [`stats.atime`](https://nodejs.org/dist/latest/docs/api/fs.html#statsatime)
      - [`stats.mtime`](https://nodejs.org/dist/latest/docs/api/fs.html#statsmtime)
      - [`stats.ctime`](https://nodejs.org/dist/latest/docs/api/fs.html#statsctime)
      - [`stats.birthtime`](https://nodejs.org/dist/latest/docs/api/fs.html#statsbirthtime)
      - [Stat time values](https://nodejs.org/dist/latest/docs/api/fs.html#stat-time-values)
    - [Class: `fs.StatFs`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatfs)
      - [`statfs.bavail`](https://nodejs.org/dist/latest/docs/api/fs.html#statfsbavail)
      - [`statfs.bfree`](https://nodejs.org/dist/latest/docs/api/fs.html#statfsbfree)
      - [`statfs.blocks`](https://nodejs.org/dist/latest/docs/api/fs.html#statfsblocks)
      - [`statfs.bsize`](https://nodejs.org/dist/latest/docs/api/fs.html#statfsbsize)
      - [`statfs.ffree`](https://nodejs.org/dist/latest/docs/api/fs.html#statfsffree)
      - [`statfs.files`](https://nodejs.org/dist/latest/docs/api/fs.html#statfsfiles)
      - [`statfs.type`](https://nodejs.org/dist/latest/docs/api/fs.html#statfstype)
    - [Class: `fs.Utf8Stream`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsutf8stream)
      - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-close_3)
      - [Event: `'drain'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-drain)
      - [Event: `'drop'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-drop)
      - [Event: `'error'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-error_1)
      - [Event: `'finish'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-finish)
      - [Event: `'ready'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-ready_1)
      - [Event: `'write'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-write)
      - [`new fs.Utf8Stream([options])`](https://nodejs.org/dist/latest/docs/api/fs.html#new-fsutf8streamoptions)
      - [`utf8Stream.append`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamappend)
      - [`utf8Stream.contentMode`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamcontentmode)
      - [`utf8Stream.destroy()`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamdestroy)
      - [`utf8Stream.end()`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamend)
      - [`utf8Stream.fd`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamfd)
      - [`utf8Stream.file`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamfile)
      - [`utf8Stream.flush(callback)`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamflushcallback)
      - [`utf8Stream.flushSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamflushsync)
      - [`utf8Stream.fsync`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamfsync)
      - [`utf8Stream.maxLength`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streammaxlength)
      - [`utf8Stream.minLength`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamminlength)
      - [`utf8Stream.mkdir`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streammkdir)
      - [`utf8Stream.mode`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streammode)
      - [`utf8Stream.periodicFlush`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamperiodicflush)
      - [`utf8Stream.reopen(file)`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamreopenfile)
      - [`utf8Stream.sync`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamsync)
      - [`utf8Stream.write(data)`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamwritedata)
      - [`utf8Stream.writing`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamwriting)
      - [`utf8Stream[Symbol.dispose]()`](https://nodejs.org/dist/latest/docs/api/fs.html#utf8streamsymboldispose)
    - [Class: `fs.WriteStream`](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream)
      - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-close_4)
      - [Event: `'open'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-open_1)
      - [Event: `'ready'`](https://nodejs.org/dist/latest/docs/api/fs.html#event-ready_2)
      - [`writeStream.bytesWritten`](https://nodejs.org/dist/latest/docs/api/fs.html#writestreambyteswritten)
      - [`writeStream.close([callback])`](https://nodejs.org/dist/latest/docs/api/fs.html#writestreamclosecallback)
      - [`writeStream.path`](https://nodejs.org/dist/latest/docs/api/fs.html#writestreampath)
      - [`writeStream.pending`](https://nodejs.org/dist/latest/docs/api/fs.html#writestreampending)
    - [`fs.constants`](https://nodejs.org/dist/latest/docs/api/fs.html#fsconstants)
      - [FS constants](https://nodejs.org/dist/latest/docs/api/fs.html#fs-constants)
        - [File access constants](https://nodejs.org/dist/latest/docs/api/fs.html#file-access-constants)
        - [File copy constants](https://nodejs.org/dist/latest/docs/api/fs.html#file-copy-constants)
        - [File open constants](https://nodejs.org/dist/latest/docs/api/fs.html#file-open-constants)
        - [File type constants](https://nodejs.org/dist/latest/docs/api/fs.html#file-type-constants)
        - [File mode constants](https://nodejs.org/dist/latest/docs/api/fs.html#file-mode-constants)
  - [Notes](https://nodejs.org/dist/latest/docs/api/fs.html#notes)
    - [Ordering of callback and promise-based operations](https://nodejs.org/dist/latest/docs/api/fs.html#ordering-of-callback-and-promise-based-operations)
    - [File paths](https://nodejs.org/dist/latest/docs/api/fs.html#file-paths)
      - [String paths](https://nodejs.org/dist/latest/docs/api/fs.html#string-paths)
      - [File URL paths](https://nodejs.org/dist/latest/docs/api/fs.html#file-url-paths)
        - [Platform-specific considerations](https://nodejs.org/dist/latest/docs/api/fs.html#platform-specific-considerations)
      - [Buffer paths](https://nodejs.org/dist/latest/docs/api/fs.html#buffer-paths)
      - [Per-drive working directories on Windows](https://nodejs.org/dist/latest/docs/api/fs.html#per-drive-working-directories-on-windows)
    - [File descriptors](https://nodejs.org/dist/latest/docs/api/fs.html#file-descriptors_1)
    - [Threadpool usage](https://nodejs.org/dist/latest/docs/api/fs.html#threadpool-usage)
    - [File system flags](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags)

- [Index](https://nodejs.org/dist/latest/docs/api/fs.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/fs.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/fs.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/fs.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/fs.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/fs.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/fs.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/fs.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/fs.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/fs.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/fs.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/fs.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/fs.json)
...
**Source Code:** [lib/fs.js](https://github.com/nodejs/node/blob/v25.2.1/lib/fs.js)
...
A [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) object is an object wrapper for a numeric file descriptor.

Instances of the [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) object are created by the `fsPromises.open()`
method.

All [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) objects are [<EventEmitter>](https://nodejs.org/dist/latest/docs/api/events.html#class-eventemitter) s.

If a [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) is not closed using the `filehandle.close()` method, it will
...
close [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) s. Node.js may change this behavior in the future.

##### Event: `'close'`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#event-close)

Added in: v15.4.0

The `'close'` event is emitted when the [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) has been closed and can no
longer be used.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type)
  ...
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) allows aborting an in-progress writeFile. **Default:**`undefined`
...
Alias of [`filehandle.writeFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlewritefiledata-options).

When operating on file handles, the mode cannot be changed from what it was set
to with [`fsPromises.open()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesopenpath-flags-mode). Therefore, this is equivalent to
[`filehandle.writeFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlewritefiledata-options).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) **Default:**`undefined`
- Returns: [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream)
...
[<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer).
...
- Returns: [<fs.WriteStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream)

`options` may also include a `start` option to allow writing data at some
position past the beginning of the file, allowed values are in the
\[0, [`Number.MAX_SAFE_INTEGER`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number/MAX_SAFE_INTEGER)\] range. Modifying a file rather than
replacing it may require the `flags``open` option to be set to `r+` rather than
the default `r`. The `encoding` can be any one of those accepted by [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer).
...
- Type: [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) The numeric file descriptor managed by the [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) object.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `autoClose` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) When true, causes the [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) to be closed when the
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type)
  ...
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) allows aborting an in-progress readFile
...
returned as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) object. Otherwise, the data will be a string.

Asynchronously reads the entire contents of a file.

If `options` is a string, then it specifies the `encoding`.

The [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) has to support reading.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `end` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) **Default:**`Infinity`
  - `highWaterMark` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) **Default:**`64 * 1024`
- Returns: [<readline.InterfaceConstructor>](https://nodejs.org/dist/latest/docs/api/readline.html#class-interfaceconstructor)

Convenience method to create a `readline` interface and stream over the file.
See [`filehandle.createReadStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlecreatereadstreamoptions) for the options.
...
- `buffers` [<Buffer\[\]>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<TypedArray\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) \| [<DataView\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView)
...
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills upon success an object containing two properties:
  ...
  - `bytesRead` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) the number of bytes read
  - `buffers` [<Buffer\[\]>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<TypedArray\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) \| [<DataView\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) property containing
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `bigint` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Whether the numeric values in the returned
    [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object should be `bigint`. **Default:**`false`.
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with an [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) for the file.
...
Change the file system timestamps of the object referenced by the [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle)
...
- `buffer` [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) \| [<DataView>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) a reference to the
`buffer` written.

It is unsafe to use `filehandle.write()` multiple times on the same file
without waiting for the promise to be fulfilled (or rejected). For this
scenario, use [`filehandle.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlecreatewritestreamoptions).
...
The [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) has to support writing.
...
- `bytesWritten` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) the number of bytes written
- `buffers` [<Buffer\[\]>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<TypedArray\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) \| [<DataView\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) a reference to the `buffers`
input.
...
- `path` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
...
`fs.constants.W_OK | fs.constants.R_OK`). Check [File access constants](https://nodejs.org/dist/latest/docs/api/fs.html#file-access-constants) for
...
- `path` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) \| [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) filename or [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle)
- `data` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer)
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type)
  - `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) **Default:**`'utf8'`
  - `mode` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) **Default:**`0o666`
  - `flag` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) See [support of file system `flags`](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags). **Default:**`'a'`.
  - `flush` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, the underlying file descriptor is flushed
    prior to closing it. **Default:**`false`.
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with `undefined` upon success.

Asynchronously append data to a file, creating the file if it does not yet
exist. `data` can be a string or a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer).

If `options` is a string, then it specifies the `encoding`.

The `mode` option only affects the newly created file. See [`fs.open()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopenpath-flags-mode-callback)
for more details.

The `path` may be specified as a [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) that has been opened
...
- `src` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) source filename to copy
- `dest` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) destination filename of the copy operation
...
- `src` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) source path to copy.
- `dest` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) destination path to copy to.
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `mode` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) modifiers for copy operation. **Default:**`0`.
    See `mode` flag of [`fsPromises.copyFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisescopyfilesrc-dest-mode).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `cwd` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) current working directory. **Default:**`process.cwd()`
...
[`fsPromises.utimes()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesutimespath-atime-mtime), with the difference that if the path refers to a
...
- `existingPath` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `newPath` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with `undefined` upon success.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `bigint` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Whether the numeric values in the returned
    [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object should be `bigint`. **Default:**`false`.
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object for the given
symbolic link `path`.

Equivalent to [`fsPromises.stat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesstatpath-options) unless `path` refers to a symbolic link,
...
- `prefix` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
...
For detailed information, see the documentation of [`fsPromises.mkdtemp()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesmkdtempprefix-options).
...
- `path` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `flags` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) See [support of file system `flags`](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags).
**Default:**`'r'`.
...
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with a [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) object.

Opens a [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle).
...
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with an [<fs.Dir>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir).

Asynchronously open a directory for iterative scanning. See the POSIX
[`opendir(3)`](http://man7.org/linux/man-pages/man3/opendir.3.html) documentation for more detail.

Creates an [<fs.Dir>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir), which contains all further functions for reading from
...
When using the async iterator, the [<fs.Dir>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir) object will be automatically
...
will be passed as [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) objects.

If `options.withFileTypes` is set to `true`, the returned array will contain
[<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) objects.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type)
  - `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) **Default:**`null`
  - `flag` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) See [support of file system `flags`](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags). **Default:**`'r'`.
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) allows aborting an in-progress readFile
...
as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) object. Otherwise, the data will be a string.
...
It is possible to abort an ongoing `readFile` using an [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal). If a
...
Any specified [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) has to support reading.
...
returned will be passed as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) object.
...
passed as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) object.
...
- `oldPath` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `newPath` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with `undefined` upon success.
...
[`fsPromises.rm()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesrmpath-options) with options `{ recursive: true, force: true }`.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `bigint` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Whether the numeric values in the returned
    [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object should be `bigint`. **Default:**`false`.
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object for the
given `path`.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `bigint` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Whether the numeric values in the returned
    [<fs.StatFs>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatfs) object should be `bigint`. **Default:**`false`.
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with the [<fs.StatFs>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatfs) object for the
given `path`.
...
- `target` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `path` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
...
- `filename` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `options` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `recursive` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Indicates whether all subdirectories should be
    ...
    specified, and only on supported platforms (See [caveats](https://nodejs.org/dist/latest/docs/api/fs.html#caveats)). **Default:**`false`.
  ...
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) An [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) used to signal when the watcher
    should stop.
...
- Returns: [<AsyncIterator>](https://tc39.github.io/ecma262/#sec-asynciterator-interface) of objects with the properties:
  ...
  - `filename` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) The name of the file changed.
...
All the [caveats](https://nodejs.org/dist/latest/docs/api/fs.html#caveats) for `fs.watch()` also apply to `fsPromises.watch()`.
...
- `file` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) \| [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) filename or `FileHandle`
- `data` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) \| [<DataView>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) \| [<AsyncIterable>](https://tc39.github.io/ecma262/#sec-asynciterable-interface) \| [<Iterable>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols#The_iterable_protocol) \| [<Stream>](https://nodejs.org/dist/latest/docs/api/stream.html#stream)
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type)
  - `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) **Default:**`'utf8'`
  - `mode` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) **Default:**`0o666`
  - `flag` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) See [support of file system `flags`](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags). **Default:**`'w'`.
  - `flush` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If all data is successfully written to the file, and
    ...
    **Default:**`false`.
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) allows aborting an in-progress writeFile
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with `undefined` upon success.
...
Any specified [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) has to support writing.
...
[`fs.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options) or [`filehandle.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#filehandlecreatewritestreamoptions).

It is possible to use an [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) to cancel an `fsPromises.writeFile()`.
...
operations. The object is the same as `fs.constants`. See [FS constants](https://nodejs.org/dist/latest/docs/api/fs.html#fs-constants)
for more details.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `force` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) overwrite existing file or directory. The copy
    ...
    **Default:**`true`.
  - `mode` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) modifiers for copy operation. **Default:**`0`.
    See `mode` flag of [`fs.copyFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscopyfilesrc-dest-mode-callback).
  - `preserveTimestamps` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) When `true` timestamps from `src` will
    be preserved. **Default:**`false`.
  - `recursive` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) copy directories recursively **Default:**`false`
  - `verbatimSymlinks` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) When `true`, path resolution for symlinks will
...
- `path` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `options` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `flags` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) See [support of file system `flags`](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags). **Default:**`'r'`.
  - `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) **Default:**`null`
  - `fd` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) \| [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) **Default:**`null`
  - `mode` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) **Default:**`0o666`
  - `autoClose` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) **Default:**`true`
  - `emitClose` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) **Default:**`true`
  - `start` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type)
  ...
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type) **Default:**`null`
- Returns: [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream)
...
[<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket).
...
- `path` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `options` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `flags` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) See [support of file system `flags`](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags). **Default:**`'w'`.
  - `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) **Default:**`'utf8'`
  - `fd` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) \| [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) **Default:**`null`
  - `mode` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) **Default:**`0o666`
  - `autoClose` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) **Default:**`true`
...
default `w`. The `encoding` can be any one of those accepted by [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer).
...
Like [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream), if `fd` is specified, [<fs.WriteStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream) will ignore the
`path` argument and will use the specified file descriptor. This means that no
`'open'` event will be emitted. `fd` should be blocking; non-blocking `fd`s
should be passed to [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket).
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated: Use [`fs.stat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatpath-options-callback) or [`fs.access()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsaccesspath-mode-callback) instead.
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `stats` [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats)

Invokes the callback with the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) for the file descriptor.
...
descriptor. See [`fs.utimes()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsutimespath-atime-mtime-callback).
...
Changes the access and modification times of a file in the same way as
[`fs.utimes()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsutimespath-atime-mtime-callback), with the difference that if the path refers to a symbolic
...
Retrieves the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) for the symbolic link referred to by the path.
The callback gets two arguments `(err, stats)` where `stats` is a [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats)
...
[`fs.chmod()`](https://nodejs.org/dist/latest/docs/api/fs.html#fschmodpath-mode-callback).
...
- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with a [<Blob>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-blob) upon success.

Returns a [<Blob>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-blob) whose data is backed by the given file.

The file must not be modified after the [<Blob>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-blob) is created. Any modifications
will cause reading the [<Blob>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-blob) data to fail with a `DOMException` error.
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `dir` [<fs.Dir>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir)
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  ...
  - `buffer` [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer)
...
Similar to the [`fs.read()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfd-buffer-offset-length-position-callback) function, this version takes an optional
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `files` [<string\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer\[\]>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<fs.Dirent\[\]>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent)
...
the filenames returned will be passed as [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) objects.
...
[`fs.readFileSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfilesyncpath-options) is platform-specific. On macOS, Linux, and Windows, an
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `linkString` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer)
...
the link path returned will be passed as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) object.
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `resolvedPath` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer)
...
the path returned will be passed as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) object.
...
To get a behavior similar to the `rm -rf` Unix command, use [`fs.rm()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrmpath-options-callback)
...
`stats` is an [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object.

In case of an error, the `err.code` will be one of [Common System Errors](https://nodejs.org/dist/latest/docs/api/errors.html#common-system-errors).

[`fs.stat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatpath-options-callback) follows symbolic links. Use [`fs.lstat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fslstatpath-options-callback) to look at the
links themselves.
...
To check if a file exists without manipulating it afterwards, [`fs.access()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsaccesspath-mode-callback)
is recommended.
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `stats` [<fs.StatFs>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatfs)

Asynchronous [`statfs(2)`](http://man7.org/linux/man-pages/man2/statfs.2.html). Returns information about the mounted file system which
contains `path`. The callback gets two arguments `(err, stats)` where `stats`
is an [<fs.StatFs>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatfs) object.
...
directory, use [`fs.rmdir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrmdirpath-options-callback).
...
Using [`fs.watch()`](https://nodejs.org/dist/latest/docs/api/fs.html#fswatchfilename-options-listener) is more efficient than `fs.watchFile()` and
...
- `options` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) Specifies the character encoding to be used for the
    filename passed to the listener. **Default:**`'utf8'`.
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) allows closing the watcher with an AbortSignal.
- `listener` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) **Default:**`undefined`
  ...
  - `filename` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type)
- Returns: [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher)
...
[<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher), but it is not the same thing as the `'change'` value of
`eventType`.

If a `signal` is passed, aborting the corresponding AbortController will close
the returned [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher).
...
- `listener` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `current` [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats)
  - `previous` [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats)
- Returns: [<fs.StatWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatwatcher)
...
for the callback. For this scenario, [`fs.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options) is
recommended.
...
[`Buffer.byteLength`](https://nodejs.org/dist/latest/docs/api/buffer.html#static-method-bufferbytelengthstring-encoding).
...
waiting for the callback. For this scenario, [`fs.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options) is
recommended.

Similarly to `fs.readFile` \- `fs.writeFile` is a convenience method that
performs multiple `write` calls internally to write the buffer passed to it.
For performance sensitive code consider using [`fs.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options).

It is possible to use an [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal) to cancel an `fs.writeFile()`.
Cancelation is "best effort", and some amount of data is likely still
to be written.
...
If this method is [`util.promisify()`](https://nodejs.org/dist/latest/docs/api/util.html#utilpromisifyoriginal) ed, it returns a promise for an
`Object` with `bytesWritten` and `buffers` properties.

It is unsafe to use `fs.writev()` multiple times on the same file without
waiting for the callback. For this scenario, use [`fs.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options).
...
this API: [`fs.chmod()`](https://nodejs.org/dist/latest/docs/api/fs.html#fschmodpath-mode-callback).
...
This is the synchronous version of [`fs.chown()`](https://nodejs.org/dist/latest/docs/api/fs.html#fschownpath-uid-gid-callback).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `force` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) overwrite existing file or directory. The copy
    ...
    **Default:**`true`.
  - `mode` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) modifiers for copy operation. **Default:**`0`.
    See `mode` flag of [`fs.copyFileSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscopyfilesyncsrc-dest-mode).
  - `preserveTimestamps` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) When `true` timestamps from `src` will
    be preserved. **Default:**`false`.
  - `recursive` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) copy directories recursively **Default:**`false`
  - `verbatimSymlinks` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) When `true`, path resolution for symlinks will
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.exists()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsexistspath-callback).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `bigint` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Whether the numeric values in the returned
    [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object should be `bigint`. **Default:**`false`.
- Returns: [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats)

Retrieves the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) for the file descriptor.
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.ftruncate()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsftruncatefd-len-callback).
...
Synchronous version of [`fs.futimes()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfutimesfd-atime-mtime-callback). Returns `undefined`.
...
the operation fails. This is the synchronous version of [`fs.lutimes()`](https://nodejs.org/dist/latest/docs/api/fs.html#fslutimespath-atime-mtime-callback).
...
Retrieves the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) for the symbolic link referred to by `path`.
...
This is the synchronous version of [`fs.mkdir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdirpath-options-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.mkdtemp()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdtempprefix-options-callback).
...
For detailed information, see the documentation of [`fs.mkdtemp()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsmkdtempprefix-options-callback).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `bufferSize` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Number of directory entries that are buffered
    ...
    performance but higher memory usage. **Default:**`32`
  - `recursive` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) **Default:**`false`
- Returns: [<fs.Dir>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir)
...
See [support of file system `flags`](https://nodejs.org/dist/latest/docs/api/fs.html#file-system-flags).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.open()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopenpath-flags-mode-callback).
...
- `options` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `recursive` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If `true`, reads the contents of a directory
    recursively. In recursive mode, it will list all files, sub files, and
    directories. **Default:**`false`.
- Returns: [<string\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer\[\]>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<fs.Dirent\[\]>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent)
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.readFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfilepath-options-callback).

If the `encoding` option is specified then this function returns a
string. Otherwise it returns a buffer.

Similar to [`fs.readFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfilepath-options-callback), when the path is a directory, the behavior of
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.read()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadfd-buffer-offset-length-position-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.readv()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreadvfd-buffers-position-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.realpath()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrealpathpath-options-callback).
...
To get a behavior similar to the `rm -rf` Unix command, use [`fs.rmSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsrmsyncpath-options)
with options `{ recursive: true, force: true }`.
...
Retrieves the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) for the path.
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `bigint` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Whether the numeric values in the returned
    [<fs.StatFs>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatfs) object should be `bigint`. **Default:**`false`.
- Returns: [<fs.StatFs>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatfs)
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.symlink()`](https://nodejs.org/dist/latest/docs/api/fs.html#fssymlinktarget-path-type-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.utimes()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsutimespath-atime-mtime-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.writeFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefilefile-data-options-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.write(fd, buffer...)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefd-buffer-offset-length-position-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.write(fd, string...)`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritefd-string-position-encoding-callback).
...
For detailed information, see the documentation of the asynchronous version of
this API: [`fs.writev()`](https://nodejs.org/dist/latest/docs/api/fs.html#fswritevfd-buffers-position-callback).
...
Created by [`fs.opendir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopendirpath-options-callback), [`fs.opendirSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopendirsyncpath-options), or
[`fsPromises.opendir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesopendirpath-options).
...
The read-only path of this directory as was provided to [`fs.opendir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopendirpath-options-callback),
[`fs.opendirSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsopendirsyncpath-options), or [`fsPromises.opendir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesopendirpath-options).

##### `dir.read()`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#dirread)

Added in: v12.12.0

- Returns: [<Promise>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) Fulfills with a [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type)

Asynchronously read the next directory entry via [`readdir(3)`](http://man7.org/linux/man-pages/man3/readdir.3.html) as an
[<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent).

A promise is returned that will be fulfilled with an [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent), or `null`
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
  - `err` [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error)
  - `dirent` [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type)

Asynchronously read the next directory entry via [`readdir(3)`](http://man7.org/linux/man-pages/man3/readdir.3.html) as an
[<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent).

After the read is completed, the `callback` will be called with an
[<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent), or `null` if there are no more directory entries to read.
...
- Returns: [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) \| [<null>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#null_type)

Synchronously read the next directory entry as an [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent). See the
...
- Returns: [<AsyncIterator>](https://tc39.github.io/ecma262/#sec-asynciterator-interface) An AsyncIterator of [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent)
...
Entries returned by the async iterator are always an [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent).
The `null` case from `dir.read()` is handled internally.

See [<fs.Dir>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir) for an example.
...
within the directory, as returned by reading from an [<fs.Dir>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdir). The
directory entry is a combination of the file name and file type pairs.

Additionally, when [`fs.readdir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreaddirpath-options-callback) or [`fs.readdirSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreaddirsyncpath-options) is called with
the `withFileTypes` option set to `true`, the resulting array is filled with
[<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) objects, rather than strings or [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) s.
...
Returns `true` if the [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object describes a block device.
...
Returns `true` if the [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object describes a character device.
...
Returns `true` if the [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object describes a file system
directory.
...
Returns `true` if the [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object describes a first-in-first-out
(FIFO) pipe.
...
Returns `true` if the [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object describes a regular file.
...
Returns `true` if the [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object describes a socket.
...
Returns `true` if the [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object describes a symbolic link.

##### `dirent.name`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#direntname)

Added in: v10.10.0

- Type: [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer)

The file name that this [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object refers to. The type of this
value is determined by the `options.encoding` passed to [`fs.readdir()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreaddirpath-options-callback) or
[`fs.readdirSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsreaddirsyncpath-options).
...
The path to the parent directory of the file this [<fs.Dirent>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsdirent) object refers to.
...
A successful call to [`fs.watch()`](https://nodejs.org/dist/latest/docs/api/fs.html#fswatchfilename-options-listener) method will return a new [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher)
object.

All [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher) objects emit a `'change'` event whenever a specific watched
file is modified.
...
- `filename` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) The filename that changed (if relevant/available)

Emitted when something changes in a watched directory or file.
See more details in [`fs.watch()`](https://nodejs.org/dist/latest/docs/api/fs.html#fswatchfilename-options-listener).

The `filename` argument may not be provided depending on operating system
support. If `filename` is provided, it will be provided as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) if
...
[<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher) object is no longer usable in the event handler.
...
Stop watching for changes on the given [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher). Once stopped, the
[<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher) object is no longer usable.
...
[<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher) is active. Calling `watcher.ref()` multiple times will have
no effect.

By default, all [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher) objects are "ref'ed", making it normally
...
When called, the active [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher) object will not require the Node.js
event loop to remain active. If there is no other activity keeping the
event loop running, the process may exit before the [<fs.FSWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsfswatcher) object's
...
A successful call to `fs.watchFile()` method will return a new [<fs.StatWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatwatcher)
object.
...
When called, requests that the Node.js event loop _not_ exit so long as the
[<fs.StatWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatwatcher) is active. Calling `watcher.ref()` multiple times will have
no effect.

By default, all [<fs.StatWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatwatcher) objects are "ref'ed", making it normally
unnecessary to call `watcher.ref()` unless `watcher.unref()` had been
called previously.
...
When called, the active [<fs.StatWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatwatcher) object will not require the Node.js
event loop to remain active. If there is no other activity keeping the
event loop running, the process may exit before the [<fs.StatWatcher>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstatwatcher) object's
callback is invoked. Calling `watcher.unref()` multiple times will have
no effect.
...
- Extends: [<stream.Readable>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamreadable)

Instances of [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream) are created and returned using the
[`fs.createReadStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatereadstreampath-options) function.

##### Event: `'close'`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#event-close_2)

Added in: v0.1.93

Emitted when the [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream)'s underlying file descriptor has been closed.

##### Event: `'open'`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#event-open)

Added in: v0.1.93

- `fd` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Integer file descriptor used by the [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream).

Emitted when the [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream)'s file descriptor has been opened.

##### Event: `'ready'`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#event-ready)

Added in: v9.11.0

Emitted when the [<fs.ReadStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsreadstream) is ready to be used.
...
`readStream.path` will be a string. If `path` is passed as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer), then
`readStream.path` will be a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer). If `fd` is specified, then
...
A [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object provides information about a file.

Objects returned from [`fs.stat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatpath-options-callback), [`fs.lstat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fslstatpath-options-callback), [`fs.fstat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsfstatfd-options-callback), and
...
Returns `true` if the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object describes a block device.
...
Returns `true` if the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object describes a character device.
...
Returns `true` if the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object describes a file system directory.

If the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object was obtained from calling [`fs.lstat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fslstatpath-options-callback) on a
symbolic link which resolves to a directory, this method will return `false`.
This is because [`fs.lstat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fslstatpath-options-callback) returns information
...
Returns `true` if the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object describes a first-in-first-out (FIFO)
pipe.
...
Returns `true` if the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object describes a regular file.
...
Returns `true` if the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object describes a socket.
...
Returns `true` if the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object describes a symbolic link.

This method is only valid when using [`fs.lstat()`](https://nodejs.org/dist/latest/docs/api/fs.html#fslstatpath-options-callback).
...
Objects returned from [`fs.statfs()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsstatfspath-options-callback) and its synchronous counterpart are of
...
- `file`: [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) A path to a file to be written to (mode
...
- `data` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) The data to write.
- Returns [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)
...
the `data` argument must be a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer).
...
Instances of [<fs.WriteStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream) are created and returned using the
[`fs.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options) function.

##### Event: `'close'`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#event-close_4)

Added in: v0.1.93

Emitted when the [<fs.WriteStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream)'s underlying file descriptor has been closed.

##### Event: `'open'`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#event-open_1)

Added in: v0.1.93

- `fd` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Integer file descriptor used by the [<fs.WriteStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream).

Emitted when the [<fs.WriteStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream)'s file is opened.

##### Event: `'ready'`[\#](https://nodejs.org/dist/latest/docs/api/fs.html\#event-ready_2)

Added in: v9.11.0

Emitted when the [<fs.WriteStream>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fswritestream) is ready to be used.
...
argument to [`fs.createWriteStream()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscreatewritestreampath-options). If `path` is passed as a string, then
`writeStream.path` will be a string. If `path` is passed as a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer), then
`writeStream.path` will be a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer).
...
[`fsPromises.access()`](https://nodejs.org/dist/latest/docs/api/fs.html#fspromisesaccesspath-mode), [`fs.access()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsaccesspath-mode-callback), and [`fs.accessSync()`](https://nodejs.org/dist/latest/docs/api/fs.html#fsaccesssyncpath-mode).
...
The following constants are meant for use with [`fs.copyFile()`](https://nodejs.org/dist/latest/docs/api/fs.html#fscopyfilesrc-dest-mode-callback).
...
The following constants are meant for use with the [<fs.Stats>](https://nodejs.org/dist/latest/docs/api/fs.html#class-fsstats) object's
...
a string, a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer), or a [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) object using the `file:` protocol.
...
passed as a [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) object using the `file:` protocol.
...
On Windows, `file:` [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) s with a host name convert to UNC paths, while `file:` [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) s with drive letters convert to local absolute paths. `file:` [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) s
...
`file:` [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) s with drive letters must use `:` as a separator just after
the drive letter. Using another separator will result in an error.

On all other platforms, `file:` [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) s with a host name are unsupported and
...
A `file:` [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) having encoded slash characters will result in an error on all
platforms:
...
On Windows, `file:` [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) s having encoded backslash will result in an error:
...
Paths specified using a [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) are useful primarily on certain POSIX
operating systems that treat file paths as opaque byte sequences. On such
systems, it is possible for a single file path to contain sub-sequences that
use multiple character encodings. As with string paths, [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) paths may
...
The promise-based APIs use a [<FileHandle>](https://nodejs.org/dist/latest/docs/api/fs.html#class-filehandle) object in place of the numeric
