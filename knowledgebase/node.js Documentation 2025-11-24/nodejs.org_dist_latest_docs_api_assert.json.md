---
url: "https://nodejs.org/dist/latest/docs/api/assert.json"
title: undefined
---
  ...
  "modules": [
    {
      ...
      "desc": "<p><strong>Source Code:</strong> <a href=\"https://github.com/nodejs/node/blob/v25.2.1/lib/assert.js\">lib/assert.js</a></p>\n<p>The <code>node:assert</code> module provides a set of assertion functions for verifying\ninvariants.</p>",
      "modules": [
        {
