...
[Skip to content](https://nodejs.org/dist/latest/docs/api/http.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/http.html#toc-picker)




- [HTTP](https://nodejs.org/dist/latest/docs/api/http.html#http)
  - [Class: `http.Agent`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpagent)
    - [`new Agent([options])`](https://nodejs.org/dist/latest/docs/api/http.html#new-agentoptions)
    - [`agent.createConnection(options[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#agentcreateconnectionoptions-callback)
    - [`agent.keepSocketAlive(socket)`](https://nodejs.org/dist/latest/docs/api/http.html#agentkeepsocketalivesocket)
    - [`agent.reuseSocket(socket, request)`](https://nodejs.org/dist/latest/docs/api/http.html#agentreusesocketsocket-request)
    - [`agent.destroy()`](https://nodejs.org/dist/latest/docs/api/http.html#agentdestroy)
    - [`agent.freeSockets`](https://nodejs.org/dist/latest/docs/api/http.html#agentfreesockets)
    - [`agent.getName([options])`](https://nodejs.org/dist/latest/docs/api/http.html#agentgetnameoptions)
    - [`agent.maxFreeSockets`](https://nodejs.org/dist/latest/docs/api/http.html#agentmaxfreesockets)
    - [`agent.maxSockets`](https://nodejs.org/dist/latest/docs/api/http.html#agentmaxsockets)
    - [`agent.maxTotalSockets`](https://nodejs.org/dist/latest/docs/api/http.html#agentmaxtotalsockets)
    - [`agent.requests`](https://nodejs.org/dist/latest/docs/api/http.html#agentrequests)
    - [`agent.sockets`](https://nodejs.org/dist/latest/docs/api/http.html#agentsockets)
  - [Class: `http.ClientRequest`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest)
    - [Event: `'abort'`](https://nodejs.org/dist/latest/docs/api/http.html#event-abort)
    - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/http.html#event-close)
    - [Event: `'connect'`](https://nodejs.org/dist/latest/docs/api/http.html#event-connect)
    - [Event: `'continue'`](https://nodejs.org/dist/latest/docs/api/http.html#event-continue)
    - [Event: `'finish'`](https://nodejs.org/dist/latest/docs/api/http.html#event-finish)
    - [Event: `'information'`](https://nodejs.org/dist/latest/docs/api/http.html#event-information)
    - [Event: `'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response)
    - [Event: `'socket'`](https://nodejs.org/dist/latest/docs/api/http.html#event-socket)
    - [Event: `'timeout'`](https://nodejs.org/dist/latest/docs/api/http.html#event-timeout)
    - [Event: `'upgrade'`](https://nodejs.org/dist/latest/docs/api/http.html#event-upgrade)
    - [`request.abort()`](https://nodejs.org/dist/latest/docs/api/http.html#requestabort)
    - [`request.aborted`](https://nodejs.org/dist/latest/docs/api/http.html#requestaborted)
    - [`request.connection`](https://nodejs.org/dist/latest/docs/api/http.html#requestconnection)
    - [`request.cork()`](https://nodejs.org/dist/latest/docs/api/http.html#requestcork)
    - [`request.end([data[, encoding]][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#requestenddata-encoding-callback)
    - [`request.destroy([error])`](https://nodejs.org/dist/latest/docs/api/http.html#requestdestroyerror)
      - [`request.destroyed`](https://nodejs.org/dist/latest/docs/api/http.html#requestdestroyed)
    - [`request.finished`](https://nodejs.org/dist/latest/docs/api/http.html#requestfinished)
    - [`request.flushHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#requestflushheaders)
    - [`request.getHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#requestgetheadername)
    - [`request.getHeaderNames()`](https://nodejs.org/dist/latest/docs/api/http.html#requestgetheadernames)
    - [`request.getHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#requestgetheaders)
    - [`request.getRawHeaderNames()`](https://nodejs.org/dist/latest/docs/api/http.html#requestgetrawheadernames)
    - [`request.hasHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#requesthasheadername)
    - [`request.maxHeadersCount`](https://nodejs.org/dist/latest/docs/api/http.html#requestmaxheaderscount)
    - [`request.path`](https://nodejs.org/dist/latest/docs/api/http.html#requestpath)
    - [`request.method`](https://nodejs.org/dist/latest/docs/api/http.html#requestmethod)
    - [`request.host`](https://nodejs.org/dist/latest/docs/api/http.html#requesthost)
    - [`request.protocol`](https://nodejs.org/dist/latest/docs/api/http.html#requestprotocol)
    - [`request.removeHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#requestremoveheadername)
    - [`request.reusedSocket`](https://nodejs.org/dist/latest/docs/api/http.html#requestreusedsocket)
    - [`request.setHeader(name, value)`](https://nodejs.org/dist/latest/docs/api/http.html#requestsetheadername-value)
    - [`request.setNoDelay([noDelay])`](https://nodejs.org/dist/latest/docs/api/http.html#requestsetnodelaynodelay)
    - [`request.setSocketKeepAlive([enable][, initialDelay])`](https://nodejs.org/dist/latest/docs/api/http.html#requestsetsocketkeepaliveenable-initialdelay)
    - [`request.setTimeout(timeout[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#requestsettimeouttimeout-callback)
    - [`request.socket`](https://nodejs.org/dist/latest/docs/api/http.html#requestsocket)
    - [`request.uncork()`](https://nodejs.org/dist/latest/docs/api/http.html#requestuncork)
    - [`request.writableEnded`](https://nodejs.org/dist/latest/docs/api/http.html#requestwritableended)
    - [`request.writableFinished`](https://nodejs.org/dist/latest/docs/api/http.html#requestwritablefinished)
    - [`request.write(chunk[, encoding][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#requestwritechunk-encoding-callback)
  - [Class: `http.Server`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserver)
    - [Event: `'checkContinue'`](https://nodejs.org/dist/latest/docs/api/http.html#event-checkcontinue)
    - [Event: `'checkExpectation'`](https://nodejs.org/dist/latest/docs/api/http.html#event-checkexpectation)
    - [Event: `'clientError'`](https://nodejs.org/dist/latest/docs/api/http.html#event-clienterror)
    - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/http.html#event-close_1)
    - [Event: `'connect'`](https://nodejs.org/dist/latest/docs/api/http.html#event-connect_1)
    - [Event: `'connection'`](https://nodejs.org/dist/latest/docs/api/http.html#event-connection)
    - [Event: `'dropRequest'`](https://nodejs.org/dist/latest/docs/api/http.html#event-droprequest)
    - [Event: `'request'`](https://nodejs.org/dist/latest/docs/api/http.html#event-request)
    - [Event: `'upgrade'`](https://nodejs.org/dist/latest/docs/api/http.html#event-upgrade_1)
    - [`server.close([callback])`](https://nodejs.org/dist/latest/docs/api/http.html#serverclosecallback)
    - [`server.closeAllConnections()`](https://nodejs.org/dist/latest/docs/api/http.html#servercloseallconnections)
    - [`server.closeIdleConnections()`](https://nodejs.org/dist/latest/docs/api/http.html#servercloseidleconnections)
    - [`server.headersTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverheaderstimeout)
    - [`server.listen()`](https://nodejs.org/dist/latest/docs/api/http.html#serverlisten)
    - [`server.listening`](https://nodejs.org/dist/latest/docs/api/http.html#serverlistening)
    - [`server.maxHeadersCount`](https://nodejs.org/dist/latest/docs/api/http.html#servermaxheaderscount)
    - [`server.requestTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverrequesttimeout)
    - [`server.setTimeout([msecs][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#serversettimeoutmsecs-callback)
    - [`server.maxRequestsPerSocket`](https://nodejs.org/dist/latest/docs/api/http.html#servermaxrequestspersocket)
    - [`server.timeout`](https://nodejs.org/dist/latest/docs/api/http.html#servertimeout)
    - [`server.keepAliveTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverkeepalivetimeout)
    - [`server.keepAliveTimeoutBuffer`](https://nodejs.org/dist/latest/docs/api/http.html#serverkeepalivetimeoutbuffer)
    - [`server[Symbol.asyncDispose]()`](https://nodejs.org/dist/latest/docs/api/http.html#serversymbolasyncdispose)
  - [Class: `http.ServerResponse`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserverresponse)
    - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/http.html#event-close_2)
    - [Event: `'finish'`](https://nodejs.org/dist/latest/docs/api/http.html#event-finish_1)
    - [`response.addTrailers(headers)`](https://nodejs.org/dist/latest/docs/api/http.html#responseaddtrailersheaders)
    - [`response.connection`](https://nodejs.org/dist/latest/docs/api/http.html#responseconnection)
    - [`response.cork()`](https://nodejs.org/dist/latest/docs/api/http.html#responsecork)
    - [`response.end([data[, encoding]][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#responseenddata-encoding-callback)
    - [`response.finished`](https://nodejs.org/dist/latest/docs/api/http.html#responsefinished)
    - [`response.flushHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#responseflushheaders)
    - [`response.getHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#responsegetheadername)
    - [`response.getHeaderNames()`](https://nodejs.org/dist/latest/docs/api/http.html#responsegetheadernames)
    - [`response.getHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#responsegetheaders)
    - [`response.hasHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#responsehasheadername)
    - [`response.headersSent`](https://nodejs.org/dist/latest/docs/api/http.html#responseheaderssent)
    - [`response.removeHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#responseremoveheadername)
    - [`response.req`](https://nodejs.org/dist/latest/docs/api/http.html#responsereq)
    - [`response.sendDate`](https://nodejs.org/dist/latest/docs/api/http.html#responsesenddate)
    - [`response.setHeader(name, value)`](https://nodejs.org/dist/latest/docs/api/http.html#responsesetheadername-value)
    - [`response.setTimeout(msecs[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#responsesettimeoutmsecs-callback)
    - [`response.socket`](https://nodejs.org/dist/latest/docs/api/http.html#responsesocket)
    - [`response.statusCode`](https://nodejs.org/dist/latest/docs/api/http.html#responsestatuscode)
    - [`response.statusMessage`](https://nodejs.org/dist/latest/docs/api/http.html#responsestatusmessage)
    - [`response.strictContentLength`](https://nodejs.org/dist/latest/docs/api/http.html#responsestrictcontentlength)
    - [`response.uncork()`](https://nodejs.org/dist/latest/docs/api/http.html#responseuncork)
    - [`response.writableEnded`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritableended)
    - [`response.writableFinished`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritablefinished)
    - [`response.write(chunk[, encoding][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritechunk-encoding-callback)
    - [`response.writeContinue()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritecontinue)
    - [`response.writeEarlyHints(hints[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteearlyhintshints-callback)
    - [`response.writeHead(statusCode[, statusMessage][, headers])`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers)
    - [`response.writeProcessing()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteprocessing)
  - [Class: `http.IncomingMessage`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage)
    - [Event: `'aborted'`](https://nodejs.org/dist/latest/docs/api/http.html#event-aborted)
    - [Event: `'close'`](https://nodejs.org/dist/latest/docs/api/http.html#event-close_3)
    - [`message.aborted`](https://nodejs.org/dist/latest/docs/api/http.html#messageaborted)
    - [`message.complete`](https://nodejs.org/dist/latest/docs/api/http.html#messagecomplete)
    - [`message.connection`](https://nodejs.org/dist/latest/docs/api/http.html#messageconnection)
    - [`message.destroy([error])`](https://nodejs.org/dist/latest/docs/api/http.html#messagedestroyerror)
    - [`message.headers`](https://nodejs.org/dist/latest/docs/api/http.html#messageheaders)
    - [`message.headersDistinct`](https://nodejs.org/dist/latest/docs/api/http.html#messageheadersdistinct)
    - [`message.httpVersion`](https://nodejs.org/dist/latest/docs/api/http.html#messagehttpversion)
    - [`message.method`](https://nodejs.org/dist/latest/docs/api/http.html#messagemethod)
    - [`message.rawHeaders`](https://nodejs.org/dist/latest/docs/api/http.html#messagerawheaders)
    - [`message.rawTrailers`](https://nodejs.org/dist/latest/docs/api/http.html#messagerawtrailers)
    - [`message.setTimeout(msecs[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#messagesettimeoutmsecs-callback)
    - [`message.socket`](https://nodejs.org/dist/latest/docs/api/http.html#messagesocket)
    - [`message.statusCode`](https://nodejs.org/dist/latest/docs/api/http.html#messagestatuscode)
    - [`message.statusMessage`](https://nodejs.org/dist/latest/docs/api/http.html#messagestatusmessage)
    - [`message.trailers`](https://nodejs.org/dist/latest/docs/api/http.html#messagetrailers)
    - [`message.trailersDistinct`](https://nodejs.org/dist/latest/docs/api/http.html#messagetrailersdistinct)
    - [`message.url`](https://nodejs.org/dist/latest/docs/api/http.html#messageurl)
  - [Class: `http.OutgoingMessage`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpoutgoingmessage)
    - [Event: `'drain'`](https://nodejs.org/dist/latest/docs/api/http.html#event-drain)
    - [Event: `'finish'`](https://nodejs.org/dist/latest/docs/api/http.html#event-finish_2)
    - [Event: `'prefinish'`](https://nodejs.org/dist/latest/docs/api/http.html#event-prefinish)
    - [`outgoingMessage.addTrailers(headers)`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageaddtrailersheaders)
    - [`outgoingMessage.appendHeader(name, value)`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageappendheadername-value)
    - [`outgoingMessage.connection`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageconnection)
    - [`outgoingMessage.cork()`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagecork)
    - [`outgoingMessage.destroy([error])`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagedestroyerror)
    - [`outgoingMessage.end(chunk[, encoding][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageendchunk-encoding-callback)
    - [`outgoingMessage.flushHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageflushheaders)
    - [`outgoingMessage.getHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagegetheadername)
    - [`outgoingMessage.getHeaderNames()`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagegetheadernames)
    - [`outgoingMessage.getHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagegetheaders)
    - [`outgoingMessage.hasHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagehasheadername)
    - [`outgoingMessage.headersSent`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageheaderssent)
    - [`outgoingMessage.pipe()`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagepipe)
    - [`outgoingMessage.removeHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageremoveheadername)
    - [`outgoingMessage.setHeader(name, value)`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagesetheadername-value)
    - [`outgoingMessage.setHeaders(headers)`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagesetheadersheaders)
    - [`outgoingMessage.setTimeout(msecs[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagesettimeoutmsecs-callback)
    - [`outgoingMessage.socket`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagesocket)
    - [`outgoingMessage.uncork()`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessageuncork)
    - [`outgoingMessage.writableCorked`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagewritablecorked)
    - [`outgoingMessage.writableEnded`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagewritableended)
    - [`outgoingMessage.writableFinished`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagewritablefinished)
    - [`outgoingMessage.writableHighWaterMark`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagewritablehighwatermark)
    - [`outgoingMessage.writableLength`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagewritablelength)
    - [`outgoingMessage.writableObjectMode`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagewritableobjectmode)
    - [`outgoingMessage.write(chunk[, encoding][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagewritechunk-encoding-callback)
  - [`http.METHODS`](https://nodejs.org/dist/latest/docs/api/http.html#httpmethods)
  - [`http.STATUS_CODES`](https://nodejs.org/dist/latest/docs/api/http.html#httpstatus_codes)
  - [`http.createServer([options][, requestListener])`](https://nodejs.org/dist/latest/docs/api/http.html#httpcreateserveroptions-requestlistener)
  - [`http.get(options[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#httpgetoptions-callback)
  - [`http.get(url[, options][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#httpgeturl-options-callback)
  - [`http.globalAgent`](https://nodejs.org/dist/latest/docs/api/http.html#httpglobalagent)
  - [`http.maxHeaderSize`](https://nodejs.org/dist/latest/docs/api/http.html#httpmaxheadersize)
  - [`http.request(options[, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#httprequestoptions-callback)
  - [`http.request(url[, options][, callback])`](https://nodejs.org/dist/latest/docs/api/http.html#httprequesturl-options-callback)
  - [`http.validateHeaderName(name[, label])`](https://nodejs.org/dist/latest/docs/api/http.html#httpvalidateheadernamename-label)
  - [`http.validateHeaderValue(name, value)`](https://nodejs.org/dist/latest/docs/api/http.html#httpvalidateheadervaluename-value)
  - [`http.setMaxIdleHTTPParsers(max)`](https://nodejs.org/dist/latest/docs/api/http.html#httpsetmaxidlehttpparsersmax)
  - [Class: `WebSocket`](https://nodejs.org/dist/latest/docs/api/http.html#class-websocket)
  - [Built-in Proxy Support](https://nodejs.org/dist/latest/docs/api/http.html#built-in-proxy-support)
    - [Proxy URL Format](https://nodejs.org/dist/latest/docs/api/http.html#proxy-url-format)
    - [`NO_PROXY` Format](https://nodejs.org/dist/latest/docs/api/http.html#no_proxy-format)
    - [Example](https://nodejs.org/dist/latest/docs/api/http.html#example)

- [Index](https://nodejs.org/dist/latest/docs/api/http.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/http.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/http.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/http.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/http.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/http.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/http.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/http.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/http.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/http.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/http.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/http.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/http.json)
...
**Source Code:** [lib/http.js](https://github.com/nodejs/node/blob/v25.2.1/lib/http.js)
...
See [`message.headers`](https://nodejs.org/dist/latest/docs/api/http.html#messageheaders) for details on how duplicate headers are handled.
...
`keepAlive` [option](https://nodejs.org/dist/latest/docs/api/http.html#new-agentoptions).
...
(see [`socket.unref()`](https://nodejs.org/dist/latest/docs/api/net.html#socketunref)).

It is good practice, to [`destroy()`](https://nodejs.org/dist/latest/docs/api/http.html#agentdestroy) an `Agent` instance when it is no
...
Can have the following fields:
  ...
  - `keepAliveMsecs` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) When using the `keepAlive` option, specifies
    the [initial delay](https://nodejs.org/dist/latest/docs/api/net.html#socketsetkeepaliveenable-initialdelay)
  ...
  - `proxyEnv` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) Environment variables for proxy configuration.
    See [Built-in Proxy Support](https://nodejs.org/dist/latest/docs/api/http.html#built-in-proxy-support) for details. **Default:**`undefined`
...
`options` in [`socket.connect()`](https://nodejs.org/dist/latest/docs/api/net.html#socketconnectoptions-connectlistener) are also supported.

To configure any of them, a custom [`http.Agent`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpagent) instance must be created.
...
[`net.createConnection()`](https://nodejs.org/dist/latest/docs/api/net.html#netcreateconnectionoptions-connectlistener) for the format of the options. For custom agents,
...
created, especially for asynchronous operations.
  ...
  - `socket` [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex) The created socket.
- Returns: [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex) The created socket. This is returned by the default
...
By default, this function behaves identically to [`net.createConnection()`](https://nodejs.org/dist/latest/docs/api/net.html#netcreateconnectionoptions-connectlistener),
...
The `socket` argument can be an instance of [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket), a subclass of
[<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex).
...
- `socket` [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex)
- `request` [<http.ClientRequest>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest)
...
can have open per origin. Origin is the returned value of [`agent.getName()`](https://nodejs.org/dist/latest/docs/api/http.html#agentgetnameoptions).
...
- Extends: [<http.OutgoingMessage>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpoutgoingmessage)

This object is created internally and returned from [`http.request()`](https://nodejs.org/dist/latest/docs/api/http.html#httprequestoptions-callback). It
represents an _in-progress_ request whose header has already been queued. The
header is still mutable using the [`setHeader(name, value)`](https://nodejs.org/dist/latest/docs/api/http.html#requestsetheadername-value),
[`getHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#requestgetheadername), [`removeHeader(name)`](https://nodejs.org/dist/latest/docs/api/http.html#requestremoveheadername) API. The actual header will
be sent along with the first data chunk or when calling [`request.end()`](https://nodejs.org/dist/latest/docs/api/http.html#requestenddata-encoding-callback).

To get the response, add a listener for [`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) to the request object.
[`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) will be emitted from the request object when the response
headers have been received. The [`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) event is executed with one
argument which is an instance of [`http.IncomingMessage`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage).

During the [`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) event, one can add listeners to the
response object; particularly to listen for the `'data'` event.

If no [`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) handler is added, then the response will be
entirely discarded. However, if a [`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) event handler is added,
...
If [`response.strictContentLength`](https://nodejs.org/dist/latest/docs/api/http.html#responsestrictcontentlength) is set to `true`, mismatching the
`Content-Length` header value will result in an `Error` being thrown,
identified by `code:` [`'ERR_HTTP_CONTENT_LENGTH_MISMATCH'`](https://nodejs.org/dist/latest/docs/api/errors.html#err_http_content_length_mismatch).

`Content-Length` value should be in bytes, not characters. Use
[`Buffer.byteLength()`](https://nodejs.org/dist/latest/docs/api/buffer.html#static-method-bufferbytelengthstring-encoding) to determine the length of the body in bytes.

#### Event: `'abort'`[\#](https://nodejs.org/dist/latest/docs/api/http.html\#event-abort)

Added in: v1.4.1Deprecated since: v17.0.0, v16.12.0

[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Listen for the `'close'` event instead.
...
- `response` [<http.IncomingMessage>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage)
- `socket` [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex)
- `head` [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer)

Emitted each time a server responds to a request with a `CONNECT` method. If
this event is not being listened for, clients receiving a `CONNECT` method will
have their connections closed.

This event is guaranteed to be passed an instance of the [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket) class,
a subclass of [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex), unless the user specifies a socket
type other than [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket).
...
[`'upgrade'`](https://nodejs.org/dist/latest/docs/api/http.html#event-upgrade) event instead.
...
See also: [`request.setTimeout()`](https://nodejs.org/dist/latest/docs/api/http.html#requestsettimeouttimeout-callback).
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated: Use [`request.destroy()`](https://nodejs.org/dist/latest/docs/api/http.html#requestdestroyerror) instead.
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Check [`request.destroyed`](https://nodejs.org/dist/latest/docs/api/http.html#requestdestroyed) instead.
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Use [`request.socket`](https://nodejs.org/dist/latest/docs/api/http.html#requestsocket).

- Type: [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex)

See [`request.socket`](https://nodejs.org/dist/latest/docs/api/http.html#requestsocket).

#### `request.cork()`[\#](https://nodejs.org/dist/latest/docs/api/http.html\#requestcork)

Added in: v13.2.0, v12.16.0

See [`writable.cork()`](https://nodejs.org/dist/latest/docs/api/stream.html#writablecork).
...
- `data` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
...
[`request.write(data, encoding)`](https://nodejs.org/dist/latest/docs/api/http.html#requestwritechunk-encoding-callback) followed by `request.end(callback)`.
...
See [`writable.destroy()`](https://nodejs.org/dist/latest/docs/api/stream.html#writabledestroyerror) for further details.
...
Is `true` after [`request.destroy()`](https://nodejs.org/dist/latest/docs/api/http.html#requestdestroyerror) has been called.

See [`writable.destroyed`](https://nodejs.org/dist/latest/docs/api/stream.html#writabledestroyed) for further details.

#### `request.finished`[\#](https://nodejs.org/dist/latest/docs/api/http.html\#requestfinished)

Added in: v0.0.1Deprecated since: v13.4.0, v12.16.0

[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Use [`request.writableEnded`](https://nodejs.org/dist/latest/docs/api/http.html#requestwritableended).

- Type: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)

The `request.finished` property will be `true` if [`request.end()`](https://nodejs.org/dist/latest/docs/api/http.html#requestenddata-encoding-callback)
has been called. `request.end()` will automatically be called if the
request was initiated via [`http.get()`](https://nodejs.org/dist/latest/docs/api/http.html#httpgetoptions-callback).
...
[`request.setHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#requestsetheadername-value).
...
stored without modification. Therefore, [`request.getHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#requestgetheadername) may return
...
[`socket.setNoDelay()`](https://nodejs.org/dist/latest/docs/api/net.html#socketsetnodelaynodelay) will be called.
...
Once a socket is assigned to this request and is connected
[`socket.setKeepAlive()`](https://nodejs.org/dist/latest/docs/api/net.html#socketsetkeepaliveenable-initialdelay) will be called.
...
Once a socket is assigned to this request and is connected
[`socket.setTimeout()`](https://nodejs.org/dist/latest/docs/api/net.html#socketsettimeouttimeout-callback) will be called.
...
This property is guaranteed to be an instance of the [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket) class,
a subclass of [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex), unless the user specified a socket
type other than [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket).
...
See [`writable.uncork()`](https://nodejs.org/dist/latest/docs/api/stream.html#writableuncork).
...
Is `true` after [`request.end()`](https://nodejs.org/dist/latest/docs/api/http.html#requestenddata-encoding-callback) has been called. This property
does not indicate whether the data has been flushed, for this use
[`request.writableFinished`](https://nodejs.org/dist/latest/docs/api/http.html#requestwritablefinished) instead.
...
before the [`'finish'`](https://nodejs.org/dist/latest/docs/api/http.html#event-finish) event is emitted.
...
- `chunk` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
- `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type)
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)
...
`Transfer-Encoding: chunked` header is added. Calling [`request.end()`](https://nodejs.org/dist/latest/docs/api/http.html#requestenddata-encoding-callback)
...
- `request` [<http.IncomingMessage>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage)
- `response` [<http.ServerResponse>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserverresponse)

Emitted each time a request with an HTTP `Expect: 100-continue` is received.
If this event is not listened for, the server will automatically respond
with a `100 Continue` as appropriate.

Handling this event involves calling [`response.writeContinue()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritecontinue) if the
client should continue to send the request body, or generating an appropriate
HTTP response (e.g. 400 Bad Request) if the client should not continue to send
the request body.

When this event is emitted and handled, the [`'request'`](https://nodejs.org/dist/latest/docs/api/http.html#event-request) event will
not be emitted.
...
[`HPE_HEADER_OVERFLOW`](https://nodejs.org/dist/latest/docs/api/errors.html#hpe_header_overflow) error. If the socket is not writable or headers
of the current attached [`http.ServerResponse`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserverresponse) has been sent, it is
immediately destroyed.

`socket` is the [`net.Socket`](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket) object that the error originated from.
...
- `request` [<http.IncomingMessage>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage) Arguments for the HTTP request, as it is in
the [`'request'`](https://nodejs.org/dist/latest/docs/api/http.html#event-request) event
- `socket` [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex) Network socket between the server and client
- `head` [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) The first packet of the tunneling stream (may be empty)
...
typically an object of type [`net.Socket`](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket). Usually users will not want to
access this event. In particular, the socket will not emit `'readable'` events
because of how the protocol parser attaches to the socket. The `socket` can
also be accessed at `request.socket`.

This event can also be explicitly emitted by users to inject connections
into the HTTP server. In that case, any [`Duplex`](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex) stream can be passed.
...
the [`'request'`](https://nodejs.org/dist/latest/docs/api/http.html#event-request) event
- `socket` [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex) Network socket between the server and client
- `head` [<Buffer>](https://nodejs.org/dist/latest/docs/api/buffer.html#class-buffer) The first packet of the upgraded stream (may be empty)
...
a response.
See [`net.Server.close()`](https://nodejs.org/dist/latest/docs/api/net.html#serverclosecallback).
...
- Type: [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) **Default:** The minimum between [`server.requestTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverrequesttimeout) or `60000`.
...
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [<http.Server>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserver)
...
[`server.keepAliveTimeoutBuffer`](https://nodejs.org/dist/latest/docs/api/http.html#serverkeepalivetimeoutbuffer) option to determine the actual socket
timeout, calculated as:
socketTimeout = keepAliveTimeout + keepAliveTimeoutBuffer
If the server receives new data before the keep-alive timeout has fired, it
will reset the regular inactivity timeout, i.e., [`server.timeout`](https://nodejs.org/dist/latest/docs/api/http.html#servertimeout).
...
[`server.keepAliveTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverkeepalivetimeout) to extend the internal socket timeout.
...
Calls [`server.close()`](https://nodejs.org/dist/latest/docs/api/http.html#serverclosecallback) and returns a promise that fulfills when the
server has closed.
...
passed as the second parameter to the [`'request'`](https://nodejs.org/dist/latest/docs/api/http.html#event-request) event.
...
will result in a [`TypeError`](https://nodejs.org/dist/latest/docs/api/errors.html#class-typeerror) being thrown.

#### `response.connection`[\#](https://nodejs.org/dist/latest/docs/api/http.html\#responseconnection)

Added in: v0.3.0Deprecated since: v13.0.0

[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Use [`response.socket`](https://nodejs.org/dist/latest/docs/api/http.html#responsesocket).

- Type: [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex)

See [`response.socket`](https://nodejs.org/dist/latest/docs/api/http.html#responsesocket).
...
[`response.write(data, encoding)`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritechunk-encoding-callback) followed by `response.end(callback)`.
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Use [`response.writableEnded`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritableended).

- Type: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type)

The `response.finished` property will be `true` if [`response.end()`](https://nodejs.org/dist/latest/docs/api/http.html#responseenddata-encoding-callback)
has been called.
...
Flushes the response headers. See also: [`request.flushHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#requestflushheaders).
...
on the arguments provided to [`response.setHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsesetheadername-value).
...
- Type: [<http.IncomingMessage>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage)
...
- Returns: [<http.ServerResponse>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserverresponse)
...
here to send multiple headers with the same name. Non-string values will be
stored without modification. Therefore, [`response.getHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsegetheadername) may return
non-string values. However, the non-string values will be converted to strings
...
When headers have been set with [`response.setHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsesetheadername-value), they will be merged
with any headers passed to [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers), with the headers passed
to [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers) given precedence.
...
If [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers) method is called and this method has not been
called, it will directly write the supplied header values onto the network
channel without caching internally, and the [`response.getHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsegetheadername) on the
header will not yield the expected result. If progressive population of headers
is desired with potential future retrieval and modification, use
[`response.setHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsesetheadername-value) instead of [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers).
...
When using implicit headers (not calling [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers) explicitly),
...
in an `Error` being thrown, identified by `code:` [`'ERR_HTTP_CONTENT_LENGTH_MISMATCH'`](https://nodejs.org/dist/latest/docs/api/errors.html#err_http_content_length_mismatch).
...
Is `true` after [`response.end()`](https://nodejs.org/dist/latest/docs/api/http.html#responseenddata-encoding-callback) has been called. This property
does not indicate whether the data has been flushed, for this use
[`response.writableFinished`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritablefinished) instead.
...
If this method is called and [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers) has not been called,
...
The first time [`response.write()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritechunk-encoding-callback) is called, it will send the buffered
header information and the first chunk of the body to the client. The second
time [`response.write()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritechunk-encoding-callback) is called, Node.js assumes data will be streamed,
...
the request body should be sent. See the [`'checkContinue'`](https://nodejs.org/dist/latest/docs/api/http.html#event-checkcontinue) event on
`Server`.
...
be called before [`response.end()`](https://nodejs.org/dist/latest/docs/api/http.html#responseenddata-encoding-callback) is called.

If [`response.write()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewritechunk-encoding-callback) or [`response.end()`](https://nodejs.org/dist/latest/docs/api/http.html#responseenddata-encoding-callback) are called before calling
...
If this method is called and [`response.setHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsesetheadername-value) has not been called,
it will directly write the supplied header values onto the network channel
without caching internally, and the [`response.getHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsegetheadername) on the header
will not yield the expected result. If progressive population of headers is
desired with potential future retrieval and modification, use
[`response.setHeader()`](https://nodejs.org/dist/latest/docs/api/http.html#responsesetheadername-value) instead.
...
[`Buffer.byteLength()`](https://nodejs.org/dist/latest/docs/api/buffer.html#static-method-bufferbytelengthstring-encoding) to determine the length of the body in bytes. Node.js
...
An `IncomingMessage` object is created by [`http.Server`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserver) or
[`http.ClientRequest`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest) and passed as the first argument to the [`'request'`](https://nodejs.org/dist/latest/docs/api/http.html#event-request)
and [`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) event respectively. It may be used to access response
status, headers, and data.

Different from its `socket` value which is a subclass of [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex), the
`IncomingMessage` itself extends [<stream.Readable>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamreadable) and is created separately to
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Listen for `'close'` event instead.
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Check `message.destroyed` from [<stream.Readable>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamreadable).
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated. Use [`message.socket`](https://nodejs.org/dist/latest/docs/api/http.html#messagesocket).

Alias for [`message.socket`](https://nodejs.org/dist/latest/docs/api/http.html#messagesocket).
...
use the option `joinDuplicateHeaders` in [`http.request()`](https://nodejs.org/dist/latest/docs/api/http.html#httprequestoptions-callback)
and [`http.createServer()`](https://nodejs.org/dist/latest/docs/api/http.html#httpcreateserveroptions-requestlistener). See RFC 9110 Section 5.3 for more
information.
...
Similar to [`message.headers`](https://nodejs.org/dist/latest/docs/api/http.html#messageheaders), but there is no join logic and the values are
...
**Only valid for request obtained from [`http.Server`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserver).**
...
- `msecs` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type)
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [<http.IncomingMessage>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage)
...
The [`net.Socket`](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket) object associated with the connection.

With HTTPS support, use [`request.socket.getPeerCertificate()`](https://nodejs.org/dist/latest/docs/api/tls.html#tlssocketgetpeercertificatedetailed) to obtain the
client's authentication details.

This property is guaranteed to be an instance of the [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket) class,
a subclass of [<stream.Duplex>](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex), unless the user specified a socket
type other than [<net.Socket>](https://nodejs.org/dist/latest/docs/api/net.html#class-netsocket) or internally nulled.
...
**Only valid for response obtained from [`http.ClientRequest`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest).**
...
Similar to [`message.trailers`](https://nodejs.org/dist/latest/docs/api/http.html#messagetrailers), but there is no join logic and the values are
always arrays of strings, even for headers received just once.
...
- Extends: [<Stream>](https://nodejs.org/dist/latest/docs/api/stream.html#stream)

This class serves as the parent class of [`http.ClientRequest`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest)
and [`http.ServerResponse`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserverresponse). It is an abstract outgoing message from
...
[Stability: 0](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Deprecated: Use [`outgoingMessage.socket`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagesocket) instead.

Alias of [`outgoingMessage.socket`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagesocket).
...
`headers` must be an instance of [`Headers`](https://nodejs.org/dist/latest/docs/api/globals.html#class-headers) or `Map`,
...
When headers have been set with [`outgoingMessage.setHeaders()`](https://nodejs.org/dist/latest/docs/api/http.html#outgoingmessagesetheadersheaders),
they will be merged with any headers passed to [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers),
with the headers passed to [`response.writeHead()`](https://nodejs.org/dist/latest/docs/api/http.html#responsewriteheadstatuscode-statusmessage-headers) given precedence.
...
[`socket.setTimeout()`](https://nodejs.org/dist/latest/docs/api/net.html#socketsettimeouttimeout-callback) will be called with `msecs` as the first parameter.
...
buffer level when [`writable.write()`](https://nodejs.org/dist/latest/docs/api/stream.html#writablewritechunk-encoding-callback) starts returning false (`16384`).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  ...
  - `headersTimeout`: Sets the timeout value in milliseconds for receiving
    ...
    See [`server.headersTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverheaderstimeout) for more information.
    **Default:**`60000`.
  - `highWaterMark` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Optionally overrides all `socket`s'
    ...
    **Default:** See [`stream.getDefaultHighWaterMark()`](https://nodejs.org/dist/latest/docs/api/stream.html#streamgetdefaulthighwatermarkobjectmode).
  - `insecureHTTPParser` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If set to `true`, it will use a HTTP parser
    ...
    See [`--insecure-http-parser`](https://nodejs.org/dist/latest/docs/api/cli.html#--insecure-http-parser) for more information.
    **Default:**`false`.
  - `IncomingMessage` [<http.IncomingMessage>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpincomingmessage) Specifies the `IncomingMessage`
  ...
  - `joinDuplicateHeaders` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If set to `true`, this option allows
    ...
    For more information, refer to [`message.headers`](https://nodejs.org/dist/latest/docs/api/http.html#messageheaders).
    **Default:**`false`.
  ...
  - `keepAliveTimeout`: The number of milliseconds of inactivity a server
    ...
    See [`server.keepAliveTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverkeepalivetimeout) for more information.
    **Default:**`5000`.
  - `maxHeaderSize` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Optionally overrides the value of
    [`--max-http-header-size`](https://nodejs.org/dist/latest/docs/api/cli.html#--max-http-header-sizesize) for requests received by this server, i.e.
  ...
  - `requestTimeout`: Sets the timeout value in milliseconds for receiving
    ...
    See [`server.requestTimeout`](https://nodejs.org/dist/latest/docs/api/http.html#serverrequesttimeout) for more information.
    **Default:**`300000`.
  - `requireHostHeader` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) If set to `true`, it forces the server to
    ...
    **Default:**`true`.
  - `ServerResponse` [<http.ServerResponse>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserverresponse) Specifies the `ServerResponse` class
...
Returns a new instance of [`http.Server`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpserver).

The `requestListener` is a function which is automatically
added to the [`'request'`](https://nodejs.org/dist/latest/docs/api/http.html#event-request) event.
...
[`http.request()`](https://nodejs.org/dist/latest/docs/api/http.html#httprequestoptions-callback), with the method set to GET by default.
- `callback` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function)
- Returns: [<http.ClientRequest>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest)

Since most requests are GET requests without bodies, Node.js provides this
convenience method. The only difference between this method and
[`http.request()`](https://nodejs.org/dist/latest/docs/api/http.html#httprequestoptions-callback) is that it sets the method to GET by default and calls `req.end()`
automatically. The callback must take care to consume the response
data for reasons stated in [`http.ClientRequest`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest) section.
...
- Type: [<http.Agent>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpagent)
...
Defaults to 16 KiB. Configurable using the [`--max-http-header-size`](https://nodejs.org/dist/latest/docs/api/cli.html#--max-http-header-sizesize) CLI
option.
...
- `url` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api)
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `agent` [<http.Agent>](https://nodejs.org/dist/latest/docs/api/http.html#class-httpagent) \| [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Controls [`Agent`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpagent) behavior. Possible
    values:

    - `undefined` (default): use [`http.globalAgent`](https://nodejs.org/dist/latest/docs/api/http.html#httpglobalagent) for this host and port.
  ...
  - `createConnection` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) A function that produces a socket/stream to
    ...
    `createConnection` function. See [`agent.createConnection()`](https://nodejs.org/dist/latest/docs/api/http.html#agentcreateconnectionoptions-callback) for more
    details. Any [`Duplex`](https://nodejs.org/dist/latest/docs/api/stream.html#class-streamduplex) stream is a valid return value.
  ...
  - `headers` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) \| [<Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) An object or an array of strings containing request
    headers. The array is in the same format as [`message.rawHeaders`](https://nodejs.org/dist/latest/docs/api/http.html#messagerawheaders).
  - `hints` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Optional [`dns.lookup()` hints](https://nodejs.org/dist/latest/docs/api/dns.html#supported-getaddrinfo-flags).
  - `host` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) A domain name or IP address of the server to issue the
    request to. **Default:**`'localhost'`.
  - `hostname` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) Alias for `host`. To support [`url.parse()`](https://nodejs.org/dist/latest/docs/api/url.html#urlparseurlstring-parsequerystring-slashesdenotehost),
  ...
  - `joinDuplicateHeaders` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) It joins the field line values of
    ...
    the duplicates. See [`message.headers`](https://nodejs.org/dist/latest/docs/api/http.html#messageheaders) for more information.
    **Default:**`false`.
  - `localAddress` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) Local interface to bind for network connections.
  ...
  - `maxHeaderSize` [<number>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) Optionally overrides the value of
    [`--max-http-header-size`](https://nodejs.org/dist/latest/docs/api/cli.html#--max-http-header-sizesize) (the maximum length of response headers in
  ...
  - `setHost` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type): Specifies whether or not to automatically add the
    ...
    `true`.
  - `signal` [<AbortSignal>](https://nodejs.org/dist/latest/docs/api/globals.html#class-abortsignal): An AbortSignal that may be used to abort an ongoing
    request.
...
`url` can be a string or a [`URL`](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) object. If `url` is a
...
the [`'response'`](https://nodejs.org/dist/latest/docs/api/http.html#event-response) event.

`http.request()` returns an instance of the [`http.ClientRequest`](https://nodejs.org/dist/latest/docs/api/http.html#class-httpclientrequest)
...
Passing illegal value as `name` will result in a [`TypeError`](https://nodejs.org/dist/latest/docs/api/errors.html#class-typeerror) being thrown,
...
Passing illegal value as `value` will result in a [`TypeError`](https://nodejs.org/dist/latest/docs/api/errors.html#class-typeerror) being thrown.
