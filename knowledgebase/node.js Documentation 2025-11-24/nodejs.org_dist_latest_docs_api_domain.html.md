---
url: "https://nodejs.org/dist/latest/docs/api/domain.html"
title: "Domain | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/domain.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/domain.html#toc-picker)




- [Domain](https://nodejs.org/dist/latest/docs/api/domain.html#domain)
  - [Warning: Don't ignore errors!](https://nodejs.org/dist/latest/docs/api/domain.html#warning-dont-ignore-errors)
  - [Additions to `Error` objects](https://nodejs.org/dist/latest/docs/api/domain.html#additions-to-error-objects)
  - [Implicit binding](https://nodejs.org/dist/latest/docs/api/domain.html#implicit-binding)
  - [Explicit binding](https://nodejs.org/dist/latest/docs/api/domain.html#explicit-binding)
  - [`domain.create()`](https://nodejs.org/dist/latest/docs/api/domain.html#domaincreate)
  - [Class: `Domain`](https://nodejs.org/dist/latest/docs/api/domain.html#class-domain)
    - [`domain.members`](https://nodejs.org/dist/latest/docs/api/domain.html#domainmembers)
    - [`domain.add(emitter)`](https://nodejs.org/dist/latest/docs/api/domain.html#domainaddemitter)
    - [`domain.bind(callback)`](https://nodejs.org/dist/latest/docs/api/domain.html#domainbindcallback)
    - [`domain.enter()`](https://nodejs.org/dist/latest/docs/api/domain.html#domainenter)
    - [`domain.exit()`](https://nodejs.org/dist/latest/docs/api/domain.html#domainexit)
    - [`domain.intercept(callback)`](https://nodejs.org/dist/latest/docs/api/domain.html#domaininterceptcallback)
    - [`domain.remove(emitter)`](https://nodejs.org/dist/latest/docs/api/domain.html#domainremoveemitter)
    - [`domain.run(fn[, ...args])`](https://nodejs.org/dist/latest/docs/api/domain.html#domainrunfn-args)
  - [Domains and promises](https://nodejs.org/dist/latest/docs/api/domain.html#domains-and-promises)

- [Index](https://nodejs.org/dist/latest/docs/api/domain.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/domain.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/domain.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/domain.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/domain.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/domain.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/domain.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/domain.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/domain.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/domain.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/domain.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/domain.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/domain.json)
...
**Source Code:** [lib/domain.js](https://github.com/nodejs/node/blob/v25.2.1/lib/domain.js)
...
- Returns: [<Domain>](https://nodejs.org/dist/latest/docs/api/domain.html#class-domain)
...
- `emitter` [<EventEmitter>](https://nodejs.org/dist/latest/docs/api/events.html#class-eventemitter) \| [<Timer>](https://nodejs.org/dist/latest/docs/api/timers.html#timers) emitter or timer to be added to the domain
...
This also works with timers that are returned from [`setInterval()`](https://nodejs.org/dist/latest/docs/api/timers.html#setintervalcallback-delay-args) and
[`setTimeout()`](https://nodejs.org/dist/latest/docs/api/timers.html#settimeoutcallback-delay-args). If their callback function throws, it will be caught by
...
stack managed by the domain module (see [`domain.exit()`](https://nodejs.org/dist/latest/docs/api/domain.html#domainexit) for details on the
...
This method is almost identical to [`domain.bind(callback)`](https://nodejs.org/dist/latest/docs/api/domain.html#domainbindcallback). However, in
addition to catching thrown errors, it will also intercept [`Error`](https://nodejs.org/dist/latest/docs/api/errors.html#class-error)
...
- `emitter` [<EventEmitter>](https://nodejs.org/dist/latest/docs/api/events.html#class-eventemitter) \| [<Timer>](https://nodejs.org/dist/latest/docs/api/timers.html#timers) emitter or timer to be removed from the domain

The opposite of [`domain.add(emitter)`](https://nodejs.org/dist/latest/docs/api/domain.html#domainaddemitter). Removes domain handling from the
specified emitter.
...
A callback may be bound to a specific domain using [`domain.bind(callback)`](https://nodejs.org/dist/latest/docs/api/domain.html#domainbindcallback):
