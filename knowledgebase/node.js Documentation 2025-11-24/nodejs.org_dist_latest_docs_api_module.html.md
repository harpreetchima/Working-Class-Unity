---
url: "https://nodejs.org/dist/latest/docs/api/module.html"
title: "Modules: node:module API | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/module.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/module.html#toc-picker)




- [Modules: `node:module` API](https://nodejs.org/dist/latest/docs/api/module.html#modules-nodemodule-api)
  - [The `Module` object](https://nodejs.org/dist/latest/docs/api/module.html#the-module-object)
    - [`module.builtinModules`](https://nodejs.org/dist/latest/docs/api/module.html#modulebuiltinmodules)
    - [`module.createRequire(filename)`](https://nodejs.org/dist/latest/docs/api/module.html#modulecreaterequirefilename)
    - [`module.findPackageJSON(specifier[, base])`](https://nodejs.org/dist/latest/docs/api/module.html#modulefindpackagejsonspecifier-base)
    - [`module.isBuiltin(moduleName)`](https://nodejs.org/dist/latest/docs/api/module.html#moduleisbuiltinmodulename)
    - [`module.register(specifier[, parentURL][, options])`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterspecifier-parenturl-options)
    - [`module.registerHooks(options)`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterhooksoptions)
    - [`module.stripTypeScriptTypes(code[, options])`](https://nodejs.org/dist/latest/docs/api/module.html#modulestriptypescripttypescode-options)
    - [`module.syncBuiltinESMExports()`](https://nodejs.org/dist/latest/docs/api/module.html#modulesyncbuiltinesmexports)
  - [Module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache)
    - [Portability of the compile cache](https://nodejs.org/dist/latest/docs/api/module.html#portability-of-the-compile-cache)
    - [Limitations of the compile cache](https://nodejs.org/dist/latest/docs/api/module.html#limitations-of-the-compile-cache)
    - [`module.constants.compileCacheStatus`](https://nodejs.org/dist/latest/docs/api/module.html#moduleconstantscompilecachestatus)
    - [`module.enableCompileCache([options])`](https://nodejs.org/dist/latest/docs/api/module.html#moduleenablecompilecacheoptions)
    - [`module.flushCompileCache()`](https://nodejs.org/dist/latest/docs/api/module.html#moduleflushcompilecache)
    - [`module.getCompileCacheDir()`](https://nodejs.org/dist/latest/docs/api/module.html#modulegetcompilecachedir)
  - [Customization Hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks)
    - [Enabling](https://nodejs.org/dist/latest/docs/api/module.html#enabling)
    - [Chaining](https://nodejs.org/dist/latest/docs/api/module.html#chaining)
    - [Communication with module customization hooks](https://nodejs.org/dist/latest/docs/api/module.html#communication-with-module-customization-hooks)
    - [Hooks](https://nodejs.org/dist/latest/docs/api/module.html#hooks)
      - [Asynchronous hooks accepted by `module.register()`](https://nodejs.org/dist/latest/docs/api/module.html#asynchronous-hooks-accepted-by-moduleregister)
      - [Synchronous hooks accepted by `module.registerHooks()`](https://nodejs.org/dist/latest/docs/api/module.html#synchronous-hooks-accepted-by-moduleregisterhooks)
      - [Conventions of hooks](https://nodejs.org/dist/latest/docs/api/module.html#conventions-of-hooks)
      - [`initialize()`](https://nodejs.org/dist/latest/docs/api/module.html#initialize)
      - [`resolve(specifier, context, nextResolve)`](https://nodejs.org/dist/latest/docs/api/module.html#resolvespecifier-context-nextresolve)
      - [`load(url, context, nextLoad)`](https://nodejs.org/dist/latest/docs/api/module.html#loadurl-context-nextload)
        - [Caveat in the asynchronous `load` hook](https://nodejs.org/dist/latest/docs/api/module.html#caveat-in-the-asynchronous-load-hook)
    - [Examples](https://nodejs.org/dist/latest/docs/api/module.html#examples)
      - [Import from HTTPS](https://nodejs.org/dist/latest/docs/api/module.html#import-from-https)
      - [Transpilation](https://nodejs.org/dist/latest/docs/api/module.html#transpilation)
        - [Asynchronous version](https://nodejs.org/dist/latest/docs/api/module.html#asynchronous-version)
        - [Synchronous version](https://nodejs.org/dist/latest/docs/api/module.html#synchronous-version)
      - [Running hooks](https://nodejs.org/dist/latest/docs/api/module.html#running-hooks)
      - [Import maps](https://nodejs.org/dist/latest/docs/api/module.html#import-maps)
        - [Asynchronous version](https://nodejs.org/dist/latest/docs/api/module.html#asynchronous-version_1)
        - [Synchronous version](https://nodejs.org/dist/latest/docs/api/module.html#synchronous-version_1)
        - [Using the hooks](https://nodejs.org/dist/latest/docs/api/module.html#using-the-hooks)
  - [Source Map Support](https://nodejs.org/dist/latest/docs/api/module.html#source-map-support)
    - [`module.getSourceMapsSupport()`](https://nodejs.org/dist/latest/docs/api/module.html#modulegetsourcemapssupport)
    - [`module.findSourceMap(path)`](https://nodejs.org/dist/latest/docs/api/module.html#modulefindsourcemappath)
    - [`module.setSourceMapsSupport(enabled[, options])`](https://nodejs.org/dist/latest/docs/api/module.html#modulesetsourcemapssupportenabled-options)
    - [Class: `module.SourceMap`](https://nodejs.org/dist/latest/docs/api/module.html#class-modulesourcemap)
      - [`new SourceMap(payload[, { lineLengths }])`](https://nodejs.org/dist/latest/docs/api/module.html#new-sourcemappayload--linelengths-)
      - [`sourceMap.payload`](https://nodejs.org/dist/latest/docs/api/module.html#sourcemappayload)
      - [`sourceMap.findEntry(lineOffset, columnOffset)`](https://nodejs.org/dist/latest/docs/api/module.html#sourcemapfindentrylineoffset-columnoffset)
      - [`sourceMap.findOrigin(lineNumber, columnNumber)`](https://nodejs.org/dist/latest/docs/api/module.html#sourcemapfindoriginlinenumber-columnnumber)

- [Index](https://nodejs.org/dist/latest/docs/api/module.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/module.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/module.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/module.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/module.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/module.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/module.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/module.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/module.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/module.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/module.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/module.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/module.json)
...
`Module`, the [`module`](https://nodejs.org/dist/latest/docs/api/module.html#the-module-object) variable often seen in [CommonJS](https://nodejs.org/dist/latest/docs/api/modules.html) modules. Accessed
...
by the [module wrapper](https://nodejs.org/dist/latest/docs/api/modules.html#the-module-wrapper). To access it, require the `Module` module:
...
- `filename` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) Filename to be used to construct the require
function. Must be a file URL object, file URL string, or absolute path
string.
- Returns: [<require>](https://nodejs.org/dist/latest/docs/api/modules.html#requireid) Require function
...
- `specifier` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) The specifier for the module whose `package.json` to
...
- `base` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) The absolute location (`file:` URL string or FS path) of the
...
> [`resolve` customization hooks](https://nodejs.org/dist/latest/docs/api/module.html#resolvespecifier-context-nextresolve) are registered, they will not affect the resolution.
...
- `specifier` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) Customization hooks to be registered; this should be
the same string that would be passed to `import()`, except that if it is
relative, it is resolved relative to `parentURL`.
- `parentURL` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) If you want to resolve `specifier` relative to a base
URL, such as `import.meta.url`, you can pass that URL here. **Default:**`'data:'`
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `parentURL` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<URL>](https://nodejs.org/dist/latest/docs/api/url.html#the-whatwg-url-api) If you want to resolve `specifier` relative to a
  ...
  - `data` [<any>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Data_types) Any arbitrary, cloneable JavaScript value to pass into the
    [`initialize`](https://nodejs.org/dist/latest/docs/api/module.html#initialize) hook.
  - `transferList` [<Object\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) [transferable objects](https://nodejs.org/dist/latest/docs/api/worker_threads.html#portpostmessagevalue-transferlist) to be passed into the
    `initialize` hook.

Register a module that exports [hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks) that customize Node.js module
resolution and loading behavior. See [Customization hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks).
...
- `options` [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `load` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) See [load hook](https://nodejs.org/dist/latest/docs/api/module.html#loadurl-context-nextload). **Default:**`undefined`.
  - `resolve` [<Function>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) See [resolve hook](https://nodejs.org/dist/latest/docs/api/module.html#resolvespecifier-context-nextresolve). **Default:**`undefined`.

Register [hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks) that customize Node.js module resolution and loading behavior.
See [Customization hooks](https://nodejs.org/dist/latest/docs/api/module.html#customization-hooks).
...
see [type-stripping](https://nodejs.org/dist/latest/docs/api/typescript.html#type-stripping) for more information.
When mode is `'transform'`, it also transforms TypeScript features to JavaScript,
see [transform TypeScript features](https://nodejs.org/dist/latest/docs/api/typescript.html#typescript-features) for more information.
...
builtin [ES Modules](https://nodejs.org/dist/latest/docs/api/esm.html) to match the properties of the [CommonJS](https://nodejs.org/dist/latest/docs/api/modules.html) exports. It
does not add or remove exported names from the [ES Modules](https://nodejs.org/dist/latest/docs/api/esm.html).
...
The module compile cache can be enabled either using the [`module.enableCompileCache()`](https://nodejs.org/dist/latest/docs/api/module.html#moduleenablecompilecacheoptions)
method or the [`NODE_COMPILE_CACHE=dir`](https://nodejs.org/dist/latest/docs/api/cli.html#node_compile_cachedir) environment variable. After it is enabled,
...
under the [`os.tmpdir()`](https://nodejs.org/dist/latest/docs/api/os.html#ostmpdir). If the compile cache is enabled by a call to
[`module.enableCompileCache()`](https://nodejs.org/dist/latest/docs/api/module.html#moduleenablecompilecacheoptions) without specifying the `directory`, Node.js will use
the [`NODE_COMPILE_CACHE=dir`](https://nodejs.org/dist/latest/docs/api/cli.html#node_compile_cachedir) environment variable if it's set, or defaults
to `path.join(os.tmpdir(), 'node-compile-cache')` otherwise. To locate the compile cache
directory used by a running Node.js instance, use [`module.getCompileCacheDir()`](https://nodejs.org/dist/latest/docs/api/module.html#modulegetcompilecachedir).

The enabled module compile cache can be disabled by the [`NODE_DISABLE_COMPILE_CACHE=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_disable_compile_cache1)
...
[`module.flushCompileCache()`](https://nodejs.org/dist/latest/docs/api/module.html#moduleflushcompilecache) method can be used to ensure the accumulated code cache
...
1. Using the portable option in [`module.enableCompileCache()`](https://nodejs.org/dist/latest/docs/api/module.html#moduleenablecompilecacheoptions):
...
2. Setting the environment variable: [`NODE_COMPILE_CACHE_PORTABLE=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_compile_cache_portable1)
...
[`module.enableCompileCache()`](https://nodejs.org/dist/latest/docs/api/module.html#moduleenablecompilecacheoptions) to indicate the result of the attempt to enable the
[module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache).
...
- `options` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object) Optional. If a string is passed, it is considered to be `options.directory`.
  ...
  - `directory` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) Optional. Directory to store the compile cache. If not specified,
    the directory specified by the [`NODE_COMPILE_CACHE=dir`](https://nodejs.org/dist/latest/docs/api/cli.html#node_compile_cachedir) environment variable
  ...
  - `portable` [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#boolean_type) Optional. If `true`, enables portable compile cache so that
    ...
    [`NODE_COMPILE_CACHE_PORTABLE=1`](https://nodejs.org/dist/latest/docs/api/cli.html#node_compile_cache_portable1) is set.
- Returns: [<Object>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)
  - `status` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#number_type) One of the [`module.constants.compileCacheStatus`](https://nodejs.org/dist/latest/docs/api/module.html#moduleconstantscompilecachestatus)
...
Enable [module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) in the current Node.js instance.
...
values to indicate the result of the attempt to enable the [module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache).

This method only affects the current Node.js instance. To enable it in child worker threads,
either call this method in child worker threads too, or set the
`process.env.NODE_COMPILE_CACHE` value to compile cache directory so the behavior can
be inherited into the child workers. The directory can be obtained either from the
`directory` field returned by this method, or with [`module.getCompileCacheDir()`](https://nodejs.org/dist/latest/docs/api/module.html#modulegetcompilecachedir).
...
Flush the [module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) accumulated from modules already loaded
...
- Returns: [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#string_type) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) Path to the [module compile cache](https://nodejs.org/dist/latest/docs/api/module.html#module-compile-cache) directory if it is enabled,
...
[`register`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterspecifier-parenturl-options) method from `node:module`,
2. Registering a set of synchronous hook functions using the [`registerHooks`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterhooksoptions) method
from `node:module`.

The hooks can be registered before the application code is run by using the
[`--import`](https://nodejs.org/dist/latest/docs/api/cli.html#--importmodule) or [`--require`](https://nodejs.org/dist/latest/docs/api/cli.html#-r---require-module) flag:
...
Where `some-package` has an [`"exports"`](https://nodejs.org/dist/latest/docs/api/packages.html#exports) field defining the `/register`
...
The `register` method can be used to pass data to an [`initialize`](https://nodejs.org/dist/latest/docs/api/module.html#initialize) hook. The
...
The [`register`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterspecifier-parenturl-options) method can be used to register a module that exports a set of
...
[`--import`](https://nodejs.org/dist/latest/docs/api/cli.html#--importmodule) or [`--require`](https://nodejs.org/dist/latest/docs/api/cli.html#-r---require-module), child worker threads can inherit the preloaded scripts
via `process.execArgv` inheritance. See [the documentation of `Worker`](https://nodejs.org/dist/latest/docs/api/worker_threads.html#new-workerfilename-options) for detail.
...
Hooks are part of a [chain](https://nodejs.org/dist/latest/docs/api/module.html#chaining), even if that chain consists of only one
...
The `initialize` hook is only accepted by [`register`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterspecifier-parenturl-options). `registerHooks()` does
...
when the hooks module is registered via [`register`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterspecifier-parenturl-options).

This hook can receive data from a [`register`](https://nodejs.org/dist/latest/docs/api/module.html#moduleregisterspecifier-parenturl-options) invocation, including
...
to match [package exports conditions](https://nodejs.org/dist/latest/docs/api/packages.html#conditional-exports) for this resolution
request. They can be used for looking up conditional mappings elsewhere or to
modify the list when calling the default resolution logic.

The current [package exports conditions](https://nodejs.org/dist/latest/docs/api/packages.html#conditional-exports) are always in
...
is not a string, it is converted to a string using [`util.TextDecoder`](https://nodejs.org/dist/latest/docs/api/util.html#class-utiltextdecoder).
...
source to a supported one (see [Examples](https://nodejs.org/dist/latest/docs/api/module.html#examples) below).
...
JavaScript using the [`load` hook](https://nodejs.org/dist/latest/docs/api/module.html#loadurl-context-nextload).
...
the [load hook](https://nodejs.org/dist/latest/docs/api/module.html#loadurl-context-nextload) documentation).
...
[`--enable-source-maps`](https://nodejs.org/dist/latest/docs/api/cli.html#--enable-source-maps), or with code coverage enabled by setting
[`NODE_V8_COVERAGE=dir`](https://nodejs.org/dist/latest/docs/api/cli.html#node_v8_coveragedir), or be enabled programmatically via
[`module.setSourceMapsSupport()`](https://nodejs.org/dist/latest/docs/api/module.html#modulesetsourcemapssupportenabled-options).
...
- Returns: [<module.SourceMap>](https://nodejs.org/dist/latest/docs/api/module.html#class-modulesourcemap) \| [<undefined>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#undefined_type) Returns `module.SourceMap` if a source
...
Getter for the payload used to construct the [`SourceMap`](https://nodejs.org/dist/latest/docs/api/module.html#class-modulesourcemap) instance.
