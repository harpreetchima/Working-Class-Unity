---
url: "https://nodejs.org/dist/latest/docs/api/inspector.html"
title: "Inspector | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/inspector.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/inspector.html#toc-picker)




- [Inspector](https://nodejs.org/dist/latest/docs/api/inspector.html#inspector)
  - [Promises API](https://nodejs.org/dist/latest/docs/api/inspector.html#promises-api)
    - [Class: `inspector.Session`](https://nodejs.org/dist/latest/docs/api/inspector.html#class-inspectorsession)
      - [`new inspector.Session()`](https://nodejs.org/dist/latest/docs/api/inspector.html#new-inspectorsession)
      - [Event: `'inspectorNotification'`](https://nodejs.org/dist/latest/docs/api/inspector.html#event-inspectornotification)
      - [Event: `<inspector-protocol-method>`](https://nodejs.org/dist/latest/docs/api/inspector.html#event-inspector-protocol-method)
      - [`session.connect()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnect)
      - [`session.connectToMainThread()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnecttomainthread)
      - [`session.disconnect()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessiondisconnect)
      - [`session.post(method[, params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionpostmethod-params)
      - [Example usage](https://nodejs.org/dist/latest/docs/api/inspector.html#example-usage)
        - [CPU profiler](https://nodejs.org/dist/latest/docs/api/inspector.html#cpu-profiler)
        - [Heap profiler](https://nodejs.org/dist/latest/docs/api/inspector.html#heap-profiler)
  - [Callback API](https://nodejs.org/dist/latest/docs/api/inspector.html#callback-api)
    - [Class: `inspector.Session`](https://nodejs.org/dist/latest/docs/api/inspector.html#class-inspectorsession_1)
      - [`new inspector.Session()`](https://nodejs.org/dist/latest/docs/api/inspector.html#new-inspectorsession_1)
      - [Event: `'inspectorNotification'`](https://nodejs.org/dist/latest/docs/api/inspector.html#event-inspectornotification_1)
      - [Event: `<inspector-protocol-method>`;](https://nodejs.org/dist/latest/docs/api/inspector.html#event-inspector-protocol-method_1)
      - [`session.connect()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnect_1)
      - [`session.connectToMainThread()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnecttomainthread_1)
      - [`session.disconnect()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessiondisconnect_1)
      - [`session.post(method[, params][, callback])`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionpostmethod-params-callback)
      - [Example usage](https://nodejs.org/dist/latest/docs/api/inspector.html#example-usage_1)
        - [CPU profiler](https://nodejs.org/dist/latest/docs/api/inspector.html#cpu-profiler_1)
        - [Heap profiler](https://nodejs.org/dist/latest/docs/api/inspector.html#heap-profiler_1)
  - [Common Objects](https://nodejs.org/dist/latest/docs/api/inspector.html#common-objects)
    - [`inspector.close()`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectorclose)
    - [`inspector.console`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectorconsole)
    - [`inspector.open([port[, host[, wait]]])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectoropenport-host-wait)
    - [`inspector.url()`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectorurl)
    - [`inspector.waitForDebugger()`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectorwaitfordebugger)
  - [Integration with DevTools](https://nodejs.org/dist/latest/docs/api/inspector.html#integration-with-devtools)
    - [`inspector.Network.dataReceived([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkdatareceivedparams)
    - [`inspector.Network.dataSent([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkdatasentparams)
    - [`inspector.Network.requestWillBeSent([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkrequestwillbesentparams)
    - [`inspector.Network.responseReceived([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkresponsereceivedparams)
    - [`inspector.Network.loadingFinished([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkloadingfinishedparams)
    - [`inspector.Network.loadingFailed([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkloadingfailedparams)
    - [`inspector.Network.webSocketCreated([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkwebsocketcreatedparams)
    - [`inspector.Network.webSocketHandshakeResponseReceived([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkwebsockethandshakeresponsereceivedparams)
    - [`inspector.Network.webSocketClosed([params])`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkwebsocketclosedparams)
    - [`inspector.NetworkResources.put`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectornetworkresourcesput)
  - [Support of breakpoints](https://nodejs.org/dist/latest/docs/api/inspector.html#support-of-breakpoints)

- [Index](https://nodejs.org/dist/latest/docs/api/inspector.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/inspector.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/inspector.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/inspector.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/inspector.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/inspector.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/inspector.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/inspector.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/inspector.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/inspector.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/inspector.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/inspector.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/inspector.json)
...
**Source Code:** [lib/inspector.js](https://github.com/nodejs/node/blob/v25.2.1/lib/inspector.js)
...
needs to be connected through [`session.connect()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnect) before the messages
...
with an error. [`session.connect()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnect) will need to be called to be able to send
...
**Default:**`false`.
- Returns: [<Disposable>](https://tc39.es/proposal-explicit-resource-management/#sec-disposable-interface) A Disposable that calls [`inspector.close()`](https://nodejs.org/dist/latest/docs/api/inspector.html#inspectorclose).
...
See the [security warning](https://nodejs.org/dist/latest/docs/api/cli.html#warning-binding-inspector-to-a-public-ipport-combination-is-insecure) regarding the `host`
parameter usage.
...
connected by [`session.connect()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnect), should be avoided as the program being
attached and paused is exactly the debugger itself. Instead, try connect to the
main thread by [`session.connectToMainThread()`](https://nodejs.org/dist/latest/docs/api/inspector.html#sessionconnecttomainthread) and set breakpoints in a
worker thread, or connect with a [Debugger](https://nodejs.org/dist/latest/docs/api/debugger.html) program over WebSocket
connection.