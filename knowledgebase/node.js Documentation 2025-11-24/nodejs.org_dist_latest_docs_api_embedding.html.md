---
url: "https://nodejs.org/dist/latest/docs/api/embedding.html"
title: "C++ embedder API | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/embedding.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/embedding.html#toc-picker)




- [C++ embedder API](https://nodejs.org/dist/latest/docs/api/embedding.html#c-embedder-api)
  - [Example embedding application](https://nodejs.org/dist/latest/docs/api/embedding.html#example-embedding-application)
    - [Setting up a per-process state](https://nodejs.org/dist/latest/docs/api/embedding.html#setting-up-a-per-process-state)
    - [Setting up a per-instance state](https://nodejs.org/dist/latest/docs/api/embedding.html#setting-up-a-per-instance-state)

- [Index](https://nodejs.org/dist/latest/docs/api/embedding.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/embedding.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/embedding.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/embedding.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/embedding.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/embedding.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/embedding.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/embedding.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/embedding.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/embedding.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/embedding.html)
...
- [Options](https://nodejs.org/dist/latest/docs/api/embedding.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/embedding.json)
...
[deprecation policy](https://nodejs.org/dist/latest/docs/api/deprecations.html) and may occur on each semver-major release without prior
warning.
...
- Arguments parsing for Node.js [CLI options](https://nodejs.org/dist/latest/docs/api/cli.html),
