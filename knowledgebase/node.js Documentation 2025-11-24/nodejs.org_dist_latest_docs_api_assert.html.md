---
url: "https://nodejs.org/dist/latest/docs/api/assert.html"
title: "Assert | Node.js v25.2.1 Documentation"
---

[Skip to content](https://nodejs.org/dist/latest/docs/api/assert.html#apicontent)
...
- Node.js v25.2.1
- [Table of contents](https://nodejs.org/dist/latest/docs/api/assert.html#toc-picker)




- [Assert](https://nodejs.org/dist/latest/docs/api/assert.html#assert)
  - [Strict assertion mode](https://nodejs.org/dist/latest/docs/api/assert.html#strict-assertion-mode)
  - [Legacy assertion mode](https://nodejs.org/dist/latest/docs/api/assert.html#legacy-assertion-mode)
  - [Class: `assert.AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror)
    - [`new assert.AssertionError(options)`](https://nodejs.org/dist/latest/docs/api/assert.html#new-assertassertionerroroptions)
  - [Class: `assert.Assert`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassert)
    - [`new assert.Assert([options])`](https://nodejs.org/dist/latest/docs/api/assert.html#new-assertassertoptions)
  - [`assert(value[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertvalue-message)
  - [`assert.deepEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepequalactual-expected-message)
    - [Comparison details](https://nodejs.org/dist/latest/docs/api/assert.html#comparison-details)
  - [`assert.deepStrictEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message)
    - [Comparison details](https://nodejs.org/dist/latest/docs/api/assert.html#comparison-details_1)
  - [`assert.doesNotMatch(string, regexp[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdoesnotmatchstring-regexp-message)
  - [`assert.doesNotReject(asyncFn[, error][, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdoesnotrejectasyncfn-error-message)
  - [`assert.doesNotThrow(fn[, error][, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdoesnotthrowfn-error-message)
  - [`assert.equal(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertequalactual-expected-message)
  - [`assert.fail([message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertfailmessage)
  - [`assert.ifError(value)`](https://nodejs.org/dist/latest/docs/api/assert.html#assertiferrorvalue)
  - [`assert.match(string, regexp[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertmatchstring-regexp-message)
  - [`assert.notDeepEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotdeepequalactual-expected-message)
  - [`assert.notDeepStrictEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotdeepstrictequalactual-expected-message)
  - [`assert.notEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotequalactual-expected-message)
  - [`assert.notStrictEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotstrictequalactual-expected-message)
  - [`assert.ok(value[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertokvalue-message)
  - [`assert.rejects(asyncFn[, error][, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertrejectsasyncfn-error-message)
  - [`assert.strictEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertstrictequalactual-expected-message)
  - [`assert.throws(fn[, error][, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertthrowsfn-error-message)
  - [`assert.partialDeepStrictEqual(actual, expected[, message])`](https://nodejs.org/dist/latest/docs/api/assert.html#assertpartialdeepstrictequalactual-expected-message)
    - [Comparison details](https://nodejs.org/dist/latest/docs/api/assert.html#comparison-details_2)

- [Index](https://nodejs.org/dist/latest/docs/api/assert.html#gtoc-picker)
...
- [Other versions](https://nodejs.org/dist/latest/docs/api/assert.html#alt-docs)


01. [25.x](https://nodejs.org/docs/latest-v25.x/api/assert.html)
02. [24.x **LTS**](https://nodejs.org/docs/latest-v24.x/api/assert.html)
03. [23.x](https://nodejs.org/docs/latest-v23.x/api/assert.html)
04. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/assert.html)
05. [21.x](https://nodejs.org/docs/latest-v21.x/api/assert.html)
06. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/assert.html)
07. [19.x](https://nodejs.org/docs/latest-v19.x/api/assert.html)
08. [18.x](https://nodejs.org/docs/latest-v18.x/api/assert.html)
09. [17.x](https://nodejs.org/docs/latest-v17.x/api/assert.html)
10. [16.x](https://nodejs.org/docs/latest-v16.x/api/assert.html)
11. [15.x](https://nodejs.org/docs/latest-v15.x/api/assert.html)
12. [14.x](https://nodejs.org/docs/latest-v14.x/api/assert.html)
13. [13.x](https://nodejs.org/docs/latest-v13.x/api/assert.html)
14. [12.x](https://nodejs.org/docs/latest-v12.x/api/assert.html)
15. [11.x](https://nodejs.org/docs/latest-v11.x/api/assert.html)
16. [10.x](https://nodejs.org/docs/latest-v10.x/api/assert.html)
17. [9.x](https://nodejs.org/docs/latest-v9.x/api/assert.html)
18. [8.x](https://nodejs.org/docs/latest-v8.x/api/assert.html)
19. [7.x](https://nodejs.org/docs/latest-v7.x/api/assert.html)
20. [6.x](https://nodejs.org/docs/latest-v6.x/api/assert.html)
21. [5.x](https://nodejs.org/docs/latest-v5.x/api/assert.html)
22. [4.x](https://nodejs.org/docs/latest-v4.x/api/assert.html)
23. [0.12.x](https://nodejs.org/docs/latest-v0.12.x/api/assert.html)
24. [0.10.x](https://nodejs.org/docs/latest-v0.10.x/api/assert.html)

- [Options](https://nodejs.org/dist/latest/docs/api/assert.html#options-picker)


- [View on single page](https://nodejs.org/dist/latest/docs/api/all.html)
- [View as JSON](https://nodejs.org/dist/latest/docs/api/assert.json)
...
**Source Code:** [lib/assert.js](https://github.com/nodejs/node/blob/v25.2.1/lib/assert.js)
...
strict methods. For example, [`assert.deepEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepequalactual-expected-message) will behave like
[`assert.deepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message).
...
[`getColorDepth()`](https://nodejs.org/dist/latest/docs/api/tty.html#writestreamgetcolordepthenv) documentation.
...
- [`assert.deepEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepequalactual-expected-message)
- [`assert.equal()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertequalactual-expected-message)
- [`assert.notDeepEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotdeepequalactual-expected-message)
- [`assert.notEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotequalactual-expected-message)
...
[`assert.strictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertstrictequalactual-expected-message).
...
An alias of [`assert.ok()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertokvalue-message).
...
An alias of [`assert.deepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message).

**Legacy assertion mode**

[Stability: 3](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Legacy: Use [`assert.deepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message) instead.

Tests for deep equality between the `actual` and `expected` parameters. Consider
using [`assert.deepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message) instead. [`assert.deepEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepequalactual-expected-message) can have
surprising results.
...
The following example does not throw an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) because the
...
If the values are not equal, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown with a `message`
...
[`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror).
...
`string`, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown with a `message` property set equal
...
rejected `Promise` with an [`ERR_INVALID_RETURN_VALUE`](https://nodejs.org/dist/latest/docs/api/errors.html#err_invalid_return_value) error. In both cases
...
function. See [`assert.throws()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertthrowsfn-error-message) for more details.

Besides the async nature to await the completion behaves identically to
[`assert.doesNotThrow()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdoesnotthrowfn-error-message).
...
parameter, then an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown. If the error is of a
...
However, the following will result in an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) with the message
...
If an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown and a value is provided for the `message`
parameter, the value of `message` will be appended to the [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror)
message:
...
An alias of [`assert.strictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertstrictequalactual-expected-message).

**Legacy assertion mode**

[Stability: 3](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Legacy: Use [`assert.strictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertstrictequalactual-expected-message) instead.
...
Throws an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) with the provided error message or a default
...
it will be thrown instead of the [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror).
...
An alias of [`assert.notDeepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotdeepstrictequalactual-expected-message).

**Legacy assertion mode**

[Stability: 3](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Legacy: Use [`assert.notDeepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotdeepstrictequalactual-expected-message) instead.

Tests for any deep inequality. Opposite of [`assert.deepEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepequalactual-expected-message).
...
If the values are deeply equal, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown with a
...
Tests for deep strict inequality. Opposite of [`assert.deepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message).
...
If the values are deeply and strictly equal, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown
...
instead of the [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror).
...
An alias of [`assert.notStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotstrictequalactual-expected-message).

**Legacy assertion mode**

[Stability: 3](https://nodejs.org/dist/latest/docs/api/documentation.html#stability-index) \- Legacy: Use [`assert.notStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertnotstrictequalactual-expected-message) instead.
...
If the values are equal, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown with a `message`
property set equal to the value of the `message` parameter. If the `message`
parameter is undefined, a default error message is assigned. If the `message`
parameter is an instance of [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) then it will be thrown instead of the
`AssertionError`.
...
If the values are strictly equal, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown with a
`message` property set equal to the value of the `message` parameter. If the
`message` parameter is undefined, a default error message is assigned. If the
`message` parameter is an instance of [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) then it will be thrown
instead of the `AssertionError`.
...
If `value` is not truthy, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown with a `message`
property set equal to the value of the `message` parameter. If the `message`
parameter is `undefined`, a default error message is assigned. If the `message`
parameter is an instance of [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) then it will be thrown instead of the
`AssertionError`.
...
`Promise` with an [`ERR_INVALID_RETURN_VALUE`](https://nodejs.org/dist/latest/docs/api/errors.html#err_invalid_return_value) error. In both cases the error
handler is skipped.

Besides the async nature to await the completion behaves identically to
[`assert.throws()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertthrowsfn-error-message).
...
If specified, `message` will be the message provided by the [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror)
...
example in [`assert.throws()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertthrowsfn-error-message) carefully if using a string as the second
...
If the values are not strictly equal, an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror) is thrown with a
`message` property set equal to the value of the `message` parameter. If the
`message` parameter is undefined, a default error message is assigned. If the
`message` parameter is an instance of [<Error>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) then it will be thrown
instead of the [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror).
...
It will otherwise fail with an [`AssertionError`](https://nodejs.org/dist/latest/docs/api/assert.html#class-assertassertionerror).
...
This method always passes the same test cases as [`assert.deepStrictEqual()`](https://nodejs.org/dist/latest/docs/api/assert.html#assertdeepstrictequalactual-expected-message),
