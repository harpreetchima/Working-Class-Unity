---
url: "https://nodejs.org/dist/latest/docs/api/https.json"
title: undefined
---
  ...
  "modules": [
    {
      ...
      "desc": "<p><strong>Source Code:</strong> <a href=\"https://github.com/nodejs/node/blob/v25.2.1/lib/https.js\">lib/https.js</a></p>\n<p>HTTPS is the HTTP protocol over TLS/SSL. In Node.js this is implemented as a\nseparate module.</p>",
      "modules": [
        {
      ...
      "classes": [
        ...
        },
        {
          ...
          "properties": [
            {
              "textRaw": "`headersTimeout` Type: {number} **Default:** `60000`",
              "type": "number",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`timeout` Type: {number} **Default:** 0 (no timeout)",
              "type": "number",
              "name": "Type",
              "meta": {
                "added": [
            ...
            {
              "textRaw": "`keepAliveTimeout` Type: {number} **Default:** `5000` (5 seconds)",
              "type": "number",
              "name": "Type",
              "meta": {
                "added": [
