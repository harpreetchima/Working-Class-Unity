---
url: "https://formbricks.com/docs/self-hosting/advanced/enterprise-features/team-access"
title: "Teams & Roles (RBAC) - Documentation - Formbricks"
---

[Skip to main content](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/team-access#content-area)
...
Granularly control which users have access to specific projects and surveys.

Each User can be a member of any number of Teams.Each Team can have Read, Write or Manage access to any number of Projects.In the Community Edition, each User has Admin rights.In the Enterprise Edition, you can granularly assign Roles and Memberships to users.Here are [all details of user management](https://formbricks.com/docs/xm-and-surveys/core-features/user-management#memberships)

Was this page helpful?

YesNo

[White-label Follow-ups](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/whitelabel-email-follow-ups) [Contacts & Segments](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/contact-management-segments)
