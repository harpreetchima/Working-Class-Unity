---
url: "https://formbricks.com/docs/self-hosting/advanced/enterprise-features/oidc-sso"
title: "OAuth & SSO - Documentation - Formbricks"
---

[Skip to main content](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/oidc-sso#content-area)
...
Configure Single Sign-On with your Formbricks instance.

Implement enterprise-grade authentication for your survey platform with [Open ID connect, Azure AD OAuth, Google OAuth, and SAML](https://formbricks.com/docs/self-hosting/configuration/auth-sso)

Was this page helpful?

YesNo

[Multi-language Surveys](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/multi-language-surveys) [SAML SSO](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/saml-sso)
