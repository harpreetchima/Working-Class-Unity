---
url: "https://formbricks.com/docs/self-hosting/advanced/enterprise-features/contact-management-segments"
title: "Contact management & segments - Documentation - Formbricks"
---

[Skip to main content](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/contact-management-segments#content-area)
...
Create and manage contacts and attribute-based segments with Formbricks.

Contacts are helpful if you want to assign response to specific contacts or users of your mobile application. Also, if you’d like to do [attribute-based targeting](https://formbricks.com/docs/xm-and-surveys/surveys/website-app-surveys/advanced-targeting) of specific cohorts or segments of your user base you need this feature.

Was this page helpful?

YesNo

[Teams & Roles (RBAC)](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/team-access) [Multi-language Surveys](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/multi-language-surveys)
