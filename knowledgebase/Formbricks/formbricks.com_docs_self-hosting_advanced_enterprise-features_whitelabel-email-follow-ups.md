---
url: "https://formbricks.com/docs/self-hosting/advanced/enterprise-features/whitelabel-email-follow-ups"
title: "White-label Follow-ups - Documentation - Formbricks"
---

[Skip to main content](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/whitelabel-email-follow-ups#content-area)
...
Add you own logo to emails sent to respondents

With the Enterprise Edition, you can customize the [Follow-up Emails](https://formbricks.com/docs/xm-and-surveys/core-features/email-customization) sent to respondents.

Emails sent to the coworkers of your organisation (e.g. invitations to join a Formbricks team) remain Formbricks branded.

Was this page helpful?

YesNo

[Hide Branding](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/hide-powered-by-formbricks) [Teams & Roles (RBAC)](https://formbricks.com/docs/self-hosting/advanced/enterprise-features/team-access)
