---
url: "https://tailwindcss.com/plus/ui-blocks/documentation/select"
...
- [Component API](https://tailwindcss.com/plus/ui-blocks/documentation/select#component-api)
- [<el-select>](https://tailwindcss.com/plus/ui-blocks/documentation/select#el-select)
- [<el-options>](https://tailwindcss.com/plus/ui-blocks/documentation/select#el-options)
- [<el-option>](https://tailwindcss.com/plus/ui-blocks/documentation/select#el-option)
- [<el-selectedcontent>](https://tailwindcss.com/plus/ui-blocks/documentation/select#el-selectedcontent)
- [Examples](https://tailwindcss.com/plus/ui-blocks/documentation/select#examples)
- [Basic example](https://tailwindcss.com/plus/ui-blocks/documentation/select#basic-example)
- [Positioning the dropdown](https://tailwindcss.com/plus/ui-blocks/documentation/select#positioning-the-dropdown)
- [Setting the dropdown width](https://tailwindcss.com/plus/ui-blocks/documentation/select#setting-the-dropdown-width)
- [Adding transitions](https://tailwindcss.com/plus/ui-blocks/documentation/select#adding-transitions)
- [Disabling the input](https://tailwindcss.com/plus/ui-blocks/documentation/select#disabling-the-input)
