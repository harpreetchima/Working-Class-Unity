...
- [Primer](https://primer.tailwindui.com/) — a landing page template for ebooks and courses that bakes
in a lot of the best practices we've learned releasing our own info products.
- [Salient](https://salient.tailwindui.com/) — a stunning but simple SaaS marketing website you can
quickly adapt for your next idea without burning time you wish you were spending on the actual product.
- [Keynote](https://keynote.tailwindui.com/) — a beautiful conference website design that works just as
well for small local gatherings as it does for international events.
- [Transmit](https://transmit.tailwindui.com/) — an awesome podcasting template with a custom
