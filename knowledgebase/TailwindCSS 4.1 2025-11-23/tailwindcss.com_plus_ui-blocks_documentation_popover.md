---
url: "https://tailwindcss.com/plus/ui-blocks/documentation/popover"
...
[Analytics](https://tailwindcss.com/plus/ui-blocks/documentation/popover#)

Get a better understanding of your traffic

[Engagement](https://tailwindcss.com/plus/ui-blocks/documentation/popover#)

Speak directly to your customers

[Security](https://tailwindcss.com/plus/ui-blocks/documentation/popover#)

Your customers' data will be safe and secure

[Integrations](https://tailwindcss.com/plus/ui-blocks/documentation/popover#)

Connect with third-party tools

[Automations](https://tailwindcss.com/plus/ui-blocks/documentation/popover#)

Build strategic funnels that will convert

[Watch demo](https://tailwindcss.com/plus/ui-blocks/documentation/popover#) [Contact sales](https://tailwindcss.com/plus/ui-blocks/documentation/popover#)
...
| `anchor-strategy` | Sets the `position` CSS property of the popover to either`absolute` (default) or `fixed`. |
...
- [Component API](https://tailwindcss.com/plus/ui-blocks/documentation/popover#component-api)
- [<el-popover>](https://tailwindcss.com/plus/ui-blocks/documentation/popover#el-popover)
- [<el-popover-group>](https://tailwindcss.com/plus/ui-blocks/documentation/popover#el-popover-group)
- [Examples](https://tailwindcss.com/plus/ui-blocks/documentation/popover#examples)
- [Basic example](https://tailwindcss.com/plus/ui-blocks/documentation/popover#basic-example)
- [Toggling popovers](https://tailwindcss.com/plus/ui-blocks/documentation/popover#toggling-popovers)
- [Opening popovers](https://tailwindcss.com/plus/ui-blocks/documentation/popover#opening-popovers)
- [Closing popovers](https://tailwindcss.com/plus/ui-blocks/documentation/popover#closing-popovers)
- [Setting the panel width](https://tailwindcss.com/plus/ui-blocks/documentation/popover#setting-the-panel-width)
- [Positioning the panel](https://tailwindcss.com/plus/ui-blocks/documentation/popover#positioning-the-panel)
- [Adding transitions](https://tailwindcss.com/plus/ui-blocks/documentation/popover#adding-transitions)
- [Grouping related popovers](https://tailwindcss.com/plus/ui-blocks/documentation/popover#grouping-popovers)
