...
[Skip to content](https://vuejs.org/api/built-in-directives#VPContent)
...
[简体中文](https://cn.vuejs.org/api/built-in-directives) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/api/built-in-directives) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/api/built-in-directives) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/api/built-in-directives) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/api/built-in-directives) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/api/built-in-directives) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/api/built-in-directives) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/api/built-in-directives) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/api/built-in-directives) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/api/built-in-directives) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/api/built-in-directives) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/api/built-in-directives) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/api/built-in-directives) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
# Built-in Directives [​](https://vuejs.org/api/built-in-directives\#built-in-directives)
...
`v-text` works by setting the element's [textContent](https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent) property, so it will overwrite any existing content inside the element. If you need to update only part of the `textContent`, you should use [mustache interpolations](https://vuejs.org/guide/essentials/template-syntax#text-interpolation) instead (ie. `<span>Keep this but update a {{dynamicPortion}}</span>`).
...
- **See also** [Template Syntax - Text Interpolation](https://vuejs.org/guide/essentials/template-syntax#text-interpolation)
...
In [Single-File Components](https://vuejs.org/guide/scaling-up/sfc), `scoped` styles will not apply to content inside `v-html`, because that HTML is not processed by Vue's template compiler. If you want to target `v-html` content with scoped CSS, you can instead use [CSS modules](https://vuejs.org/api/sfc-css-features#css-modules) or an additional, global `<style>` element with a manual scoping strategy such as BEM.
...
- **See also** [Template Syntax - Raw HTML](https://vuejs.org/guide/essentials/template-syntax#raw-html)
...
- **See also** [Conditional Rendering - v-show](https://vuejs.org/guide/essentials/conditional#v-show)
...
When used together, `v-if` has a higher priority than `v-for`. We don't recommend using these two directives together on one element — see the [list rendering guide](https://vuejs.org/guide/essentials/list#v-for-with-v-if) for details.

- **See also** [Conditional Rendering - v-if](https://vuejs.org/guide/essentials/conditional#v-if)
...
- **See also** [Conditional Rendering - v-else](https://vuejs.org/guide/essentials/conditional#v-else)
...
- **See also** [Conditional Rendering - v-else-if](https://vuejs.org/guide/essentials/conditional#v-else-if)
...
- **See also**
  ...
  - [Components - Custom Events](https://vuejs.org/guide/essentials/component-basics#listening-to-events)
...
- **See also**
  ...
  - [Components - Prop Passing Details](https://vuejs.org/guide/components/props#prop-passing-details)
...
- **Modifiers**
  ...
  - [`.lazy`](https://vuejs.org/guide/essentials/forms#lazy) \- listen to `change` events instead of `input`
  - [`.number`](https://vuejs.org/guide/essentials/forms#number) \- cast valid input string to numbers
  - [`.trim`](https://vuejs.org/guide/essentials/forms#trim) \- trim input
- **See also**

  - [Form Input Bindings](https://vuejs.org/guide/essentials/forms)
  - [Component Events - Usage with `v-model`](https://vuejs.org/guide/components/v-model)
...
- **Limited to:**
  ...
  - `<template>`
  - [components](https://vuejs.org/guide/components/slots#scoped-slots) (for a lone default slot with props)
- **Example**
...
- **See also**
  ...
  - [Components - Slots](https://vuejs.org/guide/components/slots)
...
Since 3.2, you can also memoize part of the template with invalidation conditions using [`v-memo`](https://vuejs.org/api/built-in-directives#v-memo).

- **See also**

  - [Data Binding Syntax - interpolations](https://vuejs.org/guide/essentials/template-syntax#text-interpolation)
  - [v-memo](https://vuejs.org/api/built-in-directives#v-memo)
...
[PreviousComponent Instance](https://vuejs.org/api/component-instance) [Next Components](https://vuejs.org/api/built-in-components)

Built-in Directives has loaded