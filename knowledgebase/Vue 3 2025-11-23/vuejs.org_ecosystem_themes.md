...
[Skip to content](https://vuejs.org/ecosystem/themes#VPContent)
...
[简体中文](https://cn.vuejs.org/ecosystem/themes) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/ecosystem/themes) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/ecosystem/themes) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/ecosystem/themes) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/ecosystem/themes) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/ecosystem/themes) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/ecosystem/themes) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/ecosystem/themes) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/ecosystem/themes) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/ecosystem/themes) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/ecosystem/themes) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/ecosystem/themes) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/ecosystem/themes) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
[Nuxt UI](https://ui.nuxt.com/) is an intuitive, open-source UI library for Vue and Nuxt applications. Built with Tailwind CSS and Reka UI, it provides 100+ beautifully crafted, accessible components with a flexible CSS-first design system.

[![Dashboard](https://res.cloudinary.com/nuxt/image/upload/v1742036101/nuxt-ui/nuxt-ui-dashboard-social-card_kpeysq.png)\\
\\
**Dashboard** \\
\\
Professional Vue Dashboard Template showcasing Nuxt UI capabilities.\\
\\
FREE](https://vue-dashboard-template.nuxt.dev/)

[See More Themes from Nuxt UI](https://ui.nuxt.com/)
...
Check out the themes, UI Kits and plugins below built by our partners from [MDBootstrap](https://mdbootstrap.com/?utm_ref_id=82665). Learn how to use Vue in professional projects along such technologies as Bootstrap. Templates & ready components make your development faster and more efficient.
...
The open-source UI component library [PrimeVue](https://www.primefaces.org/primevue/?af_id=4218) offers over 90 flexible components to build your apps with! They have a ton of different component themes and application templates available to get the look & feel that suits you best.
...
Check out the admin dashboard templates built by our partners from [Flatlogic](https://flatlogic.com/templates?ref=x-fdkuTAVW). With these themes you can see how real applications are built. Additionally, these templates will help you to start a new application and save you time and money.
...
Explore Vue.js admin dashboard templates crafted with developers in mind by our partners at [CodedThemes](https://codedthemes.com/). Download now to expedite the development of your real-time web applications, saving you countless hours in design and development.
...
\\
$69](https://codedthemes.com/item/berry-vue-admin-dashboard/?ref=evan.vuejs)
...
\\
$69](https://codedthemes.com/item/mantis-vue-admin-template/?ref=evan.vuejs)
...
[![Free Datta Able Vue Admin Template](https://org-public-assets.s3.us-west-2.amazonaws.com/Banners/Datta+able-free-vue.png)\\
\\
**Free Datta Able Vue Admin Template** \\
\\
Free & Open Source VueJs Bootstrap Admin Template\\
\\
FREE](https://codedthemes.com/item/datta-able-free-vue-admin-template/?ref=evan.vuejs)

[![Datta Able Vue + Bootstrap Admin Template](https://org-public-assets.s3.us-west-2.amazonaws.com/Banners/Datta+able-pro-vue.png)\\
\\
**Datta Able Vue + Bootstrap Admin Template** \\
\\
Premium VueJs + Bootstrap + Vite + Typescript Admin Template\\
\\
$69](https://codedthemes.com/item/datta-able-vue-admin-template/?ref=evan.vuejs)
...
\\
Vue3 + Vite + Vuetify + Typescript Dashboard Template\\
\\
$69](https://codedthemes.com/item/able-pro-vuejs-admin-dashboard/?ref=evan.vuejs)

[![Able Pro Vue Laravel Admin Dashboard Template](https://org-public-assets.s3.us-west-2.amazonaws.com/Banners/Able+pro-pro-vue-laravel.png)\\
\\
**Able Pro Vue Laravel Admin Dashboard Template** \\
\\
A powerful Vue + Laravel Dashboard Theme\\
\\
$69](https://codedthemes.com/item/able-pro-vue-laravel-admin-dashboard/?ref=evan.vuejs)

[See More Themes from CodedThemes](https://codedthemes.com/item/category/templates/vue-template/)

## ThemeSelection

Check out the admin [dashboard templates](https://themeselection.com/item/category/admin-templates/?ref=14) built by our partners from ThemeSelection.
...
Check out top [Vue dashboard templates](https://adminmart.com/templates/vuejs-admin/?ref=34) built by our partners from [AdminMart](https://adminmart.com/?ref=34). Download them to speed up your web development process and build top class web applications.
...
Want to feature your themes here? [Contact us!](mailto:evan@vuejs.org?subject=Theme+affiliation)
