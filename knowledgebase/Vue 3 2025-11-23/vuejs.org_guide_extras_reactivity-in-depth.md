...
[Skip to content](https://vuejs.org/guide/extras/reactivity-in-depth#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/extras/reactivity-in-depth) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/extras/reactivity-in-depth) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/extras/reactivity-in-depth) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/extras/reactivity-in-depth) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/extras/reactivity-in-depth) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/extras/reactivity-in-depth) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/extras/reactivity-in-depth) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/extras/reactivity-in-depth) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/extras/reactivity-in-depth) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/extras/reactivity-in-depth) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/extras/reactivity-in-depth) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/extras/reactivity-in-depth) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/extras/reactivity-in-depth) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [What is Reactivity?](https://vuejs.org/guide/extras/reactivity-in-depth#what-is-reactivity)
- [How Reactivity Works in Vue](https://vuejs.org/guide/extras/reactivity-in-depth#how-reactivity-works-in-vue)
- [Runtime vs. Compile-time Reactivity](https://vuejs.org/guide/extras/reactivity-in-depth#runtime-vs-compile-time-reactivity)
- [Reactivity Debugging](https://vuejs.org/guide/extras/reactivity-in-depth#reactivity-debugging)
  - [Component Debugging Hooks](https://vuejs.org/guide/extras/reactivity-in-depth#component-debugging-hooks)
  - [Computed Debugging](https://vuejs.org/guide/extras/reactivity-in-depth#computed-debugging)
  - [Watcher Debugging](https://vuejs.org/guide/extras/reactivity-in-depth#watcher-debugging)
- [Integration with External State Systems](https://vuejs.org/guide/extras/reactivity-in-depth#integration-with-external-state-systems)
  - [Immutable Data](https://vuejs.org/guide/extras/reactivity-in-depth#immutable-data)
  - [State Machines](https://vuejs.org/guide/extras/reactivity-in-depth#state-machines)
  - [RxJS](https://vuejs.org/guide/extras/reactivity-in-depth#rxjs)
- [Connection to Signals](https://vuejs.org/guide/extras/reactivity-in-depth#connection-to-signals)
  - [API Design Trade-Offs](https://vuejs.org/guide/extras/reactivity-in-depth#api-design-trade-offs)
...
# Reactivity in Depth [​](https://vuejs.org/guide/extras/reactivity-in-depth\#reactivity-in-depth)
...
Both callbacks will receive debugger events in the [same format](https://vuejs.org/guide/extras/reactivity-in-depth#debugger-event) as component debug hooks:
...
#### Solid Signals [​](https://vuejs.org/guide/extras/reactivity-in-depth\#solid-signals)
...
#### Angular Signals [​](https://vuejs.org/guide/extras/reactivity-in-depth\#angular-signals)
...
[PreviousComposition API FAQ](https://vuejs.org/guide/extras/composition-api-faq) [Next Rendering Mechanism](https://vuejs.org/guide/extras/rendering-mechanism)
