...
[Skip to content](https://vuejs.org/guide/reusability/plugins.html#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/reusability/plugins) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/reusability/plugins) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/reusability/plugins) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/reusability/plugins) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/reusability/plugins) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/reusability/plugins) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/reusability/plugins) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/reusability/plugins) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/reusability/plugins) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/reusability/plugins) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/reusability/plugins) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/reusability/plugins) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/reusability/plugins) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Introduction](https://vuejs.org/guide/reusability/plugins.html#introduction)
...
### Provide / Inject with Plugins [​](https://vuejs.org/guide/reusability/plugins.html\#provide-inject-with-plugins)
...
### Bundle for NPM [​](https://vuejs.org/guide/reusability/plugins.html\#bundle-for-npm)
...
[PreviousCustom Directives](https://vuejs.org/guide/reusability/custom-directives) [Next Transition](https://vuejs.org/guide/built-ins/transition)
