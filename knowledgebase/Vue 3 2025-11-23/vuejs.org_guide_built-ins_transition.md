...
[Skip to content](https://vuejs.org/guide/built-ins/transition#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/built-ins/transition) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/built-ins/transition) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/built-ins/transition) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/built-ins/transition) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/built-ins/transition) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/built-ins/transition) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/built-ins/transition) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/built-ins/transition) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/built-ins/transition) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/built-ins/transition) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/built-ins/transition) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/built-ins/transition) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/built-ins/transition) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [The <Transition> Component](https://vuejs.org/guide/built-ins/transition#the-transition-component)
- [CSS-Based Transitions](https://vuejs.org/guide/built-ins/transition#css-based-transitions)
- [JavaScript Hooks](https://vuejs.org/guide/built-ins/transition#javascript-hooks)
- [Reusable Transitions](https://vuejs.org/guide/built-ins/transition#reusable-transitions)
- [Transition on Appear](https://vuejs.org/guide/built-ins/transition#transition-on-appear)
- [Transition Between Elements](https://vuejs.org/guide/built-ins/transition#transition-between-elements)
- [Transition Modes](https://vuejs.org/guide/built-ins/transition#transition-modes)
- [Transition Between Components](https://vuejs.org/guide/built-ins/transition#transition-between-components)
- [Dynamic Transitions](https://vuejs.org/guide/built-ins/transition#dynamic-transitions)
- [Transitions with the Key Attribute](https://vuejs.org/guide/built-ins/transition#transitions-with-the-key-attribute)
...
# Transition [​](https://vuejs.org/guide/built-ins/transition\#transition)
...
### Transition Classes [​](https://vuejs.org/guide/built-ins/transition\#transition-classes)
...
### Named Transitions [​](https://vuejs.org/guide/built-ins/transition\#named-transitions)
...
### CSS Transitions [​](https://vuejs.org/guide/built-ins/transition\#css-transitions)
...
### CSS Animations [​](https://vuejs.org/guide/built-ins/transition\#css-animations)
...
### Custom Transition Classes [​](https://vuejs.org/guide/built-ins/transition\#custom-transition-classes)
...
### Using Transitions and Animations Together [​](https://vuejs.org/guide/built-ins/transition\#using-transitions-and-animations-together)
...
### Nested Transitions and Explicit Transition Durations [​](https://vuejs.org/guide/built-ins/transition\#nested-transitions-and-explicit-transition-durations)
...
### Performance Considerations [​](https://vuejs.org/guide/built-ins/transition\#performance-considerations)
...
[PreviousPlugins](https://vuejs.org/guide/reusability/plugins) [Next TransitionGroup](https://vuejs.org/guide/built-ins/transition-group)
