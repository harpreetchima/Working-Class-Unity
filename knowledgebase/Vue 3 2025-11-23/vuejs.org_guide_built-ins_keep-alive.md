...
[Skip to content](https://vuejs.org/guide/built-ins/keep-alive#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/built-ins/keep-alive) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/built-ins/keep-alive) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/built-ins/keep-alive) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/built-ins/keep-alive) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/built-ins/keep-alive) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/built-ins/keep-alive) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/built-ins/keep-alive) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/built-ins/keep-alive) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/built-ins/keep-alive) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/built-ins/keep-alive) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/built-ins/keep-alive) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/built-ins/keep-alive) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/built-ins/keep-alive) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Basic Usage](https://vuejs.org/guide/built-ins/keep-alive#basic-usage)
- [Include / Exclude](https://vuejs.org/guide/built-ins/keep-alive#include-exclude)
- [Max Cached Instances](https://vuejs.org/guide/built-ins/keep-alive#max-cached-instances)
- [Lifecycle of Cached Instance](https://vuejs.org/guide/built-ins/keep-alive#lifecycle-of-cached-instance)
...
# KeepAlive [​](https://vuejs.org/guide/built-ins/keep-alive\#keepalive)
...
[PreviousTransitionGroup](https://vuejs.org/guide/built-ins/transition-group) [Next Teleport](https://vuejs.org/guide/built-ins/teleport)
