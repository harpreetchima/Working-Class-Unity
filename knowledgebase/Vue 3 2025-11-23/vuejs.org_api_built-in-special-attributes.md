...
[Skip to content](https://vuejs.org/api/built-in-special-attributes#VPContent)
...
[简体中文](https://cn.vuejs.org/api/built-in-special-attributes) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/api/built-in-special-attributes) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/api/built-in-special-attributes) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/api/built-in-special-attributes) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/api/built-in-special-attributes) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/api/built-in-special-attributes) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/api/built-in-special-attributes) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/api/built-in-special-attributes) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/api/built-in-special-attributes) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/api/built-in-special-attributes) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/api/built-in-special-attributes) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/api/built-in-special-attributes) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/api/built-in-special-attributes) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
# Built-in Special Attributes [​](https://vuejs.org/api/built-in-special-attributes\#built-in-special-attributes)
...
[PreviousSpecial Elements](https://vuejs.org/api/built-in-special-elements) [Next Syntax Specification](https://vuejs.org/api/sfc-spec)
