---
url: "https://vuejs.org/api/compile-time-flags.html"
...
[简体中文](https://cn.vuejs.org/api/compile-time-flags) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/api/compile-time-flags) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/api/compile-time-flags) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/api/compile-time-flags) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/api/compile-time-flags) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/api/compile-time-flags) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/api/compile-time-flags) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/api/compile-time-flags) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/api/compile-time-flags) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/api/compile-time-flags) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/api/compile-time-flags) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/api/compile-time-flags) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/api/compile-time-flags) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [\_\_VUE\_OPTIONS\_API\_\_](https://vuejs.org/api/compile-time-flags.html#VUE_OPTIONS_API)
- [\_\_VUE\_PROD\_DEVTOOLS\_\_](https://vuejs.org/api/compile-time-flags.html#VUE_PROD_DEVTOOLS)
- [\_\_VUE\_PROD\_HYDRATION\_MISMATCH\_DETAILS\_\_](https://vuejs.org/api/compile-time-flags.html#VUE_PROD_HYDRATION_MISMATCH_DETAILS)
...
[PreviousCustom Renderer](https://vuejs.org/api/custom-renderer)
