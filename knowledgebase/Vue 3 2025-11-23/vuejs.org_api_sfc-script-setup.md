...
[Skip to content](https://vuejs.org/api/sfc-script-setup#VPContent)
...
[简体中文](https://cn.vuejs.org/api/sfc-script-setup) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/api/sfc-script-setup) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/api/sfc-script-setup) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/api/sfc-script-setup) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/api/sfc-script-setup) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/api/sfc-script-setup) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/api/sfc-script-setup) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/api/sfc-script-setup) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/api/sfc-script-setup) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/api/sfc-script-setup) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/api/sfc-script-setup) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/api/sfc-script-setup) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/api/sfc-script-setup) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
# <script setup> [​](https://vuejs.org/api/sfc-script-setup\#script-setup)
...
### Top-level bindings are exposed to template [​](https://vuejs.org/api/sfc-script-setup\#top-level-bindings-are-exposed-to-template)
...
### Dynamic Components [​](https://vuejs.org/api/sfc-script-setup\#dynamic-components)
...
### Recursive Components [​](https://vuejs.org/api/sfc-script-setup\#recursive-components)
...
### Namespaced Components [​](https://vuejs.org/api/sfc-script-setup\#namespaced-components)
...
### Type-only props/emit declarations [​](https://vuejs.org/api/sfc-script-setup\#type-only-props-emit-declarations)
...
### Reactive Props Destructure [​](https://vuejs.org/api/sfc-script-setup\#reactive-props-destructure)
...
### Default props values when using type declaration [​](https://vuejs.org/api/sfc-script-setup\#default-props-values-when-using-type-declaration)
...
### Modifiers and Transformers [​](https://vuejs.org/api/sfc-script-setup\#modifiers-and-transformers)
...
### Usage with TypeScript [​](https://vuejs.org/api/sfc-script-setup\#usage-with-typescript)
...
[PreviousSyntax Specification](https://vuejs.org/api/sfc-spec) [Next CSS Features](https://vuejs.org/api/sfc-css-features)
