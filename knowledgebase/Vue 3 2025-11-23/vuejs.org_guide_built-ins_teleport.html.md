...
[Skip to content](https://vuejs.org/guide/built-ins/teleport.html#VPContent)
...
- [Basic Usage](https://vuejs.org/guide/built-ins/teleport.html#basic-usage)
- [Using with Components](https://vuejs.org/guide/built-ins/teleport.html#using-with-components)
- [Disabling Teleport](https://vuejs.org/guide/built-ins/teleport.html#disabling-teleport)
- [Multiple Teleports on the Same Target](https://vuejs.org/guide/built-ins/teleport.html#multiple-teleports-on-the-same-target)
