...
[Skip to content](https://vuejs.org/style-guide/rules-recommended#VPContent)
...
- [Component/instance options order](https://vuejs.org/style-guide/rules-recommended#component-instance-options-order)
- [Element attribute order](https://vuejs.org/style-guide/rules-recommended#element-attribute-order)
- [Empty lines in component/instance options](https://vuejs.org/style-guide/rules-recommended#empty-lines-in-component-instance-options)
- [Single-file component top-level element order](https://vuejs.org/style-guide/rules-recommended#single-file-component-top-level-element-order)
...
# Priority C Rules: Recommended [​](https://vuejs.org/style-guide/rules-recommended\#priority-c-rules-recommended)
