...
[Skip to content](https://vuejs.org/guide/typescript/options-api.html#VPContent)
...
- [Typing Component Props](https://vuejs.org/guide/typescript/options-api.html#typing-component-props)
- [Typing Component Emits](https://vuejs.org/guide/typescript/options-api.html#typing-component-emits)
- [Typing Computed Properties](https://vuejs.org/guide/typescript/options-api.html#typing-computed-properties)
- [Typing Event Handlers](https://vuejs.org/guide/typescript/options-api.html#typing-event-handlers)
- [Augmenting Global Properties](https://vuejs.org/guide/typescript/options-api.html#augmenting-global-properties)
- [Augmenting Custom Options](https://vuejs.org/guide/typescript/options-api.html#augmenting-custom-options)
- [Typing Global Custom Directives](https://vuejs.org/guide/typescript/options-api.html#typing-global-custom-directives)
...
# TypeScript with Options API [​](https://vuejs.org/guide/typescript/options-api.html\#typescript-with-options-api)
...
### Caveats [​](https://vuejs.org/guide/typescript/options-api.html\#caveats)
...
### Type Augmentation Placement [​](https://vuejs.org/guide/typescript/options-api.html\#type-augmentation-placement)
...
The placement of this augmentation is subject to the [same restrictions](https://vuejs.org/guide/typescript/options-api.html#type-augmentation-placement) as global property augmentations.
