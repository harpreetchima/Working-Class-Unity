---
url: "https://vuejs.org/about/community-guide.html"
title: "Community Guide | Vue.js"
---

[Skip to content](https://vuejs.org/about/community-guide.html#VPContent)
...
[简体中文](https://cn.vuejs.org/about/community-guide) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/about/community-guide) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/about/community-guide) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/about/community-guide) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/about/community-guide) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/about/community-guide) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/about/community-guide) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/about/community-guide) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/about/community-guide) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/about/community-guide) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/about/community-guide) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/about/community-guide) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/about/community-guide) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Resources](https://vuejs.org/about/community-guide.html#resources)
  - [Code of Conduct](https://vuejs.org/about/community-guide.html#code-of-conduct)
  - [Stay in the Know](https://vuejs.org/about/community-guide.html#stay-in-the-know)
  - [Get Support](https://vuejs.org/about/community-guide.html#get-support)
  - [Explore the Ecosystem](https://vuejs.org/about/community-guide.html#explore-the-ecosystem)
- [What You Can Do](https://vuejs.org/about/community-guide.html#what-you-can-do)
  - [Help Fellow Users](https://vuejs.org/about/community-guide.html#help-fellow-users)
  - [Help Triage Issues](https://vuejs.org/about/community-guide.html#help-triage-issues)
  - [Contribute Code](https://vuejs.org/about/community-guide.html#contribute-code)
  - [Share (and Build) Your Experience](https://vuejs.org/about/community-guide.html#share-and-build-your-experience)
  - [Translate Docs](https://vuejs.org/about/community-guide.html#translate-docs)
  - [Become a Community Leader](https://vuejs.org/about/community-guide.html#become-a-community-leader)
...
# Community Guide [​](https://vuejs.org/about/community-guide.html\#community-guide)
...
Our [Code of Conduct](https://vuejs.org/about/coc) is a guide to make it easier to enrich all of us and the technical communities in which we participate.

### Stay in the Know [​](https://vuejs.org/about/community-guide.html\#stay-in-the-know)

- Follow our [official Twitter account](https://x.com/vuejs).
- Follow our [team members](https://vuejs.org/about/team) on Twitter or GitHub.
...
See the [Translations guide](https://vuejs.org/translations/) for more details on how you can get involved.
