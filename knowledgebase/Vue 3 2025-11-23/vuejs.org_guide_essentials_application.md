...
[Skip to content](https://vuejs.org/guide/essentials/application#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/essentials/application) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/essentials/application) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/essentials/application) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/essentials/application) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/essentials/application) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/essentials/application) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/essentials/application) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/essentials/application) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/essentials/application) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/essentials/application) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/essentials/application) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/essentials/application) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/essentials/application) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [The Application Instance](https://vuejs.org/guide/essentials/application#the-application-instance)
- [The Root Component](https://vuejs.org/guide/essentials/application#the-root-component)
- [Mounting the App](https://vuejs.org/guide/essentials/application#mounting-the-app)
- [App Configurations](https://vuejs.org/guide/essentials/application#app-configurations)
- [Multiple Application Instances](https://vuejs.org/guide/essentials/application#multiple-application-instances)
...
# Creating a Vue Application [​](https://vuejs.org/guide/essentials/application\#creating-a-vue-application)
...
### In-DOM Root Component Template [​](https://vuejs.org/guide/essentials/application\#in-dom-root-component-template)
...
[PreviousQuick Start](https://vuejs.org/guide/quick-start) [Next Template Syntax](https://vuejs.org/guide/essentials/template-syntax)
