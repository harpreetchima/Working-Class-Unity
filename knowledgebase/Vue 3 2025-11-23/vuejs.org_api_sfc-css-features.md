...
[Skip to content](https://vuejs.org/api/sfc-css-features#VPContent)
...
[简体中文](https://cn.vuejs.org/api/sfc-css-features) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/api/sfc-css-features) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/api/sfc-css-features) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/api/sfc-css-features) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/api/sfc-css-features) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/api/sfc-css-features) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/api/sfc-css-features) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/api/sfc-css-features) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/api/sfc-css-features) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/api/sfc-css-features) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/api/sfc-css-features) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/api/sfc-css-features) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/api/sfc-css-features) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
# SFC CSS Features [​](https://vuejs.org/api/sfc-css-features\#sfc-css-features)
...
### Child Component Root Elements [​](https://vuejs.org/api/sfc-css-features\#child-component-root-elements)

With `scoped`, the parent component's styles will not leak into child components. However, a child component's root node will be affected by both the parent's scoped CSS and the child's scoped CSS. This is by design so that the parent can style the child root element for layout purposes.

### Deep Selectors [​](https://vuejs.org/api/sfc-css-features\#deep-selectors)
...
### Slotted Selectors [​](https://vuejs.org/api/sfc-css-features\#slotted-selectors)
...
### Global Selectors [​](https://vuejs.org/api/sfc-css-features\#global-selectors)
...
### Mixing Local and Global Styles [​](https://vuejs.org/api/sfc-css-features\#mixing-local-and-global-styles)
...
### Scoped Style Tips [​](https://vuejs.org/api/sfc-css-features\#scoped-style-tips)
...
### Custom Inject Name [​](https://vuejs.org/api/sfc-css-features\#custom-inject-name)
...
### Usage with Composition API [​](https://vuejs.org/api/sfc-css-features\#usage-with-composition-api)
...
[Previous<script setup>](https://vuejs.org/api/sfc-script-setup) [Next Custom Elements](https://vuejs.org/api/custom-elements)
