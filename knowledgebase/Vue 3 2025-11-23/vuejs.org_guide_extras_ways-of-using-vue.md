...
[Skip to content](https://vuejs.org/guide/extras/ways-of-using-vue#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/extras/ways-of-using-vue) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/extras/ways-of-using-vue) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/extras/ways-of-using-vue) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/extras/ways-of-using-vue) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/extras/ways-of-using-vue) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/extras/ways-of-using-vue) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/extras/ways-of-using-vue) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/extras/ways-of-using-vue) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/extras/ways-of-using-vue) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/extras/ways-of-using-vue) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/extras/ways-of-using-vue) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/extras/ways-of-using-vue) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/extras/ways-of-using-vue) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Standalone Script](https://vuejs.org/guide/extras/ways-of-using-vue#standalone-script)
- [Embedded Web Components](https://vuejs.org/guide/extras/ways-of-using-vue#embedded-web-components)
- [Single-Page Application (SPA)](https://vuejs.org/guide/extras/ways-of-using-vue#single-page-application-spa)
- [Fullstack / SSR](https://vuejs.org/guide/extras/ways-of-using-vue#fullstack-ssr)
- [JAMStack / SSG](https://vuejs.org/guide/extras/ways-of-using-vue#jamstack-ssg)
- [Beyond the Web](https://vuejs.org/guide/extras/ways-of-using-vue#beyond-the-web)
...
# Ways of Using Vue [​](https://vuejs.org/guide/extras/ways-of-using-vue\#ways-of-using-vue)
...
[PreviousTS with Options API](https://vuejs.org/guide/typescript/options-api) [Next Composition API FAQ](https://vuejs.org/guide/extras/composition-api-faq)
