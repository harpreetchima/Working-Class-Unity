...
[Skip to content](https://vuejs.org/guide/scaling-up/routing#VPContent)
...
- [Client-Side vs. Server-Side Routing](https://vuejs.org/guide/scaling-up/routing#client-side-vs-server-side-routing)
- [Official Router](https://vuejs.org/guide/scaling-up/routing#official-router)
- [Simple Routing from Scratch](https://vuejs.org/guide/scaling-up/routing#simple-routing-from-scratch)
...
# Routing [​](https://vuejs.org/guide/scaling-up/routing\#routing)
