...
[Skip to content](https://vuejs.org/about/privacy.html#VPContent)
...
[简体中文](https://cn.vuejs.org/about/privacy) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/about/privacy) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/about/privacy) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/about/privacy) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/about/privacy) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/about/privacy) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/about/privacy) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/about/privacy) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/about/privacy) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/about/privacy) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/about/privacy) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/about/privacy) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/about/privacy) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [What Kinds of Information Do We Collect?](https://vuejs.org/about/privacy.html#what-kinds-of-information-do-we-collect)
- [How Do We Use Information?](https://vuejs.org/about/privacy.html#how-do-we-use-information)
- [Data Retention](https://vuejs.org/about/privacy.html#data-retention)
- [Questions](https://vuejs.org/about/privacy.html#questions)
...
# Vue.js Privacy Policy [​](https://vuejs.org/about/privacy.html\#vue.js-privacy-policy)

> Effective Date: May 3, 2024

This Privacy Policy describes the Vue.js organization ("Vue", "we", "us" or "our") practices for handling your information in connection with this website ( [https://vuejs.org](https://vuejs.org/)) and our open source-related websites ("Websites") and any content, related documentation, information and services (e.g. tutorials, tools to support the developer workflow, access to resources, etc.) made available to you on this website (collectively, the "Services"). This Privacy Policy describes the personal information we process to support our Services.

For clarity, this Privacy Policy does not apply to any:

1. Use of open source code, documentation or specifications made available on GitHub ( [https://github.com/](https://github.com/)), which are governed by the terms of the applicable open source license;
...
3. Usage statistics of our published packages on NPM ( [https://npmjs.com/](https://npmjs.com/)), which are governed by NPM's terms and conditions; or
