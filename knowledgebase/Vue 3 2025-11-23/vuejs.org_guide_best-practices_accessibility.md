...
[Skip to content](https://vuejs.org/guide/best-practices/accessibility#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/best-practices/accessibility) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/best-practices/accessibility) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/best-practices/accessibility) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/best-practices/accessibility) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/best-practices/accessibility) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/best-practices/accessibility) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/best-practices/accessibility) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/best-practices/accessibility) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/best-practices/accessibility) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/best-practices/accessibility) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/best-practices/accessibility) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/best-practices/accessibility) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/best-practices/accessibility) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Skip link](https://vuejs.org/guide/best-practices/accessibility#skip-link)
- [Content Structure](https://vuejs.org/guide/best-practices/accessibility#content-structure)
- [Semantic Forms](https://vuejs.org/guide/best-practices/accessibility#semantic-forms)
- [Standards](https://vuejs.org/guide/best-practices/accessibility#standards)
- [Resources](https://vuejs.org/guide/best-practices/accessibility#resources)
...
# Accessibility [​](https://vuejs.org/guide/best-practices/accessibility\#accessibility)
...
### Headings [​](https://vuejs.org/guide/best-practices/accessibility\#headings)
...
### Landmarks [​](https://vuejs.org/guide/best-practices/accessibility\#landmarks)
...
### Labels [​](https://vuejs.org/guide/best-practices/accessibility\#labels)
...
#### `aria-label` [​](https://vuejs.org/guide/best-practices/accessibility\#aria-label)
...
#### `aria-labelledby` [​](https://vuejs.org/guide/best-practices/accessibility\#aria-labelledby)
...
#### `aria-describedby` [​](https://vuejs.org/guide/best-practices/accessibility\#aria-describedby)
...
### Placeholder [​](https://vuejs.org/guide/best-practices/accessibility\#placeholder)
...
### Instructions [​](https://vuejs.org/guide/best-practices/accessibility\#instructions)
...
### Hiding Content [​](https://vuejs.org/guide/best-practices/accessibility\#hiding-content)
...
#### `aria-hidden="true"` [​](https://vuejs.org/guide/best-practices/accessibility\#aria-hidden-true)
...
### Buttons [​](https://vuejs.org/guide/best-practices/accessibility\#buttons)
...
### Functional Images [​](https://vuejs.org/guide/best-practices/accessibility\#functional-images)
...
### Web Content Accessibility Guidelines (WCAG) [​](https://vuejs.org/guide/best-practices/accessibility\#web-content-accessibility-guidelines-wcag)
...
#### WCAG 2.1 Four Main Guiding Principles (abbreviated as POUR): [​](https://vuejs.org/guide/best-practices/accessibility\#wcag-2-1-four-main-guiding-principles-abbreviated-as-pour)
...
#### Web Accessibility Initiative – Accessible Rich Internet Applications (WAI-ARIA) [​](https://vuejs.org/guide/best-practices/accessibility\#web-accessibility-initiative-%E2%80%93-accessible-rich-internet-applications-wai-aria)
...
### Documentation [​](https://vuejs.org/guide/best-practices/accessibility\#documentation)
...
### Assistive Technologies [​](https://vuejs.org/guide/best-practices/accessibility\#assistive-technologies)
...
### Testing [​](https://vuejs.org/guide/best-practices/accessibility\#testing)
...
### Users [​](https://vuejs.org/guide/best-practices/accessibility\#users)
...
[PreviousPerformance](https://vuejs.org/guide/best-practices/performance) [Next Security](https://vuejs.org/guide/best-practices/security)
