---
url: "https://vuejs.org/style-guide/rules-essential.html"
...
[简体中文](https://cn.vuejs.org/style-guide/rules-essential) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/style-guide/rules-essential) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/style-guide/rules-essential) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/style-guide/rules-essential) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/style-guide/rules-essential) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/style-guide/rules-essential) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/style-guide/rules-essential) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/style-guide/rules-essential) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/style-guide/rules-essential) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/style-guide/rules-essential) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/style-guide/rules-essential) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/style-guide/rules-essential) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/style-guide/rules-essential) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
This is only relevant for [Single-File Components](https://vuejs.org/guide/scaling-up/sfc). It does _not_ require that the [`scoped` attribute](https://vue-loader.vuejs.org/guide/scoped-css.html) be used. Scoping could be through [CSS modules](https://vue-loader.vuejs.org/guide/css-modules.html), a class-based strategy such as [BEM](http://getbem.com/), or another library/convention.
...
[Edit this page on GitHub](https://github.com/vuejs/docs/edit/main/src/style-guide/rules-essential.md)

[PreviousOverview](https://vuejs.org/style-guide/) [Next B - Strongly Recommended](https://vuejs.org/style-guide/rules-strongly-recommended)
