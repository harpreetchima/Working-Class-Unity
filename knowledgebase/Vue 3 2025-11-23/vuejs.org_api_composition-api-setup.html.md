...
[Skip to content](https://vuejs.org/api/composition-api-setup.html#VPContent)
...
# Composition API: setup() [​](https://vuejs.org/api/composition-api-setup.html\#composition-api-setup)
...
### Exposing Public Properties [​](https://vuejs.org/api/composition-api-setup.html\#exposing-public-properties)
