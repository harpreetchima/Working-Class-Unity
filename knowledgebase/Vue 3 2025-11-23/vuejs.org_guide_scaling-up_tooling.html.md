...
[Skip to content](https://vuejs.org/guide/scaling-up/tooling.html#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/scaling-up/tooling) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/scaling-up/tooling) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/scaling-up/tooling) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/scaling-up/tooling) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/scaling-up/tooling) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/scaling-up/tooling) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/scaling-up/tooling) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/scaling-up/tooling) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/scaling-up/tooling) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/scaling-up/tooling) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/scaling-up/tooling) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/scaling-up/tooling) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/scaling-up/tooling) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Try It Online](https://vuejs.org/guide/scaling-up/tooling.html#try-it-online)
...
- [TypeScript](https://vuejs.org/guide/scaling-up/tooling.html#typescript)
- [Testing](https://vuejs.org/guide/scaling-up/tooling.html#testing)
- [Linting](https://vuejs.org/guide/scaling-up/tooling.html#linting)
- [Formatting](https://vuejs.org/guide/scaling-up/tooling.html#formatting)
- [SFC Custom Block Integrations](https://vuejs.org/guide/scaling-up/tooling.html#sfc-custom-block-integrations)
- [Lower-Level Packages](https://vuejs.org/guide/scaling-up/tooling.html#lower-level-packages)
- [Other Online Playgrounds](https://vuejs.org/guide/scaling-up/tooling.html#other-online-playgrounds)
...
# Tooling [​](https://vuejs.org/guide/scaling-up/tooling.html\#tooling)
...
### Vue CLI [​](https://vuejs.org/guide/scaling-up/tooling.html\#vue-cli)
...
### Note on In-Browser Template Compilation [​](https://vuejs.org/guide/scaling-up/tooling.html\#note-on-in-browser-template-compilation)
...
### `@vue/compiler-sfc` [​](https://vuejs.org/guide/scaling-up/tooling.html\#vue-compiler-sfc)
...
### `@vitejs/plugin-vue` [​](https://vuejs.org/guide/scaling-up/tooling.html\#vitejs-plugin-vue)

- [Docs](https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue)

Official plugin that provides Vue SFC support in Vite.

### `vue-loader` [​](https://vuejs.org/guide/scaling-up/tooling.html\#vue-loader)
...
[PreviousSingle-File Components](https://vuejs.org/guide/scaling-up/sfc) [Next Routing](https://vuejs.org/guide/scaling-up/routing)
