...
[Skip to content](https://vuejs.org/guide/scaling-up/state-management#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/scaling-up/state-management) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/scaling-up/state-management) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/scaling-up/state-management) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/scaling-up/state-management) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/scaling-up/state-management) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/scaling-up/state-management) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/scaling-up/state-management) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/scaling-up/state-management) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/scaling-up/state-management) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/scaling-up/state-management) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/scaling-up/state-management) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/scaling-up/state-management) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/scaling-up/state-management) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [What is State Management?](https://vuejs.org/guide/scaling-up/state-management#what-is-state-management)
- [Simple State Management with Reactivity API](https://vuejs.org/guide/scaling-up/state-management#simple-state-management-with-reactivity-api)
- [SSR Considerations](https://vuejs.org/guide/scaling-up/state-management#ssr-considerations)
- [Pinia](https://vuejs.org/guide/scaling-up/state-management#pinia)
...
# State Management [​](https://vuejs.org/guide/scaling-up/state-management\#state-management)
...
[PreviousRouting](https://vuejs.org/guide/scaling-up/routing) [Next Testing](https://vuejs.org/guide/scaling-up/testing)
