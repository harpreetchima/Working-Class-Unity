...
[Skip to content](https://vuejs.org/guide/quick-start#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/quick-start) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/quick-start) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/quick-start) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/quick-start) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/quick-start) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/quick-start) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/quick-start) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/quick-start) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/quick-start) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/quick-start) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/quick-start) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/quick-start) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/quick-start) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Try Vue Online](https://vuejs.org/guide/quick-start#try-vue-online)
- [Creating a Vue Application](https://vuejs.org/guide/quick-start#creating-a-vue-application)
- [Using Vue from CDN](https://vuejs.org/guide/quick-start#using-vue-from-cdn)
- [Next Steps](https://vuejs.org/guide/quick-start#next-steps)
...
# Quick Start [​](https://vuejs.org/guide/quick-start\#quick-start)
...
### Using the Global Build [​](https://vuejs.org/guide/quick-start\#using-the-global-build)
...
### Using the ES Module Build [​](https://vuejs.org/guide/quick-start\#using-the-es-module-build)
...
### Enabling Import maps [​](https://vuejs.org/guide/quick-start\#enabling-import-maps)
...
### Splitting Up the Modules [​](https://vuejs.org/guide/quick-start\#splitting-up-the-modules)
...
\\
The guide walks you through every aspect of the framework in full detail.](https://vuejs.org/guide/essentials/application) [Try the Tutorial\\
\\
For those who prefer learning things hands-on.](https://vuejs.org/tutorial/) [Check out the Examples\\
\\
