...
[Skip to content](https://vuejs.org/style-guide/rules-use-with-caution#VPContent)
...
- [Element selectors with scoped](https://vuejs.org/style-guide/rules-use-with-caution#element-selectors-with-scoped)
- [Implicit parent-child communication](https://vuejs.org/style-guide/rules-use-with-caution#implicit-parent-child-communication)
...
# Priority D Rules: Use with Caution [​](https://vuejs.org/style-guide/rules-use-with-caution\#priority-d-rules-use-with-caution)
