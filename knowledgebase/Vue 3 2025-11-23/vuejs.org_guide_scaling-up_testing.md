...
[Skip to content](https://vuejs.org/guide/scaling-up/testing#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/scaling-up/testing) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/scaling-up/testing) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/scaling-up/testing) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/scaling-up/testing) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/scaling-up/testing) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/scaling-up/testing) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/scaling-up/testing) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/scaling-up/testing) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/scaling-up/testing) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/scaling-up/testing) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/scaling-up/testing) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/scaling-up/testing) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/scaling-up/testing) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Why Test?](https://vuejs.org/guide/scaling-up/testing#why-test)
- [When to Test](https://vuejs.org/guide/scaling-up/testing#when-to-test)
- [Testing Types](https://vuejs.org/guide/scaling-up/testing#testing-types)
- [Overview](https://vuejs.org/guide/scaling-up/testing#overview)
- [Unit Testing](https://vuejs.org/guide/scaling-up/testing#unit-testing)
- [Component Testing](https://vuejs.org/guide/scaling-up/testing#component-testing)
- [E2E Testing](https://vuejs.org/guide/scaling-up/testing#e2e-testing)
- [Recipes](https://vuejs.org/guide/scaling-up/testing#recipes)
...
# Testing [​](https://vuejs.org/guide/scaling-up/testing\#testing)
...
There is one Vue-specific section covering composables. See [Testing Composables](https://vuejs.org/guide/scaling-up/testing#testing-composables) below for more details.
...
### Composables [​](https://vuejs.org/guide/scaling-up/testing\#composables)

One category of functions specific to Vue applications is [Composables](https://vuejs.org/guide/reusability/composables), which may require special handling during tests. See [Testing Composables](https://vuejs.org/guide/scaling-up/testing#testing-composables) below for more details.

### Unit Testing Components [​](https://vuejs.org/guide/scaling-up/testing\#unit-testing-components)
...
Tests that are "Blackbox tests" are unaware of the implementation details of a component. These tests mock as little as possible to test the integration of your component and the entire system. They usually render all child components and are considered more of an "integration test". See the [Component Testing recommendations](https://vuejs.org/guide/scaling-up/testing#component-testing) below.


### Recommendation [​](https://vuejs.org/guide/scaling-up/testing\#recommendation)
...
### Other Options [​](https://vuejs.org/guide/scaling-up/testing\#other-options)
...
### Recommendation [​](https://vuejs.org/guide/scaling-up/testing\#recommendation-1)
...
### Mounting Libraries [​](https://vuejs.org/guide/scaling-up/testing\#mounting-libraries)
...
### Other Options [​](https://vuejs.org/guide/scaling-up/testing\#other-options-1)
...
### Choosing an E2E Testing Solution [​](https://vuejs.org/guide/scaling-up/testing\#choosing-an-e2e-testing-solution)
...
#### Cross-browser testing [​](https://vuejs.org/guide/scaling-up/testing\#cross-browser-testing)
...
#### Faster feedback loops [​](https://vuejs.org/guide/scaling-up/testing\#faster-feedback-loops)
...
#### First-class debugging experience [​](https://vuejs.org/guide/scaling-up/testing\#first-class-debugging-experience)
...
#### Visibility in headless mode [​](https://vuejs.org/guide/scaling-up/testing\#visibility-in-headless-mode)
...
### Recommendation [​](https://vuejs.org/guide/scaling-up/testing\#recommendation-2)
...
### Other Options [​](https://vuejs.org/guide/scaling-up/testing\#other-options-2)
...
### Adding Vitest to a Project [​](https://vuejs.org/guide/scaling-up/testing\#adding-vitest-to-a-project)
...
### Testing Composables [​](https://vuejs.org/guide/scaling-up/testing\#testing-composables)
...
For more complex composables, it could also be easier to test it by writing tests against the wrapper component using [Component Testing](https://vuejs.org/guide/scaling-up/testing#component-testing) techniques.

[Edit this page on GitHub](https://github.com/vuejs/docs/edit/main/src/guide/scaling-up/testing.md)

[PreviousState Management](https://vuejs.org/guide/scaling-up/state-management) [Next Server-Side Rendering (SSR)](https://vuejs.org/guide/scaling-up/ssr)
