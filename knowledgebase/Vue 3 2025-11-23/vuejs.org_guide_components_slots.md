...
[Skip to content](https://vuejs.org/guide/components/slots#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/components/slots) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/components/slots) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/components/slots) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/components/slots) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/components/slots) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/components/slots) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/components/slots) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/components/slots) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/components/slots) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/components/slots) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/components/slots) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/components/slots) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/components/slots) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [Slot Content and Outlet](https://vuejs.org/guide/components/slots#slot-content-and-outlet)
- [Render Scope](https://vuejs.org/guide/components/slots#render-scope)
- [Fallback Content](https://vuejs.org/guide/components/slots#fallback-content)
- [Named Slots](https://vuejs.org/guide/components/slots#named-slots)
- [Conditional Slots](https://vuejs.org/guide/components/slots#conditional-slots)
- [Dynamic Slot Names](https://vuejs.org/guide/components/slots#dynamic-slot-names)
- [Scoped Slots](https://vuejs.org/guide/components/slots#scoped-slots)
...
# Slots [​](https://vuejs.org/guide/components/slots\#slots)
...
As discussed in [Render Scope](https://vuejs.org/guide/components/slots#render-scope), slot content does not have access to state in the child component.
...
### Named Scoped Slots [​](https://vuejs.org/guide/components/slots\#named-scoped-slots)
...
### Fancy List Example [​](https://vuejs.org/guide/components/slots\#fancy-list-example)
...
[PreviousFallthrough Attributes](https://vuejs.org/guide/components/attrs) [Next Provide / inject](https://vuejs.org/guide/components/provide-inject)
