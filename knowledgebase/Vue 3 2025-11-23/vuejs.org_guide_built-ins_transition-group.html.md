...
[Skip to content](https://vuejs.org/guide/built-ins/transition-group.html#VPContent)
...
- [Enter / Leave Transitions](https://vuejs.org/guide/built-ins/transition-group.html#enter-leave-transitions)
- [Move Transitions](https://vuejs.org/guide/built-ins/transition-group.html#move-transitions)
- [Staggering List Transitions](https://vuejs.org/guide/built-ins/transition-group.html#staggering-list-transitions)
...
### Custom TransitionGroup classes [​](https://vuejs.org/guide/built-ins/transition-group.html\#custom-transitiongroup-classes)
