...
[Skip to content](https://vuejs.org/guide/introduction#VPContent)
...
[简体中文](https://cn.vuejs.org/guide/introduction) [简体中文 Repository](https://github.com/vuejs-translations/docs-zh-cn "简体中文 Repository")

[日本語](https://ja.vuejs.org/guide/introduction) [日本語 Repository](https://github.com/vuejs-translations/docs-ja "日本語 Repository")

[Українська](https://ua.vuejs.org/guide/introduction) [Українська Repository](https://github.com/vuejs-translations/docs-uk "Українська Repository")

[Français](https://fr.vuejs.org/guide/introduction) [Français Repository](https://github.com/vuejs-translations/docs-fr "Français Repository")

[한국어](https://ko.vuejs.org/guide/introduction) [한국어 Repository](https://github.com/vuejs-translations/docs-ko "한국어 Repository")

[Português](https://pt.vuejs.org/guide/introduction) [Português Repository](https://github.com/vuejs-translations/docs-pt "Português Repository")

[বাংলা](https://bn.vuejs.org/guide/introduction) [বাংলা Repository](https://github.com/vuejs-translations/docs-bn "বাংলা Repository")

[Italiano](https://it.vuejs.org/guide/introduction) [Italiano Repository](https://github.com/vuejs-translations/docs-it "Italiano Repository")

[فارسی](https://fa.vuejs.org/guide/introduction) [فارسی Repository](https://github.com/vuejs-translations/docs-fa "فارسی Repository")

[Русский](https://ru.vuejs.org/guide/introduction) [Русский Repository](https://github.com/vuejs-translations/docs-ru "Русский Repository")

[Čeština](https://cs.vuejs.org/guide/introduction) [Čeština Repository](https://github.com/vuejs-translations/docs-cs "Čeština Repository")

[繁體中文](https://zh-hk.vuejs.org/guide/introduction) [繁體中文 Repository](https://github.com/vuejs-translations/docs-zh-hk "繁體中文 Repository")

[Polski](https://pl.vuejs.org/guide/introduction) [Polski Repository](https://github.com/vuejs-translations/docs-pl "Polski Repository")
...
- [What is Vue?](https://vuejs.org/guide/introduction#what-is-vue)
- [The Progressive Framework](https://vuejs.org/guide/introduction#the-progressive-framework)
- [Single-File Components](https://vuejs.org/guide/introduction#single-file-components)
- [API Styles](https://vuejs.org/guide/introduction#api-styles)
- [Still Got Questions?](https://vuejs.org/guide/introduction#still-got-questions)
- [Pick Your Learning Path](https://vuejs.org/guide/introduction#pick-your-learning-path)
...
# Introduction [​](https://vuejs.org/guide/introduction\#introduction)
...
### Options API [​](https://vuejs.org/guide/introduction\#options-api)
...
### Composition API [​](https://vuejs.org/guide/introduction\#composition-api)
...
### Which to Choose? [​](https://vuejs.org/guide/introduction\#which-to-choose)
