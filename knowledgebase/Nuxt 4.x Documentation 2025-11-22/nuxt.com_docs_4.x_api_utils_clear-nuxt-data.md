---
url: "https://nuxt.com/docs/4.x/api/utils/clear-nuxt-data"
...
## [Type](https://nuxt.com/docs/4.x/api/utils/clear-nuxt-data\#type)
...
## [Parameters](https://nuxt.com/docs/4.x/api/utils/clear-nuxt-data\#parameters)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/clear-nuxt-data.md)

[clearError\\
\\
The clearError composable clears all handled errors.](https://nuxt.com/docs/4.x/api/utils/clear-error) [clearNuxtState\\
\\
Delete the cached state of useState.](https://nuxt.com/docs/4.x/api/utils/clear-nuxt-state)
