---
url: "https://nuxt.com/docs/4.x/guide/best-practices/performance"
...
## [Built-in Features](https://nuxt.com/docs/4.x/guide/best-practices/performance\#built-in-features)
...
### [Links](https://nuxt.com/docs/4.x/guide/best-practices/performance\#links)
...
[NuxtLink](https://nuxt.com/docs/4.x/api/components/nuxt-link) Read more in NuxtLink.

### [Hybrid Rendering](https://nuxt.com/docs/4.x/guide/best-practices/performance\#hybrid-rendering)
...
[Hybrid rendering](https://nuxt.com/docs/4.x/guide/concepts/rendering#hybrid-rendering) Read more in Hybrid rendering.

### [Lazy Loading Components](https://nuxt.com/docs/4.x/guide/best-practices/performance\#lazy-loading-components)
...
[Lazy loading components](https://nuxt.com/docs/4.x/directory-structure/app/components#dynamic-imports) Read more in Lazy loading components.

### [Lazy Hydration](https://nuxt.com/docs/4.x/guide/best-practices/performance\#lazy-hydration)
...
[Lazy hydration](https://nuxt.com/docs/4.x/directory-structure/app/components#delayed-or-lazy-hydration) Read more in Lazy hydration.

### [Fetching data](https://nuxt.com/docs/4.x/guide/best-practices/performance\#fetching-data)
...
[Data fetching](https://nuxt.com/docs/4.x/getting-started/data-fetching) Read more in Data fetching.

## [Core Nuxt Modules](https://nuxt.com/docs/4.x/guide/best-practices/performance\#core-nuxt-modules)
...
### [Images](https://nuxt.com/docs/4.x/guide/best-practices/performance\#images)
...
[Nuxt Image](https://image.nuxt.com/usage/nuxt-img) Read more in Nuxt Image.

### [Fonts](https://nuxt.com/docs/4.x/guide/best-practices/performance\#fonts)
...
### [Scripts](https://nuxt.com/docs/4.x/guide/best-practices/performance\#scripts)
...
[Nuxt Scripts](https://scripts.nuxt.com/scripts) Read more in Nuxt Scripts.

## [Profiling Tools](https://nuxt.com/docs/4.x/guide/best-practices/performance\#profiling-tools)
...
### [Nuxi Analyze](https://nuxt.com/docs/4.x/guide/best-practices/performance\#nuxi-analyze)
...
### [Nuxt DevTools](https://nuxt.com/docs/4.x/guide/best-practices/performance\#nuxt-devtools)
...
### [Chrome DevTools](https://nuxt.com/docs/4.x/guide/best-practices/performance\#chrome-devtools)
...
### [PageSpeed Insights](https://nuxt.com/docs/4.x/guide/best-practices/performance\#pagespeed-insights)
...
### [Web Page Test](https://nuxt.com/docs/4.x/guide/best-practices/performance\#web-page-test)
...
## [Common problems](https://nuxt.com/docs/4.x/guide/best-practices/performance\#common-problems)
...
### [Overusing plugins](https://nuxt.com/docs/4.x/guide/best-practices/performance\#overusing-plugins)
...
### [Unused code / dependencies](https://nuxt.com/docs/4.x/guide/best-practices/performance\#unused-code-dependencies)
...
### [Not using Vue Performance tips](https://nuxt.com/docs/4.x/guide/best-practices/performance\#not-using-vue-performance-tips)
...
### [Not following patterns](https://nuxt.com/docs/4.x/guide/best-practices/performance\#not-following-patterns)
...
### [Trying to load everything at the same time](https://nuxt.com/docs/4.x/guide/best-practices/performance\#trying-to-load-everything-at-the-same-time)
...
## [Useful Resources](https://nuxt.com/docs/4.x/guide/best-practices/performance\#useful-resources)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/3.guide/2.best-practices/performance.md)

[Nuxt and hydration\\
\\
Why fixing hydration issues is important](https://nuxt.com/docs/4.x/guide/best-practices/hydration) [Nuxt Plugins\\
\\
Best practices when using Nuxt plugins.](https://nuxt.com/docs/4.x/guide/best-practices/plugins)
