---
url: "https://nuxt.com/docs/4.x/api/commands/add"
...
3. [Commands](https://nuxt.com/docs/4.x/api/commands)

# nuxt add

[Source](https://github.com/nuxt/cli/blob/main/packages/nuxi/src/commands/add.ts)
...
### [Arguments](https://nuxt.com/docs/4.x/api/commands/add\#arguments)
...
### [Options](https://nuxt.com/docs/4.x/api/commands/add\#options)
...
## [`nuxt add component`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-component)
...
## [`nuxt add composable`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-composable)
...
## [`nuxt add layout`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-layout)
...
## [`nuxt add plugin`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-plugin)
...
## [`nuxt add page`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-page)
...
## [`nuxt add middleware`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-middleware)
...
## [`nuxt add api`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-api)
...
## [`nuxt add layer`](https://nuxt.com/docs/4.x/api/commands/add\#nuxt-add-layer)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/4.commands/add.md)

[updateAppConfig\\
\\
Update the App Config at runtime.](https://nuxt.com/docs/4.x/api/utils/update-app-config) [nuxt analyze\\
\\
Analyze the production bundle or your Nuxt application.](https://nuxt.com/docs/4.x/api/commands/analyze)
