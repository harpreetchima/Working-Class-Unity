...
[Nuxt server engine](https://nuxt.com/docs/4.x/guide/concepts/server-engine) Read more in Nuxt server engine.

### [Production-ready](https://nuxt.com/docs/4.x/getting-started/introduction\#production-ready)

A Nuxt application can be deployed on a Node or Deno server, pre-rendered to be hosted in static environments, or deployed to serverless and edge providers.

[Deployment section](https://nuxt.com/docs/4.x/getting-started/deployment) Read more in Deployment section.
...
[Nuxt Modules Concept](https://nuxt.com/docs/4.x/guide/concepts/modules) Read more in Nuxt Modules Concept.
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/1.getting-started/01.introduction.md)
