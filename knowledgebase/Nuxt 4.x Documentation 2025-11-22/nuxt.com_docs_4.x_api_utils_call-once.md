---
url: "https://nuxt.com/docs/4.x/api/utils/call-once"
...
## [Purpose](https://nuxt.com/docs/4.x/api/utils/call-once\#purpose)
...
## [Usage](https://nuxt.com/docs/4.x/api/utils/call-once\#usage)
...
[Docs > 4 X > Getting Started > State Management](https://nuxt.com/docs/4.x/getting-started/state-management) Read more in Docs > 4 X > Getting Started > State Management.
...
## [Type](https://nuxt.com/docs/4.x/api/utils/call-once\#type)
...
## [Parameters](https://nuxt.com/docs/4.x/api/utils/call-once\#parameters)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/call-once.md)

[addRouteMiddleware\\
\\
addRouteMiddleware() is a helper function to dynamically add middleware in your application.](https://nuxt.com/docs/4.x/api/utils/add-route-middleware) [clearError\\
\\
The clearError composable clears all handled errors.](https://nuxt.com/docs/4.x/api/utils/clear-error)
