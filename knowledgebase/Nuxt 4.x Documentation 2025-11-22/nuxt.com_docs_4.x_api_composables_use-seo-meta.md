---
url: "https://nuxt.com/docs/4.x/api/composables/use-seo-meta"
...
## [Usage](https://nuxt.com/docs/4.x/api/composables/use-seo-meta\#usage)
...
## [Parameters](https://nuxt.com/docs/4.x/api/composables/use-seo-meta\#parameters)
...
## [Performance](https://nuxt.com/docs/4.x/api/composables/use-seo-meta\#performance)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-seo-meta.md)

[useRuntimeHook\\
\\
Registers a runtime hook in a Nuxt application and ensures it is properly disposed of when the scope is destroyed.](https://nuxt.com/docs/4.x/api/composables/use-runtime-hook) [useServerSeoMeta\\
\\
The useServerSeoMeta composable lets you define your site's SEO meta tags as a flat object with full TypeScript support.](https://nuxt.com/docs/4.x/api/composables/use-server-seo-meta)
