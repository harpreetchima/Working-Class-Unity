---
url: "https://nuxt.com/docs/4.x/api/components/nuxt-loading-indicator"
...
## [Usage](https://nuxt.com/docs/4.x/api/components/nuxt-loading-indicator\#usage)
...
## [Slots](https://nuxt.com/docs/4.x/api/components/nuxt-loading-indicator\#slots)

You can pass custom HTML or components through the loading indicator's default slot.

## [Props](https://nuxt.com/docs/4.x/api/components/nuxt-loading-indicator\#props)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/1.components/5.nuxt-loading-indicator.md)

[<NuxtLink>\\
\\
Nuxt provides <NuxtLink> component to handle any kind of links within your application.](https://nuxt.com/docs/4.x/api/components/nuxt-link) [<NuxtErrorBoundary>\\
\\
The <NuxtErrorBoundary> component handles client-side errors happening in its default slot.](https://nuxt.com/docs/4.x/api/components/nuxt-error-boundary)
