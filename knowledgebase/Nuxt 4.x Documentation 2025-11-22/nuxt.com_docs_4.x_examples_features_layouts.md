---
url: "https://nuxt.com/docs/4.x/examples/features/layouts"
title: "Layouts · Nuxt Examples v4"
---
...
[Docs > Getting Started > Views#layouts](https://nuxt.com/docs/getting-started/views#layouts) Read more in Docs > Getting Started > Views#layouts.

[Docs > Guide > Directory Structure > Layouts](https://nuxt.com/docs/guide/directory-structure/layouts) Read more in Docs > Guide > Directory Structure > Layouts.

Examples Layouts Example - StackBlitz
...
### Examples Layouts Example

Run official live example code for Examples Layouts, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/1.features/5.layouts.md)

[Meta Tags\\
\\
This example shows how to use the Nuxt helpers and composables for SEO and meta management.](https://nuxt.com/docs/4.x/examples/features/meta-tags) [Middleware\\
\\
This example shows how to add route middleware with the middleware/ directory or with a plugin, and how to use them globally or per page.](https://nuxt.com/docs/4.x/examples/routing/middleware)
