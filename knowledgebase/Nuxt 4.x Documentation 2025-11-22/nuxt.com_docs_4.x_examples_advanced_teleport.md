---
url: "https://nuxt.com/docs/4.x/examples/advanced/teleport"
title: "Teleport · Nuxt Examples v4"
---
...
[Docs > API > Components > Teleports](https://nuxt.com/docs/api/components/teleports) Read more in Docs > API > Components > Teleports.

Examples Teleport Example - StackBlitz
...
### Examples Teleport Example

Run official live example code for Examples Teleport, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/4.advanced/teleport.md)

[Module Extend Pages\\
\\
This example defines a new \`test\` page using \`extendPages\` within a module.](https://nuxt.com/docs/4.x/examples/advanced/module-extend-pages) [Testing\\
\\
This example shows how to test your Nuxt application.](https://nuxt.com/docs/4.x/examples/advanced/testing)
