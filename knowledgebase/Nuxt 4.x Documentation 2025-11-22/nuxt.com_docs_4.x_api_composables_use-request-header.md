---
url: "https://nuxt.com/docs/4.x/api/composables/use-request-header"
...
## [Example](https://nuxt.com/docs/4.x/api/composables/use-request-header\#example)
...
[useRequestFetch\\
\\
Forward the request context and headers for server-side fetch requests with the useRequestFetch composable.](https://nuxt.com/docs/4.x/api/composables/use-request-fetch) [useRequestHeaders\\
\\
Use useRequestHeaders to access the incoming request headers.](https://nuxt.com/docs/4.x/api/composables/use-request-headers)
