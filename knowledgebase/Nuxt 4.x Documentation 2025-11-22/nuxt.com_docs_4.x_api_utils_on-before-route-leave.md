---
url: "https://nuxt.com/docs/4.x/api/utils/on-before-route-leave"
...
[Vue Router Docs](https://router.vuejs.org/api/functions/onbeforerouteleave) Read more in Vue Router Docs.
...
[navigateTo\\
\\
navigateTo is a helper function that programmatically navigates users.](https://nuxt.com/docs/4.x/api/utils/navigate-to) [onBeforeRouteUpdate\\
\\
The onBeforeRouteUpdate composable allows registering a route guard within a component.](https://nuxt.com/docs/4.x/api/utils/on-before-route-update)
