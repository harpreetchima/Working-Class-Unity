---
url: "https://nuxt.com/docs/4.x/api/composables/use-lazy-fetch"
...
## [Usage](https://nuxt.com/docs/4.x/api/composables/use-lazy-fetch\#usage)
...
## [Type](https://nuxt.com/docs/4.x/api/composables/use-lazy-fetch\#type)
...
## [Parameters](https://nuxt.com/docs/4.x/api/composables/use-lazy-fetch\#parameters)
...
[Docs > 4 X > API > Composables > Use Fetch#parameters](https://nuxt.com/docs/4.x/api/composables/use-fetch#parameters) Read more in Docs > 4 X > API > Composables > Use Fetch#parameters.

## [Return Values](https://nuxt.com/docs/4.x/api/composables/use-lazy-fetch\#return-values)
...
[Docs > 4 X > API > Composables > Use Fetch#return Values](https://nuxt.com/docs/4.x/api/composables/use-fetch#return-values) Read more in Docs > 4 X > API > Composables > Use Fetch#return Values.

## [Examples](https://nuxt.com/docs/4.x/api/composables/use-lazy-fetch\#examples)

### [Handling Pending State](https://nuxt.com/docs/4.x/api/composables/use-lazy-fetch\#handling-pending-state)
...
[Docs > 4 X > Getting Started > Data Fetching](https://nuxt.com/docs/4.x/getting-started/data-fetching) Read more in Docs > 4 X > Getting Started > Data Fetching.
...
[useLazyAsyncData\\
\\
This wrapper around useAsyncData triggers navigation immediately.](https://nuxt.com/docs/4.x/api/composables/use-lazy-async-data) [useLoadingIndicator\\
\\
This composable gives you access to the loading state of the app page.](https://nuxt.com/docs/4.x/api/composables/use-loading-indicator)
