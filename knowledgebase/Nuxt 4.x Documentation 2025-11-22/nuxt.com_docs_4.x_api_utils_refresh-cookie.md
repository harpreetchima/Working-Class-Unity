---
url: "https://nuxt.com/docs/4.x/api/utils/refresh-cookie"
...
## [Purpose](https://nuxt.com/docs/4.x/api/utils/refresh-cookie\#purpose)
...
## [Usage](https://nuxt.com/docs/4.x/api/utils/refresh-cookie\#usage)
...
## [Type](https://nuxt.com/docs/4.x/api/utils/refresh-cookie\#type)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/refresh-cookie.md)

[prerenderRoutes\\
\\
prerenderRoutes hints to Nitro to prerender an additional route.](https://nuxt.com/docs/4.x/api/utils/prerender-routes) [refreshNuxtData\\
\\
Refresh all or specific asyncData instances in Nuxt](https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data)
