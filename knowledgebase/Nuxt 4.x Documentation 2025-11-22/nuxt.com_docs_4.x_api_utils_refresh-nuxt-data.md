---
url: "https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data"
...
3. [Utils](https://nuxt.com/docs/4.x/api/utils)
...
## [Type](https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data\#type)
...
## [Parameters](https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data\#parameters)
...
## [Return Values](https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data\#return-values)

`refreshNuxtData` returns a promise, resolving when all or specific `asyncData` instances have been refreshed.

## [Examples](https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data\#examples)

### [Refresh All Data](https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data\#refresh-all-data)
...
### [Refresh Specific Data](https://nuxt.com/docs/4.x/api/utils/refresh-nuxt-data\#refresh-specific-data)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/refresh-nuxt-data.md)

[refreshCookie\\
\\
Refresh useCookie values manually when a cookie has changed](https://nuxt.com/docs/4.x/api/utils/refresh-cookie) [reloadNuxtApp\\
\\
reloadNuxtApp will perform a hard reload of the page.](https://nuxt.com/docs/4.x/api/utils/reload-nuxt-app)
