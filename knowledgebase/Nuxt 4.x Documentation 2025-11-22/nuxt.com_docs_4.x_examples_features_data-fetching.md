---
url: "https://nuxt.com/docs/4.x/examples/features/data-fetching"
title: "Data Fetching · Nuxt Examples v4"
---
...
[Docs > Getting Started > Data Fetching](https://nuxt.com/docs/getting-started/data-fetching) Read more in Docs > Getting Started > Data Fetching.

[Docs > Guide > Directory Structure > Server](https://nuxt.com/docs/guide/directory-structure/server) Read more in Docs > Guide > Directory Structure > Server.

Examples Data Fetching Example - StackBlitz
...
### Examples Data Fetching Example

Run official live example code for Examples Data Fetching, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/1.features/2.data-fetching.md)

[Auto Imports\\
\\
This example demonstrates the auto-imports feature in Nuxt.](https://nuxt.com/docs/4.x/examples/features/auto-imports) [State Management\\
\\
This example shows how to use the \`useState\` composable to create a reactive and SSR-friendly shared state across components.](https://nuxt.com/docs/4.x/examples/features/state-management)
