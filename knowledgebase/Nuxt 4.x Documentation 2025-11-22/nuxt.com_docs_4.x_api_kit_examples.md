---
url: "https://nuxt.com/docs/4.x/api/kit/examples"
...
## [Accessing Nuxt Vite Config](https://nuxt.com/docs/4.x/api/kit/examples\#accessing-nuxt-vite-config)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/5.kit/15.examples.md)

[Builder\\
\\
Nuxt Kit provides a set of utilities to help you work with the builder. These functions allow you to extend the Vite and webpack configurations.](https://nuxt.com/docs/4.x/api/kit/builder) [Layers\\
\\
Nuxt Kit provides utilities to help you work with layers and their directory structures.](https://nuxt.com/docs/4.x/api/kit/layers)
