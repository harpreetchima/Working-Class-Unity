---
url: "https://nuxt.com/docs/4.x/api/composables/use-response-header"
...
## [Example](https://nuxt.com/docs/4.x/api/composables/use-response-header\#example)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-response-header.md)

[useRequestURL\\
\\
Access the incoming request URL with the useRequestURL composable.](https://nuxt.com/docs/4.x/api/composables/use-request-url) [useRoute\\
\\
The useRoute composable returns the current route.](https://nuxt.com/docs/4.x/api/composables/use-route)
