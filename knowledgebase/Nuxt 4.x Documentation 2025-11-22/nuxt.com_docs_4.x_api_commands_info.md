---
url: "https://nuxt.com/docs/4.x/api/commands/info"
title: "nuxt info · Nuxt Commands v4"
---
...
## [Arguments](https://nuxt.com/docs/4.x/api/commands/info\#arguments)

| Argument | Description |
| --- | --- |
| `ROOTDIR="."` | Specifies the working directory (default: `.`) |

## [Options](https://nuxt.com/docs/4.x/api/commands/info\#options)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/4.commands/info.md)

[nuxt generate\\
\\
Pre-renders every route of the application and stores the result in plain HTML files.](https://nuxt.com/docs/4.x/api/commands/generate) [create nuxt\\
\\
The init command initializes a fresh Nuxt project.](https://nuxt.com/docs/4.x/api/commands/init)
