---
url: "https://nuxt.com/docs/4.x/api/composables/use-request-fetch"
...
app/pages/index.vueserver/api/cookies.ts
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-request-fetch.md)

[useRequestEvent\\
\\
Access the incoming request event with the useRequestEvent composable.](https://nuxt.com/docs/4.x/api/composables/use-request-event) [useRequestHeader\\
\\
Use useRequestHeader to access a certain incoming request header.](https://nuxt.com/docs/4.x/api/composables/use-request-header)
