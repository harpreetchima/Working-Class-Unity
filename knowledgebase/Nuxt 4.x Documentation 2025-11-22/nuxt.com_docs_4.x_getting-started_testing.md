...
title: "Testing · Get Started with Nuxt v4"
---
...
[See full example config](https://github.com/nuxt/test-utils/blob/main/examples/app-playwright/playwright.config.ts) Read more in See full example config.
...
[Deployment\\
\\
Learn how to deploy your Nuxt application to any hosting provider.](https://nuxt.com/docs/4.x/getting-started/deployment) [Upgrade Guide\\
\\
