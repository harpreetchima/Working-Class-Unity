---
url: "https://nuxt.com/docs/4.x/api/composables/use-head-safe"
...
## [Usage](https://nuxt.com/docs/4.x/api/composables/use-head-safe\#usage)
...
## [Type](https://nuxt.com/docs/4.x/api/composables/use-head-safe\#type)
...
### [Allowed Attributes](https://nuxt.com/docs/4.x/api/composables/use-head-safe\#allowed-attributes)
...
## [Parameters](https://nuxt.com/docs/4.x/api/composables/use-head-safe\#parameters)
...
## [Return Values](https://nuxt.com/docs/4.x/api/composables/use-head-safe\#return-values)

This composable does not return any value.

## [Example](https://nuxt.com/docs/4.x/api/composables/use-head-safe\#example)
...
[https://unhead.unjs.io/docs/typescript/head/api/composables/use-head-safe](https://unhead.unjs.io/docs/typescript/head/api/composables/use-head-safe) Read more on the `Unhead` documentation.

Was this helpful?

🤩🙂☹️😰

[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-head-safe.md)

[useHead\\
\\
useHead customizes the head properties of individual pages of your Nuxt app.](https://nuxt.com/docs/4.x/api/composables/use-head) [useHydration\\
\\
Allows full control of the hydration cycle to set and receive data from the server.](https://nuxt.com/docs/4.x/api/composables/use-hydration)
