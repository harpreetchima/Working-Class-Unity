---
url: "https://nuxt.com/docs/4.x/examples/advanced/jsx"
title: "JSX / TSX · Nuxt Examples v4"
---
...
[https://vuejs.org/guide/extras/render-function.html#jsx-tsx](https://vuejs.org/guide/extras/render-function.html#jsx-tsx) Read more in https://vuejs.org/guide/extras/render-function.html#jsx-tsx.

Examples Jsx Example - StackBlitz
...
### Examples Jsx Example

Run official live example code for Examples Jsx, created by Nuxt on StackBlitz
...
<scriptlang="tsx"setup>

// Component could be a

simple function with JSX
...
// Or using defineComponent

setup that returns render

function with JSX syntax

constNuxt3=defineComponent(
...
font-bold">Nuxt 3</span>

})

// We can combine components

with JSX syntax too

constInlineComponent=()=>
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/4.advanced/jsx.md)

[Error Handling\\
\\
This example shows how to handle errors in different contexts: pages, plugins, components and middleware.](https://nuxt.com/docs/4.x/examples/advanced/error-handling) [Locale\\
\\
This example shows how to define a locale composable to handle the application's locale, both server and client side.](https://nuxt.com/docs/4.x/examples/advanced/locale)
