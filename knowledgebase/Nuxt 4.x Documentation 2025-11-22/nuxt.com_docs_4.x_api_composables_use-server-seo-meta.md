---
url: "https://nuxt.com/docs/4.x/api/composables/use-server-seo-meta"
...
[useSeoMeta\\
\\
The useSeoMeta composable lets you define your site's SEO meta tags as a flat object with full TypeScript support.](https://nuxt.com/docs/4.x/api/composables/use-seo-meta) [useState\\
\\
The useState composable creates a reactive and SSR-friendly shared state.](https://nuxt.com/docs/4.x/api/composables/use-state)
