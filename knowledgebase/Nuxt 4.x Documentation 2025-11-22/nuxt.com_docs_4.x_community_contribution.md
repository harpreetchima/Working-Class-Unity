---
url: "https://nuxt.com/docs/4.x/community/contribution"
title: "Contribution · Nuxt Community v4"
---
...
## [Ecosystem](https://nuxt.com/docs/4.x/community/contribution\#ecosystem)
...
## [How To Contribute](https://nuxt.com/docs/4.x/community/contribution\#how-to-contribute)

### [Triage Issues and Help Out in Discussions](https://nuxt.com/docs/4.x/community/contribution\#triage-issues-and-help-out-in-discussions)
...
### [Creating an Issue](https://nuxt.com/docs/4.x/community/contribution\#creating-an-issue)
...
### [Send a Pull Request](https://nuxt.com/docs/4.x/community/contribution\#send-a-pull-request)

We always welcome pull requests! ❤️

#### [Before You Start](https://nuxt.com/docs/4.x/community/contribution\#before-you-start)
...
#### [Commit Conventions](https://nuxt.com/docs/4.x/community/contribution\#commit-conventions)
...
#### [Making the Pull Request](https://nuxt.com/docs/4.x/community/contribution\#making-the-pull-request)
...
#### [Once You've Made a Pull Request](https://nuxt.com/docs/4.x/community/contribution\#once-youve-made-a-pull-request)
...
### [AI-Assisted Contributions](https://nuxt.com/docs/4.x/community/contribution\#ai-assisted-contributions)
...
#### [Never let an LLM speak for you](https://nuxt.com/docs/4.x/community/contribution\#never-let-an-llm-speak-for-you)
...
#### [Never let an LLM think for you](https://nuxt.com/docs/4.x/community/contribution\#never-let-an-llm-think-for-you)
...
### [Create a Module](https://nuxt.com/docs/4.x/community/contribution\#create-a-module)
...
### [Make an RFC](https://nuxt.com/docs/4.x/community/contribution\#make-an-rfc)
...
### [Conventions Across Ecosystem](https://nuxt.com/docs/4.x/community/contribution\#conventions-across-ecosystem)
...
#### [Module Conventions](https://nuxt.com/docs/4.x/community/contribution\#module-conventions)

Modules should follow the [Nuxt module template](https://github.com/nuxt/starter/tree/module). See [module guide](https://nuxt.com/docs/4.x/guide/going-further/modules) for more information.

#### [Use Core `unjs/` Libraries](https://nuxt.com/docs/4.x/community/contribution\#use-core-unjs-libraries)
...
#### [Use ESM Syntax and Default to `type: module`](https://nuxt.com/docs/4.x/community/contribution\#use-esm-syntax-and-default-to-type-module)
...
#### [What's Corepack](https://nuxt.com/docs/4.x/community/contribution\#whats-corepack)
...
#### [Use ESLint](https://nuxt.com/docs/4.x/community/contribution\#use-eslint)
...
#### [No Prettier](https://nuxt.com/docs/4.x/community/contribution\#no-prettier)
...
#### [Package Manager](https://nuxt.com/docs/4.x/community/contribution\#package-manager)
...
## [Documentation Style Guide](https://nuxt.com/docs/4.x/community/contribution\#documentation-style-guide)
...
[Docs > 4 X > Community > Framework Contribution#documentation Guide](https://nuxt.com/docs/4.x/community/framework-contribution#documentation-guide) Learn how to contribute to the documentation.

Was this helpful?

🤩🙂☹️😰

[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/5.community/4.contribution.md)

[Reporting Bugs\\
\\
One of the most valuable roles in open source is taking the time to report bugs helpfully.](https://nuxt.com/docs/4.x/community/reporting-bugs) [Framework\\
\\
Some specific points about contributions to the framework repository.](https://nuxt.com/docs/4.x/community/framework-contribution)
