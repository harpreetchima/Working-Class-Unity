---
url: "https://nuxt.com/docs/4.x/directory-structure/modules"
...
[Docs > 4 X > Guide > Going Further > Modules](https://nuxt.com/docs/4.x/guide/going-further/modules) Read more in Docs > 4 X > Guide > Going Further > Modules.
...
[content\\
\\
Use the content/ directory to create a file-based CMS for your application.](https://nuxt.com/docs/4.x/directory-structure/content) [node\_modules\\
\\
The package manager stores the dependencies of your project in the node\_modules/ directory.](https://nuxt.com/docs/4.x/directory-structure/node_modules)
