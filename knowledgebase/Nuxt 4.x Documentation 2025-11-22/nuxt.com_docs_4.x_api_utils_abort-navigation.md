---
url: "https://nuxt.com/docs/4.x/api/utils/abort-navigation"
...
## [Type](https://nuxt.com/docs/4.x/api/utils/abort-navigation\#type)
...
## [Parameters](https://nuxt.com/docs/4.x/api/utils/abort-navigation\#parameters)

### [`err`](https://nuxt.com/docs/4.x/api/utils/abort-navigation\#err)
...
## [Examples](https://nuxt.com/docs/4.x/api/utils/abort-navigation\#examples)
...
### [`err` as a String](https://nuxt.com/docs/4.x/api/utils/abort-navigation\#err-as-a-string)
...
### [`err` as an Error Object](https://nuxt.com/docs/4.x/api/utils/abort-navigation\#err-as-an-error-object)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/abort-navigation.md)

[$fetch\\
\\
Nuxt uses ofetch to expose globally the $fetch helper for making HTTP requests.](https://nuxt.com/docs/4.x/api/utils/dollarfetch) [addRouteMiddleware\\
\\
addRouteMiddleware() is a helper function to dynamically add middleware in your application.](https://nuxt.com/docs/4.x/api/utils/add-route-middleware)
