---
url: "https://nuxt.com/docs/4.x/api/commands/test"
...
## [Arguments](https://nuxt.com/docs/4.x/api/commands/test\#arguments)

| Argument | Description |
| --- | --- |
| `ROOTDIR="."` | Specifies the working directory (default: `.`) |

## [Options](https://nuxt.com/docs/4.x/api/commands/test\#options)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/4.commands/test.md)

[nuxt preview\\
\\
The preview command starts a server to preview your application after the build command.](https://nuxt.com/docs/4.x/api/commands/preview) [nuxt typecheck\\
\\
The typecheck command runs vue-tsc to check types throughout your app.](https://nuxt.com/docs/4.x/api/commands/typecheck)
