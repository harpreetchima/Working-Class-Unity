---
url: "https://nuxt.com/docs/4.x/api/utils/update-app-config"
...
## [Usage](https://nuxt.com/docs/4.x/api/utils/update-app-config\#usage)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/update-app-config.md)

[showError\\
\\
Nuxt provides a quick and simple way to show a full screen error page if needed.](https://nuxt.com/docs/4.x/api/utils/show-error) [nuxt add\\
\\
Scaffold an entity into your Nuxt application.](https://nuxt.com/docs/4.x/api/commands/add)
