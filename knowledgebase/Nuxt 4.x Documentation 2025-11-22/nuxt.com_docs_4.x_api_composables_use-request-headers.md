---
url: "https://nuxt.com/docs/4.x/api/composables/use-request-headers"
...
## [Example](https://nuxt.com/docs/4.x/api/composables/use-request-headers\#example)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-request-headers.md)

[useRequestHeader\\
\\
Use useRequestHeader to access a certain incoming request header.](https://nuxt.com/docs/4.x/api/composables/use-request-header) [useRequestURL\\
\\
Access the incoming request URL with the useRequestURL composable.](https://nuxt.com/docs/4.x/api/composables/use-request-url)
