---
url: "https://nuxt.com/docs/4.x/examples/advanced/module-extend-pages"
title: "Module Extend Pages · Nuxt Examples v4"
---
...
[Docs > Guide > Going Further > Modules](https://nuxt.com/docs/guide/going-further/modules) Read more in Docs > Guide > Going Further > Modules.

Examples Module Extend Pages Example - StackBlitz
...
### Examples Module Extend Pages Example

Run official live example code for Examples Module Extend Pages, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/4.advanced/module-extend-pages.md)

[Locale\\
\\
This example shows how to define a locale composable to handle the application's locale, both server and client side.](https://nuxt.com/docs/4.x/examples/advanced/locale) [Teleport\\
\\
This example shows how to use the <Teleport> with client-side and server-side rendering.](https://nuxt.com/docs/4.x/examples/advanced/teleport)
