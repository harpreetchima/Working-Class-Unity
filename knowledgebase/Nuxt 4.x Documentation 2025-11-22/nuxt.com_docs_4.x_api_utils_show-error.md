---
url: "https://nuxt.com/docs/4.x/api/utils/show-error"
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/show-error.md)

[setResponseStatus\\
\\
setResponseStatus sets the statusCode (and optionally the statusMessage) of the response.](https://nuxt.com/docs/4.x/api/utils/set-response-status) [updateAppConfig\\
\\
Update the App Config at runtime.](https://nuxt.com/docs/4.x/api/utils/update-app-config)
