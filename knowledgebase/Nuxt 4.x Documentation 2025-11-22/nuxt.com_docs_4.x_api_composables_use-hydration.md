---
url: "https://nuxt.com/docs/4.x/api/composables/use-hydration"
...
## [Usage](https://nuxt.com/docs/4.x/api/composables/use-hydration\#usage)
...
With useHydrationWithout useHydration
...
## [Type](https://nuxt.com/docs/4.x/api/composables/use-hydration\#type)
...
## [Parameters](https://nuxt.com/docs/4.x/api/composables/use-hydration\#parameters)
...
## [Return Values](https://nuxt.com/docs/4.x/api/composables/use-hydration\#return-values)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-hydration.md)

[useHeadSafe\\
\\
The recommended way to provide head data with user input.](https://nuxt.com/docs/4.x/api/composables/use-head-safe) [useLazyAsyncData\\
\\
This wrapper around useAsyncData triggers navigation immediately.](https://nuxt.com/docs/4.x/api/composables/use-lazy-async-data)
