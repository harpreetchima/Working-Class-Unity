---
url: "https://nuxt.com/docs/4.x/examples/routing/universal-router"
title: "Universal Router · Nuxt Examples v4"
---
...
Examples Universal Router Example - StackBlitz
...
### Examples Universal Router Example

Run official live example code for Examples Universal Router, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/2.routing/universal-router.md)

[Pages\\
\\
This example shows how to use the pages/ directory to create application routes.](https://nuxt.com/docs/4.x/examples/routing/pages) [Layers\\
\\
This example shows how to use the extends key in \`nuxt.config.ts\`.](https://nuxt.com/docs/4.x/examples/advanced/config-extends)
