---
url: "https://nuxt.com/docs/4.x/api/composables/use-error"
...
## [Usage](https://nuxt.com/docs/4.x/api/composables/use-error\#usage)
...
## [Type](https://nuxt.com/docs/4.x/api/composables/use-error\#type)
...
## [Parameters](https://nuxt.com/docs/4.x/api/composables/use-error\#parameters)

This composable does not take any parameters.

## [Return Values](https://nuxt.com/docs/4.x/api/composables/use-error\#return-values)
...
## [Example](https://nuxt.com/docs/4.x/api/composables/use-error\#example)
...
[useCookie\\
\\
useCookie is an SSR-friendly composable to read and write cookies.](https://nuxt.com/docs/4.x/api/composables/use-cookie) [useFetch\\
\\
Fetch data from an API endpoint with an SSR-friendly composable.](https://nuxt.com/docs/4.x/api/composables/use-fetch)
