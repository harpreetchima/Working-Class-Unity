---
url: "https://nuxt.com/docs/4.x/examples/routing/pages"
title: "Pages · Nuxt Examples v4"
---
...
[Docs > Guide > Directory Structure > Pages](https://nuxt.com/docs/guide/directory-structure/pages) Read more in Docs > Guide > Directory Structure > Pages.

Examples Pages Example - StackBlitz
...
Run official live example code for Examples Pages, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/2.routing/pages.md)

[Middleware\\
\\
This example shows how to add route middleware with the middleware/ directory or with a plugin, and how to use them globally or per page.](https://nuxt.com/docs/4.x/examples/routing/middleware) [Universal Router\\
\\
This example demonstrates Nuxt universal routing utilities without depending on \`pages/\` and \`vue-router\`.](https://nuxt.com/docs/4.x/examples/routing/universal-router)
