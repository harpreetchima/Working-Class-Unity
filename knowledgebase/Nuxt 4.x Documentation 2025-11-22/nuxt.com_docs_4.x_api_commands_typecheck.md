---
url: "https://nuxt.com/docs/4.x/api/commands/typecheck"
...
## [Arguments](https://nuxt.com/docs/4.x/api/commands/typecheck\#arguments)

| Argument | Description |
| --- | --- |
| `ROOTDIR="."` | Specifies the working directory (default: `.`) |

## [Options](https://nuxt.com/docs/4.x/api/commands/typecheck\#options)
...
[Docs > 4 X > Guide > Concepts > Typescript#type Checking](https://nuxt.com/docs/4.x/guide/concepts/typescript#type-checking) Read more on how to enable type-checking at build or development time.

Was this helpful?

🤩🙂☹️😰

[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/4.commands/typecheck.md)

[nuxt test\\
\\
The test command runs tests using @nuxt/test-utils.](https://nuxt.com/docs/4.x/api/commands/test) [nuxt upgrade\\
\\
The upgrade command upgrades Nuxt to the latest version.](https://nuxt.com/docs/4.x/api/commands/upgrade)
