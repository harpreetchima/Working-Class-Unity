---
url: "https://nuxt.com/docs/4.x/api/utils/on-nuxt-ready"
...
[onBeforeRouteUpdate\\
\\
The onBeforeRouteUpdate composable allows registering a route guard within a component.](https://nuxt.com/docs/4.x/api/utils/on-before-route-update) [prefetchComponents\\
\\
Nuxt provides utilities to give you control over prefetching components.](https://nuxt.com/docs/4.x/api/utils/prefetch-components)
