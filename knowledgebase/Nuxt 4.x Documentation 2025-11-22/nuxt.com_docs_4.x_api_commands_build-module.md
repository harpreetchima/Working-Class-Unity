---
url: "https://nuxt.com/docs/4.x/api/commands/build-module"
...
## [Arguments](https://nuxt.com/docs/4.x/api/commands/build-module\#arguments)

| Argument | Description |
| --- | --- |
| `ROOTDIR="."` | Specifies the working directory (default: `.`) |

## [Options](https://nuxt.com/docs/4.x/api/commands/build-module\#options)
...
[https://github.com/nuxt/module-builder](https://github.com/nuxt/module-builder) Read more about `@nuxt/module-builder`.

Was this helpful?

🤩🙂☹️😰

[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/4.commands/build-module.md)

[nuxt build\\
\\
Build your Nuxt application.](https://nuxt.com/docs/4.x/api/commands/build) [nuxt cleanup\\
\\
Remove common generated Nuxt files and caches.](https://nuxt.com/docs/4.x/api/commands/cleanup)
