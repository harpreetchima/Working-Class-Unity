---
url: "https://nuxt.com/docs/4.x/api/kit/compatibility"
...
## [`checkNuxtCompatibility`](https://nuxt.com/docs/4.x/api/kit/compatibility\#checknuxtcompatibility)
...
### [Usage](https://nuxt.com/docs/4.x/api/kit/compatibility\#usage)
...
### [Type](https://nuxt.com/docs/4.x/api/kit/compatibility\#type)

```ts
function checkNuxtCompatibility (constraints: NuxtCompatibility, nuxt?: Nuxt): Promise<NuxtCompatibilityIssues>
```

### [Parameters](https://nuxt.com/docs/4.x/api/kit/compatibility\#parameters)
...
## [`assertNuxtCompatibility`](https://nuxt.com/docs/4.x/api/kit/compatibility\#assertnuxtcompatibility)

Asserts that constraints are met for the current Nuxt version. If not, throws an error with the list of issues as string.

### [Type](https://nuxt.com/docs/4.x/api/kit/compatibility\#type-1)

```ts
function assertNuxtCompatibility (constraints: NuxtCompatibility, nuxt?: Nuxt): Promise<true>
```

### [Parameters](https://nuxt.com/docs/4.x/api/kit/compatibility\#parameters-1)
...
## [`hasNuxtCompatibility`](https://nuxt.com/docs/4.x/api/kit/compatibility\#hasnuxtcompatibility)
...
### [Usage](https://nuxt.com/docs/4.x/api/kit/compatibility\#usage-1)
...
### [Type](https://nuxt.com/docs/4.x/api/kit/compatibility\#type-2)

```ts
function hasNuxtCompatibility (constraints: NuxtCompatibility, nuxt?: Nuxt): Promise<boolean>
```

### [Parameters](https://nuxt.com/docs/4.x/api/kit/compatibility\#parameters-2)

**`constraints`**: Version and builder constraints to check against. Refer to the [constraints table in `checkNuxtCompatibility`](https://nuxt.com/docs/4.x/api/kit/compatibility#parameters) for details.

**`nuxt`**: Nuxt instance. If not provided, it will be retrieved from the context via `useNuxt()` call.

## [`isNuxtMajorVersion`](https://nuxt.com/docs/4.x/api/kit/compatibility\#isnuxtmajorversion)

Check if current Nuxt instance is of specified major version

### [Usage](https://nuxt.com/docs/4.x/api/kit/compatibility\#usage-2)
...
### [Type](https://nuxt.com/docs/4.x/api/kit/compatibility\#type-3)

```ts
function isNuxtMajorVersion (major: number, nuxt?: Nuxt): boolean
```

### [Parameters](https://nuxt.com/docs/4.x/api/kit/compatibility\#parameters-3)

**`major`**: Major version to check against.

**`nuxt`**: Nuxt instance. If not provided, it will be retrieved from the context via `useNuxt()` call.

## [`isNuxt3`](https://nuxt.com/docs/4.x/api/kit/compatibility\#isnuxt3)
...
### [Type](https://nuxt.com/docs/4.x/api/kit/compatibility\#type-4)

```ts
function isNuxt3 (nuxt?: Nuxt): boolean
```

### [Parameters](https://nuxt.com/docs/4.x/api/kit/compatibility\#parameters-4)

**`nuxt`**: Nuxt instance. If not provided, it will be retrieved from the context via `useNuxt()` call.

## [`isNuxt2`](https://nuxt.com/docs/4.x/api/kit/compatibility\#isnuxt2)

Checks if the current Nuxt version is 2.x.

Use `isNuxtMajorVersion(2, nuxt)` instead. This may be removed in @nuxt/kit v5 or a future major version.

### [Type](https://nuxt.com/docs/4.x/api/kit/compatibility\#type-5)

```ts
function isNuxt2 (nuxt?: Nuxt): boolean
```

### [Parameters](https://nuxt.com/docs/4.x/api/kit/compatibility\#parameters-5)

**`nuxt`**: Nuxt instance. If not provided, it will be retrieved from the context via `useNuxt()` call.

## [`getNuxtVersion`](https://nuxt.com/docs/4.x/api/kit/compatibility\#getnuxtversion)

Returns the current Nuxt version.

### [Type](https://nuxt.com/docs/4.x/api/kit/compatibility\#type-6)

```ts
function getNuxtVersion (nuxt?: Nuxt): string
```

### [Parameters](https://nuxt.com/docs/4.x/api/kit/compatibility\#parameters-6)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/5.kit/3.compatibility.md)

[Programmatic Usage\\
\\
Nuxt Kit provides a set of utilities to help you work with Nuxt programmatically. These functions allow you to load Nuxt, build Nuxt, and load Nuxt configuration.](https://nuxt.com/docs/4.x/api/kit/programmatic) [Auto-imports\\
\\
Nuxt Kit provides a set of utilities to help you work with auto-imports. These functions allow you to register your own utils, composables and Vue APIs.](https://nuxt.com/docs/4.x/api/kit/autoimports)
