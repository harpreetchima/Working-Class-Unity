...
## [Usage](https://nuxt.com/docs/4.x/api/utils/define-route-rules\#usage)
...
## [Notes](https://nuxt.com/docs/4.x/api/utils/define-route-rules\#notes)
...
[Docs > 4 X > Guide > Concepts > Rendering#hybrid Rendering](https://nuxt.com/docs/4.x/guide/concepts/rendering#hybrid-rendering) Read more about the `routeRules`.

Was this helpful?

🤩🙂☹️😰

[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/define-route-rules.md)

[definePageMeta\\
\\
Define metadata for your page components.](https://nuxt.com/docs/4.x/api/utils/define-page-meta) [navigateTo\\
\\
navigateTo is a helper function that programmatically navigates users.](https://nuxt.com/docs/4.x/api/utils/navigate-to)
