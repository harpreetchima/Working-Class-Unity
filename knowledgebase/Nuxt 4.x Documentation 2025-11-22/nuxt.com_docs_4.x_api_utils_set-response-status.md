---
url: "https://nuxt.com/docs/4.x/api/utils/set-response-status"
title: "setResponseStatus · Nuxt Utils v4"
---
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/3.utils/set-response-status.md)

[setPageLayout\\
\\
setPageLayout allows you to dynamically change the layout of a page.](https://nuxt.com/docs/4.x/api/utils/set-page-layout) [showError\\
\\
Nuxt provides a quick and simple way to show a full screen error page if needed.](https://nuxt.com/docs/4.x/api/utils/show-error)
