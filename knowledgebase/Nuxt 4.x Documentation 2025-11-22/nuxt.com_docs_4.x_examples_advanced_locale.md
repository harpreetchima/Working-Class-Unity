---
url: "https://nuxt.com/docs/4.x/examples/advanced/locale"
title: "Locale · Nuxt Examples v4"
---
...
Examples Locale Example - StackBlitz
...
### Examples Locale Example

Run official live example code for Examples Locale, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/4.advanced/locale.md)

[JSX / TSX\\
\\
This example shows how to use JSX syntax with typescript in Nuxt pages and components.](https://nuxt.com/docs/4.x/examples/advanced/jsx) [Module Extend Pages\\
\\
This example defines a new \`test\` page using \`extendPages\` within a module.](https://nuxt.com/docs/4.x/examples/advanced/module-extend-pages)
