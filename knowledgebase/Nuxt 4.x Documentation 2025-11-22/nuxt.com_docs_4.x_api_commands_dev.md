---
url: "https://nuxt.com/docs/4.x/api/commands/dev"
...
## [Arguments](https://nuxt.com/docs/4.x/api/commands/dev\#arguments)

| Argument | Description |
| --- | --- |
| `ROOTDIR="."` | Specifies the working directory (default: `.`) |

## [Options](https://nuxt.com/docs/4.x/api/commands/dev\#options)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/4.commands/dev.md)

[nuxt cleanup\\
\\
Remove common generated Nuxt files and caches.](https://nuxt.com/docs/4.x/api/commands/cleanup) [nuxt devtools\\
\\
The devtools command allows you to enable or disable Nuxt DevTools on a per-project basis.](https://nuxt.com/docs/4.x/api/commands/devtools)
