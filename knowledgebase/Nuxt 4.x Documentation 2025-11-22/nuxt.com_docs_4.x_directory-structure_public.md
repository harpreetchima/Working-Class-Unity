---
url: "https://nuxt.com/docs/4.x/directory-structure/public"
...
[node\_modules\\
\\
The package manager stores the dependencies of your project in the node\_modules/ directory.](https://nuxt.com/docs/4.x/directory-structure/node_modules) [server\\
\\
The server/ directory is used to register API and server handlers to your application.](https://nuxt.com/docs/4.x/directory-structure/server)
