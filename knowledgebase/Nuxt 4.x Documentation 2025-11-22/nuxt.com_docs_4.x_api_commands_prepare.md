---
url: "https://nuxt.com/docs/4.x/api/commands/prepare"
...
## [Arguments](https://nuxt.com/docs/4.x/api/commands/prepare\#arguments)

| Argument | Description |
| --- | --- |
| `ROOTDIR="."` | Specifies the working directory (default: `.`) |

## [Options](https://nuxt.com/docs/4.x/api/commands/prepare\#options)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/4.commands/prepare.md)

[nuxt module\\
\\
Search and add modules to your Nuxt application with the command line.](https://nuxt.com/docs/4.x/api/commands/module) [nuxt preview\\
\\
The preview command starts a server to preview your application after the build command.](https://nuxt.com/docs/4.x/api/commands/preview)
