---
url: "https://nuxt.com/docs/4.x/examples/advanced/config-extends"
title: "Layers · Nuxt Examples v4"
---
...
[Docs > Getting Started > Layers](https://nuxt.com/docs/getting-started/layers) Read more in Docs > Getting Started > Layers.

Examples Config Extends Example - StackBlitz
...
### Examples Config Extends Example

Run official live example code for Examples Config Extends, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/4.advanced/config-extends.md)

[Universal Router\\
\\
This example demonstrates Nuxt universal routing utilities without depending on \`pages/\` and \`vue-router\`.](https://nuxt.com/docs/4.x/examples/routing/universal-router) [Error Handling\\
\\
This example shows how to handle errors in different contexts: pages, plugins, components and middleware.](https://nuxt.com/docs/4.x/examples/advanced/error-handling)
