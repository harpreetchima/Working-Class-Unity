---
url: "https://nuxt.com/docs/4.x/api/utils/set-page-layout"
...
[reloadNuxtApp\\
\\
reloadNuxtApp will perform a hard reload of the page.](https://nuxt.com/docs/4.x/api/utils/reload-nuxt-app) [setResponseStatus\\
\\
setResponseStatus sets the statusCode (and optionally the statusMessage) of the response.](https://nuxt.com/docs/4.x/api/utils/set-response-status)
