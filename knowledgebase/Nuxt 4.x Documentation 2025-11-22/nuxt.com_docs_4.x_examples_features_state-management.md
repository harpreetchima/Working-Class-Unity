---
url: "https://nuxt.com/docs/4.x/examples/features/state-management"
title: "State Management · Nuxt Examples v4"
---
...
[Docs > Getting Started > State Management](https://nuxt.com/docs/getting-started/state-management) Read more in Docs > Getting Started > State Management.

[Docs > API > Composables > Use State](https://nuxt.com/docs/api/composables/use-state) Read more in Docs > API > Composables > Use State.

Examples State Management Example - StackBlitz
...
### Examples State Management Example

Run official live example code for Examples State Management, created by Nuxt on StackBlitz
...
constcounter=useState

('counter',()=>Math.round

(Math.random()\*1000))

constsameCounter=useState
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/1.features/3.state-management.md)

[Data Fetching\\
\\
This example demonstrates data fetching with Nuxt using built-in composables and API routes.](https://nuxt.com/docs/4.x/examples/features/data-fetching) [Meta Tags\\
\\
This example shows how to use the Nuxt helpers and composables for SEO and meta management.](https://nuxt.com/docs/4.x/examples/features/meta-tags)
