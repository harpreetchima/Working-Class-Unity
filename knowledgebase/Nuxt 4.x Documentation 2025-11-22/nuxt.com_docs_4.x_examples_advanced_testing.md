---
url: "https://nuxt.com/docs/4.x/examples/advanced/testing"
title: "Testing · Nuxt Examples v4"
---
...
[Docs > Getting Started > Testing](https://nuxt.com/docs/getting-started/testing) Read more in Docs > Getting Started > Testing.

Examples Testing Example - StackBlitz
...
Run official live example code for Examples Testing, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/4.advanced/testing.md)

[Teleport\\
\\
This example shows how to use the <Teleport> with client-side and server-side rendering.](https://nuxt.com/docs/4.x/examples/advanced/teleport) [useCookie\\
\\
This example shows how to use the useCookie API to persist small amounts of data that both client and server can use.](https://nuxt.com/docs/4.x/examples/advanced/use-cookie)
