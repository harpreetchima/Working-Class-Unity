---
url: "https://nuxt.com/docs/4.x/directory-structure/nuxt-config"
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/2.directory-structure/3.nuxt-config.md)

[.nuxtrc\\
\\
The .nuxtrc file allows you to define nuxt configurations in a flat syntax.](https://nuxt.com/docs/4.x/directory-structure/nuxtrc) [package.json\\
\\
The package.json file contains all the dependencies and scripts for your application.](https://nuxt.com/docs/4.x/directory-structure/package)
