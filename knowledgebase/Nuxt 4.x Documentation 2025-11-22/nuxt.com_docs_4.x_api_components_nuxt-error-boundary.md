---
url: "https://nuxt.com/docs/4.x/api/components/nuxt-error-boundary"
...
## [Events](https://nuxt.com/docs/4.x/api/components/nuxt-error-boundary\#events)
...
## [Slots](https://nuxt.com/docs/4.x/api/components/nuxt-error-boundary\#slots)
...
[Docs > 4 X > Getting Started > Error Handling](https://nuxt.com/docs/4.x/getting-started/error-handling) Read more in Docs > 4 X > Getting Started > Error Handling.

## [Examples](https://nuxt.com/docs/4.x/api/components/nuxt-error-boundary\#examples)

### [Accessing `error` and `clearError` in script](https://nuxt.com/docs/4.x/api/components/nuxt-error-boundary\#accessing-error-and-clearerror-in-script)
...
\\
Display a progress bar between page navigations.](https://nuxt.com/docs/4.x/api/components/nuxt-loading-indicator) [<NuxtWelcome>\\
\\
The <NuxtWelcome> component greets users in new projects made from the starter template.](https://nuxt.com/docs/4.x/api/components/nuxt-welcome)
