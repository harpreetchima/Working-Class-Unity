---
url: "https://nuxt.com/docs/4.x/directory-structure/package"
...
[https://docs.npmjs.com/cli/configuring-npm/package-json/](https://docs.npmjs.com/cli/configuring-npm/package-json/) Read more about the `package.json` file.

Was this helpful?

🤩🙂☹️😰

[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/2.directory-structure/3.package.md)

[nuxt.config.ts\\
\\
Nuxt can be easily configured with a single nuxt.config file.](https://nuxt.com/docs/4.x/directory-structure/nuxt-config) [tsconfig.json\\
\\
Learn how Nuxt manages TypeScript configuration across different parts of your project.](https://nuxt.com/docs/4.x/directory-structure/tsconfig)
