---
url: "https://nuxt.com/docs/4.x/api/components/teleports"
title: "<Teleport> · Nuxt Components v4"
---
...
## [Body Teleport](https://nuxt.com/docs/4.x/api/components/teleports\#body-teleport)
...
## [Client-side Teleport](https://nuxt.com/docs/4.x/api/components/teleports\#client-side-teleport)
...
Read and edit a live example in [Docs > 4 X > Examples > Advanced > Teleport](https://nuxt.com/docs/4.x/examples/advanced/teleport).

Was this helpful?

🤩🙂☹️😰

[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/1.components/11.teleports.md)

[<NuxtPicture>\\
\\
Nuxt provides a <NuxtPicture> component to handle automatic image optimization.](https://nuxt.com/docs/4.x/api/components/nuxt-picture) [<NuxtRouteAnnouncer>\\
\\
The <NuxtRouteAnnouncer> component adds a hidden element with the page title to announce route changes to assistive technologies.](https://nuxt.com/docs/4.x/api/components/nuxt-route-announcer)
