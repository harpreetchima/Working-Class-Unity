---
url: "https://nuxt.com/docs/4.x/examples/features/meta-tags"
title: "Meta Tags · Nuxt Examples v4"
---
...
[Docs > Getting Started > Seo Meta](https://nuxt.com/docs/getting-started/seo-meta) Read more in Docs > Getting Started > Seo Meta.

Examples Meta Tags Example - StackBlitz
...
### Examples Meta Tags Example

Run official live example code for Examples Meta Tags, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/1.features/4.meta-tags.md)

[State Management\\
\\
This example shows how to use the \`useState\` composable to create a reactive and SSR-friendly shared state across components.](https://nuxt.com/docs/4.x/examples/features/state-management) [Layouts\\
\\
This example shows how to define default and custom layouts.](https://nuxt.com/docs/4.x/examples/features/layouts)
