...
title: "Deployment · Get Started with Nuxt v4"
---
...
[the Nitro documentation for node-server preset](https://nitro.build/deploy/runtimes/node) Read more in the Nitro documentation for node-server preset.
...
[Nuxt prerendering](https://nuxt.com/docs/4.x/getting-started/prerendering) Read more in Nuxt prerendering.
...
[Deploy](https://nuxt.com/deploy) Read more in Deploy.
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/1.getting-started/16.deployment.md)

[Prerendering\\
\\
Nuxt allows pages to be statically rendered at build time to improve certain performance or SEO metrics](https://nuxt.com/docs/4.x/getting-started/prerendering) [Testing\\
\\
