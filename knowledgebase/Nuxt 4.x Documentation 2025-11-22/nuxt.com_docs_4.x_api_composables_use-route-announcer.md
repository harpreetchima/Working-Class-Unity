---
url: "https://nuxt.com/docs/4.x/api/composables/use-route-announcer"
...
3. [Composables](https://nuxt.com/docs/4.x/api/composables)
...
## [Description](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#description)
...
## [Parameters](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#parameters)

- `politeness`: Sets the urgency for screen reader announcements: `off` (disable the announcement), `polite` (waits for silence), or `assertive` (interrupts immediately). (default `polite`).

## [Properties](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#properties)

### [`message`](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#message)

- **type**: `Ref<string>`
- **description**: The message to announce

### [`politeness`](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#politeness)

- **type**: `Ref<string>`
- **description**: Screen reader announcement urgency level `off`, `polite`, or `assertive`

## [Methods](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#methods)

### [`set(message, politeness = "polite")`](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#setmessage-politeness-polite)

Sets the message to announce with its urgency level.

### [`polite(message)`](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#politemessage)

Sets the message with `politeness = "polite"`

### [`assertive(message)`](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#assertivemessage)

Sets the message with `politeness = "assertive"`

## [Example](https://nuxt.com/docs/4.x/api/composables/use-route-announcer\#example)
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-route-announcer.md)

[useRoute\\
\\
The useRoute composable returns the current route.](https://nuxt.com/docs/4.x/api/composables/use-route) [useRouter\\
\\
The useRouter composable returns the router instance.](https://nuxt.com/docs/4.x/api/composables/use-router)
