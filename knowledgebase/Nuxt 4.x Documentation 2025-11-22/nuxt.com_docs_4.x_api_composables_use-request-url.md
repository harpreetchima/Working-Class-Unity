---
url: "https://nuxt.com/docs/4.x/api/composables/use-request-url"
...
app/pages/about.vueResult in development
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.api/2.composables/use-request-url.md)

[useRequestHeaders\\
\\
Use useRequestHeaders to access the incoming request headers.](https://nuxt.com/docs/4.x/api/composables/use-request-headers) [useResponseHeader\\
\\
Use useResponseHeader to set a server response header.](https://nuxt.com/docs/4.x/api/composables/use-response-header)
