---
url: "https://nuxt.com/docs/4.x/examples/advanced/use-custom-fetch-composable"
title: "Use Custom Fetch Composable · Nuxt Examples v4"
---
...
[Docs > Guide > Recipes > Custom Usefetch](https://nuxt.com/docs/guide/recipes/custom-usefetch) Read more in Docs > Guide > Recipes > Custom Usefetch.

Examples Use Custom Fetch Composable Example - StackBlitz
...
### Examples Use Custom Fetch Composable Example

Run official live example code for Examples Use Custom Fetch Composable, created by Nuxt on StackBlitz
...
[Report an issue](https://github.com/nuxt/nuxt/issues/new/choose) or [Edit this page on GitHub](https://github.com/nuxt/nuxt/edit/main/docs/4.examples/4.advanced/use-custom-fetch-composable.md)

[useCookie\\
\\
This example shows how to use the useCookie API to persist small amounts of data that both client and server can use.](https://nuxt.com/docs/4.x/examples/advanced/use-cookie) [WASM\\
\\
This example demonstrates the server-side support of WebAssembly in Nuxt.](https://nuxt.com/docs/4.x/examples/experimental/wasm)
