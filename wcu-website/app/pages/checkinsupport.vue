  ...
  <div class="bg-base-100 min-h-screen">
    ...
    <section class="py-16 bg-base-200/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-3xl">
          <p class="text-base-content/70 mb-4">{{ $t('request_support.section1.p1') }}</p>
          <p class="text-base-content/70 mb-8">{{ $t('request_support.section1.p2') }}</p>
            ...
            >
              <div class="card-body py-4">
                <div class="flex items-start gap-4">
                  ...
                  <div class="text-left">
                    <p class="text-base text-base-content/80 pt-2">{{ rt(item) }}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="max-w-3xl">
          <ul class="divide-y divide-base-content/10">
            <li 
              ...
              :key="index"
              class="py-4 flex items-start gap-4 hover:bg-base-content/5 -mx-4 px-4 transition-colors"
            >
              <div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center shrink-0 text-primary font-bold">
                {{ index + 1 }}
              </div>
              <span class="text-base text-base-content/80 pt-1">{{ rt(step) }}</span>
            </li>
          </ul>
        </div>
      </div>
