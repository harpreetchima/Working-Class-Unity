...
<template>
  <div class="min-h-screen bg-base-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section class="mb-12">
        <h2 class="text-xs uppercase tracking-wide text-base-content/60 mb-6">{{ $t('kyr_ice_in_public.tactics.title') }}</h2>
          ...
          <div class="card card-border bg-base-100 hover:border-primary/50 transition-colors">
            <div class="card-body p-4">
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h4 class="font-semibold text-sm">Surveillance</h4>
                  <p class="text-xs text-base-content/60">Follow you near your home or in public spaces</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-border bg-base-100 hover:border-primary/50 transition-colors">
            <div class="card-body p-4">
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h4 class="font-semibold text-sm">Plain Clothes</h4>
                  <p class="text-xs text-base-content/60">Wear plain clothes without identifying themselves</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-border bg-base-100 hover:border-primary/50 transition-colors">
            <div class="card-body p-4">
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h4 class="font-semibold text-sm">Identity Confirmation</h4>
                  <p class="text-xs text-base-content/60">Call out your name to confirm your identity</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="mb-12">
        <div class="flex items-center gap-3 mb-6">
          <h2 class="text-xl font-bold tracking-tight">{{ $t('kyr_ice_in_public.stopped.title') }}</h2>
          <span class="badge badge-soft badge-warning">Caution</span>
        </div>

        <!-- Warning Callout: Stay Silent -->
        <div class="alert alert-soft alert-warning border border-warning/30 rounded-xl mb-6">
          <div class="flex items-start gap-3">
        ...
        <div class="alert alert-soft alert-info border border-info/30 rounded-xl mb-6">
          <div class="flex items-start gap-3">
            <!-- Speech bubble icon -->
      ...
      <section class="mb-12">
        <h2 class="text-xs uppercase tracking-wide text-base-content/60 mb-6">{{ $t('kyr_ice_in_public.protect.title') }}</h2>
        
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <!-- Item 1: Record -->
          <div class="group card card-border bg-base-100 hover:border-primary/50 transition-all">
            <div class="card-body p-5">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="font-semibold text-base-content group-hover:text-primary transition-colors">Record</h4>
                  <p class="text-sm text-base-content/60 mt-1">Record the encounter or ask someone to record. Anything you say can be used against you, so stick to repeating your rights.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="group card card-border bg-base-100 hover:border-primary/50 transition-all">
            <div class="card-body p-5">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="font-semibold text-base-content group-hover:text-primary transition-colors">Stay Anonymous</h4>
                  <p class="text-sm text-base-content/60 mt-1">When requesting help, avoid saying your name. Give them a contact's name to send the video.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="group card card-border bg-base-100 hover:border-primary/50 transition-all">
            <div class="card-body p-5">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="font-semibold text-base-content group-hover:text-primary transition-colors">Emergency Card</h4>
                  <p class="text-sm text-base-content/60 mt-1">Carry an emergency card with your lawyer's and family's contact information.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="group card card-border bg-base-100 hover:border-primary/50 transition-all">
            <div class="card-body p-5">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="font-semibold text-base-content group-hover:text-primary transition-colors">Do Not Consent</h4>
                  <p class="text-sm text-base-content/60 mt-1">If searched without consent, say: "I do not consent to this search. I want a lawyer."</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="alert alert-soft alert-info border border-info/30 rounded-xl mt-6">
          <div class="flex items-start gap-3">
            <!-- Speech bubble icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
            ...
            <div>
              <p class="text-xs uppercase tracking-wide text-base-content/60 mb-1">If searched, say this</p>
