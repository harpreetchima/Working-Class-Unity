  ...
  <div class="min-h-screen bg-base-100">
    ...
    <section class="py-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg md:text-xl text-base-content/70 max-w-3xl mx-auto mb-12">
        ...
        <p class="text-xs text-base-content/50 italic mt-8 max-w-2xl mx-auto">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div role="alert" class="alert alert-soft alert-error max-w-3xl mx-auto rounded-xl border border-error/30 mb-12">
          <div class="flex items-center gap-3">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-error animate-pulse shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="card-body">
              ...
              <div class="divide-y divide-base-300">
                <NuxtLinkLocale 
                  ...
                  class="flex items-center justify-between py-4 group hover:bg-base-200/50 -mx-4 px-4 transition-colors first:rounded-t-lg"
                >
                  <div>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-base-content/40 group-hover:text-primary group-hover:translate-x-1 transition-all shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a 
                  href="#" 
                  class="flex items-center justify-between py-4 group hover:bg-base-200/50 -mx-4 px-4 transition-colors"
                >
                  <div>
                    <span class="font-medium text-base-content group-hover:text-primary transition-colors">
                ...
                <a 
                  href="#" 
                  class="flex items-center justify-between py-4 group hover:bg-base-200/50 -mx-4 px-4 transition-colors last:rounded-b-lg"
                >
                  <div>
                    <span class="font-medium text-base-content group-hover:text-primary transition-colors">
