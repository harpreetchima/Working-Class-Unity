  ...
  <div class="bg-white min-h-screen">
    <div class="max-w-[700px] mx-auto px-4 sm:px-6">
      ...
      <header class="pt-8 pb-4 flex justify-between items-center border-b border-base-content/10">
        ...
        <a href="#solidarity" class="btn btn-outline btn-sm rounded-full">Sign the Pledge</a>
      </header>

      <!-- Hero Text (LEFT ALIGNED) -->
      <section class="pt-12 pb-16">
        <span class="text-xs uppercase tracking-[0.15em] text-base-content/50 block mb-3">San Joaquin County</span>
        <h1 class="text-4xl md:text-5xl font-bold tracking-tight text-base-content mb-6">
          {{ $t('unitedfront.title') }}
        </h1>
        <p class="text-base text-base-content/50">Published by WCU • 3 min read</p>
      </section>
      ...
      <section class="py-16 border-t border-base-content/10">
        ...
        <ul class="divide-y divide-base-content/10">
          <li class="py-4 flex items-start gap-4 hover:bg-base-content/5 -mx-4 px-4 transition-colors">
      ...
      <section id="solidarity" class="py-20 border-t border-base-content/10 scroll-mt-20">
        ...
        <div class="flex flex-col sm:flex-row gap-4 max-w-lg">
          <input 
            ...
            class="input input-lg flex-1 border-0 border-b-2 border-base-content/20 rounded-none bg-transparent focus:border-primary focus:outline-none"
          />
          <button class="btn btn-primary btn-lg">Sign</button>
        </div>
      </section>
